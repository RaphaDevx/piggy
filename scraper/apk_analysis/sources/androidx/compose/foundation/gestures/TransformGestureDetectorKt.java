...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                i += (pointerInputChange.getPreviousPressed() && pointerInputChange.getPressed()) ? 1 : 0;
                if (i3 > size) {
                    break;
                }
                i2 = i3;
        ...
        if (size2 >= 0) {
            ...
            while (true) {
                ...
                if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                    ...
                    long m1029minusMKHz9U = Offset.m1029minusMKHz9U(pointerInputChange2.getPreviousPosition(), calculateCentroid2);
                    long m1029minusMKHz9U2 = Offset.m1029minusMKHz9U(position, calculateCentroid);
                    float m246anglek4lQ0M = m246anglek4lQ0M(m1029minusMKHz9U2) - m246anglek4lQ0M(m1029minusMKHz9U);
                    float m1023getDistanceimpl = Offset.m1023getDistanceimpl(Offset.m1030plusMKHz9U(m1029minusMKHz9U2, m1029minusMKHz9U)) / 2.0f;
                    if (m246anglek4lQ0M > 180.0f) {
                        m246anglek4lQ0M -= 360.0f;
                    } else if (m246anglek4lQ0M < -180.0f) {
                        m246anglek4lQ0M += 360.0f;
                    }
                    f += m246anglek4lQ0M * m1023getDistanceimpl;
                    f2 += m1023getDistanceimpl;
                }
                if (i5 > size2) {
                    break;
                }
    ...
    private static final float m246anglek4lQ0M(long j) {
        if (Offset.m1025getXimpl(j) == 0.0f && Offset.m1026getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m1025getXimpl(j), Offset.m1026getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m1022equalsimpl0(calculateCentroid, Offset.INSTANCE.m1040getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m1041getZeroF1C5BW0();
        }
        return Offset.m1029minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                    f += Offset.m1023getDistanceimpl(Offset.m1029minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), calculateCentroid));
                    i2++;
                }
                if (i3 > size) {
                    break;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long m1041getZeroF1C5BW0 = Offset.INSTANCE.m1041getZeroF1C5BW0();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size() - 1;
        int i = 0;
        if (size >= 0) {
            ...
            while (true) {
                ...
                PointerInputChange pointerInputChange = changes.get(i);
                if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                    m1041getZeroF1C5BW0 = Offset.m1030plusMKHz9U(m1041getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                    i2++;
                }
                if (i3 > size) {
                    break;
        ...
        if (i == 0) {
            return Offset.INSTANCE.m1040getUnspecifiedF1C5BW0();
        }
        return Offset.m1020divtuRUvjQ(m1041getZeroF1C5BW0, i);
    }
}
