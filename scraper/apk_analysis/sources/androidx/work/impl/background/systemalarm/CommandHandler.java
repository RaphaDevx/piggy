...
public class CommandHandler implements ExecutionListener {
    ...
    public void m3428lambda$runOnExecuted$1$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
    ...
    private void handleStopWork(Intent intent, SystemAlarmDispatcher dispatcher) {
        ...
        for (StartStopToken startStopToken : remove) {
            ...
            dispatcher.m3428lambda$runOnExecuted$1$androidxworkimplProcessor(startStopToken.getId(), false);
        }
    }
    ...
    private void handleExecutionCompleted(Intent intent, int startId) {
        ...
        m3428lambda$runOnExecuted$1$androidxworkimplProcessor(readWorkGenerationalId, z);
    }
