...
public final class BarcodeCaptureSession implements BarcodeCaptureSessionProxy {
    ...
    public BarcodeCaptureSession(Function0<? extends NativeBarcodeCaptureSession> getImpl) {
        ...
        this.a = LazyKt.lazy(new S(getImpl));
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public long getFrameSequenceId() {
        return ((BarcodeCaptureSessionProxyAdapter) this.a.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public List<LocalizedOnlyBarcode> getNewlyLocalizedBarcodes() {
        return ((BarcodeCaptureSessionProxyAdapter) this.a.getValue()).getNewlyLocalizedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public Barcode getNewlyRecognizedBarcode() {
        return ((BarcodeCaptureSessionProxyAdapter) this.a.getValue()).getNewlyRecognizedBarcode();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public List<Barcode> get_newlyRecognizedBarcodes() {
        return ((BarcodeCaptureSessionProxyAdapter) this.a.getValue()).get_newlyRecognizedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public void reset() {
        ((BarcodeCaptureSessionProxyAdapter) this.a.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public String toJson() {
        return ((BarcodeCaptureSessionProxyAdapter) this.a.getValue()).toJson();
    }
}
