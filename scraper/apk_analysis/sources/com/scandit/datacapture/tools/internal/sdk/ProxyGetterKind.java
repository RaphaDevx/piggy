...
public final class ProxyGetterKind {
    ...
    private static final /* synthetic */ ProxyGetterKind[] a;
    ...
    static {
        ...
        a = proxyGetterKindArr;
        b = EnumEntriesKt.enumEntries(proxyGetterKindArr);
    }

    private ProxyGetterKind(String str, int i) {
    }
    ...
    public static ProxyGetterKind[] values() {
        return (ProxyGetterKind[]) a.clone();
    }
}
