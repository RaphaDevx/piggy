...
final class ExpandShrinkModifier implements LayoutModifier {
    ...
    public final long m94sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        ChangeSize value = this.expand.getValue();
        long packedValue = value == null ? fullSize : value.getSize().invoke(IntSize.m3119boximpl(fullSize)).getPackedValue();
        ChangeSize value2 = this.shrink.getValue();
        long packedValue2 = value2 == null ? fullSize : value2.getSize().invoke(IntSize.m3119boximpl(fullSize)).getPackedValue();
    ...
    public final long m95targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        IntOffset m3076boximpl;
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        if (this.currentAlignment != null && this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m3095getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m3095getZeronOccac();
            }
            ...
            if (value == null) {
                ...
                long packedValue = value.getSize().invoke(IntSize.m3119boximpl(fullSize)).getPackedValue();
                Alignment value2 = getAlignment().getValue();
                Intrinsics.checkNotNull(value2);
                long mo957alignKFBX0sM = value2.mo957alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment currentAlignment = getCurrentAlignment();
                Intrinsics.checkNotNull(currentAlignment);
                long mo957alignKFBX0sM2 = currentAlignment.mo957alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                m3076boximpl = IntOffset.m3076boximpl(IntOffsetKt.IntOffset(IntOffset.m3085getXimpl(mo957alignKFBX0sM) - IntOffset.m3085getXimpl(mo957alignKFBX0sM2), IntOffset.m3086getYimpl(mo957alignKFBX0sM) - IntOffset.m3086getYimpl(mo957alignKFBX0sM2)));
            }
            if (m3076boximpl != null) {
                return m3076boximpl.getPackedValue();
            }
            return IntOffset.INSTANCE.m3095getZeronOccac();
        }
        return IntOffset.INSTANCE.m3095getZeronOccac();
    ...
    public MeasureResult mo56measure3p2s80s(MeasureScope receiver, Measurable measurable, long j) {
        ...
        final long IntSize = IntSizeKt.IntSize(mo2510measureBRTryo0.getWidth(), mo2510measureBRTryo0.getHeight());
        long packedValue2 = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m3119boximpl(m96invokeYEO4UFwYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw-YEO4UFw, reason: not valid java name */
            public final long m96invokeYEO4UFwYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m94sizeByStateUzc_VyU(it, IntSize);
            }
        }).getValue().getPackedValue();
        final long packedValue3 = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            @Override // kotlin.jvm.functions.Function1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m3076boximpl(m97invokeBjo55l4Bjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4-Bjo55l4, reason: not valid java name */
            public final long m97invokeBjo55l4Bjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m95targetOffsetByStateoFUgxo0(it, IntSize);
            }
        }).getValue().getPackedValue();
        Alignment alignment = this.currentAlignment;
        IntOffset m3076boximpl = alignment == null ? null : IntOffset.m3076boximpl(alignment.mo957alignKFBX0sM(IntSize, packedValue2, LayoutDirection.Ltr));
        if (m3076boximpl != null) {
            packedValue = m3076boximpl.getPackedValue();
        } else {
            packedValue = IntOffset.INSTANCE.m3095getZeronOccac();
        }
        final long j2 = packedValue;
        return MeasureScope.DefaultImpls.layout$default(receiver, IntSize.m3127getWidthimpl(packedValue2), IntSize.m3126getHeightimpl(packedValue2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, Placeable.this, IntOffset.m3085getXimpl(j2) + IntOffset.m3085getXimpl(packedValue3), IntOffset.m3086getYimpl(j2) + IntOffset.m3086getYimpl(packedValue3), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
