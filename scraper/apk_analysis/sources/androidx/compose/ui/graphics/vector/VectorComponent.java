...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m1102getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m1090equalsimpl0(this.previousDrawSize, drawScope.mo1627getSizeNHjbRc())) {
            this.root.setScaleX(Size.m1094getWidthimpl(drawScope.mo1627getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m1091getHeightimpl(drawScope.mo1627getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m1716drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m1094getWidthimpl(drawScope.mo1627getSizeNHjbRc())), (int) Math.ceil(Size.m1091getHeightimpl(drawScope.mo1627getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo1627getSizeNHjbRc();
        }
    ...
    public String toString() {
        String str = "Params: \tname: " + getName() + "\n\tviewportWidth: " + getViewportWidth() + "\n\tviewportHeight: " + getViewportHeight() + StringUtils.LF;
