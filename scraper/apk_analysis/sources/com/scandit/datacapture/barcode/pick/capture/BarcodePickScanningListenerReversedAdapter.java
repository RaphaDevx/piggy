...
public final class BarcodePickScanningListenerReversedAdapter extends NativeBarcodePickScanningListener {
    ...
    public void onScanningSessionCompleted(NativeBarcodePick mode, NativeBarcodePickScanningSession session) {
        ...
        if (barcodePickInternal != null) {
            this.a.onScanningSessionCompleted(BarcodeNativeTypeFactory.INSTANCE.convert(mode), (BarcodePickScanningSession) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodePickScanningSession.class), null, session, new c(barcodePickInternal)));
        }
    }
    ...
    public void onScanningSessionUpdated(NativeBarcodePick mode, NativeBarcodePickScanningSession session) {
        ...
        BarcodePickInternal barcodePickInternal = (BarcodePickInternal) this.c.get();
        if (barcodePickInternal != null) {
            this.a.onScanningSessionUpdated(BarcodeNativeTypeFactory.INSTANCE.convert(mode), (BarcodePickScanningSession) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodePickScanningSession.class), null, session, new d(barcodePickInternal)));
        }
    }
