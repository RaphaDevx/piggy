...
public final class BarcodePickState {
    ...
    private static final /* synthetic */ BarcodePickState[] a;
    ...
    public static final class Companion {
        ...
        public final BarcodePickState fromJsonString(String value) {
            ...
            NativeBarcodePickState barcodePickStateFromJsonString = NativeBarcodeEnumDeserializer.barcodePickStateFromJsonString(value);
            Intrinsics.checkNotNull(barcodePickStateFromJsonString);
            return _fromNativeEnum$scandit_barcode_capture(barcodePickStateFromJsonString);
        }
    }
    ...
    static {
        ...
        a = barcodePickStateArr;
        b = EnumEntriesKt.enumEntries(barcodePickStateArr);
        INSTANCE = new Companion(null);
    }

    private BarcodePickState(String str, int i) {
    }
    ...
    public static BarcodePickState[] values() {
        return (BarcodePickState[]) a.clone();
    }
    ...
    public final String toJsonString() {
        String barcodePickStateToString = NativeBarcodeEnumSerializer.barcodePickStateToString(_toNativeEnum$scandit_barcode_capture());
        Intrinsics.checkNotNullExpressionValue(barcodePickStateToString, "barcodePickStateToString(...)");
