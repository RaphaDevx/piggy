...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float f) {
        ...
        this.offset = SnapshotStateKt.mutableStateOf$default(Float.valueOf(f), null, 2, null);
        ...
        this.previousSelection = TextRange.INSTANCE.m2771getZerod9O1mEE();
    ...
    public final void m519setPreviousSelection5zctL8(long j) {
    ...
    public final void update(Orientation orientation, Rect cursorRect, int containerSize, int textFieldSize) {
        ...
        if (cursorRect.getLeft() != this.previousCursorRect.getLeft() || cursorRect.getTop() != this.previousCursorRect.getTop()) {
            ...
            coerceOffset(z ? cursorRect.getTop() : cursorRect.getLeft(), z ? cursorRect.getBottom() : cursorRect.getRight(), containerSize);
            this.previousCursorRect = cursorRect;
        }
        setOffset(RangesKt.coerceIn(getOffset(), 0.0f, f));
    }

    private final void coerceOffset(float cursorStart, float cursorEnd, int containerSize) {
        float offset = getOffset();
        float f = containerSize + offset;
        if (cursorStart < offset) {
            setOffset(getOffset() - (offset - cursorStart));
        } else if (cursorEnd > f) {
            setOffset(getOffset() + (cursorEnd - f));
        }
    }

    /* renamed from: getOffsetToFollow-5zc-tL8, reason: not valid java name */
    public final int m517getOffsetToFollow5zctL8(long selection) {
        return TextRange.m2766getStartimpl(selection) != TextRange.m2766getStartimpl(getPreviousSelection()) ? TextRange.m2766getStartimpl(selection) : TextRange.m2761getEndimpl(selection) != TextRange.m2761getEndimpl(getPreviousSelection()) ? TextRange.m2761getEndimpl(selection) : TextRange.m2764getMinimpl(selection);
    }
