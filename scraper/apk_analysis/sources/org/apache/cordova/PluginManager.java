...
public class PluginManager {
    ...
    private String getLaunchUrlPrefix() {
        if (!this.app.getPreferences().getBoolean("AndroidInsecureFileModeEnabled", false)) {
            return this.app.getPreferences().getString("scheme", SCHEME_HTTPS).toLowerCase() + "://" + this.app.getPreferences().getString("hostname", DEFAULT_HOSTNAME) + JsonPointer.SEPARATOR;
        }
        return "file://";
    }
    ...
    */
    private org.apache.cordova.CordovaPlugin instantiatePlugin(java.lang.String r4) {
        /*
            r3 = this;
            r3 = 0
            if (r4 == 0) goto L12
        ...
        L17:
            r1 = 0
        L18:
            java.lang.Class<org.apache.cordova.CordovaPlugin> r2 = org.apache.cordova.CordovaPlugin.class
            ...
            org.apache.cordova.CordovaPlugin r0 = (org.apache.cordova.CordovaPlugin) r0     // Catch: java.lang.Exception -> L10
            r3 = r0
            goto L44
        L29:
            r0.printStackTrace()
