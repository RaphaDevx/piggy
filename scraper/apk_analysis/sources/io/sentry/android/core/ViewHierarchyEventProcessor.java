...
public final class ViewHierarchyEventProcessor implements EventProcessor {
    ...
    public static ViewHierarchy snapshotViewHierarchy(Activity activity, final List<ViewHierarchyExporter> list, IThreadChecker iThreadChecker, final ILogger iLogger) {
        if (activity == null) {
