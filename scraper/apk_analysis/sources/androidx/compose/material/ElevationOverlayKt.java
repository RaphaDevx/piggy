...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m3005boximpl(m740invokeD9Ej5fMD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM-D9Ej5fM, reason: not valid java name */
        public final float m740invokeD9Ej5fMD9Ej5fM() {
    ...
    public static final long m739calculateForegroundColorCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        long m1253copywmQWz5c$default = Color.m1253copywmQWz5c$default(ColorsKt.m696contentColorForek8zF_U(j, composer, i & 14), ((((float) Math.log(f + 1)) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, null);
