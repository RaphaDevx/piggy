...
public class NotificationCustomizationOptions {
    ...
    public String toString() {
        ...
        return notificationBuilder != null ? String.format(j.a, "{notificationBuilder=%s}", classNameOrNull(notificationBuilder)) : String.format(j.a, "{smallIconResId=%d, launchIntentProvider=%s, channelIdProvider=%s}", Integer.valueOf(this.smallIconResId), classNameOrNull(this.launchIntentProvider), classNameOrNull(this.channelIdProvider));
    }
