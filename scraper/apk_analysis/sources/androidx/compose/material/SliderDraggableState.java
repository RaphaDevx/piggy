...
final class SliderDraggableState implements DraggableState {
    ...
    public SliderDraggableState(Function1<? super Float, Unit> onDelta) {
        ...
        this.isDragging = SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
