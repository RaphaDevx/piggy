...
public final class LocationSelectionDeserializerProxyAdapter implements LocationSelectionDeserializerProxy {
    ...
    public NativeLocationSelectionDeserializer getA() {
        return this.a;
    }

    @Override // com.scandit.datacapture.core.area.serialization.LocationSelectionDeserializerProxy
    public void _setHelper(LocationSelectionDeserializerHelper helper) {
        this.a.setHelper(helper != null ? (LocationSelectionDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(LocationSelectionDeserializerHelper.class), null, helper, new a(helper)) : null);
    }
