...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m1757getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m1523getButtKaPHkGw();
        }
        return m1756getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m1756getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m1523getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m1525getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m1524getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m1759getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m1534getMiterLxFBmk8();
        }
        return m1758getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m1758getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m1534getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m1533getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m1535getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(XmlPullParser xmlPullParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m1290getUnspecified0d7_KjU;
        int m1203getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(xmlPullParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type >= 28 && typedValue.type <= 31) {
                m1290getUnspecified0d7_KjU = ColorKt.Color(typedValue.data);
            } else {
                m1290getUnspecified0d7_KjU = Color.INSTANCE.m1290getUnspecified0d7_KjU();
            }
        } else {
            m1290getUnspecified0d7_KjU = Color.INSTANCE.m1290getUnspecified0d7_KjU();
        }
        long j = m1290getUnspecified0d7_KjU;
        int i = obtainAttributes.getInt(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT_MODE(), -1);
        if (i == -1) {
            m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1203getSrcIn0nO6VwU();
        } else if (i == 3) {
            m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1205getSrcOver0nO6VwU();
        } else if (i == 5) {
            m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1203getSrcIn0nO6VwU();
        } else if (i == 9) {
            m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1202getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1194getModulate0nO6VwU();
                    break;
                case 15:
                    m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1199getScreen0nO6VwU();
                    break;
                case 16:
                    m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1197getPlus0nO6VwU();
                    break;
                default:
                    m1203getSrcIn0nO6VwU = BlendMode.INSTANCE.m1203getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m1203getSrcIn0nO6VwU;
        float m3007constructorimpl = Dp.m3007constructorimpl(dimension / res.getDisplayMetrics().density);
        float m3007constructorimpl2 = Dp.m3007constructorimpl(dimension2 / res.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m3007constructorimpl, m3007constructorimpl2, namedFloat, namedFloat2, j, i2, 1, null);
    }
    ...
    public static final void parsePath(XmlPullParser xmlPullParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m1756getStrokeLineCapCSYIeUk = m1756getStrokeLineCapCSYIeUk(TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m1523getButtKaPHkGw());
        int m1758getStrokeLineJoinkLtJ_vA = m1758getStrokeLineJoinkLtJ_vA(TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m1533getBevelLxFBmk8());
        ...
        builder.m1722addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m1467getNonZeroRgk1Os() : companion.m1466getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m1756getStrokeLineCapCSYIeUk, m1758getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
