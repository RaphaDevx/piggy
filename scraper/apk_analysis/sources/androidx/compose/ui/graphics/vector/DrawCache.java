...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m3132getZeroYbymL2g();
    ...
    public final void m1716drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m3127getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m3126getHeightimpl(size) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m1415ImageBitmapx__hDU$default(IntSize.m3127getWidthimpl(size), IntSize.m3126getHeightimpl(size), 0, false, null, 28, null);
        ...
        long m3137toSizeozmzZPI = IntSizeKt.m3137toSizeozmzZPI(size);
        ...
        drawParams2.m1632setSizeuvyYCjk(m3137toSizeozmzZPI);
        canvas.save();
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.DefaultImpls.m1659drawImage9jGpkUE$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 346, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.DefaultImpls.m1670drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m1280getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m1178getClear0nO6VwU(), 62, null);
    }
}
