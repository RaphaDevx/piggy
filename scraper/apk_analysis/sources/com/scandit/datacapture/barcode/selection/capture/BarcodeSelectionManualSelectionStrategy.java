...
public final class BarcodeSelectionManualSelectionStrategy implements BarcodeSelectionStrategy, BarcodeSelectionManualSelectionStrategyProxy {
    private final /* synthetic */ BarcodeSelectionManualSelectionStrategyProxyAdapter a;

    public BarcodeSelectionManualSelectionStrategy(NativeManualSelectionStrategy impl) {
        Intrinsics.checkNotNullParameter(impl, "impl");
        this.a = new BarcodeSelectionManualSelectionStrategyProxyAdapter(impl, null, 2, null);
    }
    ...
    */
    public BarcodeSelectionManualSelectionStrategy() {
        /*
            r2 = this;
            com.scandit.datacapture.barcode.selection.internal.module.capture.NativeManualSelectionStrategy r0 = com.scandit.datacapture.barcode.selection.internal.module.capture.NativeManualSelectionStrategy.create()
            java.lang.String r1 = "create(...)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)
            r2.<init>(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionManualSelectionStrategy.<init>():void");
    }
}
