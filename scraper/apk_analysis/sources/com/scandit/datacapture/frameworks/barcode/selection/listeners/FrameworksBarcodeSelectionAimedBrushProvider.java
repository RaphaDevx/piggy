...
/* compiled from: FrameworksBarcodeSelectionAimedBrushProvider.kt */
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010%\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0016\u0018\u0000 \u00122\u00020\u0001:\u0001\u0012B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0012\u0010\u0005\u001a\u0004\u0018\u00010\u00072\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u0006\u0010\r\u001a\u00020\u000eJ\u001a\u0010\u000f\u001a\u00020\u000e2\b\u0010\u0010\u001a\u0004\u0018\u00010\n2\b\u0010\u0011\u001a\u0004\u0018\u00010\nR\u0016\u0010\u0005\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\u00070\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/scandit/datacapture/frameworks/barcode/selection/listeners/FrameworksBarcodeSelectionAimedBrushProvider;", "Lcom/scandit/datacapture/barcode/selection/capture/BarcodeSelectionBrushProvider;", "eventEmitter", "Lcom/scandit/datacapture/frameworks/core/events/Emitter;", "(Lcom/scandit/datacapture/frameworks/core/events/Emitter;)V", "brushForBarcode", "Lcom/scandit/datacapture/frameworks/core/events/EventForResult;", "Lcom/scandit/datacapture/core/ui/style/Brush;", "cachedBrushes", "", "", FrameworksBarcodeSelectionAimedBrushProvider.FIELD_BARCODE, "Lcom/scandit/datacapture/barcode/data/Barcode;", "clearCache", "", "onFinishCallback", "brushJson", "selectionIdentifier", "Companion", "scandit-datacapture-frameworks-barcode_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
/* loaded from: classes2.dex */
public class FrameworksBarcodeSelectionAimedBrushProvider implements BarcodeSelectionBrushProvider {
    public static final String BRUSH_FOR_AIMED_BARCODE_EVENT_NAME = "BarcodeSelectionAimedBrushProvider.brushForBarcode";
    ...
    public FrameworksBarcodeSelectionAimedBrushProvider(Emitter eventEmitter) {
        Intrinsics.checkNotNullParameter(eventEmitter, "eventEmitter");
        this.eventEmitter = eventEmitter;
        this.cachedBrushes = new LinkedHashMap();
        this.brushForBarcode = new EventForResult<>(BRUSH_FOR_AIMED_BARCODE_EVENT_NAME, null, null, 6, null);
    }
    ...
    public Brush brushForBarcode(Barcode barcode) {
        ...
        if (!this.eventEmitter.hasListenersForEvent(BRUSH_FOR_AIMED_BARCODE_EVENT_NAME)) {
            return null;
        }
