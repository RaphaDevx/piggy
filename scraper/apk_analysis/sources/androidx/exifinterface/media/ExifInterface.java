...
public class ExifInterface {
            ...
            if ((i6 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i6].get(str3)) != null) {
                if (str4 == null) {
                    ...
                    switch (i) {
                        ...
                        case 3:
                            i2 = i4;
                            String[] split = str4.split(FirebaseConstants.SEPARATOR, -1);
                        ...
                        case 4:
                            i2 = i4;
                            String[] split2 = str4.split(FirebaseConstants.SEPARATOR, -1);
                            ...
                            break;
                        case 5:
                            String[] split3 = str4.split(FirebaseConstants.SEPARATOR, -1);
                        ...
                        case 9:
                            String[] split5 = str4.split(FirebaseConstants.SEPARATOR, -1);
                            ...
                            break;
                        case 10:
                            String[] split6 = str4.split(FirebaseConstants.SEPARATOR, -1);
                            ...
                            break;
                        case 12:
                            String[] split8 = str4.split(FirebaseConstants.SEPARATOR, -1);
    ...
    */
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            String[] split = str.split(FirebaseConstants.SEPARATOR, -1);
    ...
    */
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        if (str.contains(FirebaseConstants.SEPARATOR)) {
            String[] split = str.split(FirebaseConstants.SEPARATOR, -1);
