...
public final class DiagnosticsWorkerKt {
    ...
    public static final String workSpecRows(WorkNameDao workNameDao, WorkTagDao workTagDao, SystemIdInfoDao systemIdInfoDao, List<WorkSpec> list) {
        ...
        for (WorkSpec workSpec : list) {
            ...
            sb.append(workSpecRow(workSpec, CollectionsKt.joinToString$default(workNameDao.getNamesForWorkSpecId(workSpec.id), FirebaseConstants.SEPARATOR, null, null, 0, null, null, 62, null), systemIdInfo != null ? Integer.valueOf(systemIdInfo.systemId) : null, CollectionsKt.joinToString$default(workTagDao.getTagsForWorkSpecId(workSpec.id), FirebaseConstants.SEPARATOR, null, null, 0, null, null, 62, null)));
        }
    ...
    private static final String workSpecRow(WorkSpec workSpec, String str, Integer num, String str2) {
        return StringUtils.LF + workSpec.id + "\t " + workSpec.workerClassName + "\t " + num + "\t " + workSpec.state.name() + "\t " + str + "\t " + str2 + '\t';
    }
}
