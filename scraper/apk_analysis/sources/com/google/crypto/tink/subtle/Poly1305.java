...
class Poly1305 {
    ...
    static byte[] computeMac(byte[] bArr, byte[] bArr2) {
        ...
        long load32 = j45 + load32(bArr, 16);
        long j49 = load32 & 4294967295L;
        long load322 = j46 + load32(bArr, 20) + (load32 >> 32);
        long j50 = load322 & 4294967295L;
        long load323 = j47 + load32(bArr, 24) + (load322 >> 32);
        long j51 = load323 & 4294967295L;
        long load324 = (j48 + load32(bArr, 28) + (load323 >> 32)) & 4294967295L;
        byte[] bArr4 = new byte[16];
        toByteArray(bArr4, j49, 0);
        toByteArray(bArr4, j50, 4);
        toByteArray(bArr4, j51, 8);
