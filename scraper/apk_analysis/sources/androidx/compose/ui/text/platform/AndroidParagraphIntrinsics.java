...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, TypefaceAdapter typefaceAdapter, Density density) {
        ...
        int m2883resolveTextDirectionHeuristics9GRLPo0 = AndroidParagraphIntrinsics_androidKt.m2883resolveTextDirectionHeuristics9GRLPo0(style.getTextDirection(), style.getLocaleList());
        this.textDirectionHeuristic = m2883resolveTextDirectionHeuristics9GRLPo0;
        ...
        this.layoutIntrinsics = new LayoutIntrinsics(createCharSequence, androidTextPaint, m2883resolveTextDirectionHeuristics9GRLPo0);
    }
