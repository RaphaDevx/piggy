...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view, InputMethodManager inputMethodManager) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public final void m2878invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m2878invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m2771getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    */
    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
            ...
            public void mo2845onImeActionKlQnJC8(int imeAction) {
                Function1 function1;
                function1 = TextInputServiceAndroid.this.onImeActionPerformed;
                function1.invoke(ImeAction.m2824boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$stopInput$2
            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m2879invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m2879invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }
        };
    ...
    public void showSoftwareKeyboard() {
        this.showKeyboardChannel.mo5440trySendJP2dKIU(true);
    }

    @Override // androidx.compose.ui.text.input.PlatformTextInputService
    public void hideSoftwareKeyboard() {
        this.showKeyboardChannel.mo5440trySendJP2dKIU(false);
    }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:22:0x0053 -> B:10:0x0056). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object keyboardVisibilityEventLoop(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L46:
            ...
            r0.L$1 = r6
            r0.label = r3
            java.lang.Object r2 = r6.hasNext(r0)
            if (r2 != r1) goto L53
            return r1
        L53:
            r5 = r2
        ...
        L56:
            ...
            java.lang.Object r4 = r4.mo5448tryReceivePtdJZtk()
            java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m5460getOrNullimpl(r4)
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m2759equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            restartInput();
            return;
        }
