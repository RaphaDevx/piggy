    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L19:
            ...
            boolean r6 = r1.getCanceled()     // Catch: java.lang.Throwable -> Ld7
            if (r6 != 0) goto Lcf
            okhttp3.Response r0 = r11.proceed(r0)     // Catch: java.io.IOException -> L91 okhttp3.internal.connection.RouteException -> La9 java.lang.Throwable -> Ld7
            if (r7 == 0) goto L40
            okhttp3.Response$Builder r0 = r0.newBuilder()     // Catch: java.lang.Throwable -> Ld7
            okhttp3.Response$Builder r6 = r7.newBuilder()     // Catch: java.lang.Throwable -> Ld7
            okhttp3.Response$Builder r6 = r6.body(r4)     // Catch: java.lang.Throwable -> Ld7
            okhttp3.Response r6 = r6.build()     // Catch: java.lang.Throwable -> Ld7
            okhttp3.Response$Builder r0 = r0.priorResponse(r6)     // Catch: java.lang.Throwable -> Ld7
            okhttp3.Response r0 = r0.build()     // Catch: java.lang.Throwable -> Ld7
        L40:
            r7 = r0
            okhttp3.internal.connection.Exchange r0 = r1.getInterceptorScopedExchange()     // Catch: java.lang.Throwable -> Ld7
            okhttp3.Request r6 = r10.followUpRequest(r7, r0)     // Catch: java.lang.Throwable -> Ld7
            if (r6 != 0) goto L5a
            if (r0 == 0) goto L56
            boolean r10 = r0.getIsDuplex()     // Catch: java.lang.Throwable -> Ld7
            if (r10 == 0) goto L56
            r1.timeoutEarlyExit()     // Catch: java.lang.Throwable -> Ld7
        L56:
            r1.exitNetworkInterceptorExchange$okhttp(r3)
            return r7
        L5a:
            okhttp3.RequestBody r0 = r6.body()     // Catch: java.lang.Throwable -> Ld7
            if (r0 == 0) goto L6a
            ...
            return r7
        L6a:
            okhttp3.ResponseBody r0 = r7.body()     // Catch: java.lang.Throwable -> Ld7
            if (r0 != 0) goto L71
            goto L76
        L71:
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch: java.lang.Throwable -> Ld7
            okhttp3.internal.Util.closeQuietly(r0)     // Catch: java.lang.Throwable -> Ld7
        L76:
            int r8 = r8 + 1
            r0 = 20
            if (r8 > r0) goto L81
            ...
            goto L18
        L81:
            java.net.ProtocolException r10 = new java.net.ProtocolException     // Catch: java.lang.Throwable -> Ld7
            java.lang.String r11 = "Too many follow-up requests: "
            java.lang.Integer r0 = java.lang.Integer.valueOf(r8)     // Catch: java.lang.Throwable -> Ld7
            java.lang.String r11 = kotlin.jvm.internal.Intrinsics.stringPlus(r11, r0)     // Catch: java.lang.Throwable -> Ld7
            r10.<init>(r11)     // Catch: java.lang.Throwable -> Ld7
            throw r10     // Catch: java.lang.Throwable -> Ld7
        L91:
            r6 = move-exception
            boolean r9 = r6 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch: java.lang.Throwable -> Ld7
            r9 = r9 ^ r5
            boolean r9 = r10.recover(r6, r1, r0, r9)     // Catch: java.lang.Throwable -> Ld7
            if (r9 == 0) goto La2
            java.util.Collection r2 = (java.util.Collection) r2     // Catch: java.lang.Throwable -> Ld7
            java.util.List r2 = kotlin.collections.CollectionsKt.plus(r2, r6)     // Catch: java.lang.Throwable -> Ld7
            goto Lbe
        La2:
            java.lang.Exception r6 = (java.lang.Exception) r6     // Catch: java.lang.Throwable -> Ld7
            java.lang.Throwable r10 = okhttp3.internal.Util.withSuppressed(r6, r2)     // Catch: java.lang.Throwable -> Ld7
            throw r10     // Catch: java.lang.Throwable -> Ld7
        La9:
            r6 = move-exception
            java.io.IOException r9 = r6.getLastConnectException()     // Catch: java.lang.Throwable -> Ld7
            boolean r9 = r10.recover(r9, r1, r0, r3)     // Catch: java.lang.Throwable -> Ld7
            if (r9 == 0) goto Lc4
            java.util.Collection r2 = (java.util.Collection) r2     // Catch: java.lang.Throwable -> Ld7
            java.io.IOException r6 = r6.getFirstConnectException()     // Catch: java.lang.Throwable -> Ld7
            java.util.List r2 = kotlin.collections.CollectionsKt.plus(r2, r6)     // Catch: java.lang.Throwable -> Ld7
        Lbe:
            r1.exitNetworkInterceptorExchange$okhttp(r5)
            r6 = r3
            goto L19
        Lc4:
            java.io.IOException r10 = r6.getFirstConnectException()     // Catch: java.lang.Throwable -> Ld7
            java.lang.Exception r10 = (java.lang.Exception) r10     // Catch: java.lang.Throwable -> Ld7
            java.lang.Throwable r10 = okhttp3.internal.Util.withSuppressed(r10, r2)     // Catch: java.lang.Throwable -> Ld7
            throw r10     // Catch: java.lang.Throwable -> Ld7
        Lcf:
            java.io.IOException r10 = new java.io.IOException     // Catch: java.lang.Throwable -> Ld7
    ...
    private final Request buildRedirectRequest(Response userResponse, String method) {
        ...
        HttpUrl resolve;
        if (!this.client.followRedirects() || (header$default = Response.header$default(userResponse, javax.ws.rs.core.HttpHeaders.LOCATION, null, 2, null)) == null || (resolve = userResponse.request().url().resolve(header$default)) == null) {
            return null;
        }
        ...
        if (HttpMethod.permitsRequestBody(method)) {
            ...
            if (!z) {
                ...
                newBuilder.removeHeader(javax.ws.rs.core.HttpHeaders.CONTENT_LENGTH);
                newBuilder.removeHeader(javax.ws.rs.core.HttpHeaders.CONTENT_TYPE);
            }
        }
        if (!Util.canReuseConnectionFor(userResponse.request().url(), resolve)) {
            newBuilder.removeHeader(javax.ws.rs.core.HttpHeaders.AUTHORIZATION);
        }
        return newBuilder.url(resolve).build();
    }

    private final int retryAfter(Response userResponse, int defaultDelay) {
        String header$default = Response.header$default(userResponse, javax.ws.rs.core.HttpHeaders.RETRY_AFTER, null, 2, null);
