...
import ch.coop.apidia.appGateway.employeeDiscountCard.auth.ApiKeyAuth;
import ch.coop.apidia.appGateway.employeeDiscountCard.auth.Authentication;
import ch.coop.apidia.appGateway.employeeDiscountCard.auth.HttpBasicAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        this.basePath = "https://entw-api.supercard.ch/employee-discount-cards/api/v1";
        this.servers = new ArrayList(Arrays.asList(new ServerConfiguration("https://{environment}/employee-discount-cards/api/{version}", "App Gateway Employee Discount Card", new HashMap<String, ServerVariable>() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.ApiClient.1
            {
                put("environment", new ServerVariable("Environment", "entw-api.supercard.ch", new HashSet(Arrays.asList("entw-api.supercard.ch", "test-api.supercard.ch", "api.supercard.ch", "bdr-agwemployeediscountcard-develop.coop-appgateway-staging1.sz-gc.coop.ch", "bdr-agwemployeediscountcard-gkesz-test.coop-appgateway-staging1.sz-gc.coop.ch"))));
    ...
    */
    public java.io.File prepareDownloadFile(okhttp3.Response r7) throws java.io.IOException {
        ...
        L7f:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: ch.coop.apidia.appGateway.employeeDiscountCard.ApiClient.prepareDownloadFile(okhttp3.Response):java.io.File");
    }
    ...
    public <T> void executeAsync(Call call, final Type type, final ApiCallback<T> apiCallback) {
        call.enqueue(new Callback() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.ApiClient.2
    ...
    private Interceptor getProgressInterceptor() {
        return new Interceptor() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.ApiClient.3
    ...
    private void applySslSettings() {
        ...
        try {
            if (!this.verifyingSsl) {
                trustManagers = new TrustManager[]{new X509TrustManager() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.ApiClient.4
                ...
                hostnameVerifier = new HostnameVerifier() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.ApiClient.5
