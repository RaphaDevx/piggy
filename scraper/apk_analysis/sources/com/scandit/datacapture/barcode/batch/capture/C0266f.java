...
public final class C0266f implements BarcodeBatchDeserializerHelper, DataCaptureDeserializerHelper {
    ...
    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchDeserializerHelper
    public final void changeAdvancedOverlayAddedToView(BarcodeBatchAdvancedOverlay overlay, DataCaptureView view, boolean z) {
    ...
    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchDeserializerHelper
    public final void changeBasicOverlayAddedToView(BarcodeBatchBasicOverlay overlay, DataCaptureView view, boolean z) {
        Intrinsics.checkNotNullParameter(overlay, "overlay");
        Intrinsics.checkNotNullParameter(view, "view");
        if (z) {
            view.addOverlay(overlay);
