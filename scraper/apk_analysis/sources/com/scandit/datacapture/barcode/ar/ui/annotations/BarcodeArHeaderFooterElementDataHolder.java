...
public final /* data */ class BarcodeArHeaderFooterElementDataHolder {
    ...
    public BarcodeArHeaderFooterElementDataHolder(int i, ScanditIcon scanditIcon, String str, Typeface typeface, float f, int i2, boolean z, BarcodeArInfoAnnotationWidthPreset width, boolean z2, Function0<Unit> elementTapped) {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (hashCode + (scanditIcon == null ? 0 : scanditIcon.hashCode())) * 31;
        String str = this.text;
        return this.elementTapped.hashCode() + ((Boolean.hashCode(this.isHeader) + ((this.width.hashCode() + ((Boolean.hashCode(this.isEntireAnnotationTappable) + ((Integer.hashCode(this.textColor) + ((Float.hashCode(this.textSize) + ((this.typeface.hashCode() + ((hashCode2 + (str != null ? str.hashCode() : 0)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31);
    }
