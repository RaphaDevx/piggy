...
final class Profiling$registerForAllProfilingResults$1 extends SuspendLambda implements Function2<ProducerScope<? super ProfilingResult>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ProfilingManager m3349m = Profiling$$ExternalSyntheticApiModelOutline0.m3349m(this.$context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m3359m()));
            m3349m.registerForAllProfilingResults(new Executor() { // from class: androidx.core.os.Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda1
            ...
            if (ProduceKt.awaitClose(producerScope, new Function0<Unit>() { // from class: androidx.core.os.Profiling$registerForAllProfilingResults$1.2
                ...
                public final void invoke2() {
                    m3349m.unregisterForAllProfilingResults(consumer);
                }
    ...
    public static final void invokeSuspend$lambda$0(ProducerScope producerScope, ProfilingResult result) {
        ...
        producerScope.mo5440trySendJP2dKIU(result);
    }
}
