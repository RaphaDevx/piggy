...
public final class BarcodeArCircleHighlight implements BarcodeArHighlight {
    ...
    public static final class Companion {
        ...
        public final int getADDED_PULSE_SIZE$scandit_barcode_capture() {
            return ((Number) BarcodeArCircleHighlight.j.getValue()).intValue();
        }
    }
    ...
    public View createView() {
        FrameLayout container = new FrameLayout(this.a);
        container.setBackground(this.g);
        ...
        PulsingView pulsingView = new PulsingView(context, aDDED_PULSE_SIZE$scandit_barcode_capture, i3, gradientColors);
    ...
    public final void setSize(float f) {
        float coerceAtLeast = RangesKt.coerceAtLeast(f, 18.0f);
        this.size = coerceAtLeast;
        this.sizeInPx = PixelExtensionsKt.pxFromDp$default(coerceAtLeast, (Context) null, 1, (Object) null);
    }

    public final void setSizeInPx$scandit_barcode_capture(float f) {
        this.sizeInPx = f;
    }
    ...
    public void update(View view, Quadrilateral barcodeLocation) {
        ...
        ImageView imageView = (ImageView) view.findViewById(R.id.sc_ar_circle_highlight_icon);
        if (imageView != null) {
            ScanditIcon scanditIcon = this.icon;
            if (scanditIcon != null) {
                Context context = imageView.getContext();
                Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
                drawable = ScanditIconUtilsKt.getDrawableIgnoringBackground(scanditIcon, context);
            } else {
                drawable = null;
            }
            imageView.setImageDrawable(drawable);
            ViewGroup.LayoutParams layoutParams2 = imageView.getLayoutParams();
            int i2 = (int) (this.sizeInPx / 2);
