...
public final class BarcodeCountViewDeserializer {
    ...
    public final void updateViewFromJson(BarcodeCountView view, String json) {
        BarcodeFilterHighlightSettings _create;
        ...
        if (jsonValue.contains("style")) {
            this.a.add("Can't use while updating: \"style\"");
        }
        Boolean valueOf = !jsonValue.contains("shouldDisableModeOnExitButtonTapped") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldDisableModeOnExitButtonTapped", false));
        if (valueOf != null) {
            view.setShouldDisableModeOnExitButtonTapped(valueOf.booleanValue());
        }
        Boolean valueOf2 = !jsonValue.contains("shouldShowClearHighlightsButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowClearHighlightsButton", false));
        if (valueOf2 != null) {
            view.setShouldShowClearHighlightsButton(valueOf2.booleanValue());
        }
        Boolean valueOf3 = !jsonValue.contains("shouldShowExitButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowExitButton", false));
        if (valueOf3 != null) {
            view.setShouldShowExitButton(valueOf3.booleanValue());
        }
        Boolean valueOf4 = !jsonValue.contains("shouldShowFloatingShutterButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowFloatingShutterButton", false));
        if (valueOf4 != null) {
            view.setShouldShowFloatingShutterButton(valueOf4.booleanValue());
        }
        Boolean valueOf5 = !jsonValue.contains("shouldShowListButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowListButton", false));
        if (valueOf5 != null) {
            view.setShouldShowListButton(valueOf5.booleanValue());
        }
        Boolean valueOf6 = !jsonValue.contains("shouldShowShutterButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowShutterButton", false));
        if (valueOf6 != null) {
            view.setShouldShowShutterButton(valueOf6.booleanValue());
        }
        Boolean valueOf7 = !jsonValue.contains("shouldShowSingleScanButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowSingleScanButton", false));
        if (valueOf7 != null) {
            view.setShouldShowSingleScanButton(valueOf7.booleanValue());
        }
        Boolean valueOf8 = !jsonValue.contains("shouldShowStatusModeButton") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowStatusModeButton", false));
        if (valueOf8 != null) {
            view.setShouldShowStatusModeButton(valueOf8.booleanValue());
        }
        Boolean valueOf9 = !jsonValue.contains("shouldShowToolbar") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowToolbar", false));
        if (valueOf9 != null) {
            view.setShouldShowToolbar(valueOf9.booleanValue());
        }
        Boolean valueOf10 = !jsonValue.contains("shouldShowUserGuidanceView") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowUserGuidanceView", false));
        if (valueOf10 != null) {
            view.setShouldShowUserGuidanceView(valueOf10.booleanValue());
        }
        Boolean valueOf11 = !jsonValue.contains("shouldShowListProgressBar") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowListProgressBar", false));
        if (valueOf11 != null) {
            view.setShouldShowListProgressBar(valueOf11.booleanValue());
        }
        Boolean valueOf12 = !jsonValue.contains("tapToUncountEnabled") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("tapToUncountEnabled", false));
        if (valueOf12 != null) {
            view.setTapToUncountEnabled(valueOf12.booleanValue());
        }
        Boolean valueOf13 = !jsonValue.contains("shouldShowStatusIconsOnScan") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowStatusIconsOnScan", false));
        if (valueOf13 != null) {
            view.setShouldShowStatusIconsOnScan(valueOf13.booleanValue());
        }
        Boolean valueOf14 = !jsonValue.contains("shouldShowScanAreaGuides") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowScanAreaGuides", false));
        if (valueOf14 != null) {
            view.setShouldShowScanAreaGuides(valueOf14.booleanValue());
        }
        Brush a = a(jsonValue, "recognizedBrush");
        if (a != null) {
            view.setRecognizedBrush(a);
        }
        Brush a2 = a(jsonValue, "notInListBrush");
        if (a2 != null) {
            view.setNotInListBrush(a2);
        }
        Brush a3 = a(jsonValue, "acceptedBrush");
        if (a3 != null) {
            view.setAcceptedBrush(a3);
        }
        Brush a4 = a(jsonValue, "rejectedBrush");
        if (a4 != null) {
            view.setRejectedBrush(a4);
        }
        Boolean valueOf15 = !jsonValue.contains("shouldShowHints") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowHints", false));
        if (valueOf15 != null) {
            view.setShouldShowHints(valueOf15.booleanValue());
        }
        JsonValue byKeyAsObject = jsonValue.getByKeyAsObject("filterSettings", null);
        if (byKeyAsObject == null) {
            _create = null;
        } else {
            _create = BarcodeFilterHighlightSettings.INSTANCE._create();
            Brush a5 = a(byKeyAsObject, "brush");
            if (a5 != null) {
                _create._setBrush(a5);
            }
            BarcodeFilterHighlightType barcodeFilterHighlightType = BarcodeFilterHighlightType.BRUSH;
            Intrinsics.areEqual(byKeyAsObject.getByKeyAsString("highlightType", ""), "brush");
            _create._setHighlightType(barcodeFilterHighlightType);
        }
        if (_create != null) {
            view.setFilterSettings(_create);
        }
        ...
        if (byKeyAsObject3 != null) {
            ...
            Boolean valueOf16 = !byKeyAsObject3.contains(ExtentionsKt.ENABLED_KEY) ? null : Boolean.valueOf(byKeyAsObject3.getByKeyAsBoolean(ExtentionsKt.ENABLED_KEY, false));
            if (valueOf16 != null) {
                barcodeCountNotInListActionSettings.setEnabled(valueOf16.booleanValue());
            }
        ...
        Boolean valueOf17 = !jsonValue.contains("shouldShowTorchControl") ? null : Boolean.valueOf(jsonValue.getByKeyAsBoolean("shouldShowTorchControl", false));
        if (valueOf17 != null) {
            view.setShouldShowTorchControl(valueOf17.booleanValue());
        }
        String byKeyAsString36 = !jsonValue.contains("torchControlPosition") ? null : jsonValue.getByKeyAsString("torchControlPosition", "");
        Anchor fromJson = byKeyAsString36 != null ? AnchorDeserializer.fromJson(byKeyAsString36) : null;
        if (fromJson != null) {
            view.setTorchControlPosition(fromJson);
        }
    ...
    public final BarcodeCountView viewFromJson(Context context, DataCaptureContext dataCaptureContext, BarcodeCount mode, String json) {
        ...
        if (Intrinsics.areEqual(byKeyAsString, "dot")) {
            barcodeCountViewStyle = BarcodeCountViewStyle.DOT;
        } else {
            Intrinsics.areEqual(byKeyAsString, BarcodePickDeserializer.FIELD_ICON);
        }
        jsonValue._removeKeys(CollectionsKt.arrayListOf("style"));
        BarcodeCountView newInstance = BarcodeCountView.INSTANCE.newInstance(context, dataCaptureContext, mode, barcodeCountViewStyle);
        updateViewFromJson(newInstance, jsonValue.jsonString());
        return newInstance;
    }
}
