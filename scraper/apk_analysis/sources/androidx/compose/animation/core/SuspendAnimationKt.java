...
public final class SuspendAnimationKt {
    ...
    public static final <T, V extends AnimationVector> Object animate(final TwoWayConverter<T, V> twoWayConverter, T t, T t2, T t3, AnimationSpec<T> animationSpec, final Function2<? super T, ? super T, Unit> function2, Continuation<? super Unit> continuation) {
        V invoke = t3 == null ? null : twoWayConverter.getConvertToVector().invoke(t3);
        if (invoke == null) {
            invoke = AnimationVectorsKt.newInstance(twoWayConverter.getConvertToVector().invoke(t));
        }
        Object animate$default = animate$default(new AnimationState(twoWayConverter, t, invoke, 0L, 0L, false, 56, null), new TargetBasedAnimation(animationSpec, twoWayConverter, t, t2, invoke), 0L, new Function1<AnimationScope<T, V>, Unit>() { // from class: androidx.compose.animation.core.SuspendAnimationKt$animate$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x00ed A[Catch: CancellationException -> 0x0062, TRY_LEAVE, TryCatch #0 {CancellationException -> 0x0062, blocks: (B:12:0x005b, B:15:0x00de, B:17:0x00ed), top: B:11:0x005b }] */
