...
public final class ScanditIconBuilder {
    ...
    private ScanditIconType a;
    private Integer b;
    private Integer c;
    private Integer d;
    private float e = 2.0f;
    private ScanditIconShape f;

    public final ScanditIcon build() {
        return new ScanditIcon(this.a, this.b, this.c, this.d, this.e, this.f);
    }
