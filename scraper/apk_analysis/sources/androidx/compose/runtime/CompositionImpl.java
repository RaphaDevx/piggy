...
public final class CompositionImpl implements ControlledComposition {
    ...
    public CompositionImpl(CompositionContext parent, Applier<?> applier, CoroutineContext coroutineContext) {
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m929getLambda1$runtime_release();
    }
    ...
    public void dispose() {
        synchronized (this.lock) {
            if (!this.disposed) {
                this.disposed = true;
                setComposable(ComposableSingletons$CompositionKt.INSTANCE.m930getLambda2$runtime_release());
    ...
    private final void addPendingInvalidationsLocked(Set<? extends Object> values) {
                    ...
                    while (true) {
                        ...
                        if (obj2 != null) {
                            if (!hashSet.contains((RecomposeScopeImpl) obj2)) {
                                if (i != i7) {
                                    identityArraySet.getValues()[i] = obj2;
                                }
                                i++;
                            }
                            if (i8 >= size2) {
        ...
        if (i2 < size4) {
            ...
            while (true) {
                int i13 = i12 + 1;
                identityScopeMap2.getValues()[identityScopeMap2.getValueOrder()[i12]] = null;
                if (i13 >= size4) {
                    break;
                } else {
                    i12 = i13;
                ...
                try {
                    ...
                    if (getPendingInvalidScopes()) {
                        ...
                        if (size6 > 0) {
                            ...
                            while (true) {
                                ...
                                if (size7 > 0) {
                                    ...
                                    while (true) {
                                        int i23 = i22 + 1;
                                        Object obj2 = identityArraySet2.getValues()[i22];
                                        if (obj2 != null) {
                                            if (this.observations.contains((DerivedState) obj2)) {
                                                if (i3 != i22) {
                                                    identityArraySet2.getValues()[i3] = obj2;
                                                }
                                                i3++;
                                            }
                                            if (i23 >= size7) {
                                ...
                                if (i3 < size8) {
                                    ...
                                    while (true) {
                                        int i25 = i24 + 1;
                                        identityArraySet2.getValues()[i24] = null;
                                        if (i25 >= size8) {
                                            break;
                                        } else {
                                            i24 = i25;
                        ...
                        if (i2 < size9) {
                            ...
                            while (true) {
                                int i28 = i27 + 1;
                                identityScopeMap2.getValues()[identityScopeMap2.getValueOrder()[i27]] = null;
                                if (i28 >= size9) {
                                    break;
                                } else {
                                    i27 = i28;
