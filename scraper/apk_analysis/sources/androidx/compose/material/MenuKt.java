...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m3007constructorimpl(16);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m3007constructorimpl(b.p);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m3007constructorimpl(280);
    ...
    */
    ...
    public static final float m767DropdownMenuContent$lambda1(State<Float> state) {
        return state.getValue().floatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: DropdownMenuContent$lambda-3, reason: not valid java name */
    public static final float m768DropdownMenuContent$lambda3(State<Float> state) {
        return state.getValue().floatValue();
    }

    static {
        float f = 8;
        MenuElevation = Dp.m3007constructorimpl(f);
        float f2 = 48;
        MenuVerticalMargin = Dp.m3007constructorimpl(f2);
        DropdownMenuVerticalPadding = Dp.m3007constructorimpl(f);
        DropdownMenuItemDefaultMinHeight = Dp.m3007constructorimpl(f2);
    }
}
