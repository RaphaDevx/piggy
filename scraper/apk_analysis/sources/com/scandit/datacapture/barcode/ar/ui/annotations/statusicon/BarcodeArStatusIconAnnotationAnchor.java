...
public final class BarcodeArStatusIconAnnotationAnchor {
    ...
    private static final /* synthetic */ BarcodeArStatusIconAnnotationAnchor[] a;
    ...
    static {
        ...
        a = barcodeArStatusIconAnnotationAnchorArr;
        b = EnumEntriesKt.enumEntries(barcodeArStatusIconAnnotationAnchorArr);
    }

    private BarcodeArStatusIconAnnotationAnchor(String str, int i) {
    }
    ...
    public static BarcodeArStatusIconAnnotationAnchor[] values() {
        return (BarcodeArStatusIconAnnotationAnchor[]) a.clone();
    }
}
