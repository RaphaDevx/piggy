...
public final class ZoomSwitchControl implements Control {
    ...
    private String contentDescriptionWhenZoomedOut;

    /* renamed from: d, reason: from kotlin metadata */
    private String contentDescriptionWhenZoomedIn;

    /* renamed from: e, reason: from kotlin metadata */
    private volatile ZoomState currentZoomState;
    private volatile ZoomGesture f;
    private WeakReference g;
    private WeakReference h;
    private ZoomSwitchControl$_onFrameSourceChanged$2 i;
    private final ZoomSwitchControl$zoomGestureListener$1 j;
    ...
    public ZoomSwitchControl(ZoomControlIconsHandler iconsHandler, ToggleImageButton view) {
        ...
        this.a = iconsHandler;
        this.b = view;
        String string = view.getContext().getString(R.string.sc_cd_zoom_control);
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        this.contentDescriptionWhenZoomedOut = string;
        String string2 = view.getContext().getString(R.string.sc_cd_zoom_control);
        Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
        this.contentDescriptionWhenZoomedIn = string2;
        this.currentZoomState = ZoomState.ZoomedOut.INSTANCE;
        this.g = new WeakReference(null);
        this.h = new WeakReference(null);
        this.j = new ZoomGestureListener() { // from class: com.scandit.datacapture.core.ui.control.ZoomSwitchControl$zoomGestureListener$1
        ...
        iconsHandler.a((AnonymousClass1) new com.scandit.datacapture.core.internal.module.ui.control.zoom.b() { // from class: com.scandit.datacapture.core.ui.control.ZoomSwitchControl.1
            ...
            public void onIconsChanged(ZoomState state, boolean pressed) {
                ...
                if (Intrinsics.areEqual(ZoomSwitchControl.this.getCurrentZoomState(), state) && ZoomSwitchControl.this.b.b() == pressed) {
                    ZoomSwitchControl.this.a();
                }
            }
        });
    ...
    public final synchronized void a() {
        String str;
        Bitmap a = this.a.a(this.currentZoomState, this.b.b());
        if (a != null) {
        ...
        if (Intrinsics.areEqual(zoomState, ZoomState.ZoomedIn.INSTANCE)) {
            str = this.contentDescriptionWhenZoomedIn;
        } else {
            if (!Intrinsics.areEqual(zoomState, ZoomState.ZoomedOut.INSTANCE)) {
                throw new NoWhenBranchMatchedException();
            }
            str = this.contentDescriptionWhenZoomedOut;
        }
    ...
    public static final void access$toggleZoom(ZoomSwitchControl zoomSwitchControl) {
        ...
        if (zoomState2 instanceof ZoomState.ZoomedOut) {
            DataCaptureView dataCaptureView = (DataCaptureView) zoomSwitchControl.g.get();
            ...
            DataCaptureView dataCaptureView2 = (DataCaptureView) zoomSwitchControl.g.get();
    ...
    public void _onDataCaptureViewChanged(DataCaptureView dataCaptureView) {
        ...
        if (Intrinsics.areEqual(this.f, zoomGesture)) {
            return;
        }
        ZoomGesture zoomGesture2 = this.f;
        if (zoomGesture2 != null) {
            zoomGesture2.removeListener(this.j);
        }
        this.f = zoomGesture;
        ZoomGesture zoomGesture3 = this.f;
        if (zoomGesture3 != null) {
            zoomGesture3.addListener(this.j);
        }
        ZoomGesture zoomGesture4 = this.f;
    ...
    public void _onFrameSourceChanged(FrameSource frameSource) {
        ...
        DataCaptureView dataCaptureView = (DataCaptureView) this.g.get();
        if (dataCaptureView != null) {
            dataCaptureView._performUiTriggeredZoomOut();
        }
        this.currentZoomState = ZoomState.ZoomedOut.INSTANCE;
        a();
        ZoomSwitchControl$_onFrameSourceChanged$2 zoomSwitchControl$_onFrameSourceChanged$2 = this.i;
        if (zoomSwitchControl$_onFrameSourceChanged$2 != null && (frameSource2 = (FrameSource) this.h.get()) != null) {
        ...
        ?? r3 = new FrameSourceListener() { // from class: com.scandit.datacapture.core.ui.control.ZoomSwitchControl$_onFrameSourceChanged$2
    ...
    public void _onRemoveControl() {
        ...
        ZoomSwitchControl$_onFrameSourceChanged$2 zoomSwitchControl$_onFrameSourceChanged$2 = this.i;
        if (zoomSwitchControl$_onFrameSourceChanged$2 != null && (frameSource = (FrameSource) this.h.get()) != null) {
    ...
    public final String getContentDescriptionWhenZoomedIn() {
        return this.contentDescriptionWhenZoomedIn;
    }

    public final String getContentDescriptionWhenZoomedOut() {
        return this.contentDescriptionWhenZoomedOut;
    }
    ...
    public final void setContentDescriptionWhenZoomedIn(String str) {
        Intrinsics.checkNotNullParameter(str, "<set-?>");
        this.contentDescriptionWhenZoomedIn = str;
    }

    public final void setContentDescriptionWhenZoomedOut(String str) {
        Intrinsics.checkNotNullParameter(str, "<set-?>");
        this.contentDescriptionWhenZoomedOut = str;
    }
