...
public final class InitializationState {
    ...
    private static final /* synthetic */ InitializationState[] a;
    ...
    static {
        ...
        a = initializationStateArr;
        b = EnumEntriesKt.enumEntries(initializationStateArr);
    }
    ...
    public static InitializationState[] values() {
        return (InitializationState[]) a.clone();
    }
}
