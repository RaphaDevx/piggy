...
public final class Profiling {
    ...
    public static final void registerForAllProfilingResults(Context context, Executor executor, Consumer<ProfilingResult> listener) {
        ...
        Profiling$$ExternalSyntheticApiModelOutline0.m3349m(context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m3359m())).registerForAllProfilingResults(executor, listener);
    }

    public static final void unregisterForAllProfilingResults(Context context, Consumer<ProfilingResult> listener) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(listener, "listener");
        Profiling$$ExternalSyntheticApiModelOutline0.m3349m(context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m3359m())).unregisterForAllProfilingResults(listener);
    }
    ...
    public static final void requestProfiling(Context context, ProfilingRequest profilingRequest, Executor executor, Consumer<ProfilingResult> consumer) {
        ...
        Profiling$$ExternalSyntheticApiModelOutline0.m3349m(context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m3359m())).requestProfiling(profilingRequest.getProfilingType(), profilingRequest.getParams(), profilingRequest.getTag(), profilingRequest.getCancellationSignal(), executor, consumer);
    }
}
