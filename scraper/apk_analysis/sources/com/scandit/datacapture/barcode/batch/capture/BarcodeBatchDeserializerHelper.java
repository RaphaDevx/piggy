...
public interface BarcodeBatchDeserializerHelper extends DataCaptureDeserializerHelper {
    ...
    @Deprecated(message = "Scenarios are no longer supported")
    @ProxyCacheResult
    @ProxyFunction
