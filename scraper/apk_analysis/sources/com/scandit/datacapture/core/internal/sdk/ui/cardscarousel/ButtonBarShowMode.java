...
public final class ButtonBarShowMode {
    ...
    private static final /* synthetic */ ButtonBarShowMode[] a;
    ...
    static {
        ...
        a = buttonBarShowModeArr;
        b = EnumEntriesKt.enumEntries(buttonBarShowModeArr);
    }

    private ButtonBarShowMode(String str, int i) {
    }
    ...
    public static ButtonBarShowMode[] values() {
        return (ButtonBarShowMode[]) a.clone();
    }
}
