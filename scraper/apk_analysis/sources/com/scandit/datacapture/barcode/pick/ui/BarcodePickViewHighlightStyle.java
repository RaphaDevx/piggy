...
public interface BarcodePickViewHighlightStyle {
    ...
    public static final class DotWithIcons implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleDotWithIconsProxy {
        ...
        public DotWithIcons(NativeBarcodePickViewHighlightStyleDotWithIcons nativeBarcodePickViewHighlightStyleDotWithIcons, BarcodePickHighlightStyleIconsHolder barcodePickHighlightStyleIconsHolder, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this(nativeBarcodePickViewHighlightStyleDotWithIcons, (i & 2) != 0 ? new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.f() : barcodePickHighlightStyleIconsHolder);
        }
        ...
        @NativeImpl
        /* renamed from: _impl */
        public NativeBarcodePickViewHighlightStyleDotWithIcons getA() {
            return this.a.getA();
        }
        ...
        public Brush getSelectedBrushForState(BarcodePickState state) {
            Intrinsics.checkNotNullParameter(state, "state");
            return this.a.getSelectedBrushForState(state);
        }
        ...
        public boolean getStyleResponseCacheEnabled() {
            return this.a.getStyleResponseCacheEnabled();
        }
        ...
        public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.checkNotNullParameter(state, "state");
            this.a.setSelectedBrushForState(brush, state);
        }
        ...
        public void setStyleResponseCacheEnabled(boolean z) {
            this.a.setStyleResponseCacheEnabled(z);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyle
        public String toJson() {
            return com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.b.a(this, getA().toJson());
        }
    ...
    public static final class RectangularWithIcons implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleRectangularWithIconsProxy {
        ...
        public RectangularWithIcons(NativeBarcodePickViewHighlightStyleRectangularWithIcons nativeBarcodePickViewHighlightStyleRectangularWithIcons, BarcodePickHighlightStyleIconsHolder barcodePickHighlightStyleIconsHolder, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this(nativeBarcodePickViewHighlightStyleRectangularWithIcons, (i & 2) != 0 ? new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.f() : barcodePickHighlightStyleIconsHolder);
        }
        ...
        @NativeImpl
        /* renamed from: _impl */
        public NativeBarcodePickViewHighlightStyleRectangularWithIcons getA() {
            return this.a.getA();
        }
        ...
        public final BarcodePickStatusIconSettings getStatusIconSettings() {
            NativeBarcodePickStatusIconSettings statusIconSettings = getA().getStatusIconSettings();
            Intrinsics.checkNotNullExpressionValue(statusIconSettings, "getStatusIconSettings(...)");
        ...
        public final void setStatusIconSettings(BarcodePickStatusIconSettings value) {
            ...
            getA().setStatusIconSettings(value.getA());
        }
    ...
    public static final class CustomView implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleCustomViewProxy {
        private final /* synthetic */ BarcodePickViewHighlightStyleCustomViewProxyAdapter a;
        ...
        public CustomView(NativeBarcodePickViewHighlightStyleCustomView impl) {
            Intrinsics.checkNotNullParameter(impl, "impl");
            this.a = new BarcodePickViewHighlightStyleCustomViewProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        }
        ...
        */
        public CustomView() {
            /*
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyle.CustomView.<init>():void");
        }
    }

    @Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\u0018\u00002\u00020\u00012\u00020\u0002B\u0007\b\u0016¢\u0006\u0002\u0010\u0003B\u000f\b\u0000\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\u0007\u001a\u00020\bH\u0097\u0001J\t\u0010\t\u001a\u00020\u0005H\u0097\u0001J\u0011\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0097\u0001J\u0013\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0097\u0001J\u0019\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0097\u0001J\u001b\u0010\u0012\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0097\u0001J\b\u0010\u0013\u001a\u00020\u0014H\u0016¨\u0006\u0015"}, d2 = {"Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickViewHighlightStyle$Dot;", "Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickViewHighlightStyle;", "Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickViewHighlightStyleDotProxy;", "()V", "impl", "Lcom/scandit/datacapture/barcode/internal/module/pick/ui/NativeBarcodePickViewHighlightStyleDot;", "(Lcom/scandit/datacapture/barcode/internal/module/pick/ui/NativeBarcodePickViewHighlightStyleDot;)V", "_highlightStyleImpl", "Lcom/scandit/datacapture/barcode/internal/module/pick/ui/NativeBarcodePickViewHighlightStyle;", "_impl", "getBrushForState", "Lcom/scandit/datacapture/core/ui/style/Brush;", SentryThread.JsonKeys.STATE, "Lcom/scandit/datacapture/barcode/pick/capture/BarcodePickState;", "getSelectedBrushForState", "setBrushForState", "", "brush", "setSelectedBrushForState", "toJson", "", "scandit-barcode-capture"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public static final class Rectangular implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleRectangularProxy {
        ...
        @NativeImpl
        /* renamed from: _impl */
        public NativeBarcodePickViewHighlightStyleRectangular getA() {
            return this.a.getA();
        }
