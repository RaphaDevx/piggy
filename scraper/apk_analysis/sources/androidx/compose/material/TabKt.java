...
public final class TabKt {
    ...
    */
    public static final void m871Tab0nDMI0(final boolean r29, final kotlin.jvm.functions.Function0<kotlin.Unit> r30, androidx.compose.ui.Modifier r31, boolean r32, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.foundation.interaction.MutableInteractionSource r35, long r36, long r38, androidx.compose.runtime.Composer r40, final int r41, final int r42) {
        /*
            Method dump skipped, instructions count: 676
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TabKt.m871Tab0nDMI0(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.foundation.interaction.MutableInteractionSource, long, long, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m872TabEVJuX4I(final boolean r27, final kotlin.jvm.functions.Function0<kotlin.Unit> r28, androidx.compose.ui.Modifier r29, boolean r30, androidx.compose.foundation.interaction.MutableInteractionSource r31, long r32, long r34, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 579
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TabKt.m872TabEVJuX4I(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: TabTransition-Klgx-Pg, reason: not valid java name */
    public static final void m873TabTransitionKlgxPg(final long j, final long j2, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        Composer startRestartGroup = composer.startRestartGroup(-1597696775);
        ComposerKt.sourceInformation(startRestartGroup, "C(TabTransition)P(0:c#ui.graphics.Color,2:c#ui.graphics.Color,3)269@11702L26,270@11757L550,288@12312L164:Tab.kt#jmzs0o");
        if ((i & 14) == 0) {
        ...
        if (((i2 & 5851) ^ 1170) != 0 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.startReplaceableGroup(-2026688550);
            ComposerKt.sourceInformation(startRestartGroup, "C:Tab.kt#jmzs0o");
            long j3 = booleanValue ? j : j2;
            startRestartGroup.endReplaceableGroup();
            ColorSpace m1258getColorSpaceimpl = Color.m1258getColorSpaceimpl(j3);
            startRestartGroup.startReplaceableGroup(-3686930);
            ComposerKt.sourceInformation(startRestartGroup, "C(remember)P(1):Composables.kt#9igjgp");
            boolean changed = startRestartGroup.changed(m1258getColorSpaceimpl);
            ...
            startRestartGroup.endReplaceableGroup();
            Color m1244boximpl = Color.m1244boximpl(j4);
            boolean booleanValue3 = ((Boolean) updateTransition.getTargetState()).booleanValue();
            startRestartGroup.startReplaceableGroup(-2026688550);
            ComposerKt.sourceInformation(startRestartGroup, "C:Tab.kt#jmzs0o");
            long j5 = booleanValue3 ? j : j2;
            startRestartGroup.endReplaceableGroup();
            State createTransitionAnimation = TransitionKt.createTransitionAnimation(updateTransition, m1244boximpl, Color.m1244boximpl(j5), tabKt$TabTransition$color$2.invoke((TabKt$TabTransition$color$2) updateTransition.getSegment(), (Transition.Segment) startRestartGroup, (Composer) 0), twoWayConverter, "ColorAnimation", startRestartGroup, 32768);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m1244boximpl(Color.m1253copywmQWz5c$default(m874TabTransition_Klgx_Pg$lambda5(createTransitionAnimation), 1.0f, 0.0f, 0.0f, 0.0f, 14, null))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m1256getAlphaimpl(m874TabTransition_Klgx_Pg$lambda5(createTransitionAnimation))))}, function2, startRestartGroup, (i3 & b.p) | 8);
        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$TabTransition$1
            ...
            public final void invoke(Composer composer2, int i4) {
                TabKt.m873TabTransitionKlgxPg(j, j2, z, function2, composer2, i | 1);
            }
        });
    }
    ...
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        int i2;
        Composer startRestartGroup = composer.startRestartGroup(448372750);
        ComposerKt.sourceInformation(startRestartGroup, "C(TabBaselineLayout)P(1)305@12884L1909:Tab.kt#jmzs0o");
        if ((i & 14) == 0) {
        ...
        if (((i2 & 91) ^ 18) != 0 || !startRestartGroup.getSkipping()) {
                ...
                public final MeasureResult mo40measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    if (function2 != null) {
                        for (Measurable measurable : measurables) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "text")) {
                                mo2510measureBRTryo0 = measurable.mo2510measureBRTryo0(Constraints.m2968copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                            }
                        }
                    ...
                    if (function22 != null) {
                        for (Measurable measurable2 : measurables) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), BarcodePickDeserializer.FIELD_ICON)) {
                                mo2510measureBRTryo02 = measurable2.mo2510measureBRTryo0(j);
                            }
                        }
                        throw new NoSuchElementException("Collection contains no element matching the predicate.");
                    }
                    mo2510measureBRTryo02 = null;
                    final int max = Math.max(mo2510measureBRTryo0 == null ? 0 : mo2510measureBRTryo0.getWidth(), mo2510measureBRTryo02 != null ? mo2510measureBRTryo02.getWidth() : 0);
                    final int i3 = Layout.mo222roundToPx0680j_4((mo2510measureBRTryo0 == null || mo2510measureBRTryo02 == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
                    final Integer valueOf = mo2510measureBRTryo0 == null ? null : Integer.valueOf(mo2510measureBRTryo0.get(AlignmentLineKt.getFirstBaseline()));
                    final Integer valueOf2 = mo2510measureBRTryo0 == null ? null : Integer.valueOf(mo2510measureBRTryo0.get(AlignmentLineKt.getLastBaseline()));
                    final Placeable placeable = mo2510measureBRTryo0;
                    final Placeable placeable2 = mo2510measureBRTryo02;
                    return MeasureScope.DefaultImpls.layout$default(Layout, max, i3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabKt$TabBaselineLayout$2$measure$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            TabKt.placeTextAndIcon(layout, measureScope, placeable4, placeable3, i4, i5, intValue, valueOf2.intValue());
                        }
                    }, 4, null);
                }
            };
            ...
            startRestartGroup.startReplaceableGroup(-2141028427);
            ComposerKt.sourceInformation(startRestartGroup, "C:Tab.kt#jmzs0o");
            if (function2 != null) {
                startRestartGroup.startReplaceableGroup(-2141028409);
                ComposerKt.sourceInformation(startRestartGroup, "308@12950L123");
                Modifier m317paddingVpY3zN4$default = PaddingKt.m317paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, "text"), HorizontalTextPadding, 0.0f, 2, null);
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m317paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                startRestartGroup.startReplaceableGroup(-1952926227);
                ComposerKt.sourceInformation(startRestartGroup, "C310@13065L6:Tab.kt#jmzs0o");
                ...
                startRestartGroup.startReplaceableGroup(-2141028254);
                startRestartGroup.endReplaceableGroup();
            }
            if (function22 != null) {
                startRestartGroup.startReplaceableGroup(-2141028223);
                ComposerKt.sourceInformation(startRestartGroup, "313@13136L41");
                ...
                startRestartGroup.startReplaceableGroup(-1952926123);
                ComposerKt.sourceInformation(startRestartGroup, "C313@13169L6:Tab.kt#jmzs0o");
                ...
                startRestartGroup.startReplaceableGroup(-2141028150);
                startRestartGroup.endReplaceableGroup();
            }
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        ...
        int mo222roundToPx0680j_4 = density.mo222roundToPx0680j_4(f) + density.mo222roundToPx0680j_4(TabRowDefaults.INSTANCE.m882getIndicatorHeightD9Ej5fM());
        int height = (placeable2.getHeight() + density.mo221roundToPxR2X_6o(IconDistanceFromBaseline)) - i3;
        int i5 = (i2 - i4) - mo222roundToPx0680j_4;
    ...
    private static final long m874TabTransition_Klgx_Pg$lambda5(State<Color> state) {
