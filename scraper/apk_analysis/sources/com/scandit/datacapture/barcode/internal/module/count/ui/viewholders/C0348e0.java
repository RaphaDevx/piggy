...
public final class C0348e0 implements Y {
    ...
    public C0348e0(C0353h layoutHelper, RelativeLayout container) {
        ...
        this.c = C0342b0.a;
        this.e = barcodeCountViewDefaults.getNextButtonText();
        this.f = new z1(container);
    }

    public static final void a(C0348e0 this$0, View view) {
    ...
    public final void b() {
        this.f.b(this.d, new C0340a0(this));
    }
    ...
    public final com.scandit.datacapture.barcode.internal.module.ui.b a(Context context) {
        ...
        bVar.b.setImageResource(R.drawable.sc_ic_right);
        bVar.setVisibility(4);
        bVar.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.barcode.internal.module.count.ui.viewholders.e0$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                C0348e0.a(C0348e0.this, view);
            }
        });
        bVar.a(this.e);
