...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", StringUtils.SPACE, "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", g.g, Bridge.CAPACITOR_HTTP_INTERCEPTOR_URL_PARAM, "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    ...
    private static final String[] PUNCT_TABLE = {"FLG(n)", StringUtils.CR, "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", FirebaseConstants.SEPARATOR, "-", ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", StringUtils.SPACE, "0", "1", ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", BuildConfig.PUBLISH_SETTINGS_VERSION, "6", "7", "8", "9", FirebaseConstants.SEPARATOR, ".", "CTRL_UL", "CTRL_US"};
