...
public final class CardView extends FrameLayout {
    ...
    private static final Lazy e = LazyKt.lazy(C0612a.a);
    private CardSubView a;
    private CardData b;
    ...
    public static final class Companion {
        ...
        public final int getBORDER_WIDTH$scandit_capture_core() {
            return ((Number) CardView.e.getValue()).intValue();
        }

        public final float getELEVATION$scandit_capture_core() {
            return ((Number) CardView.d.getValue()).floatValue();
        }
    }

    public /* synthetic */ CardView(Context context, CardSubView cardSubView, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i & 2) != 0 ? null : cardSubView);
    }
    ...
    public final void setCardData(CardData cardData) {
        ...
        Drawable findDrawableByLayerId = ((RippleDrawable) background).findDrawableByLayerId(R.id.background);
        ...
        CardSubView cardSubView = this.a;
        if (cardSubView != null) {
    ...
    public CardView(Context context, CardSubView<CardData> cardSubView) {
        ...
        this.c = layoutParams;
        setBackgroundResource(com.scandit.datacapture.core.R.drawable.sc_item_card_background);
        Object obj = this.a;
