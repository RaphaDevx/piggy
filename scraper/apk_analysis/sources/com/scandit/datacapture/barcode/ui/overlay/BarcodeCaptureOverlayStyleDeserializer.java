...
public final class BarcodeCaptureOverlayStyleDeserializer {
    ...
    public static final BarcodeCaptureOverlayStyle fromJson(String json) {
        ...
        NativeBarcodeCaptureOverlayStyle barcodeCaptureOverlayStyleFromJsonString = NativeBarcodeEnumDeserializer.barcodeCaptureOverlayStyleFromJsonString(json);
        Intrinsics.checkNotNullExpressionValue(barcodeCaptureOverlayStyleFromJsonString, "barcodeCaptureOverlayStyleFromJsonString(...)");
        return BarcodeCaptureOverlayStyleKt.fromNative(barcodeCaptureOverlayStyleFromJsonString);
    }
}
