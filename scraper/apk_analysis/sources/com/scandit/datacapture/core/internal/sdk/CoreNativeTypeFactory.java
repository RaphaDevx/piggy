...
public final class CoreNativeTypeFactory {
    ...
    @ProxyConverter
    public final FrameData convert(final NativeFrameData source) {
        Intrinsics.checkNotNullParameter(source, "source");
        return new FrameData(source) { // from class: com.scandit.datacapture.core.internal.sdk.CoreNativeTypeFactory$convert$1
            ...
            public ImageBuffer getImageBuffer() {
                ...
                Intrinsics.checkNotNullExpressionValue(imageBuffer, "getImageBuffer(...)");
            ...
            public long getTimestamp() {
                return this.a.getTimestampForAndroid();
            }
    ...
    public final NativeAbstractCamera convert(Camera camera) {
        ...
        NativeAbstractCamera asAbstractCamera = camera.getA().asAbstractCamera();
        Intrinsics.checkNotNullExpressionValue(asAbstractCamera, "asAbstractCamera(...)");
