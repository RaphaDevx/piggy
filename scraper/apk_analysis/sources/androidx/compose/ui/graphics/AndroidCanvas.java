...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo1121clipRectmtrdDE(androidx.compose.ui.geometry.Rect rect, int i) {
        Canvas.DefaultImpls.m1232clipRectmtrdDE(this, rect, i);
    }
    ...
    public void mo1122concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (MatrixKt.m1442isIdentity58bKbWc(matrix)) {
            return;
        }
        android.graphics.Matrix matrix2 = new android.graphics.Matrix();
        AndroidMatrixConversions_androidKt.m1137setFromEL8BTi8(matrix2, matrix);
        this.internalCanvas.concat(matrix2);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipRect-N_I0leg, reason: not valid java name */
    public void mo1120clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m1130toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo1119clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m1130toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m1130toRegionOp7u2Bmg(int i) {
        return ClipOp.m1238equalsimpl0(i, ClipOp.INSTANCE.m1242getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo1126drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m1025getXimpl(p1), Offset.m1026getYimpl(p1), Offset.m1025getXimpl(p2), Offset.m1026getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo1123drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m1025getXimpl(center), Offset.m1026getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo1124drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m1025getXimpl(topLeftOffset), Offset.m1026getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo1125drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        Bitmap asAndroidBitmap = AndroidImageBitmap_androidKt.asAndroidBitmap(image);
        Rect srcRect = getSrcRect();
        srcRect.left = IntOffset.m3085getXimpl(srcOffset);
        srcRect.top = IntOffset.m3086getYimpl(srcOffset);
        srcRect.right = IntOffset.m3085getXimpl(srcOffset) + IntSize.m3127getWidthimpl(srcSize);
        srcRect.bottom = IntOffset.m3086getYimpl(srcOffset) + IntSize.m3126getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect dstRect = getDstRect();
        dstRect.left = IntOffset.m3085getXimpl(dstOffset);
        dstRect.top = IntOffset.m3086getYimpl(dstOffset);
        dstRect.right = IntOffset.m3085getXimpl(dstOffset) + IntSize.m3127getWidthimpl(dstSize);
        dstRect.bottom = IntOffset.m3086getYimpl(dstOffset) + IntSize.m3126getHeightimpl(dstSize);
    ...
    public void mo1127drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (PointMode.m1484equalsimpl0(pointMode, PointMode.INSTANCE.m1488getLinesr_lszbg())) {
            drawLines(points, paint, 2);
        } else if (PointMode.m1484equalsimpl0(pointMode, PointMode.INSTANCE.m1490getPolygonr_lszbg())) {
            drawLines(points, paint, 1);
        } else if (PointMode.m1484equalsimpl0(pointMode, PointMode.INSTANCE.m1489getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        ...
        while (true) {
            ...
            this.internalCanvas.drawLine(Offset.m1025getXimpl(packedValue), Offset.m1026getYimpl(packedValue), Offset.m1025getXimpl(packedValue2), Offset.m1026getYimpl(packedValue2), paint.getInternalPaint());
            if (first == last) {
                return;
            } else {
                first = i;
    ...
    public void mo1128drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    public void mo1129drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m1169toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        while (true) {
            ...
            getInternalCanvas().drawPoint(Offset.m1025getXimpl(packedValue), Offset.m1026getYimpl(packedValue), paint.getInternalPaint());
            if (i2 > size) {
                return;
            } else {
                i = i2;
