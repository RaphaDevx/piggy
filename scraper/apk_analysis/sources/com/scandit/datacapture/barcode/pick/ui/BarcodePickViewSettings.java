...
public final class BarcodePickViewSettings implements BarcodePickViewSettingsProxy {
    ...
    public final /* synthetic */ float getMinimumHighlightHeightPx$scandit_barcode_capture() {
        ...
        if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.Rectangular) {
            valueOf = Integer.valueOf(((BarcodePickViewHighlightStyle.Rectangular) barcodePickViewHighlightStyle).getMinimumHighlightHeight());
        } else if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.RectangularWithIcons) {
            valueOf = Integer.valueOf(((BarcodePickViewHighlightStyle.RectangularWithIcons) barcodePickViewHighlightStyle).getMinimumHighlightHeight());
        } else if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.CustomView) {
            valueOf = Integer.valueOf(((BarcodePickViewHighlightStyle.CustomView) barcodePickViewHighlightStyle).getMinimumHighlightHeight());
        ...
        return PixelExtensionsKt.pxFromDp$default(valueOf.floatValue(), (Context) null, 1, (Object) null);
    }
    ...
    public final /* synthetic */ float getMinimumHighlightWidthPx$scandit_barcode_capture() {
        ...
        Intrinsics.checkNotNullParameter(barcodePickViewHighlightStyle, "<this>");
        if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.Rectangular) {
            valueOf = Integer.valueOf(((BarcodePickViewHighlightStyle.Rectangular) barcodePickViewHighlightStyle).getMinimumHighlightWidth());
        } else if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.RectangularWithIcons) {
            valueOf = Integer.valueOf(((BarcodePickViewHighlightStyle.RectangularWithIcons) barcodePickViewHighlightStyle).getMinimumHighlightWidth());
        } else if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.CustomView) {
            valueOf = Integer.valueOf(((BarcodePickViewHighlightStyle.CustomView) barcodePickViewHighlightStyle).getMinimumHighlightWidth());
        } else if (barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.Dot) {
            valueOf = Float.valueOf(0.0f);
        } else {
            if (!(barcodePickViewHighlightStyle instanceof BarcodePickViewHighlightStyle.DotWithIcons)) {
    ...
    public String getTapShutterToPauseGuidelineText() {
        return this.a.getTapShutterToPauseGuidelineText();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    @ProxyFunction(property = "torchButtonPosition")
    public Anchor getTorchButtonPosition() {
        return this.a.getTorchButtonPosition();
    }
    ...
    public Anchor getZoomButtonPosition() {
        return this.a.getZoomButtonPosition();
    }
    ...
    public final void setHighlightStyle(BarcodePickViewHighlightStyle value) {
        ...
        getA().setHighlightStyle(value._highlightStyleImpl());
    ...
    public void setLoadingDialogTextForPicking(String str) {
        Intrinsics.checkNotNullParameter(str, "<set-?>");
        this.a.setLoadingDialogTextForPicking(str);
    }
    ...
    public void setLoadingDialogTextForUnpicking(String str) {
        Intrinsics.checkNotNullParameter(str, "<set-?>");
        this.a.setLoadingDialogTextForUnpicking(str);
    }
    ...
    public void setTapShutterToPauseGuidelineText(String str) {
        Intrinsics.checkNotNullParameter(str, "<set-?>");
        this.a.setTapShutterToPauseGuidelineText(str);
    }
    ...
    public void setTorchButtonPosition(Anchor anchor) {
        ...
        this.a.setTorchButtonPosition(anchor);
    }
    ...
    public void setZoomButtonPosition(Anchor anchor) {
        Intrinsics.checkNotNullParameter(anchor, "<set-?>");
        this.a.setZoomButtonPosition(anchor);
    }
