...
public final class SoundPoolExtensionsKt {
    public static final int load(SoundPool soundPool, Context context, Sound sound) {
        ...
        String str = (String) CollectionsKt.first(StringsKt.split$default((CharSequence) assetSound.getAssetName(), new String[]{"."}, false, 0, 6, (Object) null));
        int resourceByName = ContextExtensionsKt.getResourceByName(context, str);
        if (resourceByName <= 0 && !StringsKt.startsWith$default(str, "sc_", false, 2, (Object) null)) {
