...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m3945constructorimpl = Result.m3945constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m3945constructorimpl = Result.m3945constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            m3945constructorimpl = Result.m3945constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m3951isFailureimpl(m3945constructorimpl) ? null : m3945constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m3945constructorimpl = Result.m3945constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m3945constructorimpl = Result.m3945constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m3951isFailureimpl(m3945constructorimpl)) {
            m3945constructorimpl = valueOf;
        }
        return ((Number) m3945constructorimpl).intValue();
    }
