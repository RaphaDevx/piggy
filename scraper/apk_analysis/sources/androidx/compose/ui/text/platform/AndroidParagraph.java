...
public final class AndroidParagraph implements Paragraph {
    ...
    public AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int i, boolean z, float f) {
        ...
        if ((getWidth() >= 0.0f) == false) {
            throw new IllegalArgumentException("width should not be negative".toString());
        }
        TextStyle style = paragraphIntrinsics.getStyle();
        m2886toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m2886toLayoutAlignAMY3VfE(style.getTextAlign());
        TextAlign textAlign = style.getTextAlign();
        boolean m2929equalsimpl0 = textAlign == null ? false : TextAlign.m2929equalsimpl0(textAlign.getValue(), TextAlign.INSTANCE.m2935getJustifye0LSkKk());
        if (z) {
            truncateAt = TextUtils.TruncateAt.END;
        } else {
            truncateAt = null;
        }
        this.layout = new TextLayout(paragraphIntrinsics.getCharSequence(), getWidth(), getTextPaint$ui_text_release(), m2886toLayoutAlignAMY3VfE, truncateAt, paragraphIntrinsics.getTextDirectionHeuristic(), 1.0f, 0.0f, false, i, 0, 0, m2929equalsimpl0 ? 1 : 0, null, null, paragraphIntrinsics.getLayoutIntrinsics(), 28032, null);
    ...
    public int mo2693getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m1026getYimpl(position)), Offset.m1025getXimpl(position));
    }
    ...
    public long mo2694getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo2695paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        getTextPaint$ui_text_release().m2887setColor8_81llA(color);
