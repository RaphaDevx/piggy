...
public final class TrackedObjectProxyAdapter implements TrackedObjectProxy {
    ...
    public /* synthetic */ TrackedObjectProxyAdapter(NativeTrackedObject nativeTrackedObject, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeTrackedObject, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
