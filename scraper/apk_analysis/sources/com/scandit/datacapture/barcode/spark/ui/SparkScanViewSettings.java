...
public final class SparkScanViewSettings {
    ...
    private SparkScanToastSettings toastSettings = w;

    /* renamed from: k, reason: from kotlin metadata */
    private TimeInterval inactiveStateTimeout = r;
    ...
    private CameraPosition defaultCameraPosition = s;

    /* renamed from: o, reason: from kotlin metadata */
    private SparkScanMiniPreviewSize defaultMiniPreviewSize = x;

    /* renamed from: p, reason: from kotlin metadata */
    private SparkScanViewHandMode defaultHandMode = v;
    ...
    public static final class Companion {
        ...
        public final SparkScanScanningMode.Default getDEFAULT_SCANNING_MODE() {
            return SparkScanViewSettings.q;
        }
    }

    static {
        TimeInterval.Companion companion = TimeInterval.INSTANCE;
        r = companion.seconds(10.0f);
        s = CameraPosition.WORLD_FACING;
        t = companion.seconds(5.0f);
        u = TorchState.OFF;
        v = SparkScanViewHandMode.RIGHT;
        w = new SparkScanToastSettings(false, null, null, null, null, null, null, null, null, null, null, null, null, null, 16383, null);
        x = SparkScanMiniPreviewSize.REGULAR;
    }
    ...
    public int hashCode() {
        int hashCode = (Boolean.hashCode(this.hardwareTriggerEnabled) + ((Boolean.hashCode(this.hapticEnabled) + ((Boolean.hashCode(this.soundEnabled) + ((Boolean.hashCode(this.holdToScanEnabled) + ((this.defaultScanningMode.hashCode() + ((this.defaultTorchState.hashCode() + (this.triggerButtonCollapseTimeout.hashCode() * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31;
        Integer num = this.hardwareTriggerKeyCode;
        return this.defaultMiniPreviewSize.hashCode() + ((this.defaultCameraPosition.hashCode() + ((Float.hashCode(this.zoomFactorIn) + ((Float.hashCode(this.zoomFactorOut) + ((this.inactiveStateTimeout.hashCode() + ((this.toastSettings.hashCode() + ((Boolean.hashCode(this.visualFeedbackEnabled) + ((hashCode + (num != null ? num.intValue() : 0)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31);
    }
