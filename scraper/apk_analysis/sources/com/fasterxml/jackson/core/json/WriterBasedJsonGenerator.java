    ...
    */
    ...
    private void _prependOrWriteCharacterEscape(char c, int i) throws IOException, JsonGenerationException {
        ...
        if (i != -2) {
            ...
            if (i5 >= 6) {
                ...
                if (c > 255) {
                    int i7 = c >> '\b';
                    cArr3[i5 - 4] = hexChars[(i7 & 255) >> 4];
                    i2 = i5 - 3;
                    cArr3[i2] = hexChars[i7 & 15];
                    c = (char) (c & 255);
                } else {
                    cArr3[i5 - 4] = '0';
                    i2 = i5 - 3;
                ...
                cArr3[i2 + 1] = hexChars[c >> 4];
                cArr3[i2 + 2] = hexChars[c & 15];
                return;
            }
            ...
            if (c > 255) {
                int i8 = c >> '\b';
                cArr4[10] = hexChars[(i8 & 255) >> 4];
                cArr4[11] = hexChars[i8 & 15];
                cArr4[12] = hexChars[(c & 255) >> 4];
                cArr4[13] = hexChars[c & 15];
    ...
    private int _prependOrWriteCharacterEscape(char[] cArr, int i, int i2, char c, int i3) throws IOException, JsonGenerationException {
        ...
        if (i3 != -2) {
            ...
            if (c > 255) {
                int i10 = c >> '\b';
                cArr3[10] = hexChars[(i10 & 255) >> 4];
                cArr3[11] = hexChars[i10 & 15];
                cArr3[12] = hexChars[(c & 255) >> 4];
                cArr3[13] = hexChars[c & 15];
    ...
    private char[] _allocateCopyBuffer() {
        if (this._copyBuffer == null) {
            this._copyBuffer = this._ioContext.allocNameCopyBuffer(Priorities.AUTHORIZATION);
        }
