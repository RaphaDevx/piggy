...
public final class PathComponent extends VNode {
    ...
    public final void m1728setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo1160setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m1729setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m1730setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (this.trimPathStart == 0.0f && this.trimPathEnd == 1.0f) {
            Path.DefaultImpls.m1457addPathUv8p0NA$default(this.renderPath, this.path, 0L, 2, null);
            return;
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.DefaultImpls.m1665drawPathGBMwjPU$default(drawScope, this.renderPath, brush, getFillAlpha(), null, null, 0, 56, null);
        }
        ...
        DrawScope.DefaultImpls.m1665drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, getStrokeAlpha(), stroke, null, 0, 48, null);
    }
