...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    public String toString() {
        return "FastDateFormat[" + this.printer.getPattern() + FirebaseConstants.SEPARATOR + this.printer.getLocale() + FirebaseConstants.SEPARATOR + this.printer.getTimeZone().getID() + "]";
    }
