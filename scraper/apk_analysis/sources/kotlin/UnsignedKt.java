...
public final class UnsignedKt {
    ...
    public static final int m4297uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m4040constructorimpl((int) ((i & 4294967295L) % (i2 & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m4296uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m4040constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m4298ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m4119constructorimpl(0L) : ULong.m4119constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m4119constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m4119constructorimpl(j3 + (Long.compareUnsigned(ULong.m4119constructorimpl(j - (j3 * j2)), ULong.m4119constructorimpl(j2)) < 0 ? 0 : 1));
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m4299ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m4119constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m4119constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m4119constructorimpl(j3), ULong.m4119constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m4119constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m4040constructorimpl((int) d);
        }
        return UInt.m4040constructorimpl(UInt.m4040constructorimpl((int) (d - Integer.MAX_VALUE)) + UInt.m4040constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m4119constructorimpl((long) d);
        }
        return ULong.m4119constructorimpl(ULong.m4119constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
