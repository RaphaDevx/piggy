...
public final class BarcodeSelectionSession implements BarcodeSelectionSessionProxy {
    ...
    public NativeBarcodeSelectionSession getA() {
        return (NativeBarcodeSelectionSession) this.a.invoke();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public int getCount(Barcode barcode) {
        Intrinsics.checkNotNullParameter(barcode, "barcode");
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).getCount(barcode);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public long getFrameSequenceId() {
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public int getLastProcessedFrameId() {
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).getLastProcessedFrameId();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getNewlySelectedBarcodes() {
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).getNewlySelectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getNewlyUnselectedBarcodes() {
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).getNewlyUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getSelectedBarcodes() {
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).getSelectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public void reset() {
        ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public void selectUnselectedBarcodes() {
        ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).selectUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public String toJson() {
        return ((BarcodeSelectionSessionProxyAdapter) this.b.getValue()).toJson();
    }
}
