...
public final class BarcodeFilterHighlightType {
    ...
    private static final /* synthetic */ BarcodeFilterHighlightType[] a;
    ...
    static {
        ...
        a = barcodeFilterHighlightTypeArr;
        b = EnumEntriesKt.enumEntries(barcodeFilterHighlightTypeArr);
    ...
    public static BarcodeFilterHighlightType[] values() {
        return (BarcodeFilterHighlightType[]) a.clone();
    }
    ...
    public final String toJson() {
        String barcodeFilterHighlightTypeToString = NativeBarcodeEnumSerializer.barcodeFilterHighlightTypeToString(_toNativeEnum$scandit_barcode_capture());
        Intrinsics.checkNotNullExpressionValue(barcodeFilterHighlightTypeToString, "barcodeFilterHighlightTypeToString(...)");
