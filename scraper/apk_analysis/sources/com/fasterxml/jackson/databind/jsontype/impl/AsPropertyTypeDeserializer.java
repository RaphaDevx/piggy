...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.As as) {
        ...
        if (this._property == null) {
            format = String.format("missing type id property '%s'", this._typePropertyName);
        } else {
            format = String.format("missing type id property '%s' (for POJO property '%s')", this._typePropertyName, this._property.getName());
        }
        this._msgForMissingId = format;
        this._inclusion = as;
    }
