...
@DebugMetadata(c = "androidx.compose.material.DefaultButtonElevation$elevation$3", f = "Button.kt", i = {}, l = {TypedValues.PositionType.TYPE_CURVE_FIT}, m = "invokeSuspend", n = {}, s = {})
...
final class DefaultButtonElevation$elevation$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PressInteraction.Press press = Dp.m3012equalsimpl0(value, f) ? new PressInteraction.Press(Offset.INSTANCE.m1041getZeroF1C5BW0(), null) : null;
            this.label = 1;
            if (ElevationKt.m736animateElevationrAjV9yQ(this.$animatable, this.$target, press, this.$interaction, this) == coroutine_suspended) {
