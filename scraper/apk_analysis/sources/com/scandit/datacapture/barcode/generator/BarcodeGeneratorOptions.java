...
public final class BarcodeGeneratorOptions {
    ...
    public BarcodeGeneratorOptions(Integer num, Integer num2, int i, QrCodeErrorCorrectionLevel qrCodeErrorCorrectionLevel, Integer num3, Integer num4, Integer num5) {
        this.backgroundColor = num;
