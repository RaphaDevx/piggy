...
public final class ConstraintSetParserKt {
    ...
    */
    public static final void parseKeyCycle(androidx.constraintlayout.core.parser.CLObject r19, androidx.constraintlayout.core.state.Transition r20) {
        /*
                        ...
                        if (hashCode != -1727069561) {
                            if (hashCode == -1606703562) {
                                if (stringOrNull.equals("constraints")) {
                                    object.remove("start");
                                    object.remove("end");
                                    object.remove(RRWebVideoEvent.JsonKeys.TOP);
    ...
    */
                ...
                if (hashCode != -678927291) {
                    if (hashCode != 100571) {
                        if (hashCode == 109757538 && str2.equals("start")) {
                            guidelineReference.start(Integer.valueOf(state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(cLObject.getFloat(str2))))));
                        }
                    } else if (str2.equals("end")) {
                        guidelineReference.end(Integer.valueOf(state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(cLObject.getFloat(str2))))));
                    }
                } else if (str2.equals(ProfileMeasurement.UNIT_PERCENT)) {
                    ...
                    if (hashCode == -962590849) {
                        if (str.equals("direction") && (string = element.getString(str)) != null) {
                            switch (string.hashCode()) {
                                ...
                                case 115029:
                                    if (!string.equals(RRWebVideoEvent.JsonKeys.TOP)) {
                                        break;
                                    } else {
                                ...
                                case 3317767:
                                    if (!string.equals(RRWebVideoEvent.JsonKeys.LEFT)) {
                                        break;
                                    } else {
    ...
    private static final void parseConstraint(State state, LayoutVariables layoutVariables, CLObject cLObject, ConstraintReference constraintReference, String str) {
            ...
            if (stringOrNull != null) {
                ...
                switch (str.hashCode()) {
                    ...
                    case 100571:
                        ...
                        break;
                    case 115029:
                        if (str.equals(RRWebVideoEvent.JsonKeys.TOP)) {
        ...
        if (arrayOrNull.size() > 2) {
            ...
            f = state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(layoutVariables.get(orNull))));
        } else {
            f = 0.0f;
        }
        if (arrayOrNull.size() > 3) {
            ...
            f2 = state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(layoutVariables.get(orNull2))));
        } else {
            f2 = 0.0f;
        }
        ...
        switch (str.hashCode()) {
            case -1720785339:
                if (str.equals("baseline") && stringOrNull2 != null) {
                    ...
                    } else if (hashCode == 115029 && stringOrNull2.equals(RRWebVideoEvent.JsonKeys.TOP)) {
            ...
            case -1383228885:
                if (str.equals("bottom")) {
                    if (!Intrinsics.areEqual(stringOrNull2, RRWebVideoEvent.JsonKeys.TOP)) {
            ...
            case 115029:
                ...
                break;
            case 3317767:
                if (str.equals(RRWebVideoEvent.JsonKeys.LEFT)) {
                    if (!Intrinsics.areEqual(stringOrNull2, RRWebVideoEvent.JsonKeys.LEFT)) {
    ...
    private static final androidx.constraintlayout.core.state.Dimension parseDimension(CLObject cLObject, String str, State state) {
        ...
        if (cLElement instanceof CLNumber) {
            androidx.constraintlayout.core.state.Dimension Fixed2 = androidx.constraintlayout.core.state.Dimension.Fixed(state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(cLObject.getFloat(str)))));
        ...
        if (orNull != null) {
            if (orNull instanceof CLNumber) {
                Fixed.min(state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(orNull.getFloat()))));
            } else if (orNull instanceof CLString) {
                Fixed.min(androidx.constraintlayout.core.state.Dimension.WRAP_DIMENSION);
            }
        }
        CLElement orNull2 = cLObject2.getOrNull(CardsAccountDigitalPaymentCardLoadWithSuperpointsStatusBlocksPeriod.SERIALIZED_NAME_MAX);
        if (orNull2 == null) {
            return Fixed;
        }
        if (orNull2 instanceof CLNumber) {
            Fixed.max(state.convertDimension(Dp.m3005boximpl(Dp.m3007constructorimpl(orNull2.getFloat()))));
            return Fixed;
        }
