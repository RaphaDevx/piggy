...
public final class BarcodeBatchDeserializerListenerReversedAdapter extends NativeBarcodeTrackingDeserializerListener {
    private final BarcodeBatchDeserializerListener a;

    /* renamed from: b, reason: from kotlin metadata */
    private final ProxyCache proxyCache;
    private final WeakReference c;

    public /* synthetic */ BarcodeBatchDeserializerListenerReversedAdapter(BarcodeBatchDeserializerListener barcodeBatchDeserializerListener, BarcodeBatchDeserializer barcodeBatchDeserializer, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(barcodeBatchDeserializerListener, barcodeBatchDeserializer, (i & 4) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
    ...
    public void onAdvancedOverlayDeserializationFinished(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTrackingAdvancedOverlay overlay, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new l(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatchAdvancedOverlay barcodeBatchAdvancedOverlay = (BarcodeBatchAdvancedOverlay) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingAdvancedOverlay.class), null, overlay);
            ...
            this.a.onAdvancedOverlayDeserializationFinished((BarcodeBatchDeserializer) orPut, barcodeBatchAdvancedOverlay, jsonValue);
        }
    }
    ...
    public void onAdvancedOverlayDeserializationStarted(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTrackingAdvancedOverlay overlay, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new n(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatchAdvancedOverlay barcodeBatchAdvancedOverlay = (BarcodeBatchAdvancedOverlay) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingAdvancedOverlay.class), null, overlay);
            ...
            this.a.onAdvancedOverlayDeserializationStarted((BarcodeBatchDeserializer) orPut, barcodeBatchAdvancedOverlay, jsonValue);
        }
    }
    ...
    public void onBasicOverlayDeserializationFinished(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTrackingBasicOverlay overlay, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new p(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatchBasicOverlay barcodeBatchBasicOverlay = (BarcodeBatchBasicOverlay) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingBasicOverlay.class), null, overlay);
            ...
            this.a.onBasicOverlayDeserializationFinished((BarcodeBatchDeserializer) orPut, barcodeBatchBasicOverlay, jsonValue);
        }
    }
    ...
    public void onBasicOverlayDeserializationStarted(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTrackingBasicOverlay overlay, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new r(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatchBasicOverlay barcodeBatchBasicOverlay = (BarcodeBatchBasicOverlay) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingBasicOverlay.class), null, overlay);
            ...
            this.a.onBasicOverlayDeserializationStarted((BarcodeBatchDeserializer) orPut, barcodeBatchBasicOverlay, jsonValue);
        }
    }
    ...
    public void onModeDeserializationFinished(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTracking mode, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new t(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatch barcodeBatch = (BarcodeBatch) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTracking.class), null, mode);
            ...
            this.a.onModeDeserializationFinished((BarcodeBatchDeserializer) orPut, barcodeBatch, jsonValue);
        }
    }
    ...
    public void onModeDeserializationStarted(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTracking mode, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new v(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatch barcodeBatch = (BarcodeBatch) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTracking.class), null, mode);
            ...
            this.a.onModeDeserializationStarted((BarcodeBatchDeserializer) orPut, barcodeBatch, jsonValue);
        }
    }
    ...
    public void onSettingsDeserializationFinished(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTrackingSettings settings, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new x(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatchSettings barcodeBatchSettings = (BarcodeBatchSettings) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingSettings.class), null, settings);
            JsonValue jsonValue = (JsonValue) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeJsonValue.class), null, json, new y(json));
            this.a.onSettingsDeserializationFinished((BarcodeBatchDeserializer) orPut, barcodeBatchSettings, jsonValue);
        }
    }
    ...
    public void onSettingsDeserializationStarted(NativeBarcodeTrackingDeserializer deserializer, NativeBarcodeTrackingSettings settings, NativeJsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.c.get();
        if (barcodeBatchDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingDeserializer.class), null, deserializer, new z(barcodeBatchDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            BarcodeBatchSettings barcodeBatchSettings = (BarcodeBatchSettings) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingSettings.class), null, settings);
            JsonValue jsonValue = (JsonValue) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeJsonValue.class), null, json, new A(json));
            this.a.onSettingsDeserializationStarted((BarcodeBatchDeserializer) orPut, barcodeBatchSettings, jsonValue);
        }
    }
    ...
    public BarcodeBatchDeserializerListenerReversedAdapter(BarcodeBatchDeserializerListener _BarcodeBatchDeserializerListener, BarcodeBatchDeserializer _BarcodeBatchDeserializer, ProxyCache proxyCache) {
        ...
        this.a = _BarcodeBatchDeserializerListener;
        this.proxyCache = proxyCache;
        this.c = new WeakReference(_BarcodeBatchDeserializer);
    }
}
