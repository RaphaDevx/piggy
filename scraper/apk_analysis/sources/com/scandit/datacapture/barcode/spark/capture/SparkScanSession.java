...
public final class SparkScanSession implements SparkScanSessionProxy {
    ...
    public SparkScanSession(Function0<? extends NativeSparkScanSession> getImpl) {
        ...
        this.a = LazyKt.lazy(new a(getImpl));
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public long getFrameSequenceId() {
        return ((SparkScanSessionProxyAdapter) this.a.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public Barcode getNewlyRecognizedBarcode() {
        return ((SparkScanSessionProxyAdapter) this.a.getValue()).getNewlyRecognizedBarcode();
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public void reset() {
        ((SparkScanSessionProxyAdapter) this.a.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public String toJson() {
        return ((SparkScanSessionProxyAdapter) this.a.getValue()).toJson();
    }
}
