    ...
    public final void moveGroup(int offset) {
        ...
        if (i < i14) {
            ...
            while (true) {
                ...
                int i17 = i11;
                int i18 = i10;
                updateDataIndex(iArr, groupIndexToAddress2, dataIndexToDataAnchor(dataIndex(iArr, groupIndexToAddress2) - i10, i13 < groupIndexToAddress2 ? 0 : i17, i12, length));
                if (i16 >= i14) {
                    break;
                }
                i11 = i17;
            ...
            if (locationOf < locationOf2) {
                ...
                if (locationOf < locationOf2) {
                    ...
                    while (true) {
                        ...
                        anchor2.setLocation$runtime_release(anchor2.getLocation() + i7);
