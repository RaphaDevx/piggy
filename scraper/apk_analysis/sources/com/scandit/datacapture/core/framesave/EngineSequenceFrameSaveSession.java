...
public final class EngineSequenceFrameSaveSession implements FrameSaveSession, SequenceFrameSaveSessionProxy {
    ...
    public static final class Companion {
        ...
        public static final class Builder {
            ...
            public final EngineSequenceFrameSaveSession build() {
                ...
                NativeSequenceFrameSaveSession create = NativeSequenceFrameSaveSession.create(forRemoteStorage);
                Intrinsics.checkNotNull(create);
                return new EngineSequenceFrameSaveSession(create, null);
            }
    ...
    public EngineSequenceFrameSaveSession(NativeSequenceFrameSaveSession nativeSequenceFrameSaveSession, DefaultConstructorMarker defaultConstructorMarker) {
        this.a = new SequenceFrameSaveSessionProxyAdapter(nativeSequenceFrameSaveSession, null, 2, 0 == true ? 1 : 0);
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeSequenceFrameSaveSession getA() {
        return this.a.getA();
    }
