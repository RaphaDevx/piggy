...
final class DerivedSnapshotState<T> implements StateObject, DerivedState<T> {
    ...
    private static final class ResultRecord<T> extends StateRecord {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Removed duplicated region for block: B:21:0x0054 A[Catch: all -> 0x0097, LOOP:1: B:19:0x004e->B:21:0x0054, LOOP_END, TryCatch #0 {all -> 0x0097, blocks: (B:18:0x004a, B:19:0x004e, B:21:0x0054, B:23:0x0077), top: B:17:0x004a }] */
        /* JADX WARN: Removed duplicated region for block: B:26:0x0081 A[LOOP:2: B:26:0x0081->B:28:0x0095, LOOP_START, PHI: r3
          0x0081: PHI (r3v3 int) = (r3v0 int), (r3v4 int) binds: [B:25:0x007f, B:28:0x0095] A[DONT_GENERATE, DONT_INLINE]] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public final int readableHash(androidx.compose.runtime.DerivedState<?> r7, androidx.compose.runtime.snapshots.Snapshot r8) {
            /*
                r6 = this;
                ...
                monitor-enter(r0)
                java.util.HashSet r6 = r6.getDependencies()     // Catch: java.lang.Throwable -> Lb7
                monitor-exit(r0)
                r0 = 7
                if (r6 == 0) goto Lb6
                androidx.compose.runtime.SnapshotThreadLocal r1 = androidx.compose.runtime.SnapshotStateKt.access$getDerivedStateObservers$p()
                java.lang.Object r1 = r1.get()
                androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList r1 = (androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList) r1
                if (r1 != 0) goto L28
                androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList r1 = androidx.compose.runtime.external.kotlinx.collections.immutable.ExtensionsKt.persistentListOf()
            L28:
            ...
            L4e:
                ...
                androidx.compose.runtime.snapshots.StateObject r2 = (androidx.compose.runtime.snapshots.StateObject) r2     // Catch: java.lang.Throwable -> L97
                androidx.compose.runtime.snapshots.StateRecord r4 = r2.getFirstStateRecord()     // Catch: java.lang.Throwable -> L97
                java.lang.String r5 = "stateObject"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r5)     // Catch: java.lang.Throwable -> L97
                androidx.compose.runtime.snapshots.StateRecord r2 = androidx.compose.runtime.snapshots.SnapshotKt.readable(r4, r2, r8)     // Catch: java.lang.Throwable -> L97
                int r0 = r0 * 31
                int r4 = androidx.compose.runtime.ActualJvm_jvmKt.identityHashCode(r2)     // Catch: java.lang.Throwable -> L97
                int r0 = r0 + r4
                int r0 = r0 * 31
                int r2 = r2.getSnapshotId()     // Catch: java.lang.Throwable -> L97
                int r0 = r0 + r2
                goto L4e
            L77:
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x0057 A[LOOP:1: B:18:0x0057->B:20:0x006b, LOOP_START, PHI: r2
      0x0057: PHI (r2v5 int) = (r2v0 int), (r2v10 int) binds: [B:17:0x0055, B:20:0x006b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private final androidx.compose.runtime.DerivedSnapshotState.ResultRecord<T> currentRecord(androidx.compose.runtime.DerivedSnapshotState.ResultRecord<T> r6, androidx.compose.runtime.snapshots.Snapshot r7, kotlin.jvm.functions.Function0<? extends T> r8) {
        ...
        L3f:
            ...
            goto L2b
        L41:
            androidx.compose.runtime.snapshots.Snapshot$Companion r1 = androidx.compose.runtime.snapshots.Snapshot.INSTANCE     // Catch: java.lang.Throwable -> L9e
            androidx.compose.runtime.DerivedSnapshotState$currentRecord$result$1$1 r3 = new androidx.compose.runtime.DerivedSnapshotState$currentRecord$result$1$1     // Catch: java.lang.Throwable -> L9e
            r3.<init>(r5)     // Catch: java.lang.Throwable -> L9e
            kotlin.jvm.functions.Function1 r3 = (kotlin.jvm.functions.Function1) r3     // Catch: java.lang.Throwable -> L9e
            r4 = 0
            java.lang.Object r8 = r1.observe(r3, r4, r8)     // Catch: java.lang.Throwable -> L9e
            int r1 = r7.size()
            int r1 = r1 + (-1)
            if (r1 < 0) goto L6d
        L57:
        ...
        L6d:
            ...
            monitor-enter(r7)
            androidx.compose.runtime.snapshots.Snapshot$Companion r0 = androidx.compose.runtime.snapshots.Snapshot.INSTANCE     // Catch: java.lang.Throwable -> L9b
            androidx.compose.runtime.snapshots.Snapshot r0 = r0.getCurrent()     // Catch: java.lang.Throwable -> L9b
            androidx.compose.runtime.DerivedSnapshotState$ResultRecord<T> r1 = r5.first     // Catch: java.lang.Throwable -> L9b
            androidx.compose.runtime.snapshots.StateRecord r1 = (androidx.compose.runtime.snapshots.StateRecord) r1     // Catch: java.lang.Throwable -> L9b
            r2 = r5
            androidx.compose.runtime.snapshots.StateObject r2 = (androidx.compose.runtime.snapshots.StateObject) r2     // Catch: java.lang.Throwable -> L9b
            androidx.compose.runtime.snapshots.StateRecord r1 = androidx.compose.runtime.snapshots.SnapshotKt.newWritableRecord(r1, r2, r0)     // Catch: java.lang.Throwable -> L9b
            androidx.compose.runtime.DerivedSnapshotState$ResultRecord r1 = (androidx.compose.runtime.DerivedSnapshotState.ResultRecord) r1     // Catch: java.lang.Throwable -> L9b
            r1.setDependencies(r6)     // Catch: java.lang.Throwable -> L9b
            androidx.compose.runtime.DerivedState r5 = (androidx.compose.runtime.DerivedState) r5     // Catch: java.lang.Throwable -> L9b
            int r5 = r1.readableHash(r5, r0)     // Catch: java.lang.Throwable -> L9b
            r1.setResultHash(r5)     // Catch: java.lang.Throwable -> L9b
            r1.setResult(r8)     // Catch: java.lang.Throwable -> L9b
            monitor-exit(r7)
            androidx.compose.runtime.snapshots.Snapshot$Companion r5 = androidx.compose.runtime.snapshots.Snapshot.INSTANCE
            r5.notifyObjectsInitialized()
            return r1
        L9b:
            r5 = move-exception
            monitor-exit(r7)
