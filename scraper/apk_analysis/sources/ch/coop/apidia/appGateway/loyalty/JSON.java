...
import ch.coop.apidia.appGateway.loyalty.model.Image;
import ch.coop.apidia.appGateway.loyalty.model.LoyaltyDeviceMediumRequestBody;
import ch.coop.apidia.appGateway.loyalty.model.LoyaltyDonationCampaign;
...
import ch.coop.apidia.appGateway.loyalty.model.LoyaltySupercardTransaction;
import ch.coop.apidia.appGateway.loyalty.model.Rest401;
import ch.coop.apidia.appGateway.loyalty.model.Rest404;
import ch.coop.apidia.appGateway.loyalty.model.Rest500;
import ch.coop.apidia.appGateway.loyalty.model.Rest503;
import ch.coop.apidia.appGateway.loyalty.model.RestError;
...
public class JSON {
    ...
    public JSON() {
        ...
        createGson.registerTypeAdapterFactory(new LoyaltyDeviceMediumRequestBody.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltyDonationCampaign.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltyDonationCampaignsDonateRequestBody.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltyDonationCampaignsResponse.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltySupercard.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltySupercardCodeRequest.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltySupercardCodeResponse.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltySupercardDatamatrixData.CustomTypeAdapterFactory());
        createGson.registerTypeAdapterFactory(new LoyaltySupercardTransaction.CustomTypeAdapterFactory());
    ...
    /* renamed from: ch.coop.apidia.appGateway.loyalty.JSON$1, reason: invalid class name */
