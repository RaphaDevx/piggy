...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m940boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m941constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m942equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m943equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m944hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m949toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m942equalsimpl(getComposer(), obj);
    }

    public int hashCode() {
        return m944hashCodeimpl(getComposer());
    }

    public String toString() {
        return m949toStringimpl(getComposer());
    }
    ...
    public static final void m947setimpl(Composer arg0, int i, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m948setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(arg0, "arg0");
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m950updateimpl(Composer arg0, int i, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(arg0, "arg0");
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m951updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(arg0, "arg0");
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = arg0.getInserting();
    ...
    public static final void m945initimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(arg0, "arg0");
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m946reconcileimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(arg0, "arg0");
        Intrinsics.checkNotNullParameter(block, "block");
