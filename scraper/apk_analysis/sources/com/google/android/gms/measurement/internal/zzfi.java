...
public final class zzfi extends zzkh implements zzaf {
    ...
    */
                ...
                public final Object call() {
                    ...
                    return new com.google.android.gms.internal.measurement.zzu("internal.appMetadata", new Callable() { // from class: com.google.android.gms.measurement.internal.zzfb
                        ...
                        public final Object call() {
                            ...
                            hashMap.put("platform", ProfileChunk.PLATFORM_ANDROID);
    ...
    final boolean zzq(String str, String str2) {
        ...
        zzg();
        zzC(str);
        if ("ecommerce_purchase".equals(str2) || FirebaseAnalytics.Event.PURCHASE.equals(str2) || "refund".equals(str2)) {
            return true;
        }
    ...
    final boolean zzy(String str) {
        ...
        zzC(str);
        if (this.zza.get(str) != null) {
            return ((Set) this.zza.get(str)).contains(DataSources.Key.OS_VERSION) || ((Set) this.zza.get(str)).contains("device_info");
        }
        return false;
    }
