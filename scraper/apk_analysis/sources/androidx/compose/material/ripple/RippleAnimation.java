...
public final class RippleAnimation {
    ...
    private RippleAnimation(Offset offset, float f, boolean z) {
        ...
        this.finishedFadingIn = SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
        this.finishRequested = SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
    }
    ...
    */
    ...
    public final void m916draw4WTKRHQ(DrawScope receiver, long j) {
        Float valueOf;
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m918getRippleStartRadiusuvyYCjk(receiver.mo1627getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                valueOf = Float.valueOf(RippleAnimationKt.m917getRippleEndRadiuscSwnlzA(receiver, this.bounded, receiver.mo1627getSizeNHjbRc()));
            } else {
                valueOf = Float.valueOf(receiver.mo227toPx0680j_4(this.radius));
            }
            this.targetRadius = valueOf;
        }
        if (this.origin == null) {
            this.origin = Offset.m1014boximpl(receiver.mo1626getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m1014boximpl(OffsetKt.Offset(Size.m1094getWidthimpl(receiver.mo1627getSizeNHjbRc()) / 2.0f, Size.m1091getHeightimpl(receiver.mo1627getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m1025getXimpl = Offset.m1025getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(m1025getXimpl, Offset.m1025getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m1026getYimpl = Offset.m1026getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(m1026getYimpl, Offset.m1026getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long m1253copywmQWz5c$default = Color.m1253copywmQWz5c$default(j, Color.m1256getAlphaimpl(j) * floatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.DefaultImpls.m1658drawCircleVaOC9Bg$default(receiver, m1253copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, 120, null);
            return;
        }
