...
public final class BarcodeArPopoverAnnotationAnchor {
    ...
    private static final /* synthetic */ BarcodeArPopoverAnnotationAnchor[] a;
    ...
    static {
        ...
        a = barcodeArPopoverAnnotationAnchorArr;
        b = EnumEntriesKt.enumEntries(barcodeArPopoverAnnotationAnchorArr);
    }

    private BarcodeArPopoverAnnotationAnchor(String str, int i) {
    }
    ...
    public static BarcodeArPopoverAnnotationAnchor[] values() {
        return (BarcodeArPopoverAnnotationAnchor[]) a.clone();
    }
}
