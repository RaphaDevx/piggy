...
public final class BarcodeCountCaptureListSessionProxyAdapter implements BarcodeCountCaptureListSessionProxy {
    ...
    public List<TrackedBarcode> getAcceptedBarcodes() {
        ArrayList<NativeTrackedBarcode> acceptedBarcodesList = this.a.getAcceptedBarcodesList();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(acceptedBarcodesList);
    ...
    public List<Barcode> getAdditionalBarcodes() {
        ArrayList<NativeBarcode> additionalBarcodes = this.a.getAdditionalBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TrackedBarcode> getCorrectBarcodes() {
        ArrayList<NativeTrackedBarcode> correctBarcodes = this.a.getCorrectBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(correctBarcodes);
    ...
    public List<TargetBarcode> getMissingBarcodes() {
        ArrayList<NativeTargetBarcode> missingBarcodes = this.a.getMissingBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(missingBarcodes);
    ...
    public List<TrackedBarcode> getRejectedBarcodes() {
        ArrayList<NativeTrackedBarcode> rejectedBarcodesList = this.a.getRejectedBarcodesList();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(rejectedBarcodesList);
    ...
    public List<TrackedBarcode> getWrongBarcodes() {
        ArrayList<NativeTrackedBarcode> wrongBarcodes = this.a.getWrongBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(wrongBarcodes);
