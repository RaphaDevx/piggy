...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    protected Object invokeSuspend(Object result) {
        Throwable m3948exceptionOrNullimpl = Result.m3948exceptionOrNullimpl(result);
        if (m3948exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(m3948exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion_;
