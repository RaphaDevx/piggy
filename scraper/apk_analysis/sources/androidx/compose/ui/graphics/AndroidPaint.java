...
public final class AndroidPaint implements Paint {
    ...
    private int _blendMode = BlendMode.INSTANCE.m1205getSrcOver0nO6VwU();
    ...
    public long mo1140getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo1146setColor8_81llA(long j) {
        AndroidPaint_androidKt.m1152setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo1145setBlendModes9anfk8(int i) {
        this._blendMode = i;
        AndroidPaint_androidKt.m1151setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo1144getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo1150setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m1156setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo1142getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo1148setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m1154setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo1143getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo1149setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m1155setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo1141getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo1147setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m1153setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
