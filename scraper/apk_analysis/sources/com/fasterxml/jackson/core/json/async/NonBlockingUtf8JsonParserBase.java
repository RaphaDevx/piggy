...
public abstract class NonBlockingUtf8JsonParserBase extends NonBlockingJsonParserBase {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x003a, code lost:
        ...
        if ((r2._features & com.fasterxml.jackson.core.json.async.NonBlockingUtf8JsonParserBase.FEAT_MASK_ALLOW_MISSING) == 0) goto L36;
     */
                    ...
                    if (i5 == 0) {
                        ...
                        if (i4 >= i2) {
                            ...
                            if (i5 == 1) {
                                ...
                                i += 4;
                                int _decodeUTF8_4 = _decodeUTF8_4(byteFromBuffer, byteFromBuffer2, byteFromBuffer3, getByteFromBuffer(i7));
                                ...
                                byteFromBuffer = (_decodeUTF8_4 & FastDoubleMath.DOUBLE_EXPONENT_BIAS) | 56320;
                            }
                            if (currentSegmentSize >= bufferWithoutReset.length) {
                                bufferWithoutReset = this._textBuffer.finishCurrentSegment();
                            } else {
