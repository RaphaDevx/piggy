...
public final class zznp implements zzno {
    ...
    static {
        ...
        zzl = zza2.zzd("measurement.alarm_manager.minimum_interval", DateUtils.MILLIS_PER_MINUTE);
        ...
        zzq = zza2.zzd("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        ...
        zzy = zza2.zzd("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzM = zza2.zzd("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
    }
