...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m4113boximpl(ULong.m4119constructorimpl(getMostSignificantBits())), ULong.m4113boximpl(ULong.m4119constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m5424fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$0(Uuid a, Uuid b) {
        ...
        if (j != b.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m4119constructorimpl(j), ULong.m4119constructorimpl(b.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m4119constructorimpl(a.leastSignificantBits), ULong.m4119constructorimpl(b.leastSignificantBits));
    }
}
