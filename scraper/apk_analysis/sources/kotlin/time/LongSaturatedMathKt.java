...
public final class LongSaturatedMathKt {
    ...
    public static final long m5389saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long m5329toLongimpl = Duration.m5329toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m5388checkInfiniteSumDefinedPjuGub4(j, j2, m5329toLongimpl);
        }
        if ((1 | (m5329toLongimpl - 1)) == Long.MAX_VALUE) {
            return m5390saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + m5329toLongimpl;
        return ((j ^ j3) & (m5329toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m5388checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m5315isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m5390saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long m5293divUwyO8pc = Duration.m5293divUwyO8pc(j2, 2);
        long m5329toLongimpl = Duration.m5329toLongimpl(m5293divUwyO8pc, durationUnit);
        return (1 | (m5329toLongimpl - 1)) == Long.MAX_VALUE ? m5329toLongimpl : m5389saturatingAddNuflL3o(m5389saturatingAddNuflL3o(j, durationUnit, m5293divUwyO8pc), durationUnit, Duration.m5318minusLRDsOJo(j2, m5293divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m5380getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m5379getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m5334unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m5319plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m5334unaryMinusUwyO8pc(infinityOfSign(j3));
        }
