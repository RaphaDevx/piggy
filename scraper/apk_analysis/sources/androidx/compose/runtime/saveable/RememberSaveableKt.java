...
public final class RememberSaveableKt {
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] inputs, Saver<T, ? extends Object> stateSaver, String str, Function0<? extends MutableState<T>> init, Composer composer, int i, int i2) {
        ...
        MutableState<T> mutableState = (MutableState) m954rememberSaveable(Arrays.copyOf(inputs, inputs.length), mutableStateSaver(stateSaver), str, (Function0) init, composer, (i & 896) | 8 | (i & 7168), 0);
        composer.endReplaceableGroup();
        return mutableState;
    }
