...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo3426clone = transition.mo3426clone();
        mo3426clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo3426clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo3426clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo3426clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo3426clone = transition.mo3426clone();
        sceneChangeSetup(viewGroup, mo3426clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo3426clone);
    }
