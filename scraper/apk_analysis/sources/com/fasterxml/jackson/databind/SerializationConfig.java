...
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> implements Serializable {
    ...
    private SerializationConfig _withJsonWriteFeatures(FormatFeature... formatFeatureArr) {
        ...
        return (this._formatWriteFeatures == i4 && this._formatWriteFeaturesToChange == i5 && this._generatorFeatures == i6 && this._generatorFeaturesToChange == i7) ? this : new SerializationConfig(this, this._mapperFeatures, this._serFeatures, i6, i7, i4, i5);
    }
