...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m5474trySendImplMj0NB7M = conflatedBufferedChannel.m5474trySendImplMj0NB7M(e, true);
        if (m5474trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m5459exceptionOrNullimpl(m5474trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m5474trySendImplMj0NB7M = conflatedBufferedChannel.m5474trySendImplMj0NB7M(e, true);
        if (!(m5474trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo5440trySendJP2dKIU(E element) {
        return m5474trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m5474trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m5473trySendDropLatestMj0NB7M(element, isSendOp) : m5449trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m5473trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo5440trySendJP2dKIU = super.mo5440trySendJP2dKIU(element);
        if (ChannelResult.m5465isSuccessimpl(mo5440trySendJP2dKIU) || ChannelResult.m5463isClosedimpl(mo5440trySendJP2dKIU)) {
            return mo5440trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo5440trySendJP2dKIU = mo5440trySendJP2dKIU(element);
        if (!(mo5440trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo5440trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m5459exceptionOrNullimpl(mo5440trySendJP2dKIU);
