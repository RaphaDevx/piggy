...
public final class OuterMeasurablePlaceable extends Placeable implements Measurable {
    ...
    public OuterMeasurablePlaceable(LayoutNode layoutNode, LayoutNodeWrapper outerWrapper) {
        ...
        this.lastPosition = IntOffset.INSTANCE.m3095getZeronOccac();
        this.measureIteration = -1L;
    }

    /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m2624getLastConstraintsDWUhwKw() {
        if (this.measuredOnce) {
            return Constraints.m2965boximpl(getMeasurementConstraints());
        }
        return null;
    }
    ...
    public Placeable mo2510measureBRTryo0(long constraints) {
        ...
        m2625remeasureBRTryo0(constraints);
        return this;
    }

    /* renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m2625remeasureBRTryo0(final long constraints) {
        ...
        if (this.layoutNode.getLayoutState() != LayoutNode.LayoutState.NeedsRemeasure && Constraints.m2970equalsimpl0(getMeasurementConstraints(), constraints)) {
            return false;
        }
        ...
        long mo2522getSizeYbymL2g = this.outerWrapper.mo2522getSizeYbymL2g();
        requireOwner.getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, new Function0<Unit>() { // from class: androidx.compose.ui.node.OuterMeasurablePlaceable$remeasure$3
            ...
            public final void invoke2() {
                OuterMeasurablePlaceable.this.getOuterWrapper().mo2510measureBRTryo0(constraints);
            }
        });
        ...
        if (IntSize.m3125equalsimpl0(this.outerWrapper.mo2522getSizeYbymL2g(), mo2522getSizeYbymL2g) && this.outerWrapper.getWidth() == getWidth() && this.outerWrapper.getHeight() == getHeight()) {
            z = false;
        }
        m2546setMeasuredSizeozmzZPI(IntSizeKt.IntSize(this.outerWrapper.getWidth(), this.outerWrapper.getHeight()));
        return z;
    }
    ...
    public void mo2511placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        if (layerBlock == null) {
            companion.m2552place70tqf50(getOuterWrapper(), position, this.lastZIndex);
        } else {
            companion.m2557placeWithLayeraW9wM(getOuterWrapper(), position, this.lastZIndex, layerBlock);
        }
    }
    ...
    public final void replace() {
        ...
        mo2511placeAtf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
    }
