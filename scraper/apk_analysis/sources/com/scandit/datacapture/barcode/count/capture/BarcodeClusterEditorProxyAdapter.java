...
public final class BarcodeClusterEditorProxyAdapter implements BarcodeClusterEditorProxy {
    private final NativeBarcodeClusterEditor a;
    ...
    public BarcodeClusterEditorProxyAdapter(NativeBarcodeClusterEditor _NativeBarcodeClusterEditor, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_NativeBarcodeClusterEditor, "_NativeBarcodeClusterEditor");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _NativeBarcodeClusterEditor;
    ...
    public void dissolveCluster(Cluster cluster) {
        ...
        this.a.dissolveCluster(BarcodeNativeTypeFactory.INSTANCE.convert(cluster));
    }
    ...
    public void formCluster(List<Barcode> barcodes) {
        ...
        this.a.formCluster(BarcodeNativeTypeFactory.INSTANCE.convertBarcodeList(barcodes));
    }
    ...
    public /* synthetic */ BarcodeClusterEditorProxyAdapter(NativeBarcodeClusterEditor nativeBarcodeClusterEditor, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeClusterEditor, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
