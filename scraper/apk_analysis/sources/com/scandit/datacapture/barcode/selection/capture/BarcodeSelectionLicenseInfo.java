...
public final class BarcodeSelectionLicenseInfo {
    private final NativeBarcodeSelectionLicenseInfo a;
    ...
    public final Set<Symbology> getLicensedSymbologies() {
        HashSet<Symbology> licensedSymbologies = this.a.getLicensedSymbologies();
        Intrinsics.checkNotNullExpressionValue(licensedSymbologies, "getLicensedSymbologies(...)");
