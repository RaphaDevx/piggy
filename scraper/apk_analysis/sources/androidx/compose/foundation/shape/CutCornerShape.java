...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo417createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1094getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m1094getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m1094getWidthimpl(size), Size.m1091getHeightimpl(size) - f2);
        Path.lineTo(Size.m1094getWidthimpl(size) - f2, Size.m1091getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m1091getHeightimpl(size));
        Path.lineTo(0.0f, Size.m1091getHeightimpl(size) - bottomEnd);
        Path.close();
