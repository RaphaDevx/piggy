...
public class Future<T> implements java.util.concurrent.Future<T> {
    ...
    public Future<Void> then(final FutureHandler<T> futureHandler) {
        ...
        SharedState.Continuation<T> continuation = new SharedState.Continuation() { // from class: com.scandit.djinni.Future$$ExternalSyntheticLambda0
    ...
    public <R> Future<R> then(final FutureHandlerWithReturn<T, R> futureHandlerWithReturn) {
        ...
        SharedState.Continuation<T> continuation = new SharedState.Continuation() { // from class: com.scandit.djinni.Future$$ExternalSyntheticLambda1
            @Override // com.scandit.djinni.SharedState.Continuation
            public final void handleResult(SharedState sharedState) {
