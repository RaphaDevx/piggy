...
public final class BarcodeCountStatusItem implements BarcodeCountStatusItemProxy {
    ...
    public static final class Companion {
        ...
        public final BarcodeCountStatusItem create(TrackedBarcode barcode, BarcodeCountStatus status) {
            ...
            NativeBarcodeCountStatusItem create = NativeBarcodeCountStatusItem.create(barcode.getA(), status);
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeCountStatusItem getA() {
        return this.a.getA();
    }
