...
public final class Node extends NodeParent {
    ...
    public boolean dispatchMainEventPass(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent) {
        ...
        long mo2522getSizeYbymL2g = layoutCoordinates.mo2522getSizeYbymL2g();
        getPointerInputFilter().mo2442onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Initial, mo2522getSizeYbymL2g);
        ...
        if (getPointerInputFilter().isAttached$ui_release()) {
            getPointerInputFilter().mo2442onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Main, mo2522getSizeYbymL2g);
        }
        return true;
    }
    ...
    private final void buildCache(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent) {
        ...
        if (this.pointerInputFilter.isAttached$ui_release()) {
            ...
            for (Map.Entry<PointerId, PointerInputChange> entry : changes.entrySet()) {
                ...
                if (this.pointerIds.contains(PointerId.m2416boximpl(value))) {
                    Map<PointerId, PointerInputChange> map = this.relevantChanges;
                    PointerId m2416boximpl = PointerId.m2416boximpl(value);
                    LayoutCoordinates layoutCoordinates = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates);
                    long mo2523localPositionOfR5De75A = layoutCoordinates.mo2523localPositionOfR5De75A(parentCoordinates, value2.getPreviousPosition());
                    LayoutCoordinates layoutCoordinates2 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates2);
                    m2424copyEzrO64 = value2.m2424copyEzrO64((r30 & 1) != 0 ? value2.getId() : 0L, (r30 & 2) != 0 ? value2.uptimeMillis : 0L, (r30 & 4) != 0 ? value2.getPosition() : layoutCoordinates2.mo2523localPositionOfR5De75A(parentCoordinates, value2.getPosition()), (r30 & 8) != 0 ? value2.pressed : false, (r30 & 16) != 0 ? value2.previousUptimeMillis : 0L, (r30 & 32) != 0 ? value2.getPreviousPosition() : mo2523localPositionOfR5De75A, (r30 & 64) != 0 ? value2.previousPressed : false, (r30 & 128) != 0 ? value2.consumed : null, (r30 & 256) != 0 ? value2.getType() : 0);
                    map.put(m2416boximpl, m2424copyEzrO64);
                }
            }
    ...
    public boolean dispatchFinalEventPass() {
        ...
        if (!this.relevantChanges.isEmpty() && getPointerInputFilter().isAttached$ui_release()) {
            ...
            LayoutCoordinates layoutCoordinates = this.coordinates;
            Intrinsics.checkNotNull(layoutCoordinates);
            getPointerInputFilter().mo2442onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Final, layoutCoordinates.mo2522getSizeYbymL2g());
            if (getPointerInputFilter().isAttached$ui_release() && (size = (children = getChildren()).getSize()) > 0) {
                Node[] content = children.getContent();
                do {
