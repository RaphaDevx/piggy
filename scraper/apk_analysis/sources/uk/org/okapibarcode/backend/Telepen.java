...
public class Telepen extends Symbol {
    ...
    private void normalMode() {
        ...
        sb.append(TELE_TABLE[95]);
        int i = 0;
        for (int i2 = 0; i2 < this.content.length(); i2++) {
            char charAt = this.content.charAt(i2);
            sb.append(TELE_TABLE[charAt]);
            i += charAt;
        }
        int i3 = 127 - (i % 127);
        int i4 = i3 != 127 ? i3 : 0;
    ...
    private void numericMode() {
        ...
        String str = (this.content.length() & 1) == 1 ? "0" + this.content : this.content;
        StringBuilder sb = new StringBuilder();
        sb.append(TELE_TABLE[95]);
        int i = 0;
        for (int i2 = 0; i2 < str.length(); i2 += 2) {
            ...
            int i3 = charAt2 == 'X' ? charAt - 31 : ((charAt - '0') * 10) + (charAt2 - '0') + 27;
            i += i3;
            sb.append(TELE_TABLE[i3]);
        }
        int i4 = 127 - (i % 127);
        int i5 = i4 != 127 ? i4 : 0;
