...
public final class FloatToDecimal {
    ...
    private static final ThreadLocal<FloatToDecimal> threadLocal = ThreadLocal.withInitial(new Supplier() { // from class: com.fasterxml.jackson.core.io.schubfach.FloatToDecimal$$ExternalSyntheticLambda0
    ...
    private Appendable appendDecimalTo(float f, Appendable appendable) throws IOException {
        int i;
        int decimal = toDecimal(f);
        if (decimal != 0) {
            if (decimal == 1) {
