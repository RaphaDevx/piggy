...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m581getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int i, int i2, TextRange textRange, boolean z, SelectionAdjustment adjustment) {
        ...
        if (textLayoutResult != null) {
            ...
            return TextSelectionDelegateKt.m589adjustSelectionLepunE(textLayoutResult, TextRange, z, textRange != null ? TextRange.m2765getReversedimpl(textRange.getPackedValue()) : false, adjustment);
        }
