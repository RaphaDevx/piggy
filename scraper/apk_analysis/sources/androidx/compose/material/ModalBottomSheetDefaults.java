...
public final class ModalBottomSheetDefaults {
    ...
    private static final float Elevation = Dp.m3007constructorimpl(16);

    private ModalBottomSheetDefaults() {
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m771getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer composer, int i) {
        ...
        long m1253copywmQWz5c$default = Color.m1253copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 0).m677getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
