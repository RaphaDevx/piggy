...
@DebugMetadata(c = "androidx.compose.foundation.text.ClickableTextKt$ClickableText$pressIndicator$1$1", f = "ClickableText.kt", i = {}, l = {Base64.mimeLineLength}, m = "invokeSuspend", n = {}, s = {})
        ...
        if (i == 0) {
            ...
            if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$pressIndicator$1$1.1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m443invokek4lQ0M(offset.getPackedValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m443invokek4lQ0M(long j) {
                    TextLayoutResult value = mutableState.getValue();
                    if (value == null) {
                        return;
                    }
                    function1.invoke(Integer.valueOf(value.m2749getOffsetForPositionk4lQ0M(j)));
                }
