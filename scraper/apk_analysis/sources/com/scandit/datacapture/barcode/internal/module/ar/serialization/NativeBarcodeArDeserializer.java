...
public abstract class NativeBarcodeArDeserializer {
    ...
    public static final class CppProxy extends NativeBarcodeArDeserializer {
        ...
        private native NativeBarcodeAr native_barcodeArFromJson(long j, NativeDataCaptureContext nativeDataCaptureContext, NativeJsonValue nativeJsonValue);

        private native NativeBarcodeArDeserializerHelper native_getHelper(long j);

        private native ArrayList<String> native_getWarnings(long j);

        private native void native_setListener(long j, NativeBarcodeArDeserializerListener nativeBarcodeArDeserializerListener);

        private native NativeBarcodeArSettings native_settingsFromJson(long j, NativeJsonValue nativeJsonValue);

        private native NativeBarcodeAr native_updateBarcodeArFromJson(long j, NativeBarcodeAr nativeBarcodeAr, NativeJsonValue nativeJsonValue);

        private native NativeBarcodeArSettings native_updateSettingsFromJson(long j, NativeBarcodeArSettings nativeBarcodeArSettings, NativeJsonValue nativeJsonValue);
