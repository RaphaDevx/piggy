...
public interface SendChannel<E> {
    ...
    Object mo5440trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo5440trySendJP2dKIU = sendChannel.mo5440trySendJP2dKIU(e);
            if (ChannelResult.m5465isSuccessimpl(mo5440trySendJP2dKIU)) {
                return true;
            }
            Throwable m5459exceptionOrNullimpl = ChannelResult.m5459exceptionOrNullimpl(mo5440trySendJP2dKIU);
