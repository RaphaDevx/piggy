...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m953assert(this.nodeMap == 0);
        CommonFunctionsKt.m953assert(this.dataMap == 0);
        CommonFunctionsKt.m953assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m953assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        int i8 = 0;
        CommonFunctionsKt.m953assert((i2 & i7) == 0);
        TrieNode<K, V> trieNode2 = (Intrinsics.areEqual(this.ownedBy, mutator.getOwnership()) && this.dataMap == i7 && this.nodeMap == i2) ? this : new TrieNode<>(i7, i2, new Object[(Integer.bitCount(i7) * 2) + Integer.bitCount(i2)]);
        int i9 = i2;
        int i10 = 0;
        while (i9 != 0) {
            int lowestOneBit2 = Integer.lowestOneBit(i9);
            int length = (trieNode2.getBuffer().length - 1) - i10;
            Object[] buffer = trieNode2.getBuffer();
            if (hasNodeAt(lowestOneBit2)) {
                makeNode = nodeAtIndex$runtime_release(nodeIndex$runtime_release(lowestOneBit2)).mutablePutAllFromOtherNodeCell(otherNode, lowestOneBit2, shift, intersectionCounter, mutator);
            } else if (otherNode.hasNodeAt(lowestOneBit2)) {
                makeNode = otherNode.nodeAtIndex$runtime_release(otherNode.nodeIndex$runtime_release(lowestOneBit2)).mutablePutAllFromOtherNodeCell(this, lowestOneBit2, shift, intersectionCounter, mutator);
            } else {
                int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(lowestOneBit2);
                K keyAtIndex = keyAtIndex(entryKeyIndex$runtime_release);
                ...
                K keyAtIndex2 = otherNode.keyAtIndex(entryKeyIndex$runtime_release2);
                i = lowestOneBit2;
                trieNode = trieNode2;
                makeNode = makeNode(keyAtIndex != null ? keyAtIndex.hashCode() : 0, keyAtIndex, valueAtKeyIndex, keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, otherNode.valueAtKeyIndex(entryKeyIndex$runtime_release2), shift + 5, mutator.getOwnership());
        ...
        while (i7 != 0) {
            ...
            if (!otherNode.hasEntryAt$runtime_release(lowestOneBit3)) {
                int entryKeyIndex$runtime_release3 = entryKeyIndex$runtime_release(lowestOneBit3);
                trieNode3.getBuffer()[i11] = keyAtIndex(entryKeyIndex$runtime_release3);
                trieNode3.getBuffer()[i11 + 1] = valueAtKeyIndex(entryKeyIndex$runtime_release3);
            } else {
                int entryKeyIndex$runtime_release4 = otherNode.entryKeyIndex$runtime_release(lowestOneBit3);
                trieNode3.getBuffer()[i11] = otherNode.keyAtIndex(entryKeyIndex$runtime_release4);
                trieNode3.getBuffer()[i11 + 1] = otherNode.valueAtKeyIndex(entryKeyIndex$runtime_release4);
        ...
        return elementsIdentityEquals(trieNode3) ? this : otherNode.elementsIdentityEquals(trieNode3) ? otherNode : trieNode3;
    }
