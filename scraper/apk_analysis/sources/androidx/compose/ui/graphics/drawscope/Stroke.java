...
public final class Stroke extends DrawStyle {
    ...
    public /* synthetic */ Stroke(float f, float f2, int i, int i2, PathEffect pathEffect, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0.0f : f, (i3 & 2) != 0 ? 4.0f : f2, (i3 & 4) != 0 ? StrokeCap.INSTANCE.m1523getButtKaPHkGw() : i, (i3 & 8) != 0 ? StrokeJoin.INSTANCE.m1534getMiterLxFBmk8() : i2, (i3 & 16) != 0 ? null : pathEffect, null);
    }
    ...
    public static final class Companion {
        ...
        public final int m1710getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m1519equalsimpl0(getCap(), stroke.getCap()) && StrokeJoin.m1529equalsimpl0(getJoin(), stroke.getJoin()) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m1520hashCodeimpl(getCap())) * 31) + StrokeJoin.m1530hashCodeimpl(getJoin())) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect == null ? 0 : pathEffect.hashCode());
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m1521toStringimpl(getCap())) + ", join=" + ((Object) StrokeJoin.m1531toStringimpl(getJoin())) + ", pathEffect=" + this.pathEffect + ')';
    }
}
