...
public final class SemanticsNode {
    ...
    public final long m2682getSizeYbymL2g() {
        return findWrapperToGetBounds().mo2522getSizeYbymL2g();
    }
    ...
    public final long m2680getPositionInRootF1C5BW0() {
        return !this.layoutNode.isAttached() ? Offset.INSTANCE.m1041getZeroF1C5BW0() : LayoutCoordinatesKt.positionInRoot(findWrapperToGetBounds());
    }
    ...
    public final long m2681getPositionInWindowF1C5BW0() {
        return !this.layoutNode.isAttached() ? Offset.INSTANCE.m1041getZeroF1C5BW0() : LayoutCoordinatesKt.positionInWindow(findWrapperToGetBounds());
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (role != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && !unmergedChildren.isEmpty()) {
            unmergedChildren.add(m2679fakeSemanticsNodeypyhhiA(role, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver fakeSemanticsNode) {
                    ...
                    SemanticsPropertiesKt.m2686setRolekuIjeqM(fakeSemanticsNode, Role.this.getValue());
                }
            }));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !unmergedChildren.isEmpty() && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                unmergedChildren.add(0, m2679fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m2679fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
