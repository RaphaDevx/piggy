    ...
    */
    public final void onFrameOutput(com.scandit.datacapture.core.source.FrameSource r2, com.scandit.datacapture.core.data.FrameData r3) {
        /*
            ...
            com.scandit.datacapture.core.source.BitmapFrameSource r1 = (com.scandit.datacapture.core.source.BitmapFrameSource) r1
            if (r1 == 0) goto L2e
            java.util.concurrent.CopyOnWriteArraySet r1 = com.scandit.datacapture.core.source.BitmapFrameSource.access$getListeners$p(r1)
            if (r1 == 0) goto L2e
        ...
        L2e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scandit.datacapture.core.source.a.onFrameOutput(com.scandit.datacapture.core.source.FrameSource, com.scandit.datacapture.core.data.FrameData):void");
    }
    ...
    */
    public final void onStateChanged(com.scandit.datacapture.core.source.FrameSource r2, com.scandit.datacapture.core.source.FrameSourceState r3) {
        ...
        L2e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scandit.datacapture.core.source.a.onStateChanged(com.scandit.datacapture.core.source.FrameSource, com.scandit.datacapture.core.source.FrameSourceState):void");
    }
}
