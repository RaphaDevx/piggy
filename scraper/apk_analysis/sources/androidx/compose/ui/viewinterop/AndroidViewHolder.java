    ...
    public AndroidViewHolder(Context context, CompositionContext compositionContext) {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo40measure3p2s80s(MeasureScope receiver, List<? extends Measurable> measurables, long j) {
                ...
                if (Constraints.m2979getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m2979getMinWidthimpl(j));
                }
                if (Constraints.m2978getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m2978getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = AndroidViewHolder.this;
                ...
                obtainMeasureSpec = androidViewHolder.obtainMeasureSpec(m2979getMinWidthimpl, m2977getMaxWidthimpl, layoutParams.width);
                ...
                obtainMeasureSpec2 = androidViewHolder2.obtainMeasureSpec(m2978getMinHeightimpl, m2976getMaxHeightimpl, layoutParams2.height);
