...
public final class BarcodePickSession implements BarcodePickSessionProxy {
    ...
    public Set<String> getAddedItems() {
        return ((BarcodePickSessionProxyAdapter) this.b.getValue()).getAddedItems();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<TrackedObject> getAddedObjects() {
        return ((BarcodePickSessionProxyAdapter) this.b.getValue()).getAddedObjects();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<String> getTrackedItems() {
        return ((BarcodePickSessionProxyAdapter) this.b.getValue()).getTrackedItems();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<TrackedObject> getTrackedObjects() {
        return ((BarcodePickSessionProxyAdapter) this.b.getValue()).getTrackedObjects();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public String toJson() {
        return ((BarcodePickSessionProxyAdapter) this.b.getValue()).toJson();
    }
}
