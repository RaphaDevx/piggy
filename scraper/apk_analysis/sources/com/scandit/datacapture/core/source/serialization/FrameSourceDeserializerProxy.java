...
public interface FrameSourceDeserializerProxy {
    ...
    public static final class DefaultImpls {
        public static CameraSettings updateCameraSettingsFromJson(FrameSourceDeserializerProxy frameSourceDeserializerProxy, CameraSettings settings, String jsonData) {
            ...
            NativeCameraSettings updateCameraSettingsFromJson = frameSourceDeserializerProxy.getA().updateCameraSettingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(settings), NativeJsonValue.fromString(jsonData));
            Intrinsics.checkNotNull(updateCameraSettingsFromJson);
            settings.updateWithNativeObject$scandit_capture_core(updateCameraSettingsFromJson);
            return settings;
        }
    }
    ...
    @NativeImpl
    /* renamed from: _impl */
    NativeFrameSourceDeserializer getA();
