...
final class TextFieldSize {
    ...
    public TextFieldSize(LayoutDirection layoutDirection, Density density, Font.ResourceLoader resourceLoader, TextStyle style) {
        ...
        this.style = style;
        this.minSize = m520computeMinSizeYbymL2g();
    }
    ...
    public final void update(LayoutDirection layoutDirection, Density density, Font.ResourceLoader resourceLoader, TextStyle style) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(resourceLoader, "resourceLoader");
        Intrinsics.checkNotNullParameter(style, "style");
    ...
    private final long m520computeMinSizeYbymL2g() {
