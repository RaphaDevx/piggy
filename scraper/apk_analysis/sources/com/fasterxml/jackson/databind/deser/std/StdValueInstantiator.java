    ...
    */
    ...
    public Object createFromInt(DeserializationContext deserializationContext, int i) throws IOException {
        if (this._fromIntCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromIntCreator.getDeclaringClass(), valueOf, this.rewrapCtorProblem(deserializationContext, th));
            }
        }
        if (this._fromLongCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromLongCreator.getDeclaringClass(), valueOf2, this.rewrapCtorProblem(deserializationContext, th2));
            }
        }
        if (this._fromBigIntegerCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromBigIntegerCreator.getDeclaringClass(), valueOf3, this.rewrapCtorProblem(deserializationContext, th3));
            }
        }
    ...
    public Object createFromLong(DeserializationContext deserializationContext, long j) throws IOException {
        if (this._fromLongCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromLongCreator.getDeclaringClass(), valueOf, this.rewrapCtorProblem(deserializationContext, th));
            }
        }
        if (this._fromBigIntegerCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromBigIntegerCreator.getDeclaringClass(), valueOf2, this.rewrapCtorProblem(deserializationContext, th2));
            }
        }
    ...
    public Object createFromBigInteger(DeserializationContext deserializationContext, BigInteger bigInteger) throws IOException {
        ...
        if (annotatedWithParams != null) {
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromBigIntegerCreator.getDeclaringClass(), bigInteger, this.rewrapCtorProblem(deserializationContext, th));
            }
        }
    ...
    public Object createFromDouble(DeserializationContext deserializationContext, double d) throws IOException {
        if (this._fromDoubleCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromDoubleCreator.getDeclaringClass(), valueOf, this.rewrapCtorProblem(deserializationContext, th));
            }
        }
        if (this._fromBigDecimalCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromBigDecimalCreator.getDeclaringClass(), valueOf2, this.rewrapCtorProblem(deserializationContext, th2));
            }
        }
    ...
    public Object createFromBigDecimal(DeserializationContext deserializationContext, BigDecimal bigDecimal) throws IOException {
        ...
        if (annotatedWithParams != null) {
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromBigDecimalCreator.getDeclaringClass(), bigDecimal, this.rewrapCtorProblem(deserializationContext, th));
            }
        }
        if (this._fromDoubleCreator != null && (tryConvertToDouble = tryConvertToDouble(bigDecimal)) != null) {
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromDoubleCreator.getDeclaringClass(), tryConvertToDouble, this.rewrapCtorProblem(deserializationContext, th2));
            }
        }
    ...
    public Object createFromBoolean(DeserializationContext deserializationContext, boolean z) throws IOException {
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._fromBooleanCreator.getDeclaringClass(), valueOf, this.rewrapCtorProblem(deserializationContext, th));
        }
    }
