...
public final class MediaType {
    ...
    public final Charset charset(Charset defaultValue) {
        String parameter = parameter(javax.ws.rs.core.MediaType.CHARSET_PARAMETER);
        if (parameter == null) {
            return defaultValue;
        }
        try {
    ...
    public static final class Companion {
        ...
        public final MediaType m5599deprecated_get(String mediaType) {
        ...
        public final MediaType m5600deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
