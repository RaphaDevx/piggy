...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo181createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Path.addRect(new Rect(0.0f, 0.0f, Size.m1094getWidthimpl(size), Size.m1091getHeightimpl(size)));
        Path Path2 = AndroidPath_androidKt.Path();
        addCutoutShape(Path2, layoutDirection, density);
        Path2.mo1159opN5in7k0(Path, Path2, PathOperation.INSTANCE.m1475getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path path, LayoutDirection layoutDirection, Density density) {
        ...
        float f3 = 2 * mo227toPx0680j_4;
        long Size = SizeKt.Size(this.fabPlacement.getWidth() + f3, this.fabPlacement.getHeight() + f3);
        float left = this.fabPlacement.getLeft() - mo227toPx0680j_4;
        float m1094getWidthimpl = left + Size.m1094getWidthimpl(Size);
        float m1091getHeightimpl = Size.m1091getHeightimpl(Size) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.mo181createOutlinePq9zytI(Size, layoutDirection, density));
        path.mo1161translatek4lQ0M(OffsetKt.Offset(left, -m1091getHeightimpl));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            f2 = AppBarKt.BottomAppBarRoundedEdgeRadius;
            addRoundedEdges(path, left, m1094getWidthimpl, m1091getHeightimpl, density.mo227toPx0680j_4(f2), 0.0f);
        }
    }
