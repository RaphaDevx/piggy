...
public final class PointerInputEventProcessor {
    ...
    public final int m2440processgBdvCQM(PointerInputEvent pointerEvent, PositionCalculator positionCalculator) {
        ...
        for (PointerInputChange pointerInputChange : produce.getChanges().values()) {
            if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
                getRoot().m2600hitTest3MmeM6k$ui_release(pointerInputChange.getPosition(), this.hitResult);
                if (!this.hitResult.isEmpty()) {
                    this.hitPathTracker.m2409addHitPathKNwqfcY(pointerInputChange.getId(), this.hitResult);
        ...
        for (PointerInputChange pointerInputChange2 : produce.getChanges().values()) {
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange2)) {
                this.hitPathTracker.m2410removeHitPath0FcD4WY(pointerInputChange2.getId());
            }
