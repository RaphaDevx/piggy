...
public final class BarcodeCountStatusProviderCallbackProxyAdapter implements BarcodeCountStatusProviderCallbackProxy {
    ...
    public void onStatusReady(BarcodeCountStatusResult statusResult) {
        ...
        NativeBarcodeCountStatusResult a = statusResult.getA();
        this.proxyCache.put(Reflection.getOrCreateKotlinClass(NativeBarcodeCountStatusResult.class), null, a, statusResult);
        this.a.onStatusReady(a);
    }
