...
final class DefaultChoreographerFrameClock implements MonotonicFrameClock {
    ...
    static {
        ...
        choreographer = (Choreographer) BuildersKt.runBlocking(Dispatchers.getMain().getImmediate(), new DefaultChoreographerFrameClock$choreographer$1(null));
    }
        ...
        final Choreographer.FrameCallback frameCallback = new Choreographer.FrameCallback() { // from class: androidx.compose.runtime.DefaultChoreographerFrameClock$withFrameNanos$2$callback$1
            ...
            public final void doFrame(long j) {
                ...
                try {
                    ...
                    m3945constructorimpl = Result.m3945constructorimpl(function12.invoke(Long.valueOf(j)));
                } catch (Throwable th) {
