...
public final class ScanditIconSerializer {
    ...
    public static final String toJson(ScanditIcon scanditIcon) {
        ...
        ScanditIconType scanditIconType = scanditIcon.getCom.scandit.datacapture.barcode.pick.serialization.BarcodePickDeserializer.FIELD_ICON java.lang.String();
        if (scanditIconType != null) {
            jSONObject.put(BarcodePickDeserializer.FIELD_ICON, ScanditIconTypeSerializer.toJson(scanditIconType));
        }
