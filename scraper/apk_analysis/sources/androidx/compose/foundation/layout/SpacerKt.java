...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u0015\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"Spacer", "", "modifier", "Landroidx/compose/ui/Modifier;", "(Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;I)V", "foundation-layout_release"}, k = 2, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        if (((i2 & 11) ^ 2) != 0 || !startRestartGroup.getSkipping()) {
            SpacerKt$Spacer$2 spacerKt$Spacer$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.SpacerKt$Spacer$2
                ...
                public final MeasureResult mo40measure3p2s80s(MeasureScope Layout, List<? extends Measurable> noName_0, long j) {
                    ...
                    return MeasureScope.DefaultImpls.layout$default(Layout, Constraints.m2975getHasFixedWidthimpl(j) ? Constraints.m2977getMaxWidthimpl(j) : 0, Constraints.m2974getHasFixedHeightimpl(j) ? Constraints.m2976getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerKt$Spacer$2$measure$1$1
            ...
            Updater.m948setimpl(m941constructorimpl, spacerKt$Spacer$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
