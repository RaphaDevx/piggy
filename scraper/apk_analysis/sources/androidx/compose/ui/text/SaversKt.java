...
public final class SaversKt {
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, ParagraphStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(it.getTextAlign()), SaversKt.save(it.getTextDirection()), SaversKt.save(TextUnit.m3138boximpl(it.getLineHeight()), SaversKt.getSaver(TextUnit.INSTANCE), Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.INSTANCE), Saver));
        }
    ...
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final SpanStyle invoke(Object it) {
            ...
            Object obj = list.get(0);
            Shadow shadow = null;
            Color restore6 = (Intrinsics.areEqual(obj, (Object) false) || obj == null) ? null : SaversKt.getSaver(Color.INSTANCE).restore(obj);
            Intrinsics.checkNotNull(restore6);
            long value = restore6.getValue();
            Object obj2 = list.get(1);
            TextUnit restore7 = (Intrinsics.areEqual(obj2, (Object) false) || obj2 == null) ? null : SaversKt.getSaver(TextUnit.INSTANCE).restore(obj2);
            Intrinsics.checkNotNull(restore7);
            long packedValue = restore7.getPackedValue();
            Object obj3 = list.get(2);
            Saver<FontWeight, Object> saver = SaversKt.getSaver(FontWeight.INSTANCE);
            ...
            TextUnit restore8 = (Intrinsics.areEqual(obj7, (Object) false) || obj7 == null) ? null : SaversKt.getSaver(TextUnit.INSTANCE).restore(obj7);
            Intrinsics.checkNotNull(restore8);
            long packedValue2 = restore8.getPackedValue();
            Object obj8 = list.get(8);
            Saver<BaselineShift, Object> saver2 = SaversKt.getSaver(BaselineShift.INSTANCE);
            ...
            Saver<TextGeometricTransform, Object> saver3 = SaversKt.getSaver(TextGeometricTransform.INSTANCE);
            ...
            Saver<LocaleList, Object> saver4 = SaversKt.getSaver(LocaleList.INSTANCE);
            ...
            Color restore9 = (Intrinsics.areEqual(obj11, (Object) false) || obj11 == null) ? null : SaversKt.getSaver(Color.INSTANCE).restore(obj11);
            Intrinsics.checkNotNull(restore9);
            long value2 = restore9.getValue();
            Object obj12 = list.get(12);
            Saver<TextDecoration, Object> saver5 = SaversKt.getSaver(TextDecoration.INSTANCE);
            ...
            Saver<Shadow, Object> saver6 = SaversKt.getSaver(Shadow.INSTANCE);
            if (!Intrinsics.areEqual(obj13, (Object) false) && obj13 != null) {
                shadow = saver6.restore(obj13);
            }
            return new SpanStyle(value, packedValue, restore, fontStyle, fontSynthesis, null, str, packedValue2, restore2, restore3, restore4, value2, restore5, shadow, 32, null);
        }
    });
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope Saver, TextIndent it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m3138boximpl(it.getFirstLine()), SaversKt.getSaver(TextUnit.INSTANCE), Saver), SaversKt.save(TextUnit.m3138boximpl(it.getRestLine()), SaversKt.getSaver(TextUnit.INSTANCE), Saver));
        }
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m2723invoke8a2Sb4w(saverScope, baselineShift.getMultiplier());
        }

        /* renamed from: invoke-8a2Sb4w, reason: not valid java name */
        public final Object m2723invoke8a2Sb4w(SaverScope Saver, float f) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
        ...
        public final BaselineShift invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return BaselineShift.m2912boximpl(BaselineShift.m2913constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m2729invokeFDrldGo(saverScope, textRange.getPackedValue());
        }

        /* renamed from: invoke-FDrldGo, reason: not valid java name */
        public final Object m2729invokeFDrldGo(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf((Integer) SaversKt.save(Integer.valueOf(TextRange.m2766getStartimpl(j))), (Integer) SaversKt.save(Integer.valueOf(TextRange.m2761getEndimpl(j))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(num2);
            return TextRange.m2754boximpl(TextRangeKt.TextRange(intValue, num2.intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope Saver, Shadow it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m1244boximpl(it.getColor()), SaversKt.getSaver(Color.INSTANCE), Saver), SaversKt.save(Offset.m1014boximpl(it.getOffset()), SaversKt.getSaver(Offset.INSTANCE), Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
    ...
    private static final Saver<Color, Object> ColorSaver = SaverKt.Saver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m2725invoke4WTKRHQ(saverScope, color.getValue());
        }

        /* renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m2725invoke4WTKRHQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return ULong.m4113boximpl(j);
        }
        ...
        public final Color invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return Color.m1244boximpl(Color.m1250constructorimpl(((ULong) it).getData()));
        }
    });
    private static final Saver<TextUnit, Object> TextUnitSaver = SaverKt.Saver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m2731invokempE4wyQ(saverScope, textUnit.getPackedValue());
        }

        /* renamed from: invoke-mpE4wyQ, reason: not valid java name */
        public final Object m2731invokempE4wyQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m3148getValueimpl(j))), SaversKt.save(TextUnitType.m3173boximpl(TextUnit.m3147getTypeUIouoOA(j))));
        }
        ...
        public final TextUnit invoke(Object it) {
            ...
            return TextUnit.m3138boximpl(TextUnitKt.m3160TextUnitanM5pPY(floatValue, textUnitType.getType()));
        }
    });
    private static final Saver<Offset, Object> OffsetSaver = SaverKt.Saver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m2727invokeUv8p0NA(saverScope, offset.getPackedValue());
        }

        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final Object m2727invokeUv8p0NA(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            if (Offset.m1022equalsimpl0(j, Offset.INSTANCE.m1040getUnspecifiedF1C5BW0())) {
                return (Serializable) false;
            }
            return CollectionsKt.arrayListOf((Float) SaversKt.save(Float.valueOf(Offset.m1025getXimpl(j))), (Float) SaversKt.save(Float.valueOf(Offset.m1026getYimpl(j))));
        }
        ...
        public final Offset invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m1014boximpl(Offset.INSTANCE.m1040getUnspecifiedF1C5BW0());
            }
            List list = (List) it;
            Object obj = list.get(0);
            Float f = obj == null ? null : (Float) obj;
            ...
            return Offset.m1014boximpl(OffsetKt.Offset(floatValue, f2.floatValue()));
        }
    });
