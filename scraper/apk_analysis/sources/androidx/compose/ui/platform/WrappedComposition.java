...
final class WrappedComposition implements Composition, LifecycleEventObserver {
    ...
    public WrappedComposition(AndroidComposeView owner, Composition original) {
        ...
        this.lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m2648getLambda1$ui_release();
    }
                    ...
                    original.setContent(ComposableLambdaKt.composableLambdaInstance(-985537314, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition$setContent$1.1
                        ...
                        public final void invoke(Composer composer, int i) {
                            ...
                            if (((i & 11) ^ 2) != 0 || !composer.getSkipping()) {
                                ...
                                EffectsKt.LaunchedEffect(WrappedComposition.this.getOwner(), new C00351(WrappedComposition.this, null), composer, 8);
