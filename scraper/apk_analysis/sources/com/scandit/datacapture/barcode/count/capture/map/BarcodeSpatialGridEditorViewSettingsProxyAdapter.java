...
public final class BarcodeSpatialGridEditorViewSettingsProxyAdapter implements BarcodeSpatialGridEditorViewSettingsProxy {
    private final NativeBarcodeSpatialGridEditorViewSettings a;
    ...
    public BarcodeSpatialGridEditorViewSettingsProxyAdapter(NativeBarcodeSpatialGridEditorViewSettings _NativeBarcodeSpatialGridEditorViewSettings, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_NativeBarcodeSpatialGridEditorViewSettings, "_NativeBarcodeSpatialGridEditorViewSettings");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _NativeBarcodeSpatialGridEditorViewSettings;
    ...
    public String getCancelMappingButtonText() {
        String cancelMappingButtonText = this.a.getCancelMappingButtonText();
        Intrinsics.checkNotNull(cancelMappingButtonText);
        return cancelMappingButtonText;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public String getFinishMappingButtonText() {
        String finishMappingButtonText = this.a.getFinishMappingButtonText();
        Intrinsics.checkNotNull(finishMappingButtonText);
    ...
    public String getReorderHintText() {
        String reorderHintText = this.a.getReorderHintText();
        Intrinsics.checkNotNull(reorderHintText);
        return reorderHintText;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public int getSubColor() {
        NativeColor subColor = this.a.getSubColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(subColor);
        return coreNativeTypeFactory.convert(subColor);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public int getToteColor() {
        NativeColor toteColor = this.a.getToteColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(toteColor);
        return coreNativeTypeFactory.convert(toteColor);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public String getToteTextFormat() {
        String toteTextFormat = this.a.getToteTextFormat();
        Intrinsics.checkNotNull(toteTextFormat);
        return toteTextFormat;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public void setCancelMappingButtonText(String p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setCancelMappingButtonText(p0);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public void setFinishMappingButtonText(String p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setFinishMappingButtonText(p0);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public void setReorderHintText(String p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setReorderHintText(p0);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public void setSubColor(int i) {
        this.a.setSubColor(CoreNativeTypeFactory.INSTANCE.convert(i));
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public void setToteColor(int i) {
        this.a.setToteColor(CoreNativeTypeFactory.INSTANCE.convert(i));
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorViewSettingsProxy
    public void setToteTextFormat(String p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setToteTextFormat(p0);
    }

    public /* synthetic */ BarcodeSpatialGridEditorViewSettingsProxyAdapter(NativeBarcodeSpatialGridEditorViewSettings nativeBarcodeSpatialGridEditorViewSettings, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeSpatialGridEditorViewSettings, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
