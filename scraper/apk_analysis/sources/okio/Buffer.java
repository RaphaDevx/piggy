...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m5660deprecated_getByte(long index) {
    ...
    public long indexOf(ByteString bytes, long fromIndex) throws IOException {
        ...
        if (segment == null) {
            ...
            if (segment != null) {
                ...
                loop1: while (j < size3) {
                    byte[] bArr = segment.data;
                    int min = (int) Math.min(segment.limit, (segment.pos + size3) - j);
                    i = (int) ((segment.pos + j3) - j);
                    if (i < min) {
                        while (true) {
                            int i2 = i + 1;
            ...
            if (segment != null) {
                ...
                loop4: while (j < size5) {
                    byte[] bArr2 = segment.data;
                    int min2 = (int) Math.min(segment.limit, (segment.pos + size5) - j);
                    i = (int) ((segment.pos + j5) - j);
                    if (i < min2) {
                        while (true) {
                            int i3 = i + 1;
                            if (bArr2[i] == b2) {
                                z = true;
                                if (_BufferKt.rangeEquals(segment, i3, internalArray$okio2, 1, size4)) {
                                    break loop4;
                                }
                            } else {
                                z = true;
