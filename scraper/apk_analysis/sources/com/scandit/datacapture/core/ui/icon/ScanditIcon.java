...
public final class ScanditIcon {
    ...
    private com.scandit.datacapture.core.internal.module.ui.icon.a g;
    private Drawable h;

    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\u0003\u0010\u0004R\u001a\u0010\u0006\u001a\u00020\u00058\u0000X\u0081T¢\u0006\f\n\u0004\b\u0006\u0010\u0007\u0012\u0004\b\b\u0010\tR\u001b\u0010\u000f\u001a\u00020\n8@X\u0080\u0084\u0002¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000e¨\u0006\u0010"}, d2 = {"Lcom/scandit/datacapture/core/ui/icon/ScanditIcon$Companion;", "", "Lcom/scandit/datacapture/core/ui/icon/ScanditIconBuilder;", "builder", "()Lcom/scandit/datacapture/core/ui/icon/ScanditIconBuilder;", "", "iconToBackgroundRatio", "F", "getIconToBackgroundRatio$scandit_capture_core$annotations", "()V", "", "iconBackgroundSize$delegate", "Lkotlin/Lazy;", "getIconBackgroundSize$scandit_capture_core", "()I", "iconBackgroundSize", "scandit-capture-core"}, k = 1, mv = {1, 9, 0})
    public static final class Companion {
        ...
        public final int getIconBackgroundSize$scandit_capture_core() {
            return ((Number) ScanditIcon.i.getValue()).intValue();
        }
    }
    ...
    public ScanditIcon(ScanditIconType scanditIconType, Integer num, Integer num2, Integer num3, float f, ScanditIconShape scanditIconShape) {
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual(ScanditIcon.class, other != null ? other.getClass() : null)) {
            return false;
        }
        Intrinsics.checkNotNull(other, "null cannot be cast to non-null type com.scandit.datacapture.core.ui.icon.ScanditIcon");
        ScanditIcon scanditIcon = (ScanditIcon) other;
        return this.icon == scanditIcon.icon && Intrinsics.areEqual(this.iconColor, scanditIcon.iconColor) && Intrinsics.areEqual(this.backgroundColor, scanditIcon.backgroundColor) && Intrinsics.areEqual(this.backgroundStrokeColor, scanditIcon.backgroundStrokeColor) && this.backgroundStrokeWidth == scanditIcon.backgroundStrokeWidth && this.backgroundShape == scanditIcon.backgroundShape;
    }
    ...
    public final /* synthetic */ Drawable getDrawable$scandit_capture_core(Context context) {
        int i2;
        Intrinsics.checkNotNullParameter(context, "context");
        com.scandit.datacapture.core.internal.module.ui.icon.a aVar = this.g;
        if (aVar != null) {
            return aVar;
        }
        ...
        if (this.backgroundShape != null) {
            ...
            int i3 = WhenMappings.$EnumSwitchMapping$0[this.backgroundShape.ordinal()];
            if (i3 == 1) {
                i2 = 1;
            } else {
                if (i3 != 2) {
        ...
        com.scandit.datacapture.core.internal.module.ui.icon.a aVar2 = new com.scandit.datacapture.core.internal.module.ui.icon.a(new Drawable[]{gradientDrawable, drawableIgnoringBackground$scandit_capture_core});
    ...
    public final Drawable getDrawableIgnoringBackground$scandit_capture_core(Context context) {
        Integer num;
        Intrinsics.checkNotNullParameter(context, "context");
        ...
        switch (scanditIconType == null ? -1 : WhenMappings.$EnumSwitchMapping$1[scanditIconType.ordinal()]) {
            ...
            default:
                throw new NoWhenBranchMatchedException();
            case 1:
                num = Integer.valueOf(R.drawable.sc_ic_to_pick);
                break;
            case 2:
                num = Integer.valueOf(R.drawable.sc_ic_checkmark);
                break;
            case 3:
                num = Integer.valueOf(R.drawable.sc_ic_x_mark);
                break;
            case 4:
                num = Integer.valueOf(R.drawable.sc_ic_question_mark);
                break;
            case 5:
                num = Integer.valueOf(R.drawable.sc_ic_exclamation_mark);
                break;
            case 6:
                num = Integer.valueOf(R.drawable.sc_ic_wrong_item);
                break;
            case 7:
                num = Integer.valueOf(R.drawable.sc_ic_low_stock);
                break;
            case 8:
                num = Integer.valueOf(R.drawable.sc_ic_inspect_item);
                break;
            case 9:
                num = Integer.valueOf(R.drawable.sc_ic_expired_item);
                break;
            case 10:
                num = Integer.valueOf(R.drawable.sc_ic_fragile_item);
                break;
            case 11:
                num = Integer.valueOf(R.drawable.sc_ic_star_filled);
                break;
            case 12:
                num = Integer.valueOf(R.drawable.sc_ic_star_half_filled);
                break;
            case 13:
                num = Integer.valueOf(R.drawable.sc_ic_star_outlined);
                break;
            case 14:
                num = Integer.valueOf(R.drawable.sc_ic_arrow_right);
                break;
            case 15:
                num = Integer.valueOf(R.drawable.sc_ic_arrow_left);
                break;
            case 16:
                num = Integer.valueOf(R.drawable.sc_ic_arrow_up);
                break;
            case 17:
                num = Integer.valueOf(R.drawable.sc_ic_arrow_down);
                break;
            case 18:
                num = Integer.valueOf(R.drawable.sc_ic_chevron_right);
                break;
            case 19:
                num = Integer.valueOf(R.drawable.sc_ic_chevron_down);
                break;
            case 20:
                num = Integer.valueOf(R.drawable.sc_ic_chevron_up);
                break;
            case 21:
                num = Integer.valueOf(R.drawable.sc_ic_chevron_left);
                break;
            case 22:
                num = Integer.valueOf(R.drawable.sc_ic_print);
                break;
        }
        if (num != null) {
            drawable2 = context.getResources().getDrawable(num.intValue(), context.getTheme()).mutate();
            Integer num2 = this.iconColor;
            drawable2.setTint(num2 != null ? num2.intValue() : 0);
            this.h = drawable2;
        }
        return drawable2;
    }
    ...
    public int hashCode() {
        ScanditIconType scanditIconType = this.icon;
        int hashCode = (scanditIconType != null ? scanditIconType.hashCode() : 0) * 31;
        Integer num = this.iconColor;
        int intValue = (hashCode + (num != null ? num.intValue() : 0)) * 31;
        Integer num2 = this.backgroundColor;
        int intValue2 = (intValue + (num2 != null ? num2.intValue() : 0)) * 31;
        Integer num3 = this.backgroundStrokeColor;
        int hashCode2 = (Float.hashCode(this.backgroundStrokeWidth) + ((intValue2 + (num3 != null ? num3.intValue() : 0)) * 31)) * 31;
        ScanditIconShape scanditIconShape = this.backgroundShape;
        return hashCode2 + (scanditIconShape != null ? scanditIconShape.hashCode() : 0);
    }
}
