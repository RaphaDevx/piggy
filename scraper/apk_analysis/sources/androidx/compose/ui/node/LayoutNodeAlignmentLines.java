...
public final class LayoutNodeAlignmentLines {
    ...
    private static final void recalculate$addAlignmentLine(LayoutNodeAlignmentLines layoutNodeAlignmentLines, AlignmentLine alignmentLine, int i, LayoutNodeWrapper layoutNodeWrapper) {
        ...
        while (true) {
            Offset = layoutNodeWrapper.m2616toParentPositionMKHz9U(Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            roundToInt = MathKt.roundToInt(Offset.m1026getYimpl(Offset));
        } else {
            roundToInt = MathKt.roundToInt(Offset.m1025getXimpl(Offset));
        }
