...
public final class TextPaintExtensions_androidKt {
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle style, TypefaceAdapter typefaceAdapter, Density density) {
        long m3159getUnspecifiedXSAIIZE;
        long background;
        ...
        long m3147getTypeUIouoOA = TextUnit.m3147getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m3176equalsimpl0(m3147getTypeUIouoOA, TextUnitType.INSTANCE.m3181getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo226toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m3176equalsimpl0(m3147getTypeUIouoOA, TextUnitType.INSTANCE.m3180getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m3148getValueimpl(style.getFontSize()));
        }
        ...
        long m3147getTypeUIouoOA2 = TextUnit.m3147getTypeUIouoOA(style.getLetterSpacing());
        if (TextUnitType.m3176equalsimpl0(m3147getTypeUIouoOA2, TextUnitType.INSTANCE.m3180getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m3148getValueimpl(style.getLetterSpacing()));
        } else {
            TextUnitType.m3176equalsimpl0(m3147getTypeUIouoOA2, TextUnitType.INSTANCE.m3181getSpUIouoOA());
        }
        ...
        androidTextPaint.m2887setColor8_81llA(style.getColor());
        androidTextPaint.setShadow(style.getShadow());
        androidTextPaint.setTextDecoration(style.getTextDecoration());
        if (TextUnitType.m3176equalsimpl0(TextUnit.m3147getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m3181getSpUIouoOA()) && TextUnit.m3148getValueimpl(style.getLetterSpacing()) != 0.0f) {
            m3159getUnspecifiedXSAIIZE = style.getLetterSpacing();
        } else {
            m3159getUnspecifiedXSAIIZE = TextUnit.INSTANCE.m3159getUnspecifiedXSAIIZE();
        }
        long j = m3159getUnspecifiedXSAIIZE;
        if (Color.m1255equalsimpl0(style.getBackground(), Color.INSTANCE.m1289getTransparent0d7_KjU())) {
            background = Color.INSTANCE.m1290getUnspecified0d7_KjU();
        } else {
            background = style.getBackground();
        }
        long j2 = background;
        BaselineShift baselineShift2 = style.getBaselineShift();
        if (baselineShift2 == null ? false : BaselineShift.m2915equalsimpl0(baselineShift2.getMultiplier(), BaselineShift.INSTANCE.m2922getNoney9eOQZs())) {
            baselineShift = null;
        } else {
    ...
    private static final Typeface createTypeface(SpanStyle spanStyle, TypefaceAdapter typefaceAdapter) {
        ...
        return typefaceAdapter.m2893createDPcqOEQ(fontFamily, fontWeight, m2807getNormal_LCdwA, fontSynthesis == null ? FontSynthesis.INSTANCE.m2817getAllGVVA2EU() : fontSynthesis.getValue());
    }
}
