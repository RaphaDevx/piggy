...
public final class RelocationRequesterModifierKt {
    ...
    public static final void bringIntoView(NestedScrollDelegatingWrapper nestedScrollDelegatingWrapper, LayoutCoordinates layoutCoordinates) {
        ...
        nestedScrollDelegatingWrapper.getModifier().getConnection().mo232onPostScrollDzOQY0M(Offset.INSTANCE.m1041getZeroF1C5BW0(), OffsetKt.Offset(calculateOffset(localBoundingBoxOf.getLeft(), localBoundingBoxOf.getRight(), IntSize.m3127getWidthimpl(nestedScrollDelegatingWrapper.mo2522getSizeYbymL2g())), calculateOffset(localBoundingBoxOf.getTop(), localBoundingBoxOf.getBottom(), IntSize.m3126getHeightimpl(nestedScrollDelegatingWrapper.mo2522getSizeYbymL2g()))), NestedScrollSource.INSTANCE.m2397getRelocateWNlRxjI());
