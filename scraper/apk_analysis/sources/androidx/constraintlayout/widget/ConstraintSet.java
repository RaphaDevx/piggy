...
public class ConstraintSet {
    ...
    */
    ...
    public void setStateLabels(String str) {
        this.mMatchLabels = str.split(FirebaseConstants.SEPARATOR);
        int i = 0;
        while (true) {
            String[] strArr = this.mMatchLabels;
            if (i >= strArr.length) {
    ...
    */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m3317clone());
            }
        }
    }
    ...
    public void parseIntAttributes(Constraint constraint, String str) {
        String[] split = str.split(FirebaseConstants.SEPARATOR);
    ...
    private String sideToString(int i) {
        switch (i) {
            ...
            case 2:
                return "right";
            case 3:
                return RRWebVideoEvent.JsonKeys.TOP;
            case 4:
                return "bottom";
            case 5:
                return "baseline";
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{RRWebVideoEvent.JsonKeys.LEFT, "right", RRWebVideoEvent.JsonKeys.TOP, "bottom", "start", "end"}, -1);
