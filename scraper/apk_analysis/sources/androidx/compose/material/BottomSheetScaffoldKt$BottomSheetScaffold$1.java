...
final class BottomSheetScaffoldKt$BottomSheetScaffold$1 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    public final void invoke(BoxWithConstraintsScope BoxWithConstraints, Composer composer, int i) {
        ...
        if (((i2 & 91) ^ 18) != 0 || !composer.getSkipping()) {
            ...
            final float mo227toPx0680j_4 = ((Density) consume).mo227toPx0680j_4(this.$sheetPeekHeight);
            ...
            m859swipeablepPrIpRY = SwipeableKt.m859swipeablepPrIpRY(NestedScrollModifierKt.nestedScroll$default(Modifier.INSTANCE, this.$scaffoldState.getBottomSheetState().getNestedScrollConnection(), null, 2, null), this.$scaffoldState.getBottomSheetState(), r18, Orientation.Vertical, (r26 & 8) != 0 ? true : this.$sheetGesturesEnabled, (r26 & 16) != 0 ? false : false, (r26 & 32) != 0 ? null : null, (r26 & 64) != 0 ? new Function2<T, T, FixedThreshold>() { // from class: androidx.compose.material.SwipeableKt$swipeable$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function2
                public final FixedThreshold invoke(T t, T t2) {
                    return new FixedThreshold(Dp.m3007constructorimpl(56), null);
                }
            } : null, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, MapsKt.mapOf(TuplesKt.to(Float.valueOf(m2976getMaxHeightimpl - mo227toPx0680j_4), BottomSheetValue.Collapsed), TuplesKt.to(Float.valueOf(m2976getMaxHeightimpl - m639invoke$lambda2(mutableState)), BottomSheetValue.Expanded)).keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m858getVelocityThresholdD9Ej5fM() : 0.0f);
            final BottomSheetScaffoldState bottomSheetScaffoldState = this.$scaffoldState;
            final CoroutineScope coroutineScope = this.$scope;
            final Modifier semantics$default = SemanticsModifierKt.semantics$default(m859swipeablepPrIpRY, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$swipeable$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    float m639invoke$lambda2;
                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                    float f = mo227toPx0680j_4;
                    m639invoke$lambda2 = BottomSheetScaffoldKt$BottomSheetScaffold$1.m639invoke$lambda2(mutableState);
                    if (f == m639invoke$lambda2) {
                        return;
                    }
                    if (bottomSheetScaffoldState.getBottomSheetState().isCollapsed()) {
                        ...
                        SemanticsPropertiesKt.expand$default(semantics, null, new Function0<Boolean>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$swipeable$1.1
                            ...
                            public final boolean invoke2() {
                                ...
                                BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00221(BottomSheetScaffoldState.this, null), 3, null);
                                return true;
                            }
                            ...
                            static final class C00221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                C00221(BottomSheetScaffoldState bottomSheetScaffoldState, Continuation<? super C00221> continuation) {
                                ...
                                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                    return new C00221(this.$scaffoldState, continuation);
                                }
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, -819899396, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1
                ...
                public final void invoke(Composer composer2, int i7) {
                    ...
                    if (((i7 & 11) ^ 2) != 0 || !composer2.getSkipping()) {
                        ...
                        ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composer2, -819899585, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1.1
                            ...
                            public final void invoke(Composer composer3, int i10) {
                                ...
                                if (((i10 & 11) ^ 2) != 0 || !composer3.getSkipping()) {
                                    ...
                                    ComposableLambda composableLambda3 = ComposableLambdaKt.composableLambda(composer3, -819900219, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt.BottomSheetScaffold.1.child.1.1.1
                                        ...
                                        public final void invoke(Composer composer4, int i13) {
                                            ...
                                            if (((i13 & 11) ^ 2) != 0 || !composer4.getSkipping()) {
                                                ...
                                                function36.invoke(PaddingKt.m312PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f5, 7, null), composer4, Integer.valueOf((i15 >> 3) & b.p));
                                                composer4.endReplaceableGroup();
                                                composer4.endReplaceableGroup();
                                                composer4.endReplaceableGroup();
                                                composer4.endNode();
                                    ...
                                    int i13 = i8;
                                    SurfaceKt.m855SurfaceFjzlyU((Modifier) null, (Shape) null, j7, j8, (BorderStroke) null, 0.0f, composableLambda3, composer3, ((i13 << 6) & 896) | 1572864 | ((i13 << 6) & 7168), 51);
                                    return;
                                }
                        ...
                        ComposableLambda composableLambda3 = ComposableLambdaKt.composableLambda(composer2, -819899921, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1.2
                            ...
                            public final void invoke(Composer composer3, int i12) {
                                ...
                                if (((i12 & 11) ^ 2) != 0 || !composer3.getSkipping()) {
                                    Modifier m348requiredHeightInVpY3zN4$default = SizeKt.m348requiredHeightInVpY3zN4$default(SizeKt.fillMaxWidth$default(Modifier.this, 0.0f, 1, null), f4, 0.0f, 2, null);
                                    ...
                                    if (changed || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                                        rememberedValue2 = (Function1) new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1$2$1$1
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            {
                                                super(1);
                                            }
                                            ...
                                            public final void invoke2(LayoutCoordinates it) {
                                                ...
                                                BottomSheetScaffoldKt$BottomSheetScaffold$1.m640invoke$lambda3(mutableState3, IntSize.m3126getHeightimpl(it.mo2522getSizeYbymL2g()));
                                            }
                                        };
                                        composer3.updateRememberedValue(rememberedValue2);
                                    }
                                    composer3.endReplaceableGroup();
                                    Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(m348requiredHeightInVpY3zN4$default, (Function1) rememberedValue2);
                                    Shape shape3 = shape2;
                                    long j9 = j7;
                                    long j10 = j8;
                                    float f6 = f5;
                                    ...
                                    ComposableLambda composableLambda4 = ComposableLambdaKt.composableLambda(composer3, -819896533, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt.BottomSheetScaffold.1.child.1.2.2
                                        ...
                                        public final void invoke(Composer composer4, int i14) {
                                            ...
                                            composer4.startReplaceableGroup(276693241);
                                            ComposerKt.sourceInformation(composer4, "C73@3564L9:Column.kt#2w3rfo");
                                            function37.invoke(ColumnScopeInstance.INSTANCE, composer4, Integer.valueOf(((i15 >> 6) & b.p) | 6));
                                            composer4.endReplaceableGroup();
                                            composer4.endReplaceableGroup();
                                            composer4.endNode();
                                            composer4.endReplaceableGroup();
                                    ...
                                    int i14 = i10;
                                    int i15 = ((i14 >> 21) & b.p) | 1572864;
                                    int i16 = i11;
                                    SurfaceKt.m855SurfaceFjzlyU(onGloballyPositioned, shape3, j9, j10, (BorderStroke) null, f6, composableLambda4, composer3, ((i16 << 6) & 7168) | i15 | ((i16 << 6) & 896) | ((i14 >> 12) & 458752), 16);
                                    return;
                                }
                                composer3.skipToGroupEnd();
                            }
                        ...
                        ComposableLambda composableLambda4 = ComposableLambdaKt.composableLambda(composer2, -819897194, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1.3
                            ...
                            public final void invoke(Composer composer3, int i13) {
                                ...
                                if (((i13 & 11) ^ 2) != 0 || !composer3.getSkipping()) {
                                    ...
                                    Composer m941constructorimpl = Updater.m941constructorimpl(composer3);
                                    Updater.m948setimpl(m941constructorimpl, rememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                                    Updater.m948setimpl(m941constructorimpl, density, ComposeUiNode.INSTANCE.getSetDensity());
                                    Updater.m948setimpl(m941constructorimpl, layoutDirection, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                                    composer3.enableReusing();
                                    materializerOf.invoke(SkippableUpdater.m932boximpl(SkippableUpdater.m933constructorimpl(composer3)), composer3, 0);
                        ...
                        final int i13 = i4;
                        BottomSheetScaffoldKt.m635BottomSheetScaffoldStackSlNgfk0(composableLambda2, composableLambda3, composableLambda4, ComposableLambdaKt.composableLambda(composer2, -819897283, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1.4
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer composer3, int i14) {
                                ...
                                if (((i14 & 11) ^ 2) != 0 || !composer3.getSkipping()) {
                                    ...
                                    function37.invoke(bottomSheetScaffoldState4.getSnackbarHostState(), composer3, Integer.valueOf((i15 >> 9) & b.p));
                                    composer3.endReplaceableGroup();
                                    composer3.endReplaceableGroup();
                                    composer3.endReplaceableGroup();
                                    composer3.endNode();
            ...
            int i7 = this.$$dirty1;
            DrawerKt.m720ModalDrawerGs3lGvM(function34, null, drawerState, z, shape2, f3, j5, j6, j7, composableLambda, composer, ((i7 >> 9) & 14) | 805306368 | ((i7 >> 3) & 7168) | ((i7 >> 3) & 57344) | ((i7 >> 3) & 458752) | ((i7 >> 3) & 3670016) | ((i7 >> 3) & 29360128) | ((i7 >> 3) & 234881024), 2);
            composer.endReplaceableGroup();
            return;
        }
    ...
    public static final float m639invoke$lambda2(MutableState<Float> mutableState) {
        return mutableState.getValue().floatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invoke$lambda-3, reason: not valid java name */
    public static final void m640invoke$lambda3(MutableState<Float> mutableState, float f) {
