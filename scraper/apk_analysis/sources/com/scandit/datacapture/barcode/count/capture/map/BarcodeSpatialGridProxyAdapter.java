...
public final class BarcodeSpatialGridProxyAdapter implements BarcodeSpatialGridProxy {
    private final NativeBarcodeSpatialGrid a;
    ...
    public BarcodeSpatialGridProxyAdapter(NativeBarcodeSpatialGrid _NativeBarcodeSpatialGrid, ProxyCache proxyCache) {
        ...
        this.a = _NativeBarcodeSpatialGrid;
    ...
    public List<Coordinate2d> coordinatesForElement(BarcodeSpatialGridElement element) {
        ...
        NativeBarcodeSpatialGridElement a = element.getA();
        this.proxyCache.put(Reflection.getOrCreateKotlinClass(NativeBarcodeSpatialGridElement.class), null, a, element);
        ArrayList<Coordinate2d> coordinatesForElement = this.a.coordinatesForElement(a);
        Intrinsics.checkNotNull(coordinatesForElement);
        return coordinatesForElement;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    public BarcodeSpatialGridElement elementAt(int row, int column) {
        NativeBarcodeSpatialGridElement elementAt = this.a.elementAt(row, column);
        if (elementAt != null) {
            return (BarcodeSpatialGridElement) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeSpatialGridElement.class), null, elementAt, new e(elementAt));
        }
        return null;
    }
