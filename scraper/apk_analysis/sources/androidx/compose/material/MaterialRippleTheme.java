...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo762defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m924defaultRippleColor5vOe2sY = companion.m924defaultRippleColor5vOe2sY(((Color) consume).getValue(), MaterialTheme.INSTANCE.getColors(composer, 0).isLight());
        composer.endReplaceableGroup();
        return m924defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        Object consume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        RippleAlpha m923defaultRippleAlphaDxMtmZc = companion.m923defaultRippleAlphaDxMtmZc(((Color) consume).getValue(), MaterialTheme.INSTANCE.getColors(composer, 0).isLight());
        composer.endReplaceableGroup();
        return m923defaultRippleAlphaDxMtmZc;
    }
}
