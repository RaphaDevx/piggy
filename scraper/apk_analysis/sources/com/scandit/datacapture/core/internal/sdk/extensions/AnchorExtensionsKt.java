...
public final class AnchorExtensionsKt {
    private static final FloatWithUnit a;
    private static final FloatWithUnit b;
    ...
    static {
        ...
        a = new FloatWithUnit(16.0f, measureUnit);
        b = new FloatWithUnit(24.0f, measureUnit);
        c = new FloatWithUnit(54.0f, measureUnit);
    }
    ...
    public static final PointWithUnit getDefaultOffset(Anchor anchor) {
        ...
        FloatWithUnit floatWithUnit = (i == 2 || i == 5 || i == 8) ? new FloatWithUnit(0.0f, MeasureUnit.PIXEL) : a;
        int i2 = iArr[anchor.ordinal()];
        return new PointWithUnit(floatWithUnit, (i2 == 1 || i2 == 2 || i2 == 3) ? b : (i2 == 7 || i2 == 8 || i2 == 9) ? c : new FloatWithUnit(0.0f, MeasureUnit.PIXEL));
    }
