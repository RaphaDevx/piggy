...
public final class BarcodeArDeserializer implements BarcodeArDeserializerProxy {
    ...
    public BarcodeArDeserializer() {
        ...
        NativeBarcodeArDeserializer create = NativeBarcodeArDeserializer.create(eVar);
        Intrinsics.checkNotNullExpressionValue(create, "create(...)");
        this.a = aVar;
        this.b = new BarcodeArDeserializerProxyAdapter(create, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(BarcodeArDeserializerHelper.class), null, aVar, new a(eVar));
        getA().setListener(new BarcodeArDeserializerListenerReversedAdapter(new b(this), this, null, 4, null));
    }
    ...
    public BarcodeAr _modeFromJson(DataCaptureContext context, String json) {
        ...
        return this.b._modeFromJson(context, json);
    }
    ...
    public final BarcodeAr modeFromJson(DataCaptureContext dataCaptureContext, String json) {
        ...
        Intrinsics.checkNotNullParameter(json, "json");
        BarcodeAr _modeFromJson = _modeFromJson(dataCaptureContext, json);
        this.a.clear();
    ...
    public final BarcodeArSettings settingsFromJson(String json) {
        Intrinsics.checkNotNullParameter(json, "json");
        BarcodeArSettings _settingsFromJson = _settingsFromJson(json);
        this.a.clear();
