...
public final class BarcodeArSession implements BarcodeArSessionProxy {
    ...
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        return ((BarcodeArSessionProxyAdapter) this.b.getValue()).getAddedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public List<Integer> getRemovedTrackedBarcodes() {
        return ((BarcodeArSessionProxyAdapter) this.b.getValue()).getRemovedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public Map<Integer, TrackedBarcode> getTrackedBarcodes() {
        return ((BarcodeArSessionProxyAdapter) this.b.getValue()).getTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public void reset() {
        ((BarcodeArSessionProxyAdapter) this.b.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public String toJson() {
        return ((BarcodeArSessionProxyAdapter) this.b.getValue()).toJson();
    }
}
