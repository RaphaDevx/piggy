...
public final class HardwareButtonHelperKt {
    ...
    public static final void setupHardwareTrigger(View view, Integer num, Function1<? super HardwareKeyEvent, Unit> onEvent) {
        ...
        if (isHardwareTriggerSupported()) {
            view.addOnUnhandledKeyEventListener(new HardwareButtonKeyListener(num != null ? num.intValue() : DeviceUtils.INSTANCE.isXCoverDevice$scandit_barcode_capture() ? PointerIconCompat.TYPE_VERTICAL_DOUBLE_ARROW : 25, onEvent));
        }
    }
}
