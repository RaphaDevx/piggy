...
public class SupercardPayLinkedSavedPaymentMethodDeleteResponse {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(final Gson gson, TypeToken<T> typeToken) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<SupercardPayLinkedSavedPaymentMethodDeleteResponse>() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.model.SupercardPayLinkedSavedPaymentMethodDeleteResponse.CustomTypeAdapterFactory.1
