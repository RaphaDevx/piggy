...
public final class BarcodeCountDeserializer implements DataCaptureModeDeserializer, BarcodeCountDeserializerProxy {
    ...
    public BarcodeCountDeserializer() {
        ...
        this.a = cVar;
        this.b = new BarcodeCountDeserializerProxyAdapter(create, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(BarcodeCountDeserializerHelper.class), null, cVar, new a(barcodeCountDeserializerHelperReversedAdapter));
        _setDeserializer(this);
        create.setListener(new BarcodeCountDeserializerListenerReversedAdapter(new b(this), this, null, 4, null));
    }
    ...
    public final BarcodeCount modeFromJson(DataCaptureContext dataCaptureContext, String json) {
        Intrinsics.checkNotNullParameter(dataCaptureContext, "dataCaptureContext");
        Intrinsics.checkNotNullParameter(json, "json");
        BarcodeCount _modeFromJson = _modeFromJson(dataCaptureContext, json);
        this.a.clear();
    ...
    public final BarcodeCountBasicOverlay overlayFromJsonInternal$scandit_barcode_capture(BarcodeCount mode, String jsonData) {
        Intrinsics.checkNotNullParameter(mode, "mode");
        Intrinsics.checkNotNullParameter(jsonData, "jsonData");
        BarcodeCountBasicOverlay _overlayFromJson = _overlayFromJson(mode, jsonData);
        this.a.clear();
    ...
    public final BarcodeCountSettings settingsFromJson(String json) {
        Intrinsics.checkNotNullParameter(json, "json");
        BarcodeCountSettings _settingsFromJson = _settingsFromJson(json);
        this.a.clear();
