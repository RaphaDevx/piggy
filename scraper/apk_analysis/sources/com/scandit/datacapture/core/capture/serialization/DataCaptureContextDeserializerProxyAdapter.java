...
public final class DataCaptureContextDeserializerProxyAdapter implements DataCaptureContextDeserializerProxy {
    ...
    public void _setHelper(DataCaptureContextDeserializerHelper helper) {
        this.a.setHelper(helper != null ? (DataCaptureContextDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(DataCaptureContextDeserializerHelper.class), null, helper, new n(helper)) : null);
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    public void _setListener(DataCaptureContextDeserializerListener listener) {
        this.a.setListener(listener != null ? (DataCaptureContextDeserializerListenerReversedAdapter) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(DataCaptureContextDeserializerListener.class), this, listener, new o(listener, this)) : null);
    }
