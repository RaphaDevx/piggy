...
public final class StructuredAppendDataProxyAdapter implements StructuredAppendDataProxy {
    ...
    public String getBarcodeSetId() {
        String barcodeSetId = this.a.getBarcodeSetId();
        Intrinsics.checkNotNull(barcodeSetId);
        return barcodeSetId;
    }
    ...
    public List<EncodingRange> getEncodingRanges() {
        ArrayList<EncodingRange> completeDataEncodings = this.a.getCompleteDataEncodings();
        Intrinsics.checkNotNull(completeDataEncodings);
    ...
    public byte[] getRawCompleteData() {
        byte[] completeDataRaw = this.a.getCompleteDataRaw();
        Intrinsics.checkNotNull(completeDataRaw);
