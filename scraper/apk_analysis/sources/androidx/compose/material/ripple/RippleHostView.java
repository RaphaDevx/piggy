...
public final class RippleHostView extends View {
    ...
    public final void m919addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m920updateRipplePropertiesbiQXAtU(size, radius, color, alpha);
        if (bounded) {
            unprojectedRipple.setHotspot(Offset.m1025getXimpl(interaction.getPressPosition()), Offset.m1026getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m920updateRipplePropertiesbiQXAtU(long size, int radius, long color, float alpha) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(radius);
        unprojectedRipple.m927setColorDxMtmZc(color, alpha);
        Rect androidRect = RectHelper_androidKt.toAndroidRect(SizeKt.m1115toRectuvyYCjk(size));
        ...
        if (!pressed && longValue < MinimumRippleStateChangeTime) {
            Runnable runnable2 = new Runnable() { // from class: androidx.compose.material.ripple.RippleHostView$setRippleState$2
                ...
                public final void run() {
                    ...
                    int[] iArr;
                    unprojectedRipple = RippleHostView.this.ripple;
                    if (unprojectedRipple != null) {
                        iArr = RippleHostView.RestingState;
