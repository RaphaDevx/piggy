...
public final class BarcodeBatchSession implements BarcodeBatchSessionProxy {
    ...
    /* renamed from: _impl */
    public NativeBarcodeTrackingSession getA() {
        return (NativeBarcodeTrackingSession) this.a.invoke();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).getAddedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public long getFrameSequenceId() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<Integer> getRemovedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).getRemovedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public Map<Integer, TrackedBarcode> getTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).getTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<TrackedBarcode> getUnscannedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).getUnscannedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<TrackedBarcode> getUpdatedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).getUpdatedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public void reset() {
        ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public String toJson() {
        return ((BarcodeBatchSessionProxyAdapter) this.b.getValue()).toJson();
    }
}
