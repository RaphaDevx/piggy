...
public class CLContainer extends CLElement {
    ...
    @Override // androidx.constraintlayout.core.parser.CLElement
    /* renamed from: clone */
    public CLContainer mo3312clone() {
        CLContainer cLContainer = (CLContainer) super.mo3312clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo3312clone = it.next().mo3312clone();
            mo3312clone.setContainer(cLContainer);
            arrayList.add(mo3312clone);
        }
