...
public final class SparkScanSessionProxyAdapter implements SparkScanSessionProxy {
    ...
    public Barcode getNewlyRecognizedBarcode() {
        ...
        if (newlyRecognizedBarcode != null) {
            return (Barcode) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcode.class), null, newlyRecognizedBarcode, new b(newlyRecognizedBarcode));
        }
        return null;
    }
