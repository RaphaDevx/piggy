...
public class SystemWebViewClient extends WebViewClient {
    ...
    public SystemWebViewClient(final SystemWebViewEngine parentEngine) {
        ...
        httpAllowed.addPathHandler("/", new WebViewAssetLoader.PathHandler() { // from class: org.apache.cordova.engine.SystemWebViewClient$$ExternalSyntheticLambda0
            ...
            public final WebResourceResponse handle(String str) {
                return SystemWebViewClient.this.m5687lambda$new$0$orgapachecordovaengineSystemWebViewClient(parentEngine, str);
            }
        });
    ...
    /* synthetic */ WebResourceResponse m5687lambda$new$0$orgapachecordovaengineSystemWebViewClient(final SystemWebViewEngine parentEngine, String path) {
        ...
        try {
            ...
            String str = MediaType.TEXT_HTML;
