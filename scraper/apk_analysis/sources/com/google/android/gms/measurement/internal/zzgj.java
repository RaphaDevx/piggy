...
public final class zzgj extends zzdw {
    ...
    public final byte[] zzu(zzaw zzawVar, String str) {
        ...
        long nanoTime = this.zza.zzav().nanoTime() / AnimationKt.MillisToNanos;
        try {
            ...
            this.zza.zzay().zzc().zzd("Log and bundle processed. event, size, time_ms", this.zza.zzj().zzd(zzawVar.zza), Integer.valueOf(bArr.length), Long.valueOf((this.zza.zzav().nanoTime() / AnimationKt.MillisToNanos) - nanoTime));
            return bArr;
        } catch (InterruptedException | ExecutionException e) {
