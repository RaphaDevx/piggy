...
public final class BarcodeCountCaptureListSession implements BarcodeCountCaptureListSessionProxy {
    ...
    public BarcodeCountCaptureListSession(Function0<? extends NativeBarcodeCountCaptureListSession> getImpl) {
        ...
        this.a = getImpl;
        this.b = LazyKt.lazy(new h(this));
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    /* renamed from: _impl */
    public NativeBarcodeCountCaptureListSession getA() {
        return (NativeBarcodeCountCaptureListSession) this.a.invoke();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getAcceptedBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).getAcceptedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<Barcode> getAdditionalBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).getAdditionalBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getCorrectBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).getCorrectBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TargetBarcode> getMissingBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).getMissingBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getRejectedBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).getRejectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getWrongBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).getWrongBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public String toJson() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.b.getValue()).toJson();
    }
}
