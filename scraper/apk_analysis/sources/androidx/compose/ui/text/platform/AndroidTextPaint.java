...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(this.shadow.getBlurRadius(), Offset.m1025getXimpl(this.shadow.getOffset()), Offset.m1026getYimpl(this.shadow.getOffset()), ColorKt.m1309toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m2887setColor8_81llA(long color) {
        int m1309toArgb8_81llA;
        if (color == Color.INSTANCE.m1290getUnspecified0d7_KjU() || getColor() == (m1309toArgb8_81llA = ColorKt.m1309toArgb8_81llA(color))) {
            return;
        }
        setColor(m1309toArgb8_81llA);
    }
}
