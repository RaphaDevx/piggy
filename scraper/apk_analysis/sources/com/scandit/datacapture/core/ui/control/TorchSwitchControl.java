...
public final class TorchSwitchControl implements Control {
    ...
    private final TorchControlIconsHandler a;
    ...
    public TorchSwitchControl(TorchControlIconsHandler iconsHandler, ToggleImageButton view) {
        ...
        this.a = iconsHandler;
        this.b = view;
        String string = view.getContext().getString(R.string.sc_cd_torch_control);
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        this.contentDescriptionWhenOff = string;
        String string2 = view.getContext().getString(R.string.sc_cd_torch_control);
        ...
        iconsHandler.a((AnonymousClass1) new com.scandit.datacapture.core.internal.module.ui.control.torch.c() { // from class: com.scandit.datacapture.core.ui.control.TorchSwitchControl.1
            ...
            public void onIconsChanged(TorchState torchState, Bitmap image, boolean pressed) {
                ...
                if ((camera != null ? camera.getDesiredTorchState() : null) == torchState && TorchSwitchControl.this.b.b() == pressed) {
    ...
    public final void a(TorchState torchState) {
        Bitmap a = this.a.a(torchState, this.b.b());
        if (a != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x0011, code lost:
        ...
        if (r3.isTorchAvailable() == true) goto L11;
     */
    /*
    ...
    */
    ...
    public void _onFrameSourceChanged(FrameSource frameSource) {
        ...
        if (!Intrinsics.areEqual(this.f, camera)) {
            ...
            if (camera != null) {
                ...
                camera.addListener(new com.scandit.datacapture.core.internal.module.ui.control.torch.a(SetsKt.setOf((Object[]) new FrameSourceState[]{FrameSourceState.STANDBY, FrameSourceState.ON}), action));
            }
    ...
    public final void setTorchOffImage(int resId) {
        TorchControlIconsHandler torchControlIconsHandler = this.a;
