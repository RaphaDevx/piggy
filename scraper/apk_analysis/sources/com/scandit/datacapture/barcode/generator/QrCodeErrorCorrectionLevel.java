...
public final class QrCodeErrorCorrectionLevel {
    ...
    private static final /* synthetic */ QrCodeErrorCorrectionLevel[] b;
    ...
    static {
        ...
        b = qrCodeErrorCorrectionLevelArr;
        c = EnumEntriesKt.enumEntries(qrCodeErrorCorrectionLevelArr);
    }

    private QrCodeErrorCorrectionLevel(String str, int i, String str2) {
    ...
    public static QrCodeErrorCorrectionLevel[] values() {
        return (QrCodeErrorCorrectionLevel[]) b.clone();
    }
