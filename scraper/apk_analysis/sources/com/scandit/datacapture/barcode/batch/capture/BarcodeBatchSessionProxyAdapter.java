...
public final class BarcodeBatchSessionProxyAdapter implements BarcodeBatchSessionProxy {
    ...
    public BarcodeBatchSessionProxyAdapter(NativeBarcodeTrackingSession _NativeBarcodeTrackingSession, ProxyCache proxyCache) {
        ...
        this.a = _NativeBarcodeTrackingSession;
    ...
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        ...
        Intrinsics.checkNotNull(addedTrackedBarcodes);
    ...
    public List<Integer> getRemovedTrackedBarcodes() {
        ...
        Intrinsics.checkNotNull(removedTrackedBarcodes);
    ...
    public List<TrackedBarcode> getUnscannedTrackedBarcodes() {
        ArrayList<NativeTrackedBarcode> unscannedTrackedBarcodes = this.a.getUnscannedTrackedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(unscannedTrackedBarcodes);
    ...
    public List<TrackedBarcode> getUpdatedTrackedBarcodes() {
        ...
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(updatedTrackedBarcodes);
    ...
    public /* synthetic */ BarcodeBatchSessionProxyAdapter(NativeBarcodeTrackingSession nativeBarcodeTrackingSession, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
