...
public final class KeyInputModifier implements Modifier.Element {
    ...
    public final boolean m2377processKeyInputZmokQxo(android.view.KeyEvent keyEvent) {
        ...
        if (modifiedKeyInputNode.m2623propagatePreviewKeyEventZmokQxo(keyEvent)) {
            return true;
        }
        return modifiedKeyInputNode.m2622propagateKeyEventZmokQxo(keyEvent);
    }
}
