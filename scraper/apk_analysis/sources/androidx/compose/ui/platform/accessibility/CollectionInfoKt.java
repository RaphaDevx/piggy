    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            if (lastIndex > 0) {
                ...
                while (true) {
                    ...
                    emptyList.add(Offset.m1014boximpl(OffsetKt.Offset(Math.abs(Offset.m1025getXimpl(semanticsNode4.getBoundsInRoot().m1055getCenterF1C5BW0()) - Offset.m1025getXimpl(semanticsNode3.getBoundsInRoot().m1055getCenterF1C5BW0())), Math.abs(Offset.m1026getYimpl(semanticsNode4.getBoundsInRoot().m1055getCenterF1C5BW0()) - Offset.m1026getYimpl(semanticsNode3.getBoundsInRoot().m1055getCenterF1C5BW0())))));
                    if (i >= lastIndex) {
                        break;
                    }
        ...
        if (emptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                ...
                while (true) {
                    int i3 = i2 + 1;
                    first = Offset.m1014boximpl(Offset.m1030plusMKHz9U(((Offset) first).getPackedValue(), ((Offset) emptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2 = i3;
        ...
        return Offset.m1016component2impl(packedValue) < Offset.m1015component1impl(packedValue);
    }
