...
public final class SemanticsPropertiesKt {
    ...
    public static final void m2685setLiveRegionhR3wRGc(SemanticsPropertyReceiver semanticsPropertyReceiver, int i) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "$this$<set-liveRegion>");
        liveRegion$delegate.setValue(semanticsPropertyReceiver, $$delegatedProperties[3], LiveRegionMode.m2657boximpl(i));
    }
    ...
    public static final void m2686setRolekuIjeqM(SemanticsPropertyReceiver semanticsPropertyReceiver, int i) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "$this$<set-role>");
        role$delegate.setValue(semanticsPropertyReceiver, $$delegatedProperties[7], Role.m2666boximpl(i));
    }
    ...
    public static final void m2687setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver semanticsPropertyReceiver, long j) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "$this$<set-textSelectionRange>");
        textSelectionRange$delegate.setValue(semanticsPropertyReceiver, $$delegatedProperties[10], TextRange.m2754boximpl(j));
    }
    ...
    public static final void m2684setImeAction4L7nppU(SemanticsPropertyReceiver semanticsPropertyReceiver, int i) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "$this$<set-imeAction>");
        imeAction$delegate.setValue(semanticsPropertyReceiver, $$delegatedProperties[11], ImeAction.m2824boximpl(i));
    }
