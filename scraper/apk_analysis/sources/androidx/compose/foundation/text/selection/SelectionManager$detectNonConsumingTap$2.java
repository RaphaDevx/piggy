...
final class SelectionManager$detectNonConsumingTap$2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00171 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00171(Function1<? super Offset, Unit> function1, Continuation<? super C00171> continuation) {
                super(2, continuation);
                this.$onTap = function1;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00171 c00171 = new C00171(this.$onTap, continuation);
                c00171.L$0 = obj;
                return c00171;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (pointerInputChange != null) {
                    this.$onTap.invoke(Offset.m1014boximpl(pointerInputChange.getPosition()));
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (this.$$this$forEachGesture.awaitPointerEventScope(new C00171(this.$onTap, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
