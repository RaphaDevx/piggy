...
@Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u0007\n\u0002\b\u0006*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J)\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0003H\u0096@ø\u0001\u0000ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0006\u0010\u0007J-\u0010\b\u001a\u00020\t2\u0006\u0010\u0004\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\f\u0010\rJ!\u0010\u000e\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0003H\u0096@ø\u0001\u0000ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u000f\u0010\u0010J%\u0010\u0011\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0012\u0010\u0013J\u0019\u0010\u0014\u001a\u00020\u0015*\u00020\tH\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0016\u0010\u0017J\u001c\u0010\u0018\u001a\u00020\t*\u00020\u0015H\u0002ø\u0001\u0000ø\u0001\u0002ø\u0001\u0001¢\u0006\u0004\b\u0019\u0010\u001a\u0082\u0002\u000f\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u001b"}, d2 = {"androidx/compose/material/SwipeableKt$PreUpPostDownNestedScrollConnection$1", "Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;", "onPostFling", "Landroidx/compose/ui/unit/Velocity;", "consumed", "available", "onPostFling-RZ2iAVY", "(JJLkotlin/coroutines/Continuation;)Ljava/lang/Object;", "onPostScroll", "Landroidx/compose/ui/geometry/Offset;", "source", "Landroidx/compose/ui/input/nestedscroll/NestedScrollSource;", "onPostScroll-DzOQY0M", "(JJI)J", "onPreFling", "onPreFling-QWom1Mo", "(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;", "onPreScroll", "onPreScroll-OzD1aCk", "(JI)J", "toFloat", "", "toFloat-k-4lQ0M", "(J)F", "toOffset", "toOffset-tuRUvjQ", "(F)J", "material_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo234onPreScrollOzD1aCk(long available, int source) {
        float m861toFloatk4lQ0M = m861toFloatk4lQ0M(available);
        if (m861toFloatk4lQ0M < 0.0f && NestedScrollSource.m2390equalsimpl0(source, NestedScrollSource.INSTANCE.m2395getDragWNlRxjI())) {
            return m862toOffsettuRUvjQ(this.$this_PreUpPostDownNestedScrollConnection.performDrag(m861toFloatk4lQ0M));
        }
    ...
    public long mo232onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (NestedScrollSource.m2390equalsimpl0(source, NestedScrollSource.INSTANCE.m2395getDragWNlRxjI())) {
            return m862toOffsettuRUvjQ(this.$this_PreUpPostDownNestedScrollConnection.performDrag(m861toFloatk4lQ0M(available)));
        }
        return Offset.INSTANCE.m1041getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo233onPreFlingQWom1Mo(long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L34:
            kotlin.ResultKt.throwOnFailure(r9)
            float r9 = androidx.compose.ui.unit.Velocity.m3192getXimpl(r7)
            float r2 = androidx.compose.ui.unit.Velocity.m3193getYimpl(r7)
            long r4 = androidx.compose.ui.geometry.OffsetKt.Offset(r9, r2)
            float r9 = r6.m861toFloatk4lQ0M(r4)
            r2 = 0
        ...
        L73:
            ...
            long r7 = r6.m3203getZero9UxMQ8M()
        L79:
            androidx.compose.ui.unit.Velocity r6 = androidx.compose.ui.unit.Velocity.m3183boximpl(r7)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo233onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object mo231onPostFlingRZ2iAVY(long r5, long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        /*
            r4 = this;
        ...
        L34:
            ...
            float r0 = androidx.compose.ui.unit.Velocity.m3192getXimpl(r7)
            float r2 = androidx.compose.ui.unit.Velocity.m3193getYimpl(r7)
            long r2 = androidx.compose.ui.geometry.OffsetKt.Offset(r0, r2)
            float r4 = r4.m861toFloatk4lQ0M(r2)
            r5.J$0 = r7
            r5.label = r1
            ...
            return r9
        L54:
            androidx.compose.ui.unit.Velocity r4 = androidx.compose.ui.unit.Velocity.m3183boximpl(r7)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo231onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: toOffset-tuRUvjQ, reason: not valid java name */
    private final long m862toOffsettuRUvjQ(float f) {
        return OffsetKt.Offset(0.0f, f);
    }

    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    private final float m861toFloatk4lQ0M(long j) {
        return Offset.m1026getYimpl(j);
    }
}
