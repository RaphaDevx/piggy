...
public final class BarcodeCountStatusResultSuccess {
    ...
    public static final class Companion {
        ...
        public final BarcodeCountStatusResult create(List<BarcodeCountStatusItem> statusList, String statusModeEnabledMessage, String statusModeDisabledMessage) {
            ...
            while (it.hasNext()) {
                arrayList.add(((BarcodeCountStatusItem) it.next()).getA());
            }
            NativeBarcodeCountStatusResult create = NativeBarcodeCountStatusResultSuccess.create(CollectionsExtensionsKt.toArrayList(arrayList), statusModeEnabledMessage, statusModeDisabledMessage);
