...
public class f {
    private static final String a = com.salesforce.marketingcloud.g.a("Version3ToVersion4");
        ...
        try {
            try {
                ...
                try {
                    ...
                    sQLiteDatabase.setTransactionSuccessful();
                    com.salesforce.marketingcloud.g.b(a, e, "Unable to update regions table", new Object[0]);
                } catch (SQLException e2) {
                    com.salesforce.marketingcloud.g.b(a, e2, "Unable to create regions table", new Object[0]);
                    sQLiteDatabase.endTransaction();
                }
                sQLiteDatabase.endTransaction();
            }
        ...
        try {
            try {
                ...
                try {
                    ...
                    sQLiteDatabase.setTransactionSuccessful();
                    com.salesforce.marketingcloud.g.b(a, e, "Unable to update messages table", new Object[0]);
                } catch (SQLException e2) {
                    com.salesforce.marketingcloud.g.b(a, e2, "Unable to create messages table", new Object[0]);
                }
                sQLiteDatabase.endTransaction();
            }
        } catch (Throwable th) {
