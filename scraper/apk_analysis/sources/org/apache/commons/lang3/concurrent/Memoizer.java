...
public class Memoizer<I, O> implements Computable<I, O> {
        ...
        while (true) {
            ...
            if (future == null && (future = this.cache.putIfAbsent(i, (futureTask = new FutureTask(new Callable() { // from class: org.apache.commons.lang3.concurrent.Memoizer$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return Memoizer.this.m5685lambda$compute$0$orgapachecommonslang3concurrentMemoizer(i);
                }
            })))) == null) {
                futureTask.run();
                future = futureTask;
    ...
    /* synthetic */ Object m5685lambda$compute$0$orgapachecommonslang3concurrentMemoizer(Object obj) throws Exception {
