...
public final class MotionLayoutKt {
    ...
    public static final void MotionLayout(ConstraintSet start, ConstraintSet end, Transition transition, float f, EnumSet<MotionLayoutDebugFlags> enumSet, Modifier modifier, int i, Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        int i5 = i2 << 3;
        int i6 = (i5 & 234881024) | (i2 & 14) | 229376 | (i2 & b.p) | (i2 & 896) | (i2 & 7168) | (i5 & 3670016) | (i5 & 29360128);
        composer.startReplaceableGroup(-1330870962);
        ComposerKt.sourceInformation(composer, "C(MotionLayout)P(7,2,8,6,1,3,4,5)");
        int i7 = (i6 & 14) | 32768 | (i6 & b.p) | (i6 & 896) | (i6 & 7168) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (3670016 & i6) | (i6 & 29360128) | (i6 & 234881024);
    ...
    public static final void MotionLayout(MotionScene motionScene, float f, EnumSet<MotionLayoutDebugFlags> enumSet, Modifier modifier, int i, Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        int i5 = (i2 & 458752) | (i2 & 14) | 512 | (i2 & b.p) | (i2 & 7168) | (57344 & i2);
        ...
        composer.endReplaceableGroup();
        String str2 = (String) constraintSet;
        ...
        if (str2 == null || str3 == null) {
            ...
            if (rememberedValue5 == Composer.INSTANCE.getEmpty()) {
                rememberedValue5 = SnapshotStateKt.mutableStateOf$default(Float.valueOf(0.0f), null, 2, null);
                composer.updateRememberedValue(rememberedValue5);
            }
            composer.endReplaceableGroup();
            MutableState mutableState2 = (MutableState) rememberedValue5;
            float forcedProgress = motionScene.getForcedProgress();
            if (Float.isNaN(forcedProgress) || m3280MotionLayoutCore$lambda26(mutableState2) != f) {
                motionScene.resetForcedProgress();
                forcedProgress = f;
            }
            m3281MotionLayoutCore$lambda27(mutableState2, f);
            ...
            MeasurePolicy rememberMotionLayoutMeasurePolicy = rememberMotionLayoutMeasurePolicy(i4, enumSet3, 0L, ConstraintSet, ConstraintSet2, Transition, mutableState3, motionMeasurer, composer, ((i7 >> 21) & 14) | 18350528);
    ...
    public static final void MotionLayout(MotionScene motionScene, String str, AnimationSpec<Float> animationSpec, EnumSet<MotionLayoutDebugFlags> enumSet, Modifier modifier, int i, Function0<Unit> function0, Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        int i7 = (i2 & 14) | 4608 | (i2 & b.p) | (i2 & 57344) | (i2 & 458752) | (i2 & 3670016) | (i2 & 29360128);
        ...
        if (str5 == null || str6 == null) {
            ...
            if (changed5 || rememberedValue6 == Composer.INSTANCE.getEmpty()) {
                MutableState mutableStateOf$default = SnapshotStateKt.mutableStateOf$default(ConstraintLayoutKt.ConstraintSet(str5), null, 2, null);
            ...
            if (changed6 || rememberedValue7 == Composer.INSTANCE.getEmpty()) {
                MutableState mutableStateOf$default2 = SnapshotStateKt.mutableStateOf$default(ConstraintLayoutKt.ConstraintSet(str6), null, 2, null);
            ...
            if (changed7 || rememberedValue9 == Composer.INSTANCE.getEmpty()) {
                rememberedValue9 = SnapshotStateKt.mutableStateOf$default(true, null, 2, null);
            ...
            if (rememberedValue11 == Composer.INSTANCE.getEmpty()) {
                i5 = 2;
                rememberedValue11 = SnapshotStateKt.mutableStateOf$default(Float.valueOf(f), null, 2, null);
            ...
            ConstraintSet m3282MotionLayoutCore$lambda8 = m3282MotionLayoutCore$lambda8(mutableState2);
            ConstraintSet m3276MotionLayoutCore$lambda11 = m3276MotionLayoutCore$lambda11(mutableState3);
            ...
            composer.startReplaceableGroup(-1330870962);
            ComposerKt.sourceInformation(composer, "C(MotionLayout)P(7,2,8,6,1,3,4,5)");
            int i11 = (i10 & 3670016) | 32768 | (i10 & 29360128) | (i10 & 234881024);
            composer.startReplaceableGroup(-1401224268);
            composer.startReplaceableGroup(i4);
            ComposerKt.sourceInformation(composer, str2);
            ...
            if (rememberedValue14 == Composer.INSTANCE.getEmpty()) {
                rememberedValue14 = SnapshotStateKt.mutableStateOf$default(Float.valueOf(f), null, i5, null);
            ...
            MeasurePolicy rememberMotionLayoutMeasurePolicy = rememberMotionLayoutMeasurePolicy(i6, enumSet5, 0L, m3282MotionLayoutCore$lambda8, m3276MotionLayoutCore$lambda11, transition, mutableState6, motionMeasurer, composer, ((i11 >> 21) & 14) | 18350528);
    ...
    public static final void MotionLayout(ConstraintSet start, ConstraintSet end, Transition transition, float f, EnumSet<MotionLayoutDebugFlags> enumSet, LayoutInformationReceiver layoutInformationReceiver, Modifier modifier, int i, Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        int i5 = (i2 & 14) | 32768 | (i2 & b.p) | (i2 & 896) | (i2 & 7168) | (i2 & 458752) | (3670016 & i2) | (29360128 & i2) | (i2 & 234881024);
        composer.startReplaceableGroup(-1401224268);
        composer.startReplaceableGroup(-3687241);
        ComposerKt.sourceInformation(composer, "C(remember):Composables.kt#9igjgp");
        Object rememberedValue = composer.rememberedValue();
    ...
    public static final void MotionLayoutCore(MotionScene motionScene, String str, AnimationSpec<Float> animationSpec, EnumSet<MotionLayoutDebugFlags> enumSet, Modifier modifier, int i, Function0<Unit> function0, Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        composer.startReplaceableGroup(-1330870962);
        ComposerKt.sourceInformation(composer, "C(MotionLayout)P(7,2,8,6,1,3,4,5)");
        int i10 = (3670016 & i9) | 32768 | (i9 & 29360128) | (i9 & 234881024);
        composer.startReplaceableGroup(-1401224268);
        composer.startReplaceableGroup(i4);
        ComposerKt.sourceInformation(composer, str2);
        Object rememberedValue12 = composer.rememberedValue();
        ...
        mutableState6.setValue(Float.valueOf(forcedProgress));
        EnumSet<MotionLayoutDebugFlags> enumSet5 = enumSet3;
        MeasurePolicy rememberMotionLayoutMeasurePolicy = rememberMotionLayoutMeasurePolicy(i6, enumSet5, 0L, m3282MotionLayoutCore$lambda8, m3276MotionLayoutCore$lambda11, transition, mutableState6, motionMeasurer, composer, ((i10 >> 21) & 14) | 18350528);
        motionMeasurer.addLayoutInformationReceiver(jSONMotionScene);
        float forcedScaleFactor = motionMeasurer.getForcedScaleFactor();
        if (!enumSet5.contains(MotionLayoutDebugFlags.NONE) || !Float.isNaN(forcedScaleFactor)) {
            Modifier modifier4 = modifier2;
    ...
    public static final ConstraintSet m3282MotionLayoutCore$lambda8(MutableState<ConstraintSet> mutableState) {
        return mutableState.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-11, reason: not valid java name */
    public static final ConstraintSet m3276MotionLayoutCore$lambda11(MutableState<ConstraintSet> mutableState) {
        return mutableState.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-16, reason: not valid java name */
    public static final boolean m3278MotionLayoutCore$lambda16(MutableState<Boolean> mutableState) {
        return mutableState.getValue().booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-17, reason: not valid java name */
    public static final void m3279MotionLayoutCore$lambda17(MutableState<Boolean> mutableState, boolean z) {
    ...
    public static final void MotionLayoutCore(MotionScene motionScene, float f, EnumSet<MotionLayoutDebugFlags> enumSet, Modifier modifier, int i, Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        mutableState3.setValue(Float.valueOf(forcedProgress));
        Object obj2 = obj;
        MeasurePolicy rememberMotionLayoutMeasurePolicy = rememberMotionLayoutMeasurePolicy(i4, enumSet3, 0L, ConstraintSet, ConstraintSet2, Transition, mutableState3, motionMeasurer, composer, ((i6 >> 21) & 14) | 18350528);
        motionMeasurer.addLayoutInformationReceiver(layoutInformationReceiver);
        float forcedScaleFactor = motionMeasurer.getForcedScaleFactor();
        if (!enumSet3.contains(MotionLayoutDebugFlags.NONE) || !Float.isNaN(forcedScaleFactor)) {
            composer.startReplaceableGroup(-1401223142);
            ...
            ComposerKt.sourceInformation(composer, "C72@3384L9:Box.kt#2w3rfo");
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            LayoutKt.MultiMeasureLayout(SemanticsModifierKt.semantics$default(modifier2, false, new MotionLayoutKt$MotionLayoutCore$3$1(motionMeasurer), 1, obj2), ComposableLambdaKt.composableLambda(composer, -819900388, true, new MotionLayoutKt$MotionLayoutCore$3$2(content, motionLayoutScope, i6)), rememberMotionLayoutMeasurePolicy, composer, 48, 0);
            if (!Float.isNaN(forcedScaleFactor)) {
                composer.startReplaceableGroup(-922833881);
                motionMeasurer.drawDebugBounds(boxScopeInstance, forcedScaleFactor, composer, 518);
                composer.endReplaceableGroup();
    ...
    public static final float m3280MotionLayoutCore$lambda26(MutableState<Float> mutableState) {
        return mutableState.getValue().floatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-27, reason: not valid java name */
    public static final void m3281MotionLayoutCore$lambda27(MutableState<Float> mutableState, float f) {
        mutableState.setValue(Float.valueOf(f));
    }
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            if (cLObject != null) {
                transition = new Transition() { // from class: androidx.constraintlayout.compose.MotionLayoutKt$Transition$transition$1$1
                    ...
                    public void applyTo(androidx.constraintlayout.core.state.Transition transition2, int i2) {
            ...
            rememberedValue = SnapshotStateKt.mutableStateOf$default(transition, null, 2, null);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
    ...
    public static final MeasurePolicy rememberMotionLayoutMeasurePolicy(final int i, EnumSet<MotionLayoutDebugFlags> debug, long j, final ConstraintSet constraintSetStart, final ConstraintSet constraintSetEnd, final Transition transition, final MutableState<Float> progress, final MotionMeasurer measurer, Composer composer, int i2) {
        ...
        if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            rememberedValue = new MeasurePolicy() { // from class: androidx.constraintlayout.compose.MotionLayoutKt$rememberMotionLayoutMeasurePolicy$1$1
                ...
                public final MeasureResult mo40measure3p2s80s(MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j2) {
                    Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
                    Intrinsics.checkNotNullParameter(measurables, "measurables");
                    long m3307performInterpolationMeasureOQbXsTc = MotionMeasurer.this.m3307performInterpolationMeasureOQbXsTc(j2, MeasurePolicy.getLayoutDirection(), constraintSetStart, constraintSetEnd, transition, measurables, i, progress.getValue().floatValue(), MeasurePolicy);
                    int m3127getWidthimpl = IntSize.m3127getWidthimpl(m3307performInterpolationMeasureOQbXsTc);
                    int m3126getHeightimpl = IntSize.m3126getHeightimpl(m3307performInterpolationMeasureOQbXsTc);
                    final MotionMeasurer motionMeasurer = MotionMeasurer.this;
                    return MeasureScope.DefaultImpls.layout$default(MeasurePolicy, m3127getWidthimpl, m3126getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.constraintlayout.compose.MotionLayoutKt$rememberMotionLayoutMeasurePolicy$1$1$measure$1
