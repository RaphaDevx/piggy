...
public final class BarcodeSpatialGridEditorViewSettings implements BarcodeSpatialGridEditorViewSettingsProxy {
    private final /* synthetic */ BarcodeSpatialGridEditorViewSettingsProxyAdapter a;

    public BarcodeSpatialGridEditorViewSettings() {
        NativeBarcodeSpatialGridEditorViewSettings create = NativeBarcodeSpatialGridEditorViewSettings.create();
        Intrinsics.checkNotNullExpressionValue(create, "create(...)");
        this.a = new BarcodeSpatialGridEditorViewSettingsProxyAdapter(create, null, 2, null);
    }
    ...
    public String getCancelMappingButtonText() {
        return this.a.getCancelMappingButtonText();
    }
    ...
    public String getToteTextFormat() {
        return this.a.getToteTextFormat();
    }
    ...
    public void setCancelMappingButtonText(String str) {
        ...
        this.a.setCancelMappingButtonText(str);
    }
    ...
    public void setFinishMappingButtonText(String str) {
        Intrinsics.checkNotNullParameter(str, "<set-?>");
        this.a.setFinishMappingButtonText(str);
    }
