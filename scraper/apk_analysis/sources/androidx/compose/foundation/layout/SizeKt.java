...
public final class SizeKt {
    ...
    public static final Modifier m360width3ABfNKs(Modifier width, final float f) {
        ...
        return width.then(new SizeModifier(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Dp.m3005boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs, reason: not valid java name */
    public static final Modifier m343height3ABfNKs(Modifier height, final float f) {
    ...
    public static /* synthetic */ Modifier m362widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
            f2 = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        return m361widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m361widthInVpY3zN4(Modifier widthIn, final float f, final float f2) {
        ...
        return widthIn.then(new SizeModifier(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m3005boximpl(f));
                inspectorInfo.getProperties().set(CardsAccountDigitalPaymentCardLoadWithSuperpointsStatusBlocksPeriod.SERIALIZED_NAME_MAX, Dp.m3005boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m345heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m344heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m344heightInVpY3zN4(Modifier heightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m359sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        return m358sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m358sizeInqDBjuR0(Modifier sizeIn, final float f, final float f2, final float f3, final float f4) {
        ...
        return sizeIn.then(new SizeModifier(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m3005boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m3005boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m3005boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m3005boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m353requiredWidth3ABfNKs(Modifier requiredWidth, final float f) {
    ...
    public static final Modifier m346requiredHeight3ABfNKs(Modifier requiredHeight, final float f) {
    ...
    public static /* synthetic */ Modifier m355requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m354requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m354requiredWidthInVpY3zN4(Modifier requiredWidthIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m348requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m347requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m347requiredHeightInVpY3zN4(Modifier requiredHeightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m352requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m351requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m351requiredSizeInqDBjuR0(Modifier requiredSizeIn, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m342defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m341defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m341defaultMinSizeVpY3zN4(Modifier defaultMinSize, final float f, final float f2) {
    ...
    private static final WrapContentModifier createWrapContentWidthModifier(final Alignment.Horizontal horizontal, final boolean z) {
        return new WrapContentModifier(Direction.Horizontal, z, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.SizeKt$createWrapContentWidthModifier$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                return IntOffset.m3076boximpl(m365invoke5SAbXVA5SAbXVA(intSize.getPackedValue(), layoutDirection));
            }

            /* renamed from: invoke-5SAbXVA-5SAbXVA, reason: not valid java name */
            public final long m365invoke5SAbXVA5SAbXVA(long j, LayoutDirection layoutDirection) {
                Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                return IntOffsetKt.IntOffset(Alignment.Horizontal.this.align(0, IntSize.m3127getWidthimpl(j), layoutDirection), 0);
            }
    ...
    private static final WrapContentModifier createWrapContentHeightModifier(final Alignment.Vertical vertical, final boolean z) {
        return new WrapContentModifier(Direction.Vertical, z, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.SizeKt$createWrapContentHeightModifier$1
            ...
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                return IntOffset.m3076boximpl(m363invoke5SAbXVA5SAbXVA(intSize.getPackedValue(), layoutDirection));
            }

            /* renamed from: invoke-5SAbXVA-5SAbXVA, reason: not valid java name */
            public final long m363invoke5SAbXVA5SAbXVA(long j, LayoutDirection noName_1) {
                Intrinsics.checkNotNullParameter(noName_1, "$noName_1");
                return IntOffsetKt.IntOffset(0, Alignment.Vertical.this.align(0, IntSize.m3126getHeightimpl(j)));
            }
    ...
    private static final WrapContentModifier createWrapContentSizeModifier(final Alignment alignment, final boolean z) {
        return new WrapContentModifier(Direction.Both, z, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.SizeKt$createWrapContentSizeModifier$1
            ...
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                return IntOffset.m3076boximpl(m364invoke5SAbXVA5SAbXVA(intSize.getPackedValue(), layoutDirection));
            }

            /* renamed from: invoke-5SAbXVA-5SAbXVA, reason: not valid java name */
            public final long m364invoke5SAbXVA5SAbXVA(long j, LayoutDirection layoutDirection) {
                Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                return Alignment.this.mo957alignKFBX0sM(IntSize.INSTANCE.m3132getZeroYbymL2g(), j, layoutDirection);
            }
    ...
    public static final Modifier m356size3ABfNKs(Modifier size, final float f) {
    ...
    public static final Modifier m357sizeVpY3zN4(Modifier size, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return size.then(new SizeModifier(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("height", Dp.m3005boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m349requiredSize3ABfNKs(Modifier requiredSize, final float f) {
    ...
    public static final Modifier m350requiredSizeVpY3zN4(Modifier requiredSize, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
