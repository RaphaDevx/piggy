...
public final class BarcodeCountScreenRatioForUi {
    ...
    private static final /* synthetic */ BarcodeCountScreenRatioForUi[] a;
    ...
    static {
        ...
        a = barcodeCountScreenRatioForUiArr;
        b = EnumEntriesKt.enumEntries(barcodeCountScreenRatioForUiArr);
    }

    private BarcodeCountScreenRatioForUi(String str, int i) {
    }
    ...
    public static BarcodeCountScreenRatioForUi[] values() {
        return (BarcodeCountScreenRatioForUi[]) a.clone();
    }
}
