...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context) {
        ...
        KeyInputModifier keyInputModifier = new KeyInputModifier(new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m2639invokeZmokQxo(keyEvent.getNativeKeyEvent());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m2639invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection mo2633getFocusDirectionP8AzH3I = AndroidComposeView.this.mo2633getFocusDirectionP8AzH3I(it);
                if (mo2633getFocusDirectionP8AzH3I == null || !KeyEventType.m2363equalsimpl0(KeyEvent_androidKt.m2371getTypeZmokQxo(it), KeyEventType.INSTANCE.m2367getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(AndroidComposeView.this.getFocusManager().mo983moveFocus3ESFkO8(mo2633getFocusDirectionP8AzH3I.getValue()));
            }
        }, null);
        ...
        this.globalPosition = IntOffset.INSTANCE.m3095getZeronOccac();
        this.tmpPositionArray = new int[]{0, 0};
        this.viewToWindowMatrix = Matrix.m1418constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m1418constructorimpl$default(null, 1, null);
        this.tmpCalculationMatrix = Matrix.m1418constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m1039getInfiniteF1C5BW0();
    ...
    public boolean mo2635sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return this.keyInputModifier.m2377processKeyInputZmokQxo(keyEvent);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (isFocused()) {
            return mo2635sendKeyEventZmokQxo(KeyEvent.m2354constructorimpl(event));
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            boolean z = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m2965boximpl(Constraints);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    z = Constraints.m2970equalsimpl0(constraints.getValue(), Constraints);
                }
                if (!z) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m2620updateRootConstraintsBRTryo0(Constraints);
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        boolean z = false;
        if (IntOffset.m3085getXimpl(this.globalPosition) != this.tmpPositionArray[0] || IntOffset.m3086getYimpl(this.globalPosition) != this.tmpPositionArray[1]) {
    ...
    public FocusDirection mo2633getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long m2370getKeyZmokQxo = KeyEvent_androidKt.m2370getKeyZmokQxo(keyEvent);
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2298getTabEK5gGoQ())) {
            return FocusDirection.m966boximpl(KeyEvent_androidKt.m2376isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m980getPreviousdhqQ8s() : FocusDirection.INSTANCE.m978getNextdhqQ8s());
        }
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2139getDirectionRightEK5gGoQ())) {
            return FocusDirection.m966boximpl(FocusDirection.INSTANCE.m981getRightdhqQ8s());
        }
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2138getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m966boximpl(FocusDirection.INSTANCE.m977getLeftdhqQ8s());
        }
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2140getDirectionUpEK5gGoQ())) {
            return FocusDirection.m966boximpl(FocusDirection.INSTANCE.m982getUpdhqQ8s());
        }
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2135getDirectionDownEK5gGoQ())) {
            return FocusDirection.m966boximpl(FocusDirection.INSTANCE.m975getDowndhqQ8s());
        }
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2134getDirectionCenterEK5gGoQ())) {
            return FocusDirection.m966boximpl(FocusDirection.INSTANCE.m976getIndhqQ8s());
        }
        if (Key.m1775equalsimpl0(m2370getKeyZmokQxo, Key.INSTANCE.m2077getBackEK5gGoQ())) {
            return FocusDirection.m966boximpl(FocusDirection.INSTANCE.m979getOutdhqQ8s());
        }
        return null;
    }
        ...
        try {
            ...
            try {
                ...
                if (convertToPointerInputEvent$ui_release != null) {
                    ProcessResult = this.pointerInputEventProcessor.m2440processgBdvCQM(convertToPointerInputEvent$ui_release, this);
                } else {
                    this.pointerInputEventProcessor.processCancel();
                    ProcessResult = PointerInputEventProcessorKt.ProcessResult(false, false);
                }
                Trace.endSection();
                if (ProcessResult.m2483getAnyMovementConsumedimpl(ProcessResult)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                return ProcessResult.m2484getDispatchedToAPointerInputModifierimpl(ProcessResult);
            } catch (Throwable th) {
                Trace.endSection();
                throw th;
            }
    ...
    public long mo2477localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long m1424mapMKHz9U = Matrix.m1424mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m1025getXimpl(m1424mapMKHz9U) + Offset.m1025getXimpl(this.windowPosition), Offset.m1026getYimpl(m1424mapMKHz9U) + Offset.m1026getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo2478screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m1424mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m1025getXimpl(positionOnScreen) - Offset.m1025getXimpl(this.windowPosition), Offset.m1026getYimpl(positionOnScreen) - Offset.m1026getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long m1424mapMKHz9U = Matrix.m1424mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m1025getXimpl(m1424mapMKHz9U), motionEvent.getRawY() - Offset.m1026getYimpl(m1424mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        Matrix.m1427resetimpl(this.viewToWindowMatrix);
        m2638transformMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m2643invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public long mo2631calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m1424mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo2632calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m1424mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    private final void m2638transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m2638transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m2637preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m2637preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            view.getLocationInWindow(this.tmpPositionArray);
            m2637preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            int[] iArr = this.tmpPositionArray;
            m2637preTranslate3XD1CNM(matrix, iArr[0], iArr[1]);
        }
        ...
        m2636preConcattUYjHk(matrix, viewMatrix);
    }

    /* renamed from: preConcat-tU-YjHk, reason: not valid java name */
    private final void m2636preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m1138setFromtUYjHk(this.tmpCalculationMatrix, matrix);
        AndroidComposeView_androidKt.m2644preTransformJiSxe2E(fArr, this.tmpCalculationMatrix);
    }

    /* renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m2637preTranslate3XD1CNM(float[] fArr, float f, float f2) {
        Matrix.m1427resetimpl(this.tmpCalculationMatrix);
        Matrix.m1438translateimpl$default(this.tmpCalculationMatrix, f, f2, 0.0f, 4, null);
        AndroidComposeView_androidKt.m2644preTransformJiSxe2E(fArr, this.tmpCalculationMatrix);
    }

    /* compiled from: AndroidComposeView.android.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0007\u001a\u00020\bH\u0003R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\b\u0012\u0002\b\u0003\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Landroidx/compose/ui/platform/AndroidComposeView$Companion;", "", "()V", "getBooleanMethod", "Ljava/lang/reflect/Method;", "systemPropertiesClass", "Ljava/lang/Class;", "getIsShowingLayoutBounds", "", "ui_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
