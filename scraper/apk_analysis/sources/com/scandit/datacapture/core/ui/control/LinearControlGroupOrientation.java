...
public final class LinearControlGroupOrientation {
    ...
    private static final /* synthetic */ LinearControlGroupOrientation[] a;
    ...
    static {
        ...
        a = linearControlGroupOrientationArr;
        b = EnumEntriesKt.enumEntries(linearControlGroupOrientationArr);
    }

    private LinearControlGroupOrientation(String str, int i) {
    }
    ...
    public static LinearControlGroupOrientation[] values() {
        return (LinearControlGroupOrientation[]) a.clone();
    }
}
