...
final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float pixels) {
        this.scrollLogic.getValue().m235dispatchScrollTj5QQXo(getLatestScrollScope(), pixels, NestedScrollSource.INSTANCE.m2395getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float delta) {
        ...
        value.m237performRawScrollMKHz9U(value.m241toOffsettuRUvjQ(delta));
    }
}
