...
final class DefaultTextFieldColors implements TextFieldColors {
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(j), composer, 0);
    ...
    public State<Color> indicatorColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = m713indicatorColor$lambda0(collectIsFocusedAsState) ? this.focusedIndicatorColor : this.unfocusedIndicatorColor;
        }
        long j2 = j;
        if (z) {
            composer.startReplaceableGroup(-2054209563);
            ComposerKt.sourceInformation(composer, "336@14195L75");
            rememberUpdatedState = SingleValueAnimationKt.m99animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, composer, 48, 4);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-2054209458);
            ComposerKt.sourceInformation(composer, "338@14300L33");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        }
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    ...
    public State<Color> backgroundColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(this.backgroundColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
    ...
    public State<Color> placeholderColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(z ? this.placeholderColor : this.disabledPlaceholderColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
    ...
    public State<Color> labelColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = m714labelColor$lambda1(collectIsFocusedAsState) ? this.focusedLabelColor : this.unfocusedLabelColor;
        }
        long j2 = j;
        if (z) {
    ...
    public State<Color> textColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(z ? this.textColor : this.disabledTextColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
    ...
    public State<Color> cursorColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1255equalsimpl0(this.textColor, defaultTextFieldColors.textColor) && Color.m1255equalsimpl0(this.disabledTextColor, defaultTextFieldColors.disabledTextColor) && Color.m1255equalsimpl0(this.cursorColor, defaultTextFieldColors.cursorColor) && Color.m1255equalsimpl0(this.errorCursorColor, defaultTextFieldColors.errorCursorColor) && Color.m1255equalsimpl0(this.focusedIndicatorColor, defaultTextFieldColors.focusedIndicatorColor) && Color.m1255equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldColors.unfocusedIndicatorColor) && Color.m1255equalsimpl0(this.errorIndicatorColor, defaultTextFieldColors.errorIndicatorColor) && Color.m1255equalsimpl0(this.disabledIndicatorColor, defaultTextFieldColors.disabledIndicatorColor) && Color.m1255equalsimpl0(this.leadingIconColor, defaultTextFieldColors.leadingIconColor) && Color.m1255equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldColors.disabledLeadingIconColor) && Color.m1255equalsimpl0(this.errorLeadingIconColor, defaultTextFieldColors.errorLeadingIconColor) && Color.m1255equalsimpl0(this.trailingIconColor, defaultTextFieldColors.trailingIconColor) && Color.m1255equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldColors.disabledTrailingIconColor) && Color.m1255equalsimpl0(this.errorTrailingIconColor, defaultTextFieldColors.errorTrailingIconColor) && Color.m1255equalsimpl0(this.backgroundColor, defaultTextFieldColors.backgroundColor) && Color.m1255equalsimpl0(this.focusedLabelColor, defaultTextFieldColors.focusedLabelColor) && Color.m1255equalsimpl0(this.unfocusedLabelColor, defaultTextFieldColors.unfocusedLabelColor) && Color.m1255equalsimpl0(this.disabledLabelColor, defaultTextFieldColors.disabledLabelColor) && Color.m1255equalsimpl0(this.errorLabelColor, defaultTextFieldColors.errorLabelColor) && Color.m1255equalsimpl0(this.placeholderColor, defaultTextFieldColors.placeholderColor) && Color.m1255equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldColors.disabledPlaceholderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((Color.m1261hashCodeimpl(this.textColor) * 31) + Color.m1261hashCodeimpl(this.disabledTextColor)) * 31) + Color.m1261hashCodeimpl(this.cursorColor)) * 31) + Color.m1261hashCodeimpl(this.errorCursorColor)) * 31) + Color.m1261hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m1261hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m1261hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m1261hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m1261hashCodeimpl(this.leadingIconColor)) * 31) + Color.m1261hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m1261hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m1261hashCodeimpl(this.trailingIconColor)) * 31) + Color.m1261hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m1261hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m1261hashCodeimpl(this.backgroundColor)) * 31) + Color.m1261hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m1261hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m1261hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m1261hashCodeimpl(this.errorLabelColor)) * 31) + Color.m1261hashCodeimpl(this.placeholderColor)) * 31) + Color.m1261hashCodeimpl(this.disabledPlaceholderColor);
    }

    /* renamed from: indicatorColor$lambda-0, reason: not valid java name */
    private static final boolean m713indicatorColor$lambda0(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: labelColor$lambda-1, reason: not valid java name */
    private static final boolean m714labelColor$lambda1(State<Boolean> state) {
        return state.getValue().booleanValue();
    }
}
