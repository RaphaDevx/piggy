...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final Function1<Float, Float> function1 = new Function1<Float, Float>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                ...
                public final float invoke(float f) {
                    ...
                    return f - scrollingLogic4.reverseIfNeeded(scrollingLogic4.m235dispatchScrollTj5QQXo(scrollScope, scrollingLogic4.reverseIfNeeded(f), NestedScrollSource.INSTANCE.m2396getFlingWNlRxjI()));
                }
            };
            ScrollScope scrollScope2 = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float pixels) {
                    return function1.invoke(Float.valueOf(pixels)).floatValue();
                }
            };
            scrollingLogic = this.this$0;
            Ref.LongRef longRef2 = this.$result;
            float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m239toFloatTH1AsA0(this.$available));
            this.L$0 = scrollingLogic;
            this.L$1 = scrollingLogic;
            this.L$2 = longRef2;
            this.label = 1;
            obj = scrollingLogic.getFlingBehavior().performFling(scrollScope2, reverseIfNeeded, this);
        ...
        longRef.element = scrollingLogic.m242toVelocityadjELrA(scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
