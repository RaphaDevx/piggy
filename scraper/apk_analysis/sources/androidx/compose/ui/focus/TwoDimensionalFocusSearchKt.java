...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final ModifiedFocusNode m990twoDimensionalFocusSearchMxy_nc0(ModifiedFocusNode twoDimensionalFocusSearch, int i) {
        ModifiedFocusNode m990twoDimensionalFocusSearchMxy_nc0;
        Rect bottomRight;
        ...
        if (i2 == 3) {
            ...
            if (focusedChild.getFocusState() == FocusStateImpl.ActiveParent && (m990twoDimensionalFocusSearchMxy_nc0 = m990twoDimensionalFocusSearchMxy_nc0(focusedChild, i)) != null) {
                return m990twoDimensionalFocusSearchMxy_nc0;
            }
            ...
            return m988findBestCandidate4WY_MpI(twoDimensionalFocusSearch.focusableChildren(), focusRect, i);
        }
        if (i2 == 4 || i2 == 5) {
            ...
            if (FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m981getRightdhqQ8s()) ? true : FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m975getDowndhqQ8s())) {
                bottomRight = topLeft(twoDimensionalFocusSearch.focusRect());
            } else {
                if (!(FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m977getLeftdhqQ8s()) ? true : FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m982getUpdhqQ8s()))) {
                    throw new IllegalStateException(invalidFocusDirection.toString());
                }
                bottomRight = bottomRight(twoDimensionalFocusSearch.focusRect());
            }
            return m988findBestCandidate4WY_MpI(focusableChildren, bottomRight, i);
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: findBestCandidate-4WY_MpI, reason: not valid java name */
    private static final ModifiedFocusNode m988findBestCandidate4WY_MpI(List<ModifiedFocusNode> list, Rect rect, int i) {
        Rect translate;
        if (FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m977getLeftdhqQ8s())) {
            translate = rect.translate(rect.getWidth() + 1, 0.0f);
        } else if (FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m981getRightdhqQ8s())) {
            translate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m982getUpdhqQ8s())) {
            translate = rect.translate(0.0f, rect.getHeight() + 1);
        } else {
            if (!FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m975getDowndhqQ8s())) {
                throw new IllegalStateException(invalidFocusDirection.toString());
            }
            translate = rect.translate(0.0f, -(rect.getHeight() + 1));
        }
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (m989isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m977getLeftdhqQ8s())) {
            if (FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m981getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m977getLeftdhqQ8s()) ? true : FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m981getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m982getUpdhqQ8s()) ? true : FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m975getDowndhqQ8s()))) {
                throw new IllegalStateException(invalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m989isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m986beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m986beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final float m987beamBeats_I7lrPNg$majorAxisDistance2(Rect rect, int i, Rect rect2) {
        float top;
        float bottom;
        float top2;
        float bottom2;
    ...
    private static final boolean m986beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m977getLeftdhqQ8s()) || FocusDirection.m969equalsimpl0(i, FocusDirection.INSTANCE.m981getRightdhqQ8s()) || m987beamBeats_I7lrPNg$majorAxisDistance2(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
