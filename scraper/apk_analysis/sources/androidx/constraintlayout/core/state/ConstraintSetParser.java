...
public class ConstraintSetParser {
    ...
    */
        ...
        while (it.hasNext()) {
            ...
            switch (next) {
                ...
                case "rowWeights":
                    ...
                    if (content3 != null && content3.contains(FirebaseConstants.SEPARATOR)) {
                ...
                case "columnWeights":
                    ...
                    if (content4 != null && content4.contains(FirebaseConstants.SEPARATOR)) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:163:0x03c5 A[Catch: NumberFormatException -> 0x0021, TryCatch #1 {NumberFormatException -> 0x0021, blocks: (B:76:0x023b, B:80:0x024a, B:81:0x0251, B:84:0x0259, B:161:0x03b6, B:163:0x03c5, B:164:0x03cc, B:167:0x03d4), top: B:75:0x023b }] */
    /* JADX WARN: Removed duplicated region for block: B:166:0x03d4 A[SYNTHETIC] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:187:0x042b A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:190:0x0021 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:80:0x024a A[Catch: NumberFormatException -> 0x0021, TryCatch #1 {NumberFormatException -> 0x0021, blocks: (B:76:0x023b, B:80:0x024a, B:81:0x0251, B:84:0x0259, B:161:0x03b6, B:163:0x03c5, B:164:0x03cc, B:167:0x03d4), top: B:75:0x023b }] */
    /* JADX WARN: Removed duplicated region for block: B:83:0x0259 A[SYNTHETIC] */
    ...
    */
        ...
        while (true) {
            ...
            while (it.hasNext()) {
                ...
                switch (next.hashCode()) {
                    case -678927291:
                        if (next.equals(ProfileMeasurement.UNIT_PERCENT)) {
                            c = 0;
                            break;
                        }
                        c = 65535;
                    ...
                    case 100571:
                        ...
                        break;
                    case 3317767:
                        if (next.equals(RRWebVideoEvent.JsonKeys.LEFT)) {
                            c = 2;
                            break;
                        }
                        c = 65535;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:66:0x00b0, code lost:
        ...
        if (r2.equals(io.sentry.rrweb.RRWebVideoEvent.JsonKeys.TOP) == false) goto L32;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
            ...
            if (z3) {
                ...
                switch (stringOrNull.hashCode()) {
                    case 100571:
                        ...
                        break;
                    case 3317767:
                        if (stringOrNull.equals(RRWebVideoEvent.JsonKeys.LEFT)) {
                            r15 = z;
                            break;
                        }
                        r15 = -1;
