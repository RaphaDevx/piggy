...
public final class UndoManager {
    ...
    public final void snapshotIfNeeded(TextFieldValue value, long now) {
        ...
        if (!this.forceNextSnapshot) {
            ...
            if (now <= (l == null ? 0L : l.longValue()) + UndoManagerKt.getSNAPSHOTS_INTERVAL_MILLIS()) {
                return;
            }
        }
    ...
    public final void makeSnapshot(TextFieldValue value) {
        ...
        if (Intrinsics.areEqual(text, entry2 == null ? null : entry2.getValue().getText())) {
