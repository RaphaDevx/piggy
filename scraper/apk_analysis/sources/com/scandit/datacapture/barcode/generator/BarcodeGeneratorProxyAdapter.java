...
public final class BarcodeGeneratorProxyAdapter implements BarcodeGeneratorProxy {
    ...
    public BarcodeGeneratorProxyAdapter(NativeBarcodeGenerator _NativeBarcodeGenerator, ProxyCache proxyCache) {
        ...
        this.a = _NativeBarcodeGenerator;
        this.proxyCache = proxyCache;
        NativeDataCaptureComponent asDataCaptureComponent = _NativeBarcodeGenerator.asDataCaptureComponent();
        Intrinsics.checkNotNullExpressionValue(asDataCaptureComponent, "asDataCaptureComponent(...)");
        this.c = asDataCaptureComponent;
    }
