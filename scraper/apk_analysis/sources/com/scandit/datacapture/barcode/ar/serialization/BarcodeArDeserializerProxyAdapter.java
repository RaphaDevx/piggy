...
public final class BarcodeArDeserializerProxyAdapter implements BarcodeArDeserializerProxy {
    private final NativeBarcodeArDeserializer a;
    ...
    public BarcodeArDeserializerProxyAdapter(NativeBarcodeArDeserializer _NativeBarcodeArDeserializer, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_NativeBarcodeArDeserializer, "_NativeBarcodeArDeserializer");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _NativeBarcodeArDeserializer;
        this.proxyCache = proxyCache;
        NativeDataCaptureModeDeserializer asDataCaptureModeDeserializer = _NativeBarcodeArDeserializer.asDataCaptureModeDeserializer();
    ...
    public NativeBarcodeArDeserializer getA() {
        return this.a;
    }
    ...
    public BarcodeAr _modeFromJson(DataCaptureContext context, String json) {
        ...
        NativeBarcodeAr barcodeArFromJson = this.a.barcodeArFromJson(a, CoreNativeTypeFactory.INSTANCE.convert(json));
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(barcodeArFromJson);
        return barcodeNativeTypeFactory.convert(barcodeArFromJson);
    }

    @Override // com.scandit.datacapture.barcode.ar.serialization.BarcodeArDeserializerProxy
    public BarcodeArSettings _settingsFromJson(String json) {
        Intrinsics.checkNotNullParameter(json, "json");
        NativeBarcodeArSettings nativeBarcodeArSettings = this.a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(NativeBarcodeArSettings.class);
        Intrinsics.checkNotNull(nativeBarcodeArSettings);
        return (BarcodeArSettings) proxyCache.require(orCreateKotlinClass, null, nativeBarcodeArSettings);
    }
    ...
    public BarcodeAr _updateModeFromJson(BarcodeAr mode, String json) {
        ...
        Intrinsics.checkNotNullParameter(json, "json");
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        NativeBarcodeAr updateBarcodeArFromJson = this.a.updateBarcodeArFromJson(barcodeNativeTypeFactory.convert(mode), CoreNativeTypeFactory.INSTANCE.convert(json));
        Intrinsics.checkNotNull(updateBarcodeArFromJson);
        return barcodeNativeTypeFactory.convert(updateBarcodeArFromJson);
    }
    ...
    public BarcodeArSettings _updateSettingsFromJson(BarcodeArSettings settings, String json) {
        ...
        Intrinsics.checkNotNullParameter(json, "json");
        NativeBarcodeArSettings a = settings.getA();
        this.proxyCache.put(Reflection.getOrCreateKotlinClass(NativeBarcodeArSettings.class), null, a, settings);
        NativeBarcodeArSettings updateSettingsFromJson = this.a.updateSettingsFromJson(a, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(NativeBarcodeArSettings.class);
        Intrinsics.checkNotNull(updateSettingsFromJson);
        return (BarcodeArSettings) proxyCache.require(orCreateKotlinClass, null, updateSettingsFromJson);
    }
    ...
    public BarcodeArDeserializerHelper get_helper() {
        return (BarcodeArDeserializerHelper) this.proxyCache.requireByValue(Reflection.getOrCreateKotlinClass(BarcodeArDeserializerHelper.class), this.a.getHelper());
    }

    public /* synthetic */ BarcodeArDeserializerProxyAdapter(NativeBarcodeArDeserializer nativeBarcodeArDeserializer, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeArDeserializer, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
