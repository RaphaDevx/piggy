...
final class DefaultTransformableState implements TransformableState {
    ...
    public DefaultTransformableState(Function3<? super Float, ? super Offset, ? super Float, Unit> onTransformation) {
        ...
        this.transformScope = new TransformScope() { // from class: androidx.compose.foundation.gestures.DefaultTransformableState$transformScope$1
            ...
            public void mo182transformByd4ec7I(float zoomChange, long panChange, float rotationChange) {
                DefaultTransformableState.this.getOnTransformation().invoke(Float.valueOf(zoomChange), Offset.m1014boximpl(panChange), Float.valueOf(rotationChange));
            }
        };
        this.transformMutex = new MutatorMutex();
        this.isTransformingState = SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
    }
