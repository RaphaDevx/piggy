...
public final class SparkScanScanningModeDeserializer {
    ...
    @JvmStatic
    public static final SparkScanScanningMode fromJson(String json) {
        String string;
        String string2;
        ...
        if (Intrinsics.areEqual(string3, "default")) {
            ...
            SparkScanScanningBehavior fromJson = SparkScanScanningBehaviorDeserializer.fromJson(string);
            Intrinsics.checkNotNull(string2);
            return new SparkScanScanningMode.Default(fromJson, SparkScanPreviewBehaviorDeserializer.fromJson(string2));
        }
        if (!Intrinsics.areEqual(string3, TypedValues.AttributesType.S_TARGET)) {
        ...
        string2 = jSONObject2.has("previewBehavior") ? jSONObject2.getString("previewBehavior") : "default";
        Intrinsics.checkNotNull(string);
        SparkScanScanningBehavior fromJson2 = SparkScanScanningBehaviorDeserializer.fromJson(string);
        Intrinsics.checkNotNull(string2);
        return new SparkScanScanningMode.Target(fromJson2, SparkScanPreviewBehaviorDeserializer.fromJson(string2));
    }
}
