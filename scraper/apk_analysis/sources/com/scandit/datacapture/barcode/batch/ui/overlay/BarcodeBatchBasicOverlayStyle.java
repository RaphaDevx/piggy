...
public final class BarcodeBatchBasicOverlayStyle {
    ...
    private static final /* synthetic */ BarcodeBatchBasicOverlayStyle[] a;
    ...
    static {
        ...
        a = barcodeBatchBasicOverlayStyleArr;
        b = EnumEntriesKt.enumEntries(barcodeBatchBasicOverlayStyleArr);
    }

    private BarcodeBatchBasicOverlayStyle(String str, int i) {
    }
    ...
    public static BarcodeBatchBasicOverlayStyle[] values() {
        return (BarcodeBatchBasicOverlayStyle[]) a.clone();
    }
}
