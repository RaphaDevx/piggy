...
public final class AndroidPopup_androidKt {
    ...
    */
    public static final void m3208PopupK5zGePQ(androidx.compose.ui.Alignment r22, long r23, kotlin.jvm.functions.Function0<kotlin.Unit> r25, androidx.compose.ui.window.PopupProperties r26, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, androidx.compose.runtime.Composer r28, final int r29, final int r30) {
        /*
            Method dump skipped, instructions count: 368
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.window.AndroidPopup_androidKt.m3208PopupK5zGePQ(androidx.compose.ui.Alignment, long, kotlin.jvm.functions.Function0, androidx.compose.ui.window.PopupProperties, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final void PopupTestTag(final String tag, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if (((i2 & 91) ^ 18) != 0 || !startRestartGroup.getSkipping()) {
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{LocalPopupTestTag.provides(tag)}, content, startRestartGroup, (i2 & b.p) | 8);
        } else {
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m948setimpl(m941constructorimpl, androidPopup_androidKt$SimpleStack$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
    ...
    public static final Function2<Composer, Integer, Unit> m3207Popup$lambda1(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
