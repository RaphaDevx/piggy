...
final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo56measure3p2s80s(MeasureScope receiver, Measurable measurable, long j) {
        ...
        m254alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m254alignmentLineOffsetMeasuretjqqzMA(receiver, this.alignmentLine, !TextUnitKt.m3166isUnspecifiedR2X_6o(getBefore()) ? receiver.mo223toDpGaN1DYA(getBefore()) : Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM(), !TextUnitKt.m3166isUnspecifiedR2X_6o(getAfter()) ? receiver.mo223toDpGaN1DYA(getAfter()) : Dp.INSTANCE.m3027getUnspecifiedD9Ej5fM(), measurable, j);
        return m254alignmentLineOffsetMeasuretjqqzMA;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m3149hashCodeimpl(getBefore())) * 31) + TextUnit.m3149hashCodeimpl(getAfter());
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnit.alignmentLine) && TextUnit.m3145equalsimpl0(getBefore(), alignmentLineOffsetTextUnit.getBefore()) && TextUnit.m3145equalsimpl0(getAfter(), alignmentLineOffsetTextUnit.getAfter());
    }

    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) TextUnit.m3155toStringimpl(getBefore())) + ", after=" + ((Object) TextUnit.m3155toStringimpl(getAfter())) + ')';
    }
}
