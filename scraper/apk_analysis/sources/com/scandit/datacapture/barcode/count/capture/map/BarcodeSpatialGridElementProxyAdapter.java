...
public final class BarcodeSpatialGridElementProxyAdapter implements BarcodeSpatialGridElementProxy {
    private final NativeBarcodeSpatialGridElement a;
    ...
    public BarcodeSpatialGridElementProxyAdapter(NativeBarcodeSpatialGridElement _NativeBarcodeSpatialGridElement, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_NativeBarcodeSpatialGridElement, "_NativeBarcodeSpatialGridElement");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _NativeBarcodeSpatialGridElement;
        this.proxyCache = proxyCache;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridElementProxy
    /* renamed from: _impl, reason: from getter */
    public NativeBarcodeSpatialGridElement getA() {
        return this.a;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridElementProxy
    public Barcode getMainBarcode() {
        NativeBarcode mainBarcode = this.a.mainBarcode();
        ProxyCache proxyCache = this.proxyCache;
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(NativeBarcode.class);
        Intrinsics.checkNotNull(mainBarcode);
        return (Barcode) proxyCache.getOrPut(orCreateKotlinClass, null, mainBarcode, new c(mainBarcode));
    }
    ...
    public Barcode getSubBarcode() {
        NativeBarcode subBarcode = this.a.subBarcode();
        if (subBarcode != null) {
            return (Barcode) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcode.class), null, subBarcode, new d(subBarcode));
        }
        return null;
    }

    public /* synthetic */ BarcodeSpatialGridElementProxyAdapter(NativeBarcodeSpatialGridElement nativeBarcodeSpatialGridElement, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeSpatialGridElement, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
