...
public final class TextLayoutInput {
    ...
    public final TextLayoutInput m2744copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.text, textLayoutInput.text) && Intrinsics.areEqual(this.style, textLayoutInput.style) && Intrinsics.areEqual(this.placeholders, textLayoutInput.placeholders) && this.maxLines == textLayoutInput.maxLines && this.softWrap == textLayoutInput.softWrap && TextOverflow.m2958equalsimpl0(getOverflow(), textLayoutInput.getOverflow()) && Intrinsics.areEqual(this.density, textLayoutInput.density) && this.layoutDirection == textLayoutInput.layoutDirection && Intrinsics.areEqual(this.resourceLoader, textLayoutInput.resourceLoader) && Constraints.m2970equalsimpl0(getConstraints(), textLayoutInput.getConstraints());
    }

    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + Boolean.hashCode(this.softWrap)) * 31) + TextOverflow.m2959hashCodeimpl(getOverflow())) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.resourceLoader.hashCode()) * 31) + Constraints.m2980hashCodeimpl(getConstraints());
    }

    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m2960toStringimpl(getOverflow())) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", resourceLoader=" + this.resourceLoader + ", constraints=" + ((Object) Constraints.m2982toStringimpl(getConstraints())) + ')';
    }
}
