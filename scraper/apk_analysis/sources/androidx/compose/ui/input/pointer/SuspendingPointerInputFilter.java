...
public final class SuspendingPointerInputFilter extends PointerInputFilter implements PointerInputModifier, PointerInputScope, Density {
    ...
    public SuspendingPointerInputFilter(ViewConfiguration viewConfiguration, Density density) {
        ...
        this.boundsSize = IntSize.INSTANCE.m3132getZeroYbymL2g();
    }
    ...
    */
    public void mo2442onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r3, androidx.compose.ui.input.pointer.PointerEventPass r4, long r5) {
        /*
            r2 = this;
        ...
        L3c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.SuspendingPointerInputFilter.mo2442onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (pointerInputChange2.getPressed()) {
                    ...
                    pointerInputChange = pointerInputChange2.m2424copyEzrO64((r30 & 1) != 0 ? pointerInputChange2.getId() : 0L, (r30 & 2) != 0 ? pointerInputChange2.uptimeMillis : 0L, (r30 & 4) != 0 ? pointerInputChange2.getPosition() : 0L, (r30 & 8) != 0 ? pointerInputChange2.pressed : false, (r30 & 16) != 0 ? pointerInputChange2.previousUptimeMillis : uptimeMillis, (r30 & 32) != 0 ? pointerInputChange2.getPreviousPosition() : position, (r30 & 64) != 0 ? pointerInputChange2.previousPressed : pressed, (r30 & 128) != 0 ? pointerInputChange2.consumed : consumedData, (r30 & 256) != 0 ? pointerInputChange2.getType() : 0);
                } else {
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo2398getSizeYbymL2g() {
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m3945constructorimpl(event));
        }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Unit unit = Unit.INSTANCE;
            Result.Companion companion = Result.INSTANCE;
            createCoroutine.resumeWith(Result.m3945constructorimpl(unit));
