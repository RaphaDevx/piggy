...
public final class DataCaptureContextDeserializerListenerReversedAdapter extends NativeDataCaptureContextDeserializerListener {
    ...
    public void onContextDeserializationFinished(NativeDataCaptureContextDeserializer deserializer, NativeDataCaptureContext context, NativeJsonValue json) {
        ...
        if (dataCaptureContextDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContextDeserializer.class), null, deserializer, new h(dataCaptureContextDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            DataCaptureContext dataCaptureContext = (DataCaptureContext) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContext.class), null, context, new i(context));
    ...
    public void onContextDeserializationStarted(NativeDataCaptureContextDeserializer deserializer, NativeDataCaptureContext context, NativeJsonValue json) {
        ...
        DataCaptureContextDeserializer dataCaptureContextDeserializer = (DataCaptureContextDeserializer) this.c.get();
        if (dataCaptureContextDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContextDeserializer.class), null, deserializer, new k(dataCaptureContextDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            DataCaptureContext dataCaptureContext = (DataCaptureContext) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContext.class), null, context, new l(context));
