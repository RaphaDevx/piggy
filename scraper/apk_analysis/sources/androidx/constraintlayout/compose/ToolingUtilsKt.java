...
public final class ToolingUtilsKt {
    ...
    private static final JSONObject boundsToJson(ConstraintWidget constraintWidget, int i, int i2) {
        return new JSONObject().put(RRWebVideoEvent.JsonKeys.LEFT, constraintWidget.getLeft() + i).put(RRWebVideoEvent.JsonKeys.TOP, constraintWidget.getTop() + i2).put("right", constraintWidget.getRight() + i).put("bottom", constraintWidget.getBottom() + i2);
    }
