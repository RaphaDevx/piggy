...
public final class SparkScanViewDefaults {
    ...
    static {
        ...
        defaultErrorBrush = BrushExtensionsKt.of(companion, defaultFeedbackErrorBrush);
    ...
    @Deprecated(message = "Use defaultTriggerButtonCollapsedColor and defaultTriggerButtonExpandedColor instead")
    @JvmStatic
    ...
    @Deprecated(message = "Not used anymore", replaceWith = @ReplaceWith(expression = "defaultTriggerButtonTintColor", imports = {}))
    @JvmStatic
    ...
    @Deprecated(message = "Torch moved to miniPreview", replaceWith = @ReplaceWith(expression = "defaultTorchControlVisible", imports = {}))
    @JvmStatic
