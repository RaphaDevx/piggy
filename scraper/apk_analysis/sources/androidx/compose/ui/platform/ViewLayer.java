...
public final class ViewLayer extends View implements OwnedLayer {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m1559getCenterSzJe1aQ();
    ...
    /* compiled from: ViewLayer.android.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0003\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0005¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, d2 = {"Landroidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29;", "", "()V", "Companion", "ui_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    private static final class UniqueDrawingIdApi29 {
        ...
        /* compiled from: ViewLayer.android.kt */
        @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0087\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29$Companion;", "", "()V", "getUniqueDrawingId", "", DataSources.EventTypeValue.VIEW_EVENT_TYPE, "Landroid/view/View;", "ui_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public void mo2630updateLayerPropertiesdRfWZ4U(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, LayoutDirection layoutDirection, Density density) {
        ...
        setPivotX(TransformOrigin.m1554getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m1555getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
    ...
    public boolean mo2626isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m1025getXimpl && m1025getXimpl < ((float) getWidth()) && 0.0f <= m1026getYimpl && m1026getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mo2629resizeozmzZPI(long size) {
        ...
        if (m3127getWidthimpl == getWidth() && m3126getHeightimpl == getHeight()) {
            return;
        }
        float f = m3127getWidthimpl;
        setPivotX(TransformOrigin.m1554getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = m3126getHeightimpl;
        setPivotY(TransformOrigin.m1555getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m2650updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m3127getWidthimpl, getTop() + m3126getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo2628movegyyYBs(long position) {
        ...
        if (m3085getXimpl != getLeft()) {
            offsetLeftAndRight(m3085getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m3086getYimpl = IntOffset.m3086getYimpl(position);
        if (m3086getYimpl != getTop()) {
            offsetTopAndBottom(m3086getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    protected void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        if (manualClipPath != null) {
            androidCanvas.save();
            Canvas.DefaultImpls.m1230clipPathmtrdDE$default(androidCanvas, manualClipPath, 0, 2, null);
        }
    ...
    public long mo2627mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return Matrix.m1424mapMKHz9U(this.matrixCache.m2654getInverseMatrixGrdbGEg(this), point);
        }
        return Matrix.m1424mapMKHz9U(this.matrixCache.m2655getMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        if (inverse) {
            Matrix.m1426mapimpl(this.matrixCache.m2654getInverseMatrixGrdbGEg(this), rect);
        } else {
            Matrix.m1426mapimpl(this.matrixCache.m2655getMatrixGrdbGEg(this), rect);
        }
    }

    /* compiled from: ViewLayer.android.kt */
    @Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u0017H\u0007R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u001e\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\b@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0010\u0010\f\u001a\u0004\u0018\u00010\rX\u0082\u000e¢\u0006\u0002\n\u0000R$\u0010\u000e\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\b@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u000b\"\u0004\b\u0010\u0010\u0011R\u0010\u0010\u0012\u001a\u0004\u0018\u00010\u0013X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0018"}, d2 = {"Landroidx/compose/ui/platform/ViewLayer$Companion;", "", "()V", "OutlineProvider", "Landroid/view/ViewOutlineProvider;", "getOutlineProvider", "()Landroid/view/ViewOutlineProvider;", "<set-?>", "", "hasRetrievedMethod", "getHasRetrievedMethod", "()Z", "recreateDisplayList", "Ljava/lang/reflect/Field;", "shouldUseDispatchDraw", "getShouldUseDispatchDraw", "setShouldUseDispatchDraw$ui_release", "(Z)V", "updateDisplayListIfDirtyMethod", "Ljava/lang/reflect/Method;", "updateDisplayList", "", DataSources.EventTypeValue.VIEW_EVENT_TYPE, "Landroid/view/View;", "ui_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class Companion {
        public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
            this();
        }
