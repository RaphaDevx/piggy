...
public final class BrushSerializer {
    ...
    public static final String toJson(Brush brush) {
        ...
        String brushToJson = NativeStructSerializer.brushToJson(new NativeBrush(NativeColorExtensionsKt.toNativeColor(brush.getFillColor()), NativeColorExtensionsKt.toNativeColor(brush.getStrokeColor()), brush.getStrokeWidth()));
