...
public class Measurer implements BasicMeasure.Measurer, DesignInfoProvider {
    ...
    public Measurer() {
        ...
        this.state = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<State>() { // from class: androidx.constraintlayout.compose.Measurer$state$2
            {
                super(0);
            }
    ...
    public void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
        ...
        if (companionWidget instanceof Measurable) {
            ...
            boolean z6 = false;
            obtainConstraints(dimensionBehaviour, measure.horizontalDimension, constraintWidget.mMatchConstraintDefaultWidth, measure.measureStrategy, ((numArr != null && (num = numArr[1]) != null) ? num.intValue() : 0) == constraintWidget.getHeight(), constraintWidget.isResolvedHorizontally(), Constraints.m2977getMaxWidthimpl(getState().getRootIncomingConstraints()), this.widthConstraintsHolder);
            ...
            if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || measure.horizontalBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultWidth != 0 || measure.verticalBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultHeight != 0) {
                ...
                if (z2) {
                    str = "CCL";
                    Log.d(str, "Measuring " + LayoutIdKt.getLayoutId((Measurable) companionWidget) + " with " + ((Object) Constraints.m2982toStringimpl(Constraints)));
                } else {
                    str = "CCL";
                }
                Measurable measurable = (Measurable) companionWidget;
                Placeable mo2510measureBRTryo0 = measurable.mo2510measureBRTryo0(Constraints);
                getPlaceables().put(companionWidget, mo2510measureBRTryo0);
                constraintWidget.setMeasureRequested(false);
                z3 = ConstraintLayoutKt.DEBUG;
                if (z3) {
                    Log.d(str, LayoutIdKt.getLayoutId(measurable) + " is size " + mo2510measureBRTryo0.getWidth() + ' ' + mo2510measureBRTryo0.getHeight());
                }
                Integer valueOf = Integer.valueOf(mo2510measureBRTryo0.getWidth());
                ...
                Integer valueOf4 = Integer.valueOf(mo2510measureBRTryo0.getHeight());
                ...
                if (intValue != mo2510measureBRTryo0.getWidth()) {
                    Constraints = ConstraintsKt.Constraints(intValue, intValue, Constraints.m2978getMinHeightimpl(Constraints), Constraints.m2976getMaxHeightimpl(Constraints));
                    z4 = true;
                } else {
                    z4 = false;
                }
                if (intValue2 != mo2510measureBRTryo0.getHeight()) {
                    Constraints = ConstraintsKt.Constraints(Constraints.m2979getMinWidthimpl(Constraints), Constraints.m2977getMaxWidthimpl(Constraints), intValue2, intValue2);
                    z4 = true;
                }
                if (z4) {
                    z5 = ConstraintLayoutKt.DEBUG;
                    if (z5) {
                        Log.d(str, "Remeasuring coerced " + LayoutIdKt.getLayoutId(measurable) + " with " + ((Object) Constraints.m2982toStringimpl(Constraints)));
                    }
                    getPlaceables().put(companionWidget, measurable.mo2510measureBRTryo0(Constraints));
                    constraintWidget.setMeasureRequested(false);
                }
            }
    ...
    public final long m3275performMeasureDjhGOtQ(long constraints, LayoutDirection layoutDirection, ConstraintSet constraintSet, List<? extends Measurable> measurables, int optimizationLevel, MeasureScope measureScope) {
        ...
        if (Constraints.m2975getHasFixedWidthimpl(constraints)) {
            min = androidx.constraintlayout.core.state.Dimension.Fixed(Constraints.m2977getMaxWidthimpl(constraints));
        } else {
            min = androidx.constraintlayout.core.state.Dimension.Wrap().min(Constraints.m2979getMinWidthimpl(constraints));
        }
        state.width(min);
        State state2 = getState();
        if (Constraints.m2974getHasFixedHeightimpl(constraints)) {
            min2 = androidx.constraintlayout.core.state.Dimension.Fixed(Constraints.m2976getMaxHeightimpl(constraints));
        } else {
            min2 = androidx.constraintlayout.core.state.Dimension.Wrap().min(Constraints.m2978getMinHeightimpl(constraints));
        }
        state2.height(min2);
        getState().m3309setRootIncomingConstraintsBRTryo0(constraints);
        ...
        if (z) {
            ...
            Log.d("CCL", Intrinsics.stringPlus("ConstraintLayout is asked to measure with ", Constraints.m2982toStringimpl(constraints)));
        ...
        while (it2.hasNext()) {
            ...
            if (companionWidget2 instanceof Measurable) {
                ...
                getPlaceables().put(companionWidget2, ((Measurable) companionWidget2).mo2510measureBRTryo0(Constraints.INSTANCE.m2985fixedJhjzzOo(next.getWidth(), next.getHeight())));
            }
        }
        z2 = ConstraintLayoutKt.DEBUG;
        if (z2) {
    ...
    protected final void m3274applyRootSizeBRTryo0(long constraints) {
        this.root.setWidth(Constraints.m2977getMaxWidthimpl(constraints));
        this.root.setHeight(Constraints.m2976getMaxHeightimpl(constraints));
        this.forcedScaleFactor = Float.NaN;
        LayoutInformationReceiver layoutInformationReceiver = this.layoutInformationReceiver;
        if (layoutInformationReceiver != null) {
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (widgetFrame.isDefaultTransform()) {
                    ...
                    if (placeable != null) {
                        Placeable.PlacementScope.m2548place70tqf50$default(placementScope, placeable, IntOffsetKt.IntOffset(i3, i4), 0.0f, 2, null);
                    }
                } else {
                    Function1<GraphicsLayerScope, Unit> function1 = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.constraintlayout.compose.Measurer$performLayout$1$layerBlock$1
                        ...
                        public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                            ...
                            if (!Float.isNaN(WidgetFrame.this.pivotX) || !Float.isNaN(WidgetFrame.this.pivotY)) {
                                graphicsLayerScope.mo1391setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(Float.isNaN(WidgetFrame.this.pivotX) ? 0.5f : WidgetFrame.this.pivotX, Float.isNaN(WidgetFrame.this.pivotY) ? 0.5f : WidgetFrame.this.pivotY));
                            }
    ...
    public final void drawDebugBounds(final BoxScope boxScope, final float f, Composer composer, final int i) {
        ...
        CanvasKt.Canvas(boxScope.matchParentSize(Modifier.INSTANCE), new Function1<DrawScope, Unit>() { // from class: androidx.constraintlayout.compose.Measurer$drawDebugBounds$1
            ...
            public final void invoke2(DrawScope Canvas) {
                ...
                float layoutCurrentHeight = f * Measurer.this.getLayoutCurrentHeight();
                float m1094getWidthimpl = (Size.m1094getWidthimpl(Canvas.mo1627getSizeNHjbRc()) - layoutCurrentWidth) / 2.0f;
                float m1091getHeightimpl = (Size.m1091getHeightimpl(Canvas.mo1627getSizeNHjbRc()) - layoutCurrentHeight) / 2.0f;
                long m1291getWhite0d7_KjU = Color.INSTANCE.m1291getWhite0d7_KjU();
                float f2 = m1094getWidthimpl + layoutCurrentWidth;
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1291getWhite0d7_KjU, OffsetKt.Offset(m1094getWidthimpl, m1091getHeightimpl), OffsetKt.Offset(f2, m1091getHeightimpl), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                long Offset = OffsetKt.Offset(f2, m1091getHeightimpl);
                float f3 = m1091getHeightimpl + layoutCurrentHeight;
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1291getWhite0d7_KjU, Offset, OffsetKt.Offset(f2, f3), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1291getWhite0d7_KjU, OffsetKt.Offset(f2, f3), OffsetKt.Offset(m1094getWidthimpl, f3), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1291getWhite0d7_KjU, OffsetKt.Offset(m1094getWidthimpl, f3), OffsetKt.Offset(m1094getWidthimpl, m1091getHeightimpl), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                float f4 = 1;
                float f5 = m1094getWidthimpl + f4;
                float f6 = m1091getHeightimpl + f4;
                long m1280getBlack0d7_KjU = Color.INSTANCE.m1280getBlack0d7_KjU();
                float f7 = layoutCurrentWidth + f5;
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1280getBlack0d7_KjU, OffsetKt.Offset(f5, f6), OffsetKt.Offset(f7, f6), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                float f8 = layoutCurrentHeight + f6;
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1280getBlack0d7_KjU, OffsetKt.Offset(f7, f6), OffsetKt.Offset(f7, f8), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1280getBlack0d7_KjU, OffsetKt.Offset(f7, f8), OffsetKt.Offset(f5, f8), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
                DrawScope.DefaultImpls.m1662drawLineNGM6Ib0$default(Canvas, m1280getBlack0d7_KjU, OffsetKt.Offset(f5, f8), OffsetKt.Offset(f5, f6), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
            }
        }, startRestartGroup, 0);
    ...
    static /* synthetic */ long m3273getColorwrIjXm8$default(Measurer measurer, String str, long j, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: getColor-wrIjXm8");
        }
        if ((i & 2) != 0) {
            j = Color.INSTANCE.m1280getBlack0d7_KjU();
        }
        return measurer.m3272getColorwrIjXm8(str, j);
    }

    /* renamed from: getColor-wrIjXm8, reason: not valid java name */
    private final long m3272getColorwrIjXm8(String str, long defaultColor) {
    ...
    private final TextStyle getTextStyle(HashMap<String, String> params) {
        String str = params.get(RRWebVideoEvent.JsonKeys.SIZE);
        long m3159getUnspecifiedXSAIIZE = TextUnit.INSTANCE.m3159getUnspecifiedXSAIIZE();
        if (str != null) {
            m3159getUnspecifiedXSAIIZE = TextUnitKt.getSp(Float.parseFloat(str));
        }
        return new TextStyle(m3273getColorwrIjXm8$default(this, params.get(TypedValues.Custom.S_COLOR), 0L, 2, null), m3159getUnspecifiedXSAIIZE, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 0L, null, 262140, null);
    }
                ...
                switch (type.hashCode()) {
                    case -1377687758:
                        if (type.equals("button")) {
                            ...
                            BasicTextKt.m441BasicTextBpD7jsM(str, PaddingKt.m315padding3ABfNKs(BackgroundKt.m145backgroundbw27NRU$default(ClipKt.clip(ConstraintLayoutTagKt.layoutId$default(Modifier.INSTANCE, id, null, 2, null), RoundedCornerShapeKt.RoundedCornerShape(20)), m3272getColorwrIjXm8(next.getParams().get("backgroundColor"), Color.INSTANCE.m1286getLightGray0d7_KjU()), null, 2, null), Dp.m3007constructorimpl(8)), getTextStyle(next.getParams()), null, 0, false, 0, startRestartGroup, 32768, 120);
                            startRestartGroup.endReplaceableGroup();
                            break;
                        }
                    ...
                    case -1031434259:
                        if (type.equals("textfield")) {
                            ...
                            BasicTextFieldKt.BasicTextField(str2, (Function1<? super String, Unit>) new Function1<String, Unit>() { // from class: androidx.constraintlayout.compose.Measurer$createDesignElements$2
                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    ...
                    case 97739:
                        if (type.equals("box")) {
                            ...
                            Modifier m145backgroundbw27NRU$default = BackgroundKt.m145backgroundbw27NRU$default(ConstraintLayoutTagKt.layoutId$default(Modifier.INSTANCE, id, null, 2, null), m3272getColorwrIjXm8(next.getParams().get("backgroundColor"), Color.INSTANCE.m1286getLightGray0d7_KjU()), null, 2, null);
                            ...
                            BasicTextKt.m441BasicTextBpD7jsM(str3, PaddingKt.m315padding3ABfNKs(Modifier.INSTANCE, Dp.m3007constructorimpl(8)), getTextStyle(next.getParams()), null, 0, false, 0, startRestartGroup, 32816, 120);
                            startRestartGroup.endReplaceableGroup();
                            startRestartGroup.endReplaceableGroup();
                    ...
                    case 3556653:
                        if (type.equals("text")) {
                            ...
                            BasicTextKt.m441BasicTextBpD7jsM(str4, ConstraintLayoutTagKt.layoutId$default(Modifier.INSTANCE, id, null, 2, null), getTextStyle(next.getParams()), null, 0, false, 0, startRestartGroup, 32768, 120);
                            startRestartGroup.endReplaceableGroup();
                            break;
                        }
                        startRestartGroup.startReplaceableGroup(-186574342);
                    ...
                    case 100313435:
                        if (type.equals("image")) {
                            ...
                            ImageKt.Image(PainterResources_androidKt.painterResource(android.R.drawable.ic_menu_gallery, startRestartGroup, 0), "Placeholder Image", ConstraintLayoutTagKt.layoutId$default(Modifier.INSTANCE, id, null, 2, null), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, startRestartGroup, 56, 120);
                            startRestartGroup.endReplaceableGroup();
                            break;
                        }
                        startRestartGroup.startReplaceableGroup(-186574342);
