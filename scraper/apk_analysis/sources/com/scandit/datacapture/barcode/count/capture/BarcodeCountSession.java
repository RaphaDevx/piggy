...
public final class BarcodeCountSession {
    ...
    public BarcodeCountSession(List<Barcode> recognizedBarcodesParam, List<Cluster> recognizedClustersParam, List<Barcode> additionalBarcodesParam, long j, List<Integer> removedRecognizedBarcodes, InternalBarcodeCountSessionCallback callbacks) {
    ...
    public final BarcodeSpatialGrid getSpatialMap(int expectedNumberOfRows, int expectedNumberOfColumns) {
        return (BarcodeSpatialGrid) this.a.a().invoke(Integer.valueOf(expectedNumberOfRows), Integer.valueOf(expectedNumberOfColumns));
    }
    ...
    public final String toJson() {
        return (String) this.a.c().invoke();
    }

    public final BarcodeSpatialGrid getSpatialMap() {
        return (BarcodeSpatialGrid) this.a.a().invoke(null, null);
    }
}
