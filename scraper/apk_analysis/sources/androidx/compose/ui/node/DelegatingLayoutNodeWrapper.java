...
public class DelegatingLayoutNodeWrapper<T extends Modifier.Element> extends LayoutNodeWrapper {
    ...
    public void mo2595hitTest3MmeM6k(long pointerPosition, List<PointerInputFilter> hitPointerInputFilters) {
        ...
        if (m2617withinLayerBoundsk4lQ0M(pointerPosition)) {
            getWrapped().mo2595hitTest3MmeM6k(getWrapped().m2612fromParentPositionMKHz9U(pointerPosition), hitPointerInputFilters);
        }
    }
    ...
    public void mo2596hitTestSemantics3MmeM6k(long pointerPosition, List<SemanticsWrapper> hitSemanticsWrappers) {
        ...
        if (m2617withinLayerBoundsk4lQ0M(pointerPosition)) {
            getWrapped().mo2596hitTestSemantics3MmeM6k(getWrapped().m2612fromParentPositionMKHz9U(pointerPosition), hitSemanticsWrappers);
        }
    }
    ...
    public void mo2511placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int m3127getWidthimpl = IntSize.m3127getWidthimpl(getMeasuredSize());
        ...
        Placeable.PlacementScope.parentWidth = m3127getWidthimpl;
    ...
    public Placeable mo2510measureBRTryo0(long constraints) {
        ...
        final Placeable placeable = getWrapped().mo2510measureBRTryo0(constraints);
        setMeasureResult$ui_release(new MeasureResult(this) { // from class: androidx.compose.ui.node.DelegatingLayoutNodeWrapper$measure$1$1
            ...
            public void placeChildren() {
                ...
                j = this.this$0.m2543getApparentToRealOffsetnOccac();
                Placeable.PlacementScope.m2548place70tqf50$default(companion, placeable2, IntOffsetKt.IntOffset(-IntOffset.m3085getXimpl(j), -IntOffset.m3086getYimpl(j)), 0.0f, 2, null);
            }
        });
        return this;
    }
