...
public final class BarcodeBatchDeserializer implements DataCaptureModeDeserializer, BarcodeBatchDeserializerProxy {
    ...
    private final /* synthetic */ BarcodeBatchDeserializerProxyAdapter b;
    ...
    public BarcodeBatchDeserializer() {
        ...
        int i = 2;
        BarcodeBatchDeserializerHelperReversedAdapter barcodeBatchDeserializerHelperReversedAdapter = new BarcodeBatchDeserializerHelperReversedAdapter(c0266f, null, i, 0 == true ? 1 : 0);
        NativeBarcodeTrackingDeserializer create = NativeBarcodeTrackingDeserializer.create(barcodeBatchDeserializerHelperReversedAdapter);
        Intrinsics.checkNotNullExpressionValue(create, "create(...)");
        this.a = c0266f;
        this.b = new BarcodeBatchDeserializerProxyAdapter(create, 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(BarcodeBatchDeserializerHelper.class), null, c0266f, new C0264d(barcodeBatchDeserializerHelperReversedAdapter));
        _setDeserializer(this);
        create.setListener(new BarcodeBatchDeserializerListenerReversedAdapter(new C0265e(this), this, null, 4, null));
    }
    ...
    public final BarcodeBatchAdvancedOverlay advancedOverlayFromJson(BarcodeBatch mode, String jsonData) {
        Intrinsics.checkNotNullParameter(mode, "mode");
        Intrinsics.checkNotNullParameter(jsonData, "jsonData");
        BarcodeBatchAdvancedOverlay _advancedOverlayFromJson = _advancedOverlayFromJson(mode, jsonData);
        this.a.clear();
    ...
    public final BarcodeBatchBasicOverlay basicOverlayFromJson(BarcodeBatch mode, String jsonData) {
        Intrinsics.checkNotNullParameter(mode, "mode");
        Intrinsics.checkNotNullParameter(jsonData, "jsonData");
        BarcodeBatchBasicOverlay _basicOverlayFromJson = _basicOverlayFromJson(mode, jsonData);
        this.a.clear();
    ...
    public final BarcodeBatch modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        Intrinsics.checkNotNullParameter(dataCaptureContext, "dataCaptureContext");
        Intrinsics.checkNotNullParameter(jsonData, "jsonData");
        BarcodeBatch _modeFromJson = _modeFromJson(dataCaptureContext, jsonData);
        this.a.clear();
    ...
    public final BarcodeBatchSettings settingsFromJson(String jsonData) {
        Intrinsics.checkNotNullParameter(jsonData, "jsonData");
        BarcodeBatchSettings _settingsFromJson = _settingsFromJson(jsonData);
        this.a.clear();
