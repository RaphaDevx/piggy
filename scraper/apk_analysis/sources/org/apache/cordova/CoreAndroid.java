...
public class CoreAndroid extends CordovaPlugin {
    ...
    public void loadUrl(String url, JSONObject props) throws JSONException {
        boolean z;
        boolean z2;
        LOG.d("App", "App.loadUrl(" + url + FirebaseConstants.SEPARATOR + props + ")");
    ...
    private void initTelephonyReceiver() {
        ...
        this.telephonyReceiver = new BroadcastReceiver() { // from class: org.apache.cordova.CoreAndroid.5
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent != null && intent.getAction().equals("android.intent.action.PHONE_STATE") && intent.hasExtra(SentryThread.JsonKeys.STATE)) {
    ...
    private void sendEventMessage(String action) {
        ...
        try {
            jSONObject.put(UrlHandler.ACTION, action);
