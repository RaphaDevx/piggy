...
public final class BarcodeNativeTypeFactory {
    ...
    public final ArrayList<NativeTrackedObject> convertTrackedObjectList(List<TrackedObject> source) {
        ...
        Iterator<T> it = source.iterator();
        while (it.hasNext()) {
            arrayList.add(((TrackedObject) it.next()).getA());
        }
        return CollectionsExtensionsKt.toArrayList(arrayList);
    }
    ...
    public final BarcodePick convert(NativeBarcodePick source) {
        Intrinsics.checkNotNullParameter(source, "source");
        return ((BarcodePickInternal) ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodePick.class), null, source, new g(source))).d();
    }
    ...
    public final BarcodeAr convert(NativeBarcodeAr source) {
        Intrinsics.checkNotNullParameter(source, "source");
        return ((BarcodeArInternal) ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeAr.class), null, source, new f(source))).c();
    }
    ...
    public final NativeSparkScanScanningMode convert(SparkScanScanningMode source) {
        ...
        if (source instanceof SparkScanScanningMode.Target) {
            ...
            NativeSparkScanScanningMode asScanningMode = NativeSparkScanScanningModeTarget.create(target.getScanningBehavior(), target.getPreviewBehavior()).asScanningMode();
            Intrinsics.checkNotNullExpressionValue(asScanningMode, "asScanningMode(...)");
            return asScanningMode;
        }
        if (source instanceof SparkScanScanningMode.Default) {
            SparkScanScanningMode.Default r2 = (SparkScanScanningMode.Default) source;
            NativeSparkScanScanningMode asScanningMode2 = NativeSparkScanScanningModeDefault.create(r2.getScanningBehavior(), r2.getPreviewBehavior()).asScanningMode();
            Intrinsics.checkNotNullExpressionValue(asScanningMode2, "asScanningMode(...)");
    ...
    public final SparkScanScanningMode convert(NativeSparkScanScanningMode source) {
        ...
        if (source.getType() == NativeSparkScanScanningModeType.DEFAULT) {
            ...
            Intrinsics.checkNotNullExpressionValue(scanningBehavior, "getScanningBehavior(...)");
            SparkScanPreviewBehavior previewBehavior = source.getPreviewBehavior();
            Intrinsics.checkNotNullExpressionValue(previewBehavior, "getPreviewBehavior(...)");
        ...
        Intrinsics.checkNotNullExpressionValue(scanningBehavior2, "getScanningBehavior(...)");
        SparkScanPreviewBehavior previewBehavior2 = source.getPreviewBehavior();
        Intrinsics.checkNotNullExpressionValue(previewBehavior2, "getPreviewBehavior(...)");
