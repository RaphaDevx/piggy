...
public final class InnerPlaceable extends LayoutNodeWrapper implements Density {
    ...
    public int mo221roundToPxR2X_6o(long j) {
        return this.$$delegate_0.mo221roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo222roundToPx0680j_4(float f) {
        return this.$$delegate_0.mo222roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-GaN1DYA */
    public float mo223toDpGaN1DYA(long j) {
        return this.$$delegate_0.mo223toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo224toDpu2uoSUM(float f) {
        return this.$$delegate_0.mo224toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo225toDpu2uoSUM(int i) {
        return this.$$delegate_0.mo225toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo226toPxR2X_6o(long j) {
        return this.$$delegate_0.mo226toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo227toPx0680j_4(float f) {
        return this.$$delegate_0.mo227toPx0680j_4(f);
    }
    ...
    public long mo228toSp0xMU5do(float f) {
        return this.$$delegate_0.mo228toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo229toSpkPz2Gy4(float f) {
        return this.$$delegate_0.mo229toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo230toSpkPz2Gy4(int i) {
        return this.$$delegate_0.mo230toSpkPz2Gy4(i);
    }
    ...
    public Placeable mo2510measureBRTryo0(long constraints) {
        ...
        getLayoutNode().handleMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo40measure3p2s80s(getLayoutNode().getMeasureScope(), getLayoutNode().getChildren$ui_release(), constraints));
        return this;
    }
    ...
    public void mo2511placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo2511placeAtf8xVGno(position, zIndex, layerBlock);
        LayoutNodeWrapper wrappedBy$ui_release = getWrappedBy();
        if (Intrinsics.areEqual((Object) (wrappedBy$ui_release == null ? null : Boolean.valueOf(wrappedBy$ui_release.getIsShallowPlacing())), (Object) true)) {
            return;
        }
    ...
    private final <T> void m2598hitTestSubtree9KIMszo(long pointerPosition, List<T> hitResult, Function3<? super LayoutNode, ? super Offset, ? super List<T>, Unit> nodeHitTest) {
        if (m2617withinLayerBoundsk4lQ0M(pointerPosition)) {
            ...
            if (size2 > 0) {
                ...
                do {
                    LayoutNode layoutNode = content[i];
                    if (layoutNode.getIsPlaced()) {
                        nodeHitTest.invoke(layoutNode, Offset.m1014boximpl(pointerPosition), hitResult);
    ...
    /* compiled from: InnerPlaceable.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/node/InnerPlaceable$Companion;", "", "()V", "innerBoundsPaint", "Landroidx/compose/ui/graphics/Paint;", "getInnerBoundsPaint", "()Landroidx/compose/ui/graphics/Paint;", "ui_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    static {
        ...
        Paint.mo1146setColor8_81llA(Color.INSTANCE.m1288getRed0d7_KjU());
    ...
    public void mo2595hitTest3MmeM6k(long pointerPosition, List<PointerInputFilter> hitPointerInputFilters) {
        ...
        if (m2617withinLayerBoundsk4lQ0M(pointerPosition)) {
            ...
            if (size2 > 0) {
                ...
                do {
                    LayoutNode layoutNode = content[i];
                    if (layoutNode.getIsPlaced()) {
                        layoutNode.m2600hitTest3MmeM6k$ui_release(pointerPosition, hitPointerInputFilters);
    ...
    public void mo2596hitTestSemantics3MmeM6k(long pointerPosition, List<SemanticsWrapper> hitSemanticsWrappers) {
        ...
        if (m2617withinLayerBoundsk4lQ0M(pointerPosition)) {
            ...
            if (size2 > 0) {
                ...
                do {
                    LayoutNode layoutNode = content[i];
                    if (layoutNode.getIsPlaced()) {
                        layoutNode.m2601hitTestSemantics3MmeM6k$ui_release(pointerPosition, hitSemanticsWrappers);
