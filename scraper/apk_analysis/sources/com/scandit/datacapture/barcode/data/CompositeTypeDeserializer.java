...
public final class CompositeTypeDeserializer {
    ...
    public static final CompositeType fromJson(String json) {
        ...
        Intrinsics.checkNotNullExpressionValue(compositeTypeFromJsonString, "compositeTypeFromJsonString(...)");
        Object first = CollectionsKt.first(compositeTypeFromJsonString);
