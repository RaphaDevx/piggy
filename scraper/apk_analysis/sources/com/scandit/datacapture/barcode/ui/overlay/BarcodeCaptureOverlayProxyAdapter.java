...
public final class BarcodeCaptureOverlayProxyAdapter implements BarcodeCaptureOverlayProxy {
    ...
    public Brush getBrush() {
        NativeBrush brushForRecognizedBarcodes = this.a.getBrushForRecognizedBarcodes();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(brushForRecognizedBarcodes);
    ...
    public BarcodeCaptureOverlayStyle getStyle() {
        NativeBarcodeCaptureOverlayStyle style = this.a.getStyle();
