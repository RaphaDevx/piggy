...
public final class BarcodeBatchBasicOverlayListenerReversedAdapter extends NativeBarcodeTrackingBasicOverlayListener {
    private final BarcodeBatchBasicOverlayListener a;

    /* renamed from: b, reason: from kotlin metadata */
    private final ProxyCache proxyCache;
    private final WeakReference c;

    public /* synthetic */ BarcodeBatchBasicOverlayListenerReversedAdapter(BarcodeBatchBasicOverlayListener barcodeBatchBasicOverlayListener, BarcodeBatchBasicOverlay barcodeBatchBasicOverlay, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(barcodeBatchBasicOverlayListener, barcodeBatchBasicOverlay, (i & 4) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
    ...
    public NativeBrush brushForTrackedBarcode(NativeBarcodeTrackingBasicOverlay overlay, NativeTrackedBarcode trackedBarcode) {
        ...
        BarcodeBatchBasicOverlay barcodeBatchBasicOverlay = (BarcodeBatchBasicOverlay) this.c.get();
        if (barcodeBatchBasicOverlay == null) {
            return null;
        }
        Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingBasicOverlay.class), null, overlay, new d(barcodeBatchBasicOverlay));
        Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
        TrackedBarcode trackedBarcode2 = (TrackedBarcode) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeTrackedBarcode.class), null, trackedBarcode, new e(trackedBarcode));
        Brush brushForTrackedBarcode = this.a.brushForTrackedBarcode((BarcodeBatchBasicOverlay) orPut, trackedBarcode2);
    ...
    public void onTrackedBarcodeTapped(NativeBarcodeTrackingBasicOverlay overlay, NativeTrackedBarcode trackedBarcode) {
        ...
        BarcodeBatchBasicOverlay barcodeBatchBasicOverlay = (BarcodeBatchBasicOverlay) this.c.get();
        if (barcodeBatchBasicOverlay != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeTrackingBasicOverlay.class), null, overlay, new f(barcodeBatchBasicOverlay));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            TrackedBarcode trackedBarcode2 = (TrackedBarcode) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeTrackedBarcode.class), null, trackedBarcode, new g(trackedBarcode));
            this.a.onTrackedBarcodeTapped((BarcodeBatchBasicOverlay) orPut, trackedBarcode2);
        }
    }
    ...
    public BarcodeBatchBasicOverlayListenerReversedAdapter(BarcodeBatchBasicOverlayListener _BarcodeBatchBasicOverlayListener, BarcodeBatchBasicOverlay _BarcodeBatchBasicOverlay, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_BarcodeBatchBasicOverlayListener, "_BarcodeBatchBasicOverlayListener");
        Intrinsics.checkNotNullParameter(_BarcodeBatchBasicOverlay, "_BarcodeBatchBasicOverlay");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _BarcodeBatchBasicOverlayListener;
        this.proxyCache = proxyCache;
        this.c = new WeakReference(_BarcodeBatchBasicOverlay);
    }
}
