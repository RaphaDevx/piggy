...
final class IntrinsicMeasureBlocks {
    ...
    private static final Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> HorizontalMinWidth = new Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer>() { // from class: androidx.compose.foundation.layout.IntrinsicMeasureBlocks$HorizontalMinWidth$1
        ...
        public final int invoke(List<? extends IntrinsicMeasurable> measurables, int i, int i2) {
            int intrinsicSize;
            ...
            intrinsicSize = RowColumnImplKt.intrinsicSize(measurables, new Function2<IntrinsicMeasurable, Integer, Integer>() { // from class: androidx.compose.foundation.layout.IntrinsicMeasureBlocks$HorizontalMinWidth$1.1
                public final int invoke(IntrinsicMeasurable intrinsicSize2, int i3) {
                    Intrinsics.checkNotNullParameter(intrinsicSize2, "$this$intrinsicSize");
                    return intrinsicSize2.minIntrinsicWidth(i3);
                }
                ...
                public final int invoke(IntrinsicMeasurable intrinsicSize2, int i3) {
                    Intrinsics.checkNotNullParameter(intrinsicSize2, "$this$intrinsicSize");
                    return intrinsicSize2.maxIntrinsicHeight(i3);
                }
    ...
    private static final Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> HorizontalMinHeight = new Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer>() { // from class: androidx.compose.foundation.layout.IntrinsicMeasureBlocks$HorizontalMinHeight$1
        ...
        public final int invoke(List<? extends IntrinsicMeasurable> measurables, int i, int i2) {
            ...
            intrinsicSize = RowColumnImplKt.intrinsicSize(measurables, new Function2<IntrinsicMeasurable, Integer, Integer>() { // from class: androidx.compose.foundation.layout.IntrinsicMeasureBlocks$HorizontalMinHeight$1.1
                public final int invoke(IntrinsicMeasurable intrinsicSize2, int i3) {
                    Intrinsics.checkNotNullParameter(intrinsicSize2, "$this$intrinsicSize");
                    return intrinsicSize2.minIntrinsicHeight(i3);
                }
                ...
                public final int invoke(IntrinsicMeasurable intrinsicSize2, int i3) {
                    Intrinsics.checkNotNullParameter(intrinsicSize2, "$this$intrinsicSize");
                    return intrinsicSize2.maxIntrinsicWidth(i3);
                }
