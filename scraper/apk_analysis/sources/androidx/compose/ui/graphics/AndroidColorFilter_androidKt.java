...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1133actualTintColorFilterxETnrds(long j, int i) {
        return new ColorFilter(BlendModeColorFilterHelper.INSTANCE.m1207BlendModeColorFilterxETnrds(j, i));
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final ColorFilter m1131actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final ColorFilter m1132actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1309toArgb8_81llA(j), ColorKt.m1309toArgb8_81llA(j2)));
    }
}
