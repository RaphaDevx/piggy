...
public final class AnimatedVisibilityScopeImpl implements AnimatedVisibilityScope {
    ...
    public AnimatedVisibilityScopeImpl(Transition<EnterExitState> transition) {
        ...
        this.targetSize = SnapshotStateKt.mutableStateOf$default(IntSize.m3119boximpl(IntSize.INSTANCE.m3132getZeroYbymL2g()), null, 2, null);
    }

    @Override // androidx.compose.animation.AnimatedVisibilityScope
    public Modifier animateEnterExit(Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition) {
        return AnimatedVisibilityScope.DefaultImpls.animateEnterExit(this, modifier, enterTransition, exitTransition);
    }
