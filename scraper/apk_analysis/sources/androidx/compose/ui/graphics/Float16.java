...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m1349constructorimpl((short) 5120);
    private static final short LowestValue = m1349constructorimpl((short) -1025);
    private static final short MaxValue = m1349constructorimpl((short) 31743);
    private static final short MinNormal = m1349constructorimpl((short) 1024);
    private static final short MinValue = m1349constructorimpl((short) 1);
    private static final short NaN = m1349constructorimpl((short) 32256);
    private static final short NegativeInfinity = m1349constructorimpl((short) -1024);
    private static final short NegativeZero = m1349constructorimpl(ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m1349constructorimpl((short) 31744);
    private static final short PositiveZero = m1349constructorimpl((short) 0);
    private static final short One = m1348constructorimpl(1.0f);
    private static final short NegativeOne = m1348constructorimpl(-1.0f);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Float16 m1344boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m1349constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1350equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).getHalfValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1351equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: getExponent-impl, reason: not valid java name */
    public static final int m1353getExponentimpl(short s) {
        return ((s >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl, reason: not valid java name */
    public static final int m1355getSignificandimpl(short s) {
        return s & 1023;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1356hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    /* renamed from: isFinite-impl, reason: not valid java name */
    public static final boolean m1357isFiniteimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) != FP16_EXPONENT_MAX;
    }

    /* renamed from: isInfinite-impl, reason: not valid java name */
    public static final boolean m1358isInfiniteimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) == FP16_EXPONENT_MAX;
    }

    /* renamed from: isNaN-impl, reason: not valid java name */
    public static final boolean m1359isNaNimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) > FP16_EXPONENT_MAX;
    }

    /* renamed from: isNormalized-impl, reason: not valid java name */
    public static final boolean m1360isNormalizedimpl(short s) {
        int i = s & FP16_EXPONENT_MAX;
        return (i == 0 || i == FP16_EXPONENT_MAX) ? false : true;
    }

    /* renamed from: toRawBits-impl, reason: not valid java name */
    public static final int m1369toRawBitsimpl(short s) {
        return s & UShort.MAX_VALUE;
    }

    public boolean equals(Object obj) {
        return m1350equalsimpl(getHalfValue(), obj);
    }

    public int hashCode() {
        return m1356hashCodeimpl(getHalfValue());
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m1374compareTo41bOqos(float16.getHalfValue());
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m1348constructorimpl(float f) {
        return m1349constructorimpl(INSTANCE.floatToHalf(f));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m1347constructorimpl(double d) {
        return m1348constructorimpl((float) d);
    }

    /* renamed from: toByte-impl, reason: not valid java name */
    public static final byte m1363toByteimpl(short s) {
        return (byte) m1365toFloatimpl(s);
    }

    /* renamed from: toShort-impl, reason: not valid java name */
    public static final short m1370toShortimpl(short s) {
        return (short) m1365toFloatimpl(s);
    }

    /* renamed from: toInt-impl, reason: not valid java name */
    public static final int m1367toIntimpl(short s) {
        return (int) m1365toFloatimpl(s);
    }

    /* renamed from: toLong-impl, reason: not valid java name */
    public static final long m1368toLongimpl(short s) {
        return (long) m1365toFloatimpl(s);
    }

    /* renamed from: toFloat-impl, reason: not valid java name */
    public static final float m1365toFloatimpl(short s) {
        int i;
        int i2;
        int i3;
        int i4 = 32768 & s;
    ...
    public static final double m1364toDoubleimpl(short s) {
        return m1365toFloatimpl(s);
    }

    /* renamed from: toBits-impl, reason: not valid java name */
    public static final int m1362toBitsimpl(short s) {
        return m1359isNaNimpl(s) ? NaN : s & UShort.MAX_VALUE;
    }

    public String toString() {
        return m1371toStringimpl(getHalfValue());
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1371toStringimpl(short s) {
        return String.valueOf(m1365toFloatimpl(s));
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public int m1374compareTo41bOqos(short s) {
        return m1346compareTo41bOqos(getHalfValue(), s);
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public static int m1346compareTo41bOqos(short s, short s2) {
        if (m1359isNaNimpl(s)) {
            return !m1359isNaNimpl(s2) ? 1 : 0;
        }
        if (m1359isNaNimpl(s2)) {
            return -1;
        }
    ...
    public static final short m1354getSignslo4al4(short s) {
        if (m1359isNaNimpl(s)) {
            return NaN;
        }
        return m1346compareTo41bOqos(s, NegativeZero) < 0 ? NegativeOne : m1346compareTo41bOqos(s, PositiveZero) > 0 ? One : s;
    }

    /* renamed from: withSign-qCeQghg, reason: not valid java name */
    public static final short m1373withSignqCeQghg(short s, short s2) {
        return m1349constructorimpl((short) ((s & ShortCompanionObject.MAX_VALUE) | (s2 & ShortCompanionObject.MIN_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4, reason: not valid java name */
    public static final short m1343absoluteValueslo4al4(short s) {
        return m1349constructorimpl((short) (s & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4, reason: not valid java name */
    public static final short m1361roundslo4al4(short s) {
        ...
        return m1349constructorimpl((short) i);
    }

    /* renamed from: ceil-slo4al4, reason: not valid java name */
    public static final short m1345ceilslo4al4(short s) {
        int i = 65535 & s;
        int i2 = s & ShortCompanionObject.MAX_VALUE;
        if (i2 < 15360) {
    ...
    public static final short m1352floorslo4al4(short s) {
        int i = s & UShort.MAX_VALUE;
        int i2 = s & ShortCompanionObject.MAX_VALUE;
        if (i2 < 15360) {
    ...
    public static final short m1372truncslo4al4(short s) {
        int i = 65535 & s;
        int i2 = s & ShortCompanionObject.MAX_VALUE;
        if (i2 < 15360) {
            i = 32768 & s;
    ...
    public static final String m1366toHexStringimpl(short s) {
    ...
    public static final class Companion {
        ...
        public final short floatToHalf(float f) {
            ...
            if (i4 == 255) {
                ...
                int i8 = i4 + PaymentManager.ERROR_TRANSACTION_CLOSED;
                if (i8 >= 31) {
                    i6 = 49;
                } else if (i8 > 0) {
                    i7 = i5 >> 13;
