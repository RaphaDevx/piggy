...
public final class BarcodeArSessionProxyAdapter implements BarcodeArSessionProxy {
    private final NativeBarcodeArSession a;
    ...
    public BarcodeArSessionProxyAdapter(NativeBarcodeArSession _NativeBarcodeArSession, ProxyCache proxyCache) {
        ...
        this.a = _NativeBarcodeArSession;
    ...
    public /* synthetic */ BarcodeArSessionProxyAdapter(NativeBarcodeArSession nativeBarcodeArSession, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeArSession, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
