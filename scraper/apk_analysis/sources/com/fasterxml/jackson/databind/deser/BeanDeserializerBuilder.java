...
public class BeanDeserializerBuilder {
    ...
    public JsonDeserializer<?> build() throws JsonMappingException {
        ...
        return new BeanDeserializer(this, this._beanDesc, construct, this._backRefProperties, this._ignorableProps, this._ignoreAllUnknown, this._includableProps, z2);
    }
