...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m5400boximpl(m5394markNowz9LOYto());
    }
    ...
    public long m5394markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m5403constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m5393elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m5392differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m5391adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m5403constructorimpl(LongSaturatedMathKt.m5389saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
