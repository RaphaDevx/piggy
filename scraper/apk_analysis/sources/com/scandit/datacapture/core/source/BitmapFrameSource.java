...
public final class BitmapFrameSource implements FrameSource, BitmapFrameSourceProxy {
    ...
    private final /* synthetic */ BitmapFrameSourceProxyAdapter a;
    ...
    public static final class Companion {
        ...
        public final BitmapFrameSource fromJson(String json) {
            ...
            Bitmap bitmapFromBase64 = BitmapExtensionsKt.bitmapFromBase64(new JsonValue(json).getByKeyAsString("image", ""));
            if (bitmapFromBase64 == null) {
                return null;
            }
            return of(bitmapFromBase64);
        }
        ...
        public final BitmapFrameSource of(Bitmap bitmap) {
            ...
            if (Intrinsics.areEqual(nativeOrder, ByteOrder.BIG_ENDIAN)) {
            ...
            SingleBitmapFrameDataCollection singleBitmapFrameDataCollection = new SingleBitmapFrameDataCollection(create);
            NativeFrameDataCollectionFrameSource create2 = NativeFrameDataCollectionFrameSource.create(singleBitmapFrameDataCollection.a());
            Intrinsics.checkNotNull(create2);
            return new BitmapFrameSource(create2, singleBitmapFrameDataCollection);
        }
    }
    ...
    public BitmapFrameSource(NativeFrameDataCollectionFrameSource impl, SingleBitmapFrameDataCollection frames) {
        ...
        this.frames = frames;
        this.a = new BitmapFrameSourceProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.b = new CopyOnWriteArraySet();
        impl.addListenerAsync(new b0(new a(this), this));
    }
    ...
    public NativeWrappedFuture _switchToDesiredState(FrameSourceState desiredState) {
        ...
        return this.a._switchToDesiredState(desiredState);
    }
    ...
    public void switchToDesiredState(FrameSourceState desiredState, Callback<? super Boolean> whenDone) {
        Intrinsics.checkNotNullParameter(desiredState, "desiredState");
        this.a.switchToDesiredState(desiredState, whenDone);
    }
}
