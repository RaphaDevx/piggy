...
public final class UStringsKt {
    ...
    public static final String m5277toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m5279toStringolVBNx4(short s, int i) {
    ...
    public static final String m5278toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m5276toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m4040constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m3957boximpl(UByte.m3963constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m4040constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m4220boximpl(UShort.m4226constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m4040constructorimpl = UInt.m4040constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m4040constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int m4040constructorimpl2 = UInt.m4040constructorimpl(i3 * m4040constructorimpl);
            int m4040constructorimpl3 = UInt.m4040constructorimpl(UInt.m4040constructorimpl(digitOf) + m4040constructorimpl2);
            if (Integer.compareUnsigned(m4040constructorimpl3, m4040constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = m4040constructorimpl3;
        }
        return UInt.m4034boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m4119constructorimpl = ULong.m4119constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m4119constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            }
            long m4119constructorimpl2 = ULong.m4119constructorimpl(j * m4119constructorimpl);
            long m4119constructorimpl3 = ULong.m4119constructorimpl(ULong.m4119constructorimpl(UInt.m4040constructorimpl(r13) & 4294967295L) + m4119constructorimpl2);
            if (Long.compareUnsigned(m4119constructorimpl3, m4119constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = m4119constructorimpl3;
        }
