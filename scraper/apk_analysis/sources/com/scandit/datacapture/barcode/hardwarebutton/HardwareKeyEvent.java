...
public final class HardwareKeyEvent {
    ...
    private static final /* synthetic */ HardwareKeyEvent[] a;
    ...
    static {
        ...
        a = hardwareKeyEventArr;
        b = EnumEntriesKt.enumEntries(hardwareKeyEventArr);
    }

    private HardwareKeyEvent(String str, int i) {
    }
    ...
    public static HardwareKeyEvent[] values() {
        return (HardwareKeyEvent[]) a.clone();
    }
}
