...
public final class BarcodeCaptureSettingsProxyAdapter implements BarcodeCaptureSettingsProxy {
    ...
    public BatterySavingMode getBatterySaving() {
        BatterySavingMode batterySavingMode = this.a.getBatterySavingMode();
        Intrinsics.checkNotNull(batterySavingMode);
        return batterySavingMode;
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSettingsProxy
    public EnumSet<CompositeType> getEnabledCompositeTypes() {
        EnumSet<CompositeType> enabledCompositeTypesBits = this.a.getEnabledCompositeTypesBits();
        Intrinsics.checkNotNull(enabledCompositeTypesBits);
    ...
    public ScanIntention getScanIntention() {
        ScanIntention scanIntention = this.a.getScanIntention();
        Intrinsics.checkNotNull(scanIntention);
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        ...
        return (SymbologySettings) proxyCache.getOrPut(orCreateKotlinClass, null, symbologySettings, new U(symbologySettings));
    }
    ...
    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSettingsProxy
    public void setBatterySaving(BatterySavingMode p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setBatterySavingMode(p0);
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSettingsProxy
    public void setEnabledCompositeTypes(EnumSet<CompositeType> p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setEnabledCompositeTypesBits(p0);
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSettingsProxy
    public void setScanIntention(ScanIntention p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        this.a.setScanIntention(p0);
    }
    ...
    public void enableSymbologies(EnumSet<CompositeType> compositeTypes) {
        ...
        this.a.enableSymbologiesForCompositeTypes(compositeTypes);
    }
}
