...
public class EmployeeDiscountCardCredentials {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(final Gson gson, TypeToken<T> typeToken) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<EmployeeDiscountCardCredentials>() { // from class: ch.coop.apidia.appGateway.employeeDiscountCard.model.EmployeeDiscountCardCredentials.CustomTypeAdapterFactory.1
