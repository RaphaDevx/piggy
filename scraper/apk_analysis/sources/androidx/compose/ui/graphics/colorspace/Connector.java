...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m1575equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m1582getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m1575equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m1582getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m1589computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
        ...
        */
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r9, androidx.compose.ui.graphics.colorspace.Rgb r10, int r11) {
            /*
                ...
                r8.mSource = r9
                r8.mDestination = r10
                float[] r9 = r8.m1590computeTransformYBCOT_4(r9, r10, r11)
                r8.mTransform = r9
                return
            */
        ...
        private final float[] m1590computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m1594equalsimpl0(intent, RenderIntent.INSTANCE.m1598getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m1589computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m1594equalsimpl0(intent, RenderIntent.INSTANCE.m1598getAbsoluteuksYyKA())) {
                return null;
            }
            boolean m1575equalsimpl0 = ColorModel.m1575equalsimpl0(source.getModel(), ColorModel.INSTANCE.m1582getRgbxdoWZVw());
            boolean m1575equalsimpl02 = ColorModel.m1575equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m1582getRgbxdoWZVw());
            if (m1575equalsimpl0 && m1575equalsimpl02) {
                return null;
            }
            if (!m1575equalsimpl0 && !m1575equalsimpl02) {
                return null;
            ...
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = m1575equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = m1575equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            ...
            final int m1600getRelativeuksYyKA = RenderIntent.INSTANCE.m1600getRelativeuksYyKA();
            return new Connector(m1600getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(ColorSpace.this, ColorSpace.this, m1600getRelativeuksYyKA, null);
                }
            };
        }
    }
