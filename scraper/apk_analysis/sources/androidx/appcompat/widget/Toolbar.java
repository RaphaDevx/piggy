...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = (this.mButtonGravity & b.p) | GravityCompat.END;
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = (this.mButtonGravity & b.p) | GravityCompat.START;
    ...
    */
    ...
    private int getChildVerticalGravity(int i) {
        int i2 = i & b.p;
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & b.p;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                generateDefaultLayoutParams.gravity = (Toolbar.this.mButtonGravity & b.p) | GravityCompat.START;
                generateDefaultLayoutParams.mViewType = 2;
