...
public final class Brush {
    ...
    public Brush(int i, int i2, float f) {
        this.fillColor = i;
        this.strokeColor = i2;
        this.strokeWidth = f;
    }
    ...
    public final Brush copy(int fillColor, int strokeColor, boolean preserveAlpha) {
        if (preserveAlpha) {
            return new Brush((fillColor & ViewCompat.MEASURED_SIZE_MASK) | ((this.fillColor >>> 24) << 24), (strokeColor & ViewCompat.MEASURED_SIZE_MASK) | ((this.strokeColor >>> 24) << 24), this.strokeWidth);
        }
        if (preserveAlpha) {
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual(Brush.class, other != null ? other.getClass() : null)) {
            return false;
        }
        Intrinsics.checkNotNull(other, "null cannot be cast to non-null type com.scandit.datacapture.core.ui.style.Brush");
