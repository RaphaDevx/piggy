...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public <R> R foldIn(R r, Function2<? super R, ? super Modifier.Element, ? extends R> function2) {
        return (R) IntrinsicSizeModifier.DefaultImpls.foldIn(this, r, function2);
    }

    @Override // androidx.compose.ui.Modifier.Element, androidx.compose.ui.Modifier
    public <R> R foldOut(R r, Function2<? super Modifier.Element, ? super R, ? extends R> function2) {
        return (R) IntrinsicSizeModifier.DefaultImpls.foldOut(this, r, function2);
    }
    ...
    public MeasureResult mo56measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return IntrinsicSizeModifier.DefaultImpls.m300measure3p2s80s(this, measureScope, measurable, j);
    }
    ...
    public long mo299calculateContentConstraintsl58MMJ0(MeasureScope receiver, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.INSTANCE.m2986fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m2977getMaxWidthimpl(j)));
    }
