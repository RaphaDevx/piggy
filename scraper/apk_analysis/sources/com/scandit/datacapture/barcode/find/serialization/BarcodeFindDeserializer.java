...
public final class BarcodeFindDeserializer implements DataCaptureModeDeserializer, BarcodeFindDeserializerProxy {
    ...
    public BarcodeFindDeserializer() {
        ...
        d dVar = new d(aVar);
        NativeBarcodeFindDeserializer create = NativeBarcodeFindDeserializer.create(dVar);
        Intrinsics.checkNotNullExpressionValue(create, "create(...)");
        this.a = aVar;
        this.b = new BarcodeFindDeserializerProxyAdapter(create, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(BarcodeFindDeserializerHelper.class), null, aVar, new a(dVar));
        getA().setListener(new n(new b(this), this));
    }
