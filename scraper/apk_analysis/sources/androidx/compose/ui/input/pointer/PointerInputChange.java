...
public final class PointerInputChange {
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, consumedData, (i2 & 256) != 0 ? PointerType.INSTANCE.m2475getTouchT8wyACA() : i, null);
    }
    ...
    public final PointerInputChange m2424copyEzrO64(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type) {
    ...
    public String toString() {
        return "PointerInputChange(id=" + ((Object) PointerId.m2421toStringimpl(getId())) + ", uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m1033toStringimpl(getPosition())) + ", pressed=" + this.pressed + ", previousUptimeMillis=" + this.previousUptimeMillis + ", previousPosition=" + ((Object) Offset.m1033toStringimpl(getPreviousPosition())) + ", previousPressed=" + this.previousPressed + ", consumed=" + this.consumed + ", type=" + ((Object) PointerType.m2470toStringimpl(getType())) + ')';
    }
}
