...
public final class ZoomGestureListenerReversedAdapter extends NativeZoomGestureListener {
    private final ZoomGestureListener a;
    ...
    public void onZoomInGesture(NativeZoomGesture zoomGesture) {
        ...
        if (zoomGesture2 != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeZoomGesture.class), null, zoomGesture, new d(zoomGesture2));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onZoomInGesture((ZoomGesture) orPut);
        }
    }
    ...
    public void onZoomOutGesture(NativeZoomGesture zoomGesture) {
        ...
        ZoomGesture zoomGesture2 = (ZoomGesture) this.c.get();
        if (zoomGesture2 != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeZoomGesture.class), null, zoomGesture, new e(zoomGesture2));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onZoomOutGesture((ZoomGesture) orPut);
        }
    }
