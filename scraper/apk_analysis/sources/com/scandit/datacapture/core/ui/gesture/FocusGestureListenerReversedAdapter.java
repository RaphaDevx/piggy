...
public final class FocusGestureListenerReversedAdapter extends NativeFocusGestureListener {
    private final FocusGestureListener a;
    ...
    public void onFocusGesture(NativeFocusGesture focusGesture, PointWithUnit point) {
        ...
        if (focusGesture2 != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFocusGesture.class), null, focusGesture, new a(focusGesture2));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onFocusGesture((FocusGesture) orPut, point);
        }
    }
