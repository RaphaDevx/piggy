...
public final class BarcodePickSessionProxyAdapter implements BarcodePickSessionProxy {
    private final NativeBarcodePickPublicSession a;
    ...
    public BarcodePickSessionProxyAdapter(NativeBarcodePickPublicSession _NativeBarcodePickPublicSession, ProxyCache proxyCache) {
        ...
        this.a = _NativeBarcodePickPublicSession;
        this.proxyCache = proxyCache;
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<String> getAddedItems() {
        HashSet<String> addedItems = this.a.getAddedItems();
        Intrinsics.checkNotNull(addedItems);
        return addedItems;
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<TrackedObject> getAddedObjects() {
        HashSet<NativeTrackedObject> addedObjects = this.a.getAddedObjects();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(addedObjects);
    ...
    public Set<String> getTrackedItems() {
        HashSet<String> trackedItems = this.a.getTrackedItems();
        Intrinsics.checkNotNull(trackedItems);
        return trackedItems;
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<TrackedObject> getTrackedObjects() {
        HashSet<NativeTrackedObject> trackedObjects = this.a.getTrackedObjects();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
