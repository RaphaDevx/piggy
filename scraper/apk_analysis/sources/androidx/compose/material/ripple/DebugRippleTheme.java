...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo762defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m924defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m924defaultRippleColor5vOe2sY(Color.INSTANCE.m1280getBlack0d7_KjU(), true);
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m923defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m923defaultRippleAlphaDxMtmZc(Color.INSTANCE.m1280getBlack0d7_KjU(), true);
        composer.endReplaceableGroup();
