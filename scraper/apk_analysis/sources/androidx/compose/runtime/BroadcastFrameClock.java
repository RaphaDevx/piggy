...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                m3945constructorimpl = Result.m3945constructorimpl(getOnFrame().invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m3945constructorimpl = Result.m3945constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(m3945constructorimpl);
        }
    }
        ...
        synchronized (this.lock) {
            ...
            if (size >= 0) {
                ...
                while (true) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuation.resumeWith(Result.m3945constructorimpl(ResultKt.createFailure(cause)));
                    if (i2 > size) {
                        break;
                    } else {
                        i = i2;
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m3945constructorimpl(ResultKt.createFailure(th)));
            } else {
