...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo5447receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo5447receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo5448tryReceivePtdJZtk() {
        return this._channel.mo5448tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo5440trySendJP2dKIU(E element) {
        return this._channel.mo5440trySendJP2dKIU(element);
    }
