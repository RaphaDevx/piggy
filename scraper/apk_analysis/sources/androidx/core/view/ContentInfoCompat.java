...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return Profiling$$ExternalSyntheticApiModelOutline0.m3351m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = Profiling$$ExternalSyntheticApiModelOutline0.m3351m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ClipData clipData, int i) {
            this.mPlatformBuilder = Profiling$$ExternalSyntheticApiModelOutline0.m(clipData, i);
        }

        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            Profiling$$ExternalSyntheticApiModelOutline0.m3362m();
            this.mPlatformBuilder = Profiling$$ExternalSyntheticApiModelOutline0.m3350m(contentInfoCompat.toContentInfo());
        }
