...
public final class Scope implements IScope {
    ...
    public Session withSession(IWithSession iWithSession) {
        ...
        try {
            ...
            Session m3833clone = this.session != null ? this.session.m3833clone() : null;
            if (acquire != null) {
                acquire.close();
            }
            return m3833clone;
    ...
    public SessionPair startSession() {
        ...
        try {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m3833clone(), session != null ? session.m3833clone() : null);
            } else {
    ...
    public Session endSession() {
        ...
        try {
            ...
            if (this.session != null) {
                this.session.end();
                this.options.getContinuousProfiler().reevaluateSampling();
                Session m3833clone = this.session.m3833clone();
                this.session = null;
                session = m3833clone;
            }
            if (acquire != null) {
