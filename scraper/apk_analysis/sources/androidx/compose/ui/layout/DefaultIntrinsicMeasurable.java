...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo2510measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, Constraints.m2976getMaxHeightimpl(constraints));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m2977getMaxWidthimpl(constraints), minIntrinsicHeight);
    }
