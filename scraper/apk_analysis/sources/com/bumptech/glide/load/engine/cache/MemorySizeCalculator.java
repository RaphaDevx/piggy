...
public class MemorySizeCalculator {
    ...
    public MemorySizeCalculator(Context context) {
        this(context, (ActivityManager) context.getSystemService(DataSources.EventTypeValue.ACTIVITY_EVENT_TYPE), new DisplayMetricsScreenDimensions(context.getResources().getDisplayMetrics()));
    }
