...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager, View view) {
        ...
        if (this.isActive) {
            ...
            int m2764getMinimpl = composition == null ? -1 : TextRange.m2764getMinimpl(composition.getPackedValue());
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(view, TextRange.m2764getMinimpl(state.getSelection()), TextRange.m2763getMaximpl(state.getSelection()), m2764getMinimpl, composition2 != null ? TextRange.m2763getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m2760getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m2764getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int m2831getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2831getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2833getGoeUduSuo();
                    break;
                case 3:
                    m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2837getSearcheUduSuo();
                    break;
                case 4:
                    m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2838getSendeUduSuo();
                    break;
                case 5:
                    m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2834getNexteUduSuo();
                    break;
                case 6:
                    m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2832getDoneeUduSuo();
                    break;
                case 7:
                    m2831getDefaulteUduSuo = ImeAction.INSTANCE.m2836getPreviouseUduSuo();
                    break;
                default:
        ...
        getEventCallback().mo2845onImeActionKlQnJC8(m2831getDefaulteUduSuo);
        return true;
    }
