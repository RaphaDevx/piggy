...
public final class SparkScanBarcodeErrorFeedbackDeserializer {
    ...
    public static final SparkScanBarcodeFeedback.Error fromJson(JsonValue json) {
        Feedback defaultErrorFeedback;
        Intrinsics.checkNotNullParameter(json, "json");
        String requireByKeyAsString = json.requireByKeyAsString("message");
        TimeInterval seconds = TimeInterval.INSTANCE.seconds(json.requireByKeyAsFloat("resumeCapturingDelay"));
        ...
        if (byKeyAsObject == null || (defaultErrorFeedback = FeedbackDeserializer.fromJson(byKeyAsObject)) == null) {
            defaultErrorFeedback = SparkScanBarcodeFeedback.INSTANCE.defaultErrorFeedback();
        }
        return new SparkScanBarcodeFeedback.Error(requireByKeyAsString, seconds, byKeyAsAndroidColor, byKeyAsBrush, defaultErrorFeedback);
    }
}
