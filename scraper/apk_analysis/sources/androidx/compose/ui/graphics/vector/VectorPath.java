...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && Intrinsics.areEqual(Reflection.getOrCreateKotlinClass(getClass()), Reflection.getOrCreateKotlinClass(other.getClass()))) {
            ...
            return Intrinsics.areEqual(this.name, vectorPath.name) && Intrinsics.areEqual(this.fill, vectorPath.fill) && this.fillAlpha == vectorPath.fillAlpha && Intrinsics.areEqual(this.stroke, vectorPath.stroke) && this.strokeAlpha == vectorPath.strokeAlpha && this.strokeLineWidth == vectorPath.strokeLineWidth && StrokeCap.m1519equalsimpl0(getStrokeLineCap(), vectorPath.getStrokeLineCap()) && StrokeJoin.m1529equalsimpl0(getStrokeLineJoin(), vectorPath.getStrokeLineJoin()) && this.strokeLineMiter == vectorPath.strokeLineMiter && this.trimPathStart == vectorPath.trimPathStart && this.trimPathEnd == vectorPath.trimPathEnd && this.trimPathOffset == vectorPath.trimPathOffset && PathFillType.m1462equalsimpl0(getPathFillType(), vectorPath.getPathFillType()) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((hashCode2 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m1520hashCodeimpl(getStrokeLineCap())) * 31) + StrokeJoin.m1530hashCodeimpl(getStrokeLineJoin())) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m1463hashCodeimpl(getPathFillType());
    }
}
