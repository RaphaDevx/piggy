...
public final class AnimatedContentScope<S> implements Transition.Segment<S> {
    ...
    public AnimatedContentScope(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt.mutableStateOf$default(IntSize.m3119boximpl(IntSize.INSTANCE.m3132getZeroYbymL2g()), null, 2, null);
    ...
    /* compiled from: AnimatedContent.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u00112\u00020\u0001:\u0001\u0011B\u0014\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\t\u0010\nJ\u0010\u0010\u000b\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\f\u0010\u0005J\u000f\u0010\r\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u000f\u0010\u0010R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0088\u0001\u0002\u0092\u0001\u00020\u0003ø\u0001\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0012"}, d2 = {"Landroidx/compose/animation/AnimatedContentScope$SlideDirection;", "", "value", "", "constructor-impl", "(I)I", "equals", "", Request.JsonKeys.OTHER, "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(I)Ljava/lang/String;", "Companion", "animation_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @JvmInline
    public static final class SlideDirection {
        ...
        public boolean equals(Object obj) {
            return m60equalsimpl(getValue(), obj);
        }

        public int hashCode() {
            return m62hashCodeimpl(getValue());
        }
        ...
        public String toString() {
            return m63toStringimpl(getValue());
        }
    ...
    public static /* synthetic */ EnterTransition m50slideIntoContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return animatedContentScope.m54slideIntoContainerHTTW7Ok(i, finiteAnimationSpec, function1);
    }

    /* renamed from: slideIntoContainer-HTTW7Ok, reason: not valid java name */
    public final EnterTransition m54slideIntoContainerHTTW7Ok(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        if (m48isLeft9jb1Dl8(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$2
                ...
                public final int invoke(int i) {
                    long m47getCurrentSizeYbymL2g;
                    long m47getCurrentSizeYbymL2g2;
                    long m44calculateOffsetemnUabE;
                    Function1<Integer, Integer> function1 = initialOffset;
                    m47getCurrentSizeYbymL2g = this.m47getCurrentSizeYbymL2g();
                    int m3127getWidthimpl = IntSize.m3127getWidthimpl(m47getCurrentSizeYbymL2g);
                    AnimatedContentScope<S> animatedContentScope = this;
                    long IntSize = IntSizeKt.IntSize(i, i);
                    m47getCurrentSizeYbymL2g2 = this.m47getCurrentSizeYbymL2g();
                    m44calculateOffsetemnUabE = animatedContentScope.m44calculateOffsetemnUabE(IntSize, m47getCurrentSizeYbymL2g2);
                    return function1.invoke(Integer.valueOf(m3127getWidthimpl - IntOffset.m3085getXimpl(m44calculateOffsetemnUabE))).intValue();
                }
            }, animationSpec);
        }
        if (m49isRight9jb1Dl8(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
                ...
                public final int invoke(int i) {
                    ...
                    long IntSize = IntSizeKt.IntSize(i, i);
                    m47getCurrentSizeYbymL2g = this.m47getCurrentSizeYbymL2g();
                    m44calculateOffsetemnUabE = animatedContentScope.m44calculateOffsetemnUabE(IntSize, m47getCurrentSizeYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m3085getXimpl(m44calculateOffsetemnUabE)) - i)).intValue();
                }
            }, animationSpec);
        }
        if (SlideDirection.m61equalsimpl0(towards, SlideDirection.INSTANCE.m70getUpaUPqQNE())) {
            return EnterExitTransitionKt.slideInVertically(new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$4
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
                ...
                public final int invoke(int i) {
                    ...
                    Function1<Integer, Integer> function1 = initialOffset;
                    m47getCurrentSizeYbymL2g = this.m47getCurrentSizeYbymL2g();
                    int m3126getHeightimpl = IntSize.m3126getHeightimpl(m47getCurrentSizeYbymL2g);
                    AnimatedContentScope<S> animatedContentScope = this;
                    long IntSize = IntSizeKt.IntSize(i, i);
                    m47getCurrentSizeYbymL2g2 = this.m47getCurrentSizeYbymL2g();
                    m44calculateOffsetemnUabE = animatedContentScope.m44calculateOffsetemnUabE(IntSize, m47getCurrentSizeYbymL2g2);
                    return function1.invoke(Integer.valueOf(m3126getHeightimpl - IntOffset.m3086getYimpl(m44calculateOffsetemnUabE))).intValue();
                }
            }, animationSpec);
        }
        if (SlideDirection.m61equalsimpl0(towards, SlideDirection.INSTANCE.m65getDownaUPqQNE())) {
            return EnterExitTransitionKt.slideInVertically(new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$5
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
                ...
                public final int invoke(int i) {
                    ...
                    m47getCurrentSizeYbymL2g = this.m47getCurrentSizeYbymL2g();
                    m44calculateOffsetemnUabE = animatedContentScope.m44calculateOffsetemnUabE(IntSize, m47getCurrentSizeYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m3086getYimpl(m44calculateOffsetemnUabE)) - i)).intValue();
                }
            }, animationSpec);
        }
    ...
    private final boolean m48isLeft9jb1Dl8(int i) {
        return SlideDirection.m61equalsimpl0(i, SlideDirection.INSTANCE.m67getLeftaUPqQNE()) || (SlideDirection.m61equalsimpl0(i, SlideDirection.INSTANCE.m69getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr) || (SlideDirection.m61equalsimpl0(i, SlideDirection.INSTANCE.m66getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-9jb1Dl8, reason: not valid java name */
    private final boolean m49isRight9jb1Dl8(int i) {
        return SlideDirection.m61equalsimpl0(i, SlideDirection.INSTANCE.m68getRightaUPqQNE()) || (SlideDirection.m61equalsimpl0(i, SlideDirection.INSTANCE.m69getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl) || (SlideDirection.m61equalsimpl0(i, SlideDirection.INSTANCE.m66getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m44calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo957alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: slideOutOfContainer-HTTW7Ok$default, reason: not valid java name */
    public static /* synthetic */ ExitTransition m51slideOutOfContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m3076boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
        ...
        return animatedContentScope.m55slideOutOfContainerHTTW7Ok(i, finiteAnimationSpec, function1);
    }

    /* renamed from: slideOutOfContainer-HTTW7Ok, reason: not valid java name */
    public final ExitTransition m55slideOutOfContainerHTTW7Ok(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(targetOffset, "targetOffset");
        if (SlideDirection.m61equalsimpl0(towards, SlideDirection.INSTANCE.m67getLeftaUPqQNE())) {
            return EnterExitTransitionKt.slideOutHorizontally(new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$2
                ...
                public final int invoke(int i) {
                    ...
                    long m3132getZeroYbymL2g = intSize == null ? IntSize.INSTANCE.m3132getZeroYbymL2g() : intSize.getPackedValue();
                    Function1<Integer, Integer> function1 = targetOffset;
                    m44calculateOffsetemnUabE = this.this$0.m44calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), m3132getZeroYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m3085getXimpl(m44calculateOffsetemnUabE)) - i)).intValue();
                }
            }, animationSpec);
        }
        if (SlideDirection.m61equalsimpl0(towards, SlideDirection.INSTANCE.m68getRightaUPqQNE())) {
            return EnterExitTransitionKt.slideOutHorizontally(new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$3
                final /* synthetic */ AnimatedContentScope<S> this$0;
                ...
                public final int invoke(int i) {
                    ...
                    Function1<Integer, Integer> function1 = targetOffset;
                    m44calculateOffsetemnUabE = this.this$0.m44calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), m3132getZeroYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m3085getXimpl(m44calculateOffsetemnUabE)) + IntSize.m3127getWidthimpl(m3132getZeroYbymL2g))).intValue();
                }
            }, animationSpec);
        }
        if (SlideDirection.m61equalsimpl0(towards, SlideDirection.INSTANCE.m70getUpaUPqQNE())) {
            return EnterExitTransitionKt.slideOutVertically(new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$4
                final /* synthetic */ AnimatedContentScope<S> this$0;
        ...
        if (SlideDirection.m61equalsimpl0(towards, SlideDirection.INSTANCE.m65getDownaUPqQNE())) {
            return EnterExitTransitionKt.slideOutVertically(new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$5
                final /* synthetic */ AnimatedContentScope<S> this$0;
                ...
                public final int invoke(int i) {
                    ...
                    Function1<Integer, Integer> function1 = targetOffset;
                    m44calculateOffsetemnUabE = this.this$0.m44calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), m3132getZeroYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m3086getYimpl(m44calculateOffsetemnUabE)) + IntSize.m3126getHeightimpl(m3132getZeroYbymL2g))).intValue();
                }
            }, animationSpec);
        }
    ...
    public final long m52getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize.getValue()).getPackedValue();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m53setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m3119boximpl(j));
    }
    ...
    public final long m47getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        IntSize value = state == null ? null : state.getValue();
        return value == null ? m52getMeasuredSizeYbymL2g$animation_release() : value.getPackedValue();
    }

    /* renamed from: createSizeAnimationModifier$lambda-2, reason: not valid java name */
    private static final boolean m45createSizeAnimationModifier$lambda2(MutableState<Boolean> mutableState) {
        return mutableState.getValue().booleanValue();
    }

    /* renamed from: createSizeAnimationModifier$lambda-3, reason: not valid java name */
    private static final void m46createSizeAnimationModifier$lambda3(MutableState<Boolean> mutableState, boolean z) {
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(createSizeAnimationModifier)479@21796L40,480@21865L52:AnimatedContent.kt#xbi5r1");
        ...
        if (Intrinsics.areEqual(this.transition.getCurrentState(), this.transition.getTargetState())) {
            m46createSizeAnimationModifier$lambda3(mutableState, false);
        } else if (rememberUpdatedState.getValue() != null) {
            m46createSizeAnimationModifier$lambda3(mutableState, true);
        }
        if (m45createSizeAnimationModifier$lambda2(mutableState)) {
            composer.startReplaceableGroup(-237336232);
            ComposerKt.sourceInformation(composer, "490@22334L48,491@22395L205");
            ...
            if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue2 = (Intrinsics.areEqual((Object) (sizeTransform != null ? Boolean.valueOf(sizeTransform.getClip()) : null), (Object) false) ? Modifier.INSTANCE : ClipKt.clipToBounds(Modifier.INSTANCE)).then(new SizeModifier(this, createDeferredAnimation, rememberUpdatedState));
    ...
    /* compiled from: AnimatedContent.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0080\b\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\t\u0010\u0007\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\b\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\t\u001a\u00020\u00032\b\u0010\n\u001a\u0004\u0018\u00010\u000bHÖ\u0003J\t\u0010\f\u001a\u00020\rHÖ\u0001J\t\u0010\u000e\u001a\u00020\u000fHÖ\u0001J\u0016\u0010\u0010\u001a\u00020\u000b*\u00020\u00112\b\u0010\u0012\u001a\u0004\u0018\u00010\u000bH\u0016R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0002\u0010\u0005\"\u0004\b\u0006\u0010\u0004¨\u0006\u0013"}, d2 = {"Landroidx/compose/animation/AnimatedContentScope$ChildData;", "Landroidx/compose/ui/layout/ParentDataModifier;", "isTarget", "", "(Z)V", "()Z", "setTarget", "component1", "copy", "equals", Request.JsonKeys.OTHER, "", "hashCode", "", "toString", "", "modifyParentData", "Landroidx/compose/ui/unit/Density;", "parentData", "animation_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: AnimatedContent.kt */
    @Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0083\u0004\u0018\u00002\u00020\u0001B6\u0012\u001c\u0010\u0002\u001a\u0018\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00050\u0003R\b\u0012\u0004\u0012\u00028\u00000\u0006\u0012\u000e\u0010\u0007\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\t0\bø\u0001\u0000¢\u0006\u0002\u0010\nJ)\u0010\u000f\u001a\u00020\u0010*\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0015H\u0016ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0016\u0010\u0017R*\u0010\u0002\u001a\u0018\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00050\u0003R\b\u0012\u0004\u0012\u00028\u00000\u0006ø\u0001\u0000¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0019\u0010\u0007\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\t0\b¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e\u0082\u0002\u000b\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001¨\u0006\u0018"}, d2 = {"Landroidx/compose/animation/AnimatedContentScope$SizeModifier;", "Landroidx/compose/ui/layout/LayoutModifier;", "sizeAnimation", "Landroidx/compose/animation/core/Transition$DeferredAnimation;", "Landroidx/compose/ui/unit/IntSize;", "Landroidx/compose/animation/core/AnimationVector2D;", "Landroidx/compose/animation/core/Transition;", "sizeTransform", "Landroidx/compose/runtime/State;", "Landroidx/compose/animation/SizeTransform;", "(Landroidx/compose/animation/AnimatedContentScope;Landroidx/compose/animation/core/Transition$DeferredAnimation;Landroidx/compose/runtime/State;)V", "getSizeAnimation", "()Landroidx/compose/animation/core/Transition$DeferredAnimation;", "getSizeTransform", "()Landroidx/compose/runtime/State;", "measure", "Landroidx/compose/ui/layout/MeasureResult;", "Landroidx/compose/ui/layout/MeasureScope;", "measurable", "Landroidx/compose/ui/layout/Measurable;", "constraints", "Landroidx/compose/ui/unit/Constraints;", "measure-3p2s80s", "(Landroidx/compose/ui/layout/MeasureScope;Landroidx/compose/ui/layout/Measurable;J)Landroidx/compose/ui/layout/MeasureResult;", "animation_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @ExperimentalAnimationApi
        ...
        public MeasureResult mo56measure3p2s80s(MeasureScope receiver, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    ...
                    IntSize value = state == null ? null : state.getValue();
                    long m3132getZeroYbymL2g = value == null ? IntSize.INSTANCE.m3132getZeroYbymL2g() : value.getPackedValue();
                    ...
                    long m3132getZeroYbymL2g2 = value2 == null ? IntSize.INSTANCE.m3132getZeroYbymL2g() : value2.getPackedValue();
                    SizeTransform value3 = this.getSizeTransform().getValue();
                    return value3 == null ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : value3.mo106createAnimationSpecTemP2vQ(m3132getZeroYbymL2g, m3132getZeroYbymL2g2);
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m3119boximpl(m57invokeYEO4UFwYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw-YEO4UFw, reason: not valid java name */
                public final long m57invokeYEO4UFwYEO4UFw(S s) {
                    State<IntSize> state = animatedContentScope2.getTargetSizeMap$animation_release().get(s);
                    IntSize value = state == null ? null : state.getValue();
                    return value == null ? IntSize.INSTANCE.m3132getZeroYbymL2g() : value.getPackedValue();
                }
            });
            this.this$0.setAnimatedSize$animation_release(animate);
            final long mo957alignKFBX0sM = this.this$0.getContentAlignment().mo957alignKFBX0sM(IntSizeKt.IntSize(mo2510measureBRTryo0.getWidth(), mo2510measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.DefaultImpls.layout$default(receiver, IntSize.m3127getWidthimpl(animate.getValue().getPackedValue()), IntSize.m3126getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m2548place70tqf50$default(layout, Placeable.this, mo957alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
