...
public class Transition implements TypedValues {
    ...
    private int mDuration = RemoteCommand.Response.STATUS_BAD_REQUEST;
    ...
    static class OnSwipe {
        ...
        private long mStart;
        public static final String[] SIDES = {RRWebVideoEvent.JsonKeys.TOP, RRWebVideoEvent.JsonKeys.LEFT, "right", "bottom", "middle", "start", "end"};
        private static final float[][] TOUCH_SIDES = {new float[]{0.5f, 0.0f}, new float[]{0.0f, 0.5f}, new float[]{1.0f, 0.5f}, new float[]{0.5f, 1.0f}, new float[]{0.5f, 0.5f}, new float[]{0.0f, 0.5f}, new float[]{1.0f, 0.5f}};
        public static final String[] DIRECTIONS = {"up", "down", RRWebVideoEvent.JsonKeys.LEFT, "right", "start", "end", "clockwise", "anticlockwise"};
