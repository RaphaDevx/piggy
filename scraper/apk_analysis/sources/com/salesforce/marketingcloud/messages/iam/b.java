...
class b extends d {
    ...
    protected void b(View view, k kVar) {
        ...
        if (l.closeButton() == null || d.a(l.title()) || (constraintLayout = (ConstraintLayout) view.findViewById(f())) == null) {
            return;
        }
    ...
    protected float c(Resources resources, InAppMessage.Size size) {
        ...
        return (i == 1 || i == 2) ? resources.getDimension(R.dimen.mcsdk_iam_banner_title_font_large) : resources.getDimension(R.dimen.mcsdk_iam_banner_title_font_small);
    }
    ...
    protected float a(Resources resources, InAppMessage.Size size) {
        ...
        int i = a.a[size.ordinal()];
        return i != 1 ? i != 2 ? resources.getDimension(R.dimen.mcsdk_iam_banner_body_font_small) : resources.getDimension(R.dimen.mcsdk_iam_banner_body_font_medium) : resources.getDimension(R.dimen.mcsdk_iam_banner_body_font_large);
    }
