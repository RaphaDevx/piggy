...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m2620updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 == null ? false : Constraints.m2970equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (this.duringMeasureLayout) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        this.rootConstraints = Constraints.m2965boximpl(constraints);
    ...
    public final boolean m2619doRemeasure0kLqBqw(LayoutNode layoutNode, long rootConstraints) {
        boolean m2599remeasure_Sx5XlM$ui_release$default;
        if (layoutNode == this.root) {
            m2599remeasure_Sx5XlM$ui_release$default = layoutNode.m2602remeasure_Sx5XlM$ui_release(Constraints.m2965boximpl(rootConstraints));
        } else {
            m2599remeasure_Sx5XlM$ui_release$default = LayoutNode.m2599remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m2599remeasure_Sx5XlM$ui_release$default) {
        ...
        try {
            ...
            while (!depthSortedSet.isEmpty()) {
                ...
                if (pop.getIsPlaced() || getCanAffectParent(pop) || pop.getAlignmentLines().getRequired$ui_release()) {
                    if (pop.getLayoutState() == LayoutNode.LayoutState.NeedsRemeasure && m2619doRemeasure0kLqBqw(pop, value)) {
                        z = true;
                    }
