...
public final class PersistentOrderedSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public PersistentSet<E> remove(E element) {
        ...
        if (links.getHasPrevious()) {
            Links links2 = (Links) remove.get(links.getPrevious());
            Intrinsics.checkNotNull(links2);
            remove = remove.put((PersistentHashMap) links.getPrevious(), (Object) links2.withNext(links.getNext()));
        }
        if (links.getHasNext()) {
            Links links3 = (Links) remove.get(links.getNext());
            Intrinsics.checkNotNull(links3);
            remove = remove.put((PersistentHashMap) links.getNext(), (Object) links3.withPrevious(links.getPrevious()));
        }
