...
public final class BarcodeSelectionAimerBehaviorDeserializer {
    ...
    public static final BarcodeSelectionAimerBehavior fromJson(String jsonData) {
        ...
        BarcodeSelectionAimerBehavior barcodeSelectionAimerBehaviorFromJsonString = NativeBarcodeEnumDeserializer.barcodeSelectionAimerBehaviorFromJsonString(jsonData);
        Intrinsics.checkNotNullExpressionValue(barcodeSelectionAimerBehaviorFromJsonString, "barcodeSelectionAimerBehaviorFromJsonString(...)");
        return barcodeSelectionAimerBehaviorFromJsonString;
    }
}
