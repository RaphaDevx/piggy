...
public final class EllipticCurves {
    ...
    public static byte[] ecdsaDer2Ieee(byte[] bArr, int i) throws GeneralSecurityException {
        ...
        int i2 = (bArr[1] & UByte.MAX_VALUE) >= 128 ? 3 : 2;
        int i3 = i2 + 1;
        int i4 = i2 + 2;
        int i5 = bArr[i3];
    ...
    public static boolean isValidDerEncoding(byte[] bArr) {
        ...
        if (i5 != (bArr.length - 1) - i || bArr[i + 1] != 2 || (i4 = (i3 = i + 3 + (i2 = bArr[i + 2] & UByte.MAX_VALUE)) + 1) >= bArr.length || i2 == 0) {
            return false;
        }
        int i6 = i + 3;
        byte b = bArr[i6];
        ...
        if ((i2 > 1 && b == 0 && (bArr[i + 4] & UByte.MAX_VALUE) < 128) || bArr[i6 + i2] != 2) {
            return false;
        }
        ...
        return i7 <= 1 || b2 != 0 || (bArr[(i + 6) + i2] & UByte.MAX_VALUE) >= 128;
    }
