...
public final class ResourceResolver {
    ...
    public final int getStringResIdentifier(String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return getResIdentifier(name, TypedValues.Custom.S_STRING);
    }

    public final InputStream openRawResource(int resId) {
        InputStream openRawResource = AppAndroidEnvironment.INSTANCE.getApplicationContext().getResources().openRawResource(resId);
