...
public class ObjectNode extends ContainerNode<ObjectNode> implements Serializable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0031, code lost:
        ...
        if (r1.isNull() == false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    protected void serializeFilteredContents(com.fasterxml.jackson.core.JsonGenerator r4, com.fasterxml.jackson.databind.SerializerProvider r5, boolean r6, boolean r7) throws java.io.IOException {
        /*
            r3 = this;
        ...
        La:
            ...
            com.fasterxml.jackson.databind.node.BaseJsonNode r1 = (com.fasterxml.jackson.databind.node.BaseJsonNode) r1
            if (r6 == 0) goto L2b
            boolean r2 = r1.isArray()
            if (r2 == 0) goto L2b
            boolean r2 = r1.isEmpty(r5)
            if (r2 == 0) goto L2b
            goto La
        L2b:
            if (r7 == 0) goto L34
