...
public class FileProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        if (lastIndexOf >= 0) {
            ...
            return mimeTypeFromExtension != null ? mimeTypeFromExtension : MediaType.APPLICATION_OCTET_STREAM;
        }
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        private boolean belongsToRoot(String str, String str2) {
            ...
            if (!removeTrailingSlash.equals(removeTrailingSlash2)) {
                if (!removeTrailingSlash.startsWith(removeTrailingSlash2 + JsonPointer.SEPARATOR)) {
                    return false;
                }
            }
            return true;
