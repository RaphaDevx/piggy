...
public final class FrameSaveSessionListenerReversedAdapter extends NativeFrameSaveSessionListener {
    ...
    public void onFrameSaveFailure(NativeFrameSaveSession session, String message, long remainingQueueSize) {
        ...
        if (frameSaveSession != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSaveSession.class), null, session, new f(frameSaveSession));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onFrameSaveFailure((FrameSaveSession) orPut, message, remainingQueueSize);
        }
    }
    ...
    public void onFrameSaveSuccess(NativeFrameSaveSession session, String message, long remainingQueueSize) {
        ...
        FrameSaveSession frameSaveSession = (FrameSaveSession) this.c.get();
        if (frameSaveSession != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSaveSession.class), null, session, new g(frameSaveSession));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onFrameSaveSuccess((FrameSaveSession) orPut, message, remainingQueueSize);
        }
    }
    ...
    public void onObservationStarted(NativeFrameSaveSession session) {
        ...
        FrameSaveSession frameSaveSession = (FrameSaveSession) this.c.get();
        if (frameSaveSession != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSaveSession.class), null, session, new h(frameSaveSession));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onObservationStarted((FrameSaveSession) orPut);
        }
    }
    ...
    public void onObservationStopped(NativeFrameSaveSession session) {
        ...
        FrameSaveSession frameSaveSession = (FrameSaveSession) this.c.get();
        if (frameSaveSession != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSaveSession.class), null, session, new i(frameSaveSession));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onObservationStopped((FrameSaveSession) orPut);
        }
    }
    ...
    public FrameSaveSessionListenerReversedAdapter(FrameSaveSessionListener _FrameSaveSessionListener, FrameSaveSession _FrameSaveSession, ProxyCache proxyCache) {
        ...
        this.a = _FrameSaveSessionListener;
