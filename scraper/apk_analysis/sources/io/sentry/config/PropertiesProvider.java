...
public interface PropertiesProvider {
    ...
    default List<String> getList(String str) {
        ...
        return property != null ? Arrays.asList(property.split(FirebaseConstants.SEPARATOR)) : Collections.emptyList();
    }

    default List<String> getListOrNull(String str) {
        String property = getProperty(str);
        if (property != null) {
            return Arrays.asList(property.split(FirebaseConstants.SEPARATOR));
        }
        return null;
    }
