...
public final class BarcodeCaptureSessionProxyAdapter implements BarcodeCaptureSessionProxy {
    ...
    public List<LocalizedOnlyBarcode> getNewlyLocalizedBarcodes() {
        ...
        Intrinsics.checkNotNull(newlyLocalizedBarcodes);
    ...
    public Barcode getNewlyRecognizedBarcode() {
        NativeBarcode newlyRecognizedBarcode = this.a.getNewlyRecognizedBarcode();
        if (newlyRecognizedBarcode != null) {
            return (Barcode) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcode.class), null, newlyRecognizedBarcode, new T(newlyRecognizedBarcode));
        }
        return null;
    }
    ...
    public List<Barcode> get_newlyRecognizedBarcodes() {
        ...
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        Intrinsics.checkNotNull(newlyRecognizedBarcodes);
