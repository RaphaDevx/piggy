...
public final /* data */ class ChangeSize {
    ...
    public /* synthetic */ ChangeSize(Alignment alignment, AnonymousClass1 anonymousClass1, SpringSpec springSpec, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(alignment, (i & 2) != 0 ? new Function1<IntSize, IntSize>() { // from class: androidx.compose.animation.ChangeSize.1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
                return IntSize.m3119boximpl(m71invokemzRDjE0mzRDjE0(intSize.getPackedValue()));
            }

            /* renamed from: invoke-mzRDjE0-mzRDjE0, reason: not valid java name */
            public final long m71invokemzRDjE0mzRDjE0(long j) {
                return IntSizeKt.IntSize(0, 0);
            }
        } : anonymousClass1, (i & 4) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, IntSize.m3119boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.INSTANCE)), 3, null) : springSpec, (i & 8) != 0 ? true : z);
    }
