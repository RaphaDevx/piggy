...
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
    ...
    public JsonDeserializer<Object> buildThrowableDeserializer(DeserializationContext deserializationContext, JavaType javaType, BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (findMethod != null) {
            ...
            if (propertyNamingStrategy != null) {
                str = propertyNamingStrategy.nameForSetterMethod(config, findMethod, "cause");
            }
    ...
    protected SettableAnyProperty constructAnySetter(DeserializationContext deserializationContext, BeanDescription beanDescription, AnnotatedMember annotatedMember) throws JsonMappingException {
        ...
        if (z) {
            return SettableAnyProperty.constructForMapField(deserializationContext, std, annotatedMember, javaType, keyDeserializer2, jsonDeserializer, typeDeserializer);
        }
        return SettableAnyProperty.constructForMethod(deserializationContext, std, annotatedMember, javaType, keyDeserializer2, jsonDeserializer, typeDeserializer);
    }
