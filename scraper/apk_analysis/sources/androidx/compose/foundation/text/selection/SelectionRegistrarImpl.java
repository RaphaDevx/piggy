...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    private Function4<? super LayoutCoordinates, ? super Offset, ? super Offset, ? super SelectionAdjustment, Unit> onSelectionUpdateCallback;
    ...
    private final MutableState subselections = SnapshotStateKt.mutableStateOf$default(MapsKt.emptyMap(), null, 2, null);
    ...
    public final Function4<LayoutCoordinates, Offset, Offset, SelectionAdjustment, Unit> getOnSelectionUpdateCallback$foundation_release() {
        return this.onSelectionUpdateCallback;
    }

    public final void setOnSelectionUpdateCallback$foundation_release(Function4<? super LayoutCoordinates, ? super Offset, ? super Offset, ? super SelectionAdjustment, Unit> function4) {
        ...
        if (!this.sorted) {
            CollectionsKt.sortWith(this._selectables, new Comparator() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl$sort$1
                ...
                public final int compare(Selectable a, Selectable b) {
                    long m1041getZeroF1C5BW0;
                    long m1041getZeroF1C5BW02;
                    ...
                    if (layoutCoordinates != null) {
                        m1041getZeroF1C5BW0 = LayoutCoordinates.this.mo2523localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m1041getZeroF1C5BW0());
                    } else {
                        m1041getZeroF1C5BW0 = Offset.INSTANCE.m1041getZeroF1C5BW0();
                    }
                    if (layoutCoordinates2 != null) {
                        m1041getZeroF1C5BW02 = LayoutCoordinates.this.mo2523localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m1041getZeroF1C5BW0());
                    } else {
                        m1041getZeroF1C5BW02 = Offset.INSTANCE.m1041getZeroF1C5BW0();
                    }
                    if (Offset.m1026getYimpl(m1041getZeroF1C5BW0) == Offset.m1026getYimpl(m1041getZeroF1C5BW02)) {
                        return ComparisonsKt.compareValues(Float.valueOf(Offset.m1025getXimpl(m1041getZeroF1C5BW0)), Float.valueOf(Offset.m1025getXimpl(m1041getZeroF1C5BW02)));
                    }
                    return ComparisonsKt.compareValues(Float.valueOf(Offset.m1026getYimpl(m1041getZeroF1C5BW0)), Float.valueOf(Offset.m1026getYimpl(m1041getZeroF1C5BW02)));
                }
            });
            this.sorted = true;
        }
    ...
    public void mo580notifySelectionUpdateStartd4ec7I(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment) {
        ...
        function3.invoke(layoutCoordinates, Offset.m1014boximpl(startPosition), adjustment);
    }
    ...
    public void mo579notifySelectionUpdated4ec7I(LayoutCoordinates layoutCoordinates, long endPosition, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        ...
        function4.invoke(layoutCoordinates, null, Offset.m1014boximpl(endPosition), adjustment);
    }

    @Override // androidx.compose.foundation.text.selection.SelectionRegistrar
    /* renamed from: notifySelectionUpdate-DUneCvk */
    public void mo578notifySelectionUpdateDUneCvk(LayoutCoordinates layoutCoordinates, long startPosition, long endPosition, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        Function4<? super LayoutCoordinates, ? super Offset, ? super Offset, ? super SelectionAdjustment, Unit> function4 = this.onSelectionUpdateCallback;
        if (function4 == null) {
        ...
        function4.invoke(layoutCoordinates, Offset.m1014boximpl(startPosition), Offset.m1014boximpl(endPosition), adjustment);
    }
