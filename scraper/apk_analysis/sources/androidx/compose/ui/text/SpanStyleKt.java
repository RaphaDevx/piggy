...
public final class SpanStyleKt {
    ...
    public static final long m2742lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m3166isUnspecifiedR2X_6o(j) || TextUnitKt.m3166isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m3138boximpl(j), TextUnit.m3138boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m3168lerpC3pnCVY(j, j2, f);
    }

    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float f) {
        Intrinsics.checkNotNullParameter(start, "start");
        Intrinsics.checkNotNullParameter(stop, "stop");
        long m1306lerpjxsXWHM = ColorKt.m1306lerpjxsXWHM(start.getColor(), stop.getColor(), f);
        FontFamily fontFamily = (FontFamily) lerpDiscrete(start.getFontFamily(), stop.getFontFamily(), f);
        long m2742lerpTextUnitInheritableC3pnCVY = m2742lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), f);
        ...
        long m2742lerpTextUnitInheritableC3pnCVY2 = m2742lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), f);
        BaselineShift baselineShift = start.getBaselineShift();
        float m2913constructorimpl = baselineShift == null ? BaselineShift.m2913constructorimpl(0.0f) : baselineShift.getMultiplier();
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float m2925lerpjWV1Mfo = BaselineShiftKt.m2925lerpjWV1Mfo(m2913constructorimpl, baselineShift2 == null ? BaselineShift.m2913constructorimpl(0.0f) : baselineShift2.getMultiplier(), f);
        ...
        long m1306lerpjxsXWHM2 = ColorKt.m1306lerpjxsXWHM(start.getBackground(), stop.getBackground(), f);
        ...
        return new SpanStyle(m1306lerpjxsXWHM, m2742lerpTextUnitInheritableC3pnCVY, lerp, fontStyle, fontSynthesis, fontFamily, str, m2742lerpTextUnitInheritableC3pnCVY2, BaselineShift.m2912boximpl(m2925lerpjWV1Mfo), lerp2, localeList, m1306lerpjxsXWHM2, textDecoration, ShadowKt.lerp(shadow, shadow2, f), null);
    }
}
