...
public abstract class SparkScanBarcodeFeedback {
    ...
    public static final class Error extends SparkScanBarcodeFeedback {
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Error(String message, TimeInterval resumeCapturingDelay, int i) {
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Error(String message, TimeInterval resumeCapturingDelay, int i, Brush brush) {
        ...
        public Error(String message, TimeInterval resumeCapturingDelay, int i, Brush brush, Feedback feedback) {
            super(null);
            Intrinsics.checkNotNullParameter(message, "message");
            Intrinsics.checkNotNullParameter(resumeCapturingDelay, "resumeCapturingDelay");
            Intrinsics.checkNotNullParameter(brush, "brush");
    ...
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0010\u0018\u00002\u00020\u0001B)\b\u0007\u0012\b\b\u0002\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0004\u0012\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\u0006¢\u0006\u0004\b\b\u0010\tR\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\u0017\u0010\u0005\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u000e\u0010\u000f\u001a\u0004\b\u0010\u0010\u0011R\u0019\u0010\u0007\u001a\u0004\u0018\u00010\u00068\u0006¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0016"}, d2 = {"Lcom/scandit/datacapture/barcode/spark/feedback/SparkScanBarcodeFeedback$Success;", "Lcom/scandit/datacapture/barcode/spark/feedback/SparkScanBarcodeFeedback;", "", "visualFeedbackColor", "Lcom/scandit/datacapture/core/ui/style/Brush;", "brush", "Lcom/scandit/datacapture/core/common/feedback/Feedback;", io.sentry.protocol.Feedback.TYPE, "<init>", "(ILcom/scandit/datacapture/core/ui/style/Brush;Lcom/scandit/datacapture/core/common/feedback/Feedback;)V", "a", "I", "getVisualFeedbackColor", "()I", "b", "Lcom/scandit/datacapture/core/ui/style/Brush;", "getBrush", "()Lcom/scandit/datacapture/core/ui/style/Brush;", "c", "Lcom/scandit/datacapture/core/common/feedback/Feedback;", "getFeedback", "()Lcom/scandit/datacapture/core/common/feedback/Feedback;", "scandit-barcode-capture"}, k = 1, mv = {1, 9, 0})
    public static final class Success extends SparkScanBarcodeFeedback {
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Success(int i, Brush brush) {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Success(int i, Brush brush, Feedback feedback) {
            super(null);
            Intrinsics.checkNotNullParameter(brush, "brush");
            this.visualFeedbackColor = i;
            this.brush = brush;
    ...
    public final String toJson() {
        ...
        if (this instanceof Error) {
            ...
            if (error.getFeedback() != null) {
                jSONObject2.put(io.sentry.protocol.Feedback.TYPE, new JSONObject(error.getFeedback().toJson()));
            }
            ...
            if (success.getFeedback() != null) {
                jSONObject3.put(io.sentry.protocol.Feedback.TYPE, new JSONObject(success.getFeedback().toJson()));
            }
