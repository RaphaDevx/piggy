...
public final class Feedback {
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual(Feedback.class, other != null ? other.getClass() : null)) {
            return false;
        }
        Intrinsics.checkNotNull(other, "null cannot be cast to non-null type com.scandit.datacapture.core.common.feedback.Feedback");
        Feedback feedback = (Feedback) other;
        return Intrinsics.areEqual(this.vibration, feedback.vibration) && Intrinsics.areEqual(this.sound, feedback.sound);
    }
    ...
    public Feedback(Vibration vibration, Sound sound) {
        ...
        this.sound = sound;
        this.c = FeedbackEmitterFactoryHolder.INSTANCE.getInstance().create(vibration, sound, AppAndroidEnvironment.INSTANCE.getApplicationContext());
