...
public final class DataCaptureContextFrameListenerReversedAdapter extends NativeDataCaptureContextFrameListener {
    ...
    public void onFrameProcessingFinished(NativeDataCaptureContext context, NativeFrameData data) {
        ...
        if (dataCaptureContext != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContext.class), null, context, new g(dataCaptureContext));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            FrameData frameData = (FrameData) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameData.class), null, data, new h(data));
    ...
    public void onFrameProcessingStarted(NativeDataCaptureContext context, NativeFrameData data) {
        ...
        DataCaptureContext dataCaptureContext = (DataCaptureContext) this.c.get();
        if (dataCaptureContext != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContext.class), null, context, new i(dataCaptureContext));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            FrameData frameData = (FrameData) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameData.class), null, data, new j(data));
    ...
    public void onObservationStarted(NativeDataCaptureContext context) {
        ...
        DataCaptureContext dataCaptureContext = (DataCaptureContext) this.c.get();
        if (dataCaptureContext != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContext.class), null, context, new k(dataCaptureContext));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
    ...
    public void onObservationStopped(NativeDataCaptureContext context) {
        ...
        DataCaptureContext dataCaptureContext = (DataCaptureContext) this.c.get();
        if (dataCaptureContext != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeDataCaptureContext.class), null, context, new l(dataCaptureContext));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
