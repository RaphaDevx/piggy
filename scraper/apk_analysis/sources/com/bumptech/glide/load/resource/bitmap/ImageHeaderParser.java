...
public class ImageHeaderParser {
    ...
    */
    public int getOrientation() throws java.io.IOException {
        ...
        L31:
            if (r0 == 0) goto L3d
            com.bumptech.glide.load.resource.bitmap.ImageHeaderParser$RandomAccessReader r0 = new com.bumptech.glide.load.resource.bitmap.ImageHeaderParser$RandomAccessReader
            r0.<init>(r6)
            int r6 = parseExifSegment(r0)
            return r6
        L3d:
            return r1
        */
