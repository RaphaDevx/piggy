...
public final class BarcodeProxyAdapter implements BarcodeProxy {
    ...
    public StructuredAppendData getStructuredAppendData() {
        ...
        if (structuredAppendData != null) {
            return (StructuredAppendData) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeAbstractStructuredAppendData.class), null, structuredAppendData, new b(structuredAppendData));
        }
        return null;
    }
