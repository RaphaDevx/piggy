...
public final /* data */ class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m2979getMinWidthimpl(j) : Constraints.m2978getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m2977getMaxWidthimpl(j) : Constraints.m2976getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m2978getMinHeightimpl(j) : Constraints.m2979getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m2976getMaxHeightimpl(j) : Constraints.m2977getMaxWidthimpl(j));
    }
    ...
    public final long m307toBoxConstraintsOenEA2s(LayoutOrientation orientation) {
