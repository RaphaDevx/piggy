...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean z, float f, State<Color> state, State<RippleAlpha> state2, RippleContainer rippleContainer) {
        ...
        this.rippleHostView = SnapshotStateKt.mutableStateOf$default(null, null, 2, null);
        this.invalidateTick = SnapshotStateKt.mutableStateOf$default(true, null, 2, null);
        this.rippleSize = Size.INSTANCE.m1103getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        this.rippleSize = contentDrawScope.mo1627getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m917getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo1627getSizeNHjbRc()));
        } else {
            i = contentDrawScope.mo222roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        ...
        m921drawStateLayerH2RKhps(contentDrawScope2, this.radius, value);
        ...
        rippleHostView.m920updateRipplePropertiesbiQXAtU(contentDrawScope.mo1627getSizeNHjbRc(), this.rippleRadius, value, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m919addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().getValue(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
