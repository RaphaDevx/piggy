...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1244boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1255equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m1255equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m1255equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m1255equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m1255equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m1255equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m1255equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m1255equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m1255equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m1255equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m1261hashCodeimpl(this.thumbColor) * 31) + Color.m1261hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m1261hashCodeimpl(this.activeTrackColor)) * 31) + Color.m1261hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m1261hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m1261hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m1261hashCodeimpl(this.activeTickColor)) * 31) + Color.m1261hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m1261hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m1261hashCodeimpl(this.disabledInactiveTickColor);
    }
}
