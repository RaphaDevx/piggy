...
public final class ScanditIconDeserializer {
    ...
    public static final ScanditIcon fromJson(String json) {
        ...
        ScanditIconBuilder builder = ScanditIcon.INSTANCE.builder();
        ...
        if (byKeyAsString.length() > 0) {
            builder.withIcon(ScanditIconTypeDeserializer.fromJson(byKeyAsString));
        }
        if (byKeyAsString2.length() > 0) {
            builder.withBackgroundShape(ScanditIconShapeDeserializer.fromJson(byKeyAsString2));
        }
        builder.withBackgroundStrokeWidth(byKeyAsFloat);
        if (byKeyAsNullableColor != null) {
            builder.withIconColor(Integer.valueOf(byKeyAsNullableColor.intValue()));
        }
        if (byKeyAsNullableColor2 != null) {
            builder.withBackgroundColor(Integer.valueOf(byKeyAsNullableColor2.intValue()));
        }
        if (byKeyAsNullableColor3 != null) {
            builder.withBackgroundStrokeColor(Integer.valueOf(byKeyAsNullableColor3.intValue()));
        }
