...
public final class c implements SparkScanViewSettingsDeserializer {
    ...
    public final void a(SparkScanViewSettings settings, JsonValue json) {
        ...
        if (json.contains("defaultCameraPosition")) {
            CameraPosition cameraPositionFromJsonString = NativeEnumDeserializer.cameraPositionFromJsonString(json.requireByKeyAsString("defaultCameraPosition"));
            Intrinsics.checkNotNullExpressionValue(cameraPositionFromJsonString, "cameraPositionFromJsonString(...)");
            settings.setDefaultCameraPosition(cameraPositionFromJsonString);
        }
