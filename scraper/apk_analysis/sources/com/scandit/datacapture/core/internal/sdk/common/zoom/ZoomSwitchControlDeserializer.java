...
public final class ZoomSwitchControlDeserializer {
    ...
    public static final void updateFromJson(ZoomSwitchControl control, JsonValue json) {
        ...
        String byKeyAsNullableString$scandit_capture_core = json.getByKeyAsNullableString$scandit_capture_core("contentDescriptionWhenZoomedOut", null);
        if (byKeyAsNullableString$scandit_capture_core != null) {
            control.setContentDescriptionWhenZoomedOut(byKeyAsNullableString$scandit_capture_core);
        }
        String byKeyAsNullableString$scandit_capture_core2 = json.getByKeyAsNullableString$scandit_capture_core("contentDescriptionWhenZoomedIn", null);
        if (byKeyAsNullableString$scandit_capture_core2 != null) {
            control.setContentDescriptionWhenZoomedIn(byKeyAsNullableString$scandit_capture_core2);
        }
        if (bitmap4 == null) {
            bitmap4 = control.getDefaultZoomedOutImage();
        }
        control.setZoomedOutImage(bitmap4);
        if (bitmap2 == null) {
            bitmap2 = control.getDefaultZoomedOutPressedImage();
        }
        control.setZoomedOutPressedImage(bitmap2);
        if (bitmap3 == null) {
            bitmap3 = control.getDefaultZoomedInImage();
        }
        control.setZoomedInImage(bitmap3);
        if (bitmap == null) {
            bitmap = control.getDefaultZoomedInPressedImage();
        }
        control.setZoomedInPressedImage(bitmap);
    }
}
