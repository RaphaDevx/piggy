...
public interface BarcodeArInfoAnnotationListener {
    ...
    public static final class DefaultImpls {
        ...
        public static void onInfoAnnotationLeftIconTapped(BarcodeArInfoAnnotationListener barcodeArInfoAnnotationListener, BarcodeArInfoAnnotation annotation, BarcodeArInfoAnnotationBodyComponent component, int i) {
            Intrinsics.checkNotNullParameter(annotation, "annotation");
            Intrinsics.checkNotNullParameter(component, "component");
        }

        public static void onInfoAnnotationRightIconTapped(BarcodeArInfoAnnotationListener barcodeArInfoAnnotationListener, BarcodeArInfoAnnotation annotation, BarcodeArInfoAnnotationBodyComponent component, int i) {
            Intrinsics.checkNotNullParameter(annotation, "annotation");
            Intrinsics.checkNotNullParameter(component, "component");
        }
