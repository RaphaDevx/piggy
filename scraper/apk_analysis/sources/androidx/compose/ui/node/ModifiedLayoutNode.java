...
public final class ModifiedLayoutNode extends DelegatingLayoutNodeWrapper<LayoutModifier> {
    ...
    public Placeable mo2510measureBRTryo0(long constraints) {
        ...
        modifiedLayoutNode.m2547setMeasurementConstraintsBRTryo0(constraints);
        setMeasureResult$ui_release(getModifier().mo56measure3p2s80s(getMeasureScope(), getWrapped(), constraints));
        ModifiedLayoutNode modifiedLayoutNode2 = this;
        OwnedLayer layer = modifiedLayoutNode.getLayer();
        if (layer != null) {
            layer.mo2629resizeozmzZPI(modifiedLayoutNode.getMeasuredSize());
        }
    ...
    public int calculateAlignmentLine(AlignmentLine alignmentLine) {
        ...
        mo2511placeAtf8xVGno(getPosition(), getZIndex(), getLayerBlock());
        setShallowPlacing(false);
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            m3085getXimpl = IntOffset.m3086getYimpl(getWrapped().getPosition());
        } else {
            m3085getXimpl = IntOffset.m3085getXimpl(getWrapped().getPosition());
        }
        return i + m3085getXimpl;
    }
    ...
    /* compiled from: ModifiedLayoutNode.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/node/ModifiedLayoutNode$Companion;", "", "()V", "modifierBoundsPaint", "Landroidx/compose/ui/graphics/Paint;", "getModifierBoundsPaint", "()Landroidx/compose/ui/graphics/Paint;", "ui_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    static {
        ...
        Paint.mo1146setColor8_81llA(Color.INSTANCE.m1281getBlue0d7_KjU());
