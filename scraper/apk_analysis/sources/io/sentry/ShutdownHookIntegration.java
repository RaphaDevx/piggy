...
public final class ShutdownHookIntegration implements Integration, Closeable {
    ...
    public void register(final IScopes iScopes, final SentryOptions sentryOptions) {
        ...
        if (sentryOptions.isEnableShutdownHook()) {
            ...
            handleShutdownInProgress(new Runnable() { // from class: io.sentry.ShutdownHookIntegration$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ShutdownHookIntegration.this.m3835lambda$register$1$iosentryShutdownHookIntegration(sentryOptions);
                }
            });
        } else {
    ...
    /* synthetic */ void m3835lambda$register$1$iosentryShutdownHookIntegration(SentryOptions sentryOptions) {
    ...
    public void close() throws IOException {
        if (this.thread != null) {
            handleShutdownInProgress(new Runnable() { // from class: io.sentry.ShutdownHookIntegration$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ShutdownHookIntegration.this.m3834lambda$close$2$iosentryShutdownHookIntegration();
                }
            });
        }
    }
    ...
    /* synthetic */ void m3834lambda$close$2$iosentryShutdownHookIntegration() {
