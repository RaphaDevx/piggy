...
public final class RectangularViewfinderStyleDeserializer {
    ...
    public static final RectangularViewfinderStyle fromJson(String json) {
        ...
        NativeRectangularViewfinderStyle rectangularViewfinderStyleFromJsonString = NativeEnumDeserializer.rectangularViewfinderStyleFromJsonString(json);
        Intrinsics.checkNotNullExpressionValue(rectangularViewfinderStyleFromJsonString, "rectangularViewfinderStyleFromJsonString(...)");
        return RectangularViewfinderStyleKt.fromNative(rectangularViewfinderStyleFromJsonString);
    }
}
