...
public final class BarcodeCountStateListenerReversedAdapter extends NativeBarcodeCountStateListener {
    private final BarcodeCountStateListener a;
    ...
    public void onObservationStarted(NativeBarcodeCount mode) {
        ...
        if (barcodeCount != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeCount.class), null, mode, new l(barcodeCount));
    ...
    public void onObservationStopped(NativeBarcodeCount mode) {
        ...
        BarcodeCount barcodeCount = (BarcodeCount) this.c.get();
        if (barcodeCount != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeCount.class), null, mode, new m(barcodeCount));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
    ...
    public void onStateChanged(BarcodeCountState oldState, BarcodeCountState newState, NativeFrameData frameData, NativeBarcodeCount mode) {
        ...
        BarcodeCount barcodeCount = (BarcodeCount) this.c.get();
        if (barcodeCount != null) {
            FrameData frameData2 = (FrameData) this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameData.class), null, frameData, new n(frameData));
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeBarcodeCount.class), null, mode, new o(barcodeCount));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            this.a.onStateChanged(oldState, newState, frameData2, (BarcodeCount) orPut);
        }
    }
    ...
    public BarcodeCountStateListenerReversedAdapter(BarcodeCountStateListener _BarcodeCountStateListener, BarcodeCount _BarcodeCount, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_BarcodeCountStateListener, "_BarcodeCountStateListener");
        Intrinsics.checkNotNullParameter(_BarcodeCount, "_BarcodeCount");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _BarcodeCountStateListener;
