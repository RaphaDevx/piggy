...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    */
    public void mo2442onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r5, androidx.compose.ui.input.pointer.PointerEventPass r6, long r7) {
        /*
            r4 = this;
        ...
        L78:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo2442onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            while (true) {
                ...
                if (PointerEventKt.anyChangeConsumed(changes.get(i2))) {
                    if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                        ...
                        m1014boximpl = layoutCoordinates$ui_release != null ? Offset.m1014boximpl(layoutCoordinates$ui_release.mo2524localToRootMKHz9U(Offset.INSTANCE.m1041getZeroF1C5BW0())) : null;
                        if (m1014boximpl != null) {
                            long packedValue = m1014boximpl.getPackedValue();
                            final PointerInteropFilter pointerInteropFilter = this.this$0;
                            PointerInteropUtils_androidKt.m2462toCancelMotionEventScoped4ec7I(pointerEvent, packedValue, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                                {
                                    super(1);
                                }
        ...
        m1014boximpl = layoutCoordinates$ui_release2 != null ? Offset.m1014boximpl(layoutCoordinates$ui_release2.mo2524localToRootMKHz9U(Offset.INSTANCE.m1041getZeroF1C5BW0())) : null;
        if (m1014boximpl != null) {
            long packedValue2 = m1014boximpl.getPackedValue();
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m2463toMotionEventScoped4ec7I(pointerEvent, packedValue2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
