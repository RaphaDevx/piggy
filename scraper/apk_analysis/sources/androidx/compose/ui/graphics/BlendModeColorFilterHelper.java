...
final class BlendModeColorFilterHelper {
    ...
    public final BlendModeColorFilter m1207BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new BlendModeColorFilter(ColorKt.m1309toArgb8_81llA(color), AndroidBlendMode_androidKt.m1117toAndroidBlendModes9anfk8(blendMode));
    }
}
