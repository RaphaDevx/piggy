...
final class RequiredMaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long mo299calculateContentConstraintsl58MMJ0(MeasureScope receiver, Measurable measurable, long j) {
        ...
        return Constraints.INSTANCE.m2987fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m2976getMaxHeightimpl(j)));
    }
