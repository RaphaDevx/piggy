...
public final class BarcodeFilterHighlightSettings implements BarcodeFilterOverlaySettingsProxy {
    ...
    private final /* synthetic */ BarcodeFilterOverlaySettingsProxyAdapter a;
    ...
    public BarcodeFilterHighlightSettings(NativeBarcodeFilterOverlaySettings impl) {
        ...
        this.a = new BarcodeFilterOverlaySettingsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeFilterOverlaySettings getA() {
        return this.a.getA();
    }
    ...
    public BarcodeFilterHighlightType getHighlightType() {
        return this.a.getHighlightType();
    }
}
