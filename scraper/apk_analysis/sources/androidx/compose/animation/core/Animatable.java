...
public final class Animatable<T, V extends AnimationVector> {
    ...
    public final Object animateDecay(T t, DecayAnimationSpec<T> decayAnimationSpec, Function1<? super Animatable<T, V>, Unit> function1, Continuation<? super AnimationResult<T, V>> continuation) {
        return runAnimation(new DecayAnimation((DecayAnimationSpec) decayAnimationSpec, (TwoWayConverter) getTypeConverter(), (Object) getValue(), (AnimationVector) getTypeConverter().getConvertToVector().invoke(t)), t, function1, continuation);
    }
    ...
    public final Object runAnimation(Animation<T, V> animation, T t, Function1<? super Animatable<T, V>, Unit> function1, Continuation<? super AnimationResult<T, V>> continuation) {
        return MutatorMutex.mutate$default(this.mutatorMutex, null, new Animatable$runAnimation$2(this, t, animation, getInternalState$animation_core_release().getLastFrameTimeNanos(), function1, null), continuation, 1, null);
    }
    ...
    public final T clampToBounds(T value) {
        ...
        return i != 0 ? this.typeConverter.getConvertFromVector().invoke(invoke) : value;
    }
