...
public final class OutlineKt {
    public static final void addOutline(Path path, Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.DefaultImpls.m1457addPathUv8p0NA$default(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }

    /* renamed from: drawOutline-hn5TExg$default, reason: not valid java name */
    public static /* synthetic */ void m1444drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        m1443drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }
    ...
    public static final void drawOutline(Canvas canvas, Outline outline, Paint paint) {
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            if (roundRectPath != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m1000getXimpl(rounded.getRoundRect().m1073getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m1001getYimpl(rounded.getRoundRect().m1073getBottomLeftCornerRadiuskKHJgLs()), paint);
                return;
            }
        }
        if (!(outline instanceof Outline.Generic)) {
    ...
    public static final boolean hasSameCornerRadius(RoundRect roundRect) {
        return ((CornerRadius.m1000getXimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m1000getXimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m1000getXimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m1000getXimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m1000getXimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m1000getXimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m1000getXimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m1000getXimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m1000getXimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m1000getXimpl(roundRect.m1075getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m1000getXimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m1000getXimpl(roundRect.m1075getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0) && ((CornerRadius.m1001getYimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m1001getYimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m1001getYimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m1001getYimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m1001getYimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m1001getYimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m1001getYimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m1001getYimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m1001getYimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m1001getYimpl(roundRect.m1075getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m1001getYimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m1001getYimpl(roundRect.m1075getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0);
    }

    /* renamed from: drawOutline-wDX37Ww, reason: not valid java name */
    public static final void m1445drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            drawOutline.mo1623drawRectnJ9OG0(j, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                ...
                drawOutline.mo1625drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m1000getXimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), style, f, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo1619drawPathLG529CI(path, j, f, style, colorFilter, i);
    }

    /* renamed from: drawOutline-hn5TExg, reason: not valid java name */
    public static final void m1443drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo1622drawRectAsUm42w(brush, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                RoundRect roundRect = rounded.getRoundRect();
                drawOutline.mo1624drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m1000getXimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, style, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo1618drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
}
