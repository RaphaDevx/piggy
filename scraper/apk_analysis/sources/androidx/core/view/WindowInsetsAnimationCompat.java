...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(Profiling$$ExternalSyntheticApiModelOutline0.m(i, interpolator, j));
        }
        ...
        private static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation m3353m = Profiling$$ExternalSyntheticApiModelOutline0.m3353m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(m3353m);
                    fraction = m3353m.getFraction();
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            Profiling$$ExternalSyntheticApiModelOutline0.m3370m$1();
            return Profiling$$ExternalSyntheticApiModelOutline0.m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
