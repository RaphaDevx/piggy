...
final class RenderNodeMatrixCache {
    ...
    public final float[] m2652getMatrixGrdbGEg(DeviceRenderNode renderNode) {
    ...
    public final float[] m2651getInverseMatrixGrdbGEg(DeviceRenderNode renderNode) {
        Intrinsics.checkNotNullParameter(renderNode, "renderNode");
