...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m3945constructorimpl = Result.m3945constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m3945constructorimpl = Result.m3945constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m3951isFailureimpl(m3945constructorimpl) ? null : m3945constructorimpl);
