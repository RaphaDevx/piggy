...
public final class AndroidPath implements Path {
    ...
    public int mo1158getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m1466getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m1467getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo1160setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m1462equalsimpl0(i, PathFillType.INSTANCE.m1466getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1000getXimpl(roundRect.m1075getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1001getYimpl(roundRect.m1075getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1000getXimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1001getYimpl(roundRect.m1076getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1000getXimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1001getYimpl(roundRect.m1074getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1000getXimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1001getYimpl(roundRect.m1073getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA, reason: not valid java name */
    public void mo1157addPathUv8p0NA(Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1025getXimpl(offset), Offset.m1026getYimpl(offset));
            return;
        }
    ...
    public void mo1161translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1025getXimpl(offset), Offset.m1026getYimpl(offset));
    ...
    public boolean mo1159opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m1471equalsimpl0(operation, PathOperation.INSTANCE.m1475getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m1471equalsimpl0(operation, PathOperation.INSTANCE.m1476getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m1471equalsimpl0(operation, PathOperation.INSTANCE.m1477getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m1471equalsimpl0(operation, PathOperation.INSTANCE.m1478getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
