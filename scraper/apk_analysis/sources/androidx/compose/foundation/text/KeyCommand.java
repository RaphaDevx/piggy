...
public enum KeyCommand {
    ...
    public static KeyCommand[] valuesCustom() {
        KeyCommand[] valuesCustom = values();
        return (KeyCommand[]) Arrays.copyOf(valuesCustom, valuesCustom.length);
    }
}
