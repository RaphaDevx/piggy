...
public final class BarcodeArSettingsProxyAdapter implements BarcodeArSettingsProxy {
    private final NativeBarcodeArSettings a;
    ...
    public BarcodeArSettingsProxyAdapter(NativeBarcodeArSettings _NativeBarcodeArSettings, ProxyCache proxyCache) {
        Intrinsics.checkNotNullParameter(_NativeBarcodeArSettings, "_NativeBarcodeArSettings");
        Intrinsics.checkNotNullParameter(proxyCache, "proxyCache");
        this.a = _NativeBarcodeArSettings;
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        ...
        return (SymbologySettings) proxyCache.getOrPut(orCreateKotlinClass, null, symbologySettings, new d(symbologySettings));
    }
    ...
    public /* synthetic */ BarcodeArSettingsProxyAdapter(NativeBarcodeArSettings nativeBarcodeArSettings, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeArSettings, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
