...
public final class SurfaceKt {
    ...
    */
    public static final void m855SurfaceFjzlyU(androidx.compose.ui.Modifier r23, androidx.compose.ui.graphics.Shape r24, long r25, long r27, androidx.compose.foundation.BorderStroke r29, float r30, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, androidx.compose.runtime.Composer r32, final int r33, final int r34) {
        /*
            Method dump skipped, instructions count: 456
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m855SurfaceFjzlyU(androidx.compose.ui.Modifier, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m853Surface9VG74zQ(final kotlin.jvm.functions.Function0<kotlin.Unit> r28, androidx.compose.ui.Modifier r29, androidx.compose.ui.graphics.Shape r30, long r31, long r33, androidx.compose.foundation.BorderStroke r35, float r36, androidx.compose.foundation.interaction.MutableInteractionSource r37, androidx.compose.foundation.Indication r38, boolean r39, java.lang.String r40, androidx.compose.ui.semantics.Role r41, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r42, androidx.compose.runtime.Composer r43, final int r44, final int r45, final int r46) {
        /*
            Method dump skipped, instructions count: 834
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m853Surface9VG74zQ(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.foundation.Indication, boolean, java.lang.String, androidx.compose.ui.semantics.Role, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: Surface-F-jzlyU, reason: not valid java name */
    public static final void m854SurfaceFjzlyU(final Modifier modifier, final Shape shape, final long j, final long j2, final BorderStroke borderStroke, final float f, final Modifier modifier2, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        char c;
        long j3;
        Composer composer2;
        ...
        if (((i3 & 23967451) ^ 4793490) != 0 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            float m3007constructorimpl = Dp.m3007constructorimpl(((Dp) consume2).getValue() + f);
            if (Color.m1255equalsimpl0(j, MaterialTheme.INSTANCE.getColors(startRestartGroup, 0).m682getSurface0d7_KjU()) && elevationOverlay != null) {
                startRestartGroup.startReplaceableGroup(-750961487);
                ComposerKt.sourceInformation(startRestartGroup, "246@11763L31");
                c = 0;
                j3 = elevationOverlay.mo712apply7g2Lkgo(j, m3007constructorimpl, startRestartGroup, (i3 >> 6) & 14);
            ...
            providedValueArr[c] = ContentColorKt.getLocalContentColor().provides(Color.m1244boximpl(j2));
            providedValueArr[1] = ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m3005boximpl(m3007constructorimpl));
            composer2 = startRestartGroup;
            final long j4 = j3;
            CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda(composer2, -819902387, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$6
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if (((i4 & 11) ^ 2) != 0 || !composer3.getSkipping()) {
                        Modifier then = ClipKt.clip(BackgroundKt.m144backgroundbw27NRU(ShadowKt.m964shadowziNgDLE(Modifier.this, f, shape, false).then(borderStroke != null ? BorderKt.border(Modifier.INSTANCE, borderStroke, shape) : Modifier.INSTANCE), j4, shape), shape).then(modifier2);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$7
            ...
            public final void invoke(Composer composer3, int i4) {
                SurfaceKt.m854SurfaceFjzlyU(Modifier.this, shape, j, j2, borderStroke, f, modifier2, (Function2<? super Composer, ? super Integer, Unit>) function2, composer3, i | 1);
            }
        });
    }
}
