...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo56measure3p2s80s(final MeasureScope receiver, Measurable measurable, long j) {
        ...
        final Placeable mo2510measureBRTryo0 = measurable.mo2510measureBRTryo0(Constraints.m2968copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo2510measureBRTryo0.getHeight(), Constraints.m2976getMaxHeightimpl(j));
        return MeasureScope.DefaultImpls.layout$default(receiver, mo2510measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke == null ? null : invoke.getValue(), false, mo2510measureBRTryo0.getWidth());
                this.getScrollerPosition().update(Orientation.Vertical, cursorRectInScroller, min, mo2510measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo2510measureBRTryo0, 0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
