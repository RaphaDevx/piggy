...
public class ConstraintWidget {
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2) {
        ...
        serializeAttribute(sb, CardsAccountDigitalPaymentCardLoadWithSuperpointsStatusBlocksPeriod.SERIALIZED_NAME_MAX, i3, Integer.MAX_VALUE);
    ...
    public StringBuilder serialize(StringBuilder sb) {
        sb.append("{\n");
        serializeAnchor(sb, RRWebVideoEvent.JsonKeys.LEFT, this.mLeft);
        serializeAnchor(sb, RRWebVideoEvent.JsonKeys.TOP, this.mTop);
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append(StringUtils.LF);
        getSceneString(sb, RRWebVideoEvent.JsonKeys.LEFT, this.mLeft);
        getSceneString(sb, RRWebVideoEvent.JsonKeys.TOP, this.mTop);
