...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo56measure3p2s80s(final MeasureScope receiver, Measurable measurable, long j) {
        ...
        final Placeable mo2510measureBRTryo0 = measurable.mo2510measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m2976getMaxHeightimpl(j)) < Constraints.m2977getMaxWidthimpl(j) ? j : Constraints.m2968copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo2510measureBRTryo0.getWidth(), Constraints.m2977getMaxWidthimpl(j));
        return MeasureScope.DefaultImpls.layout$default(receiver, min, mo2510measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke == null ? null : invoke.getValue(), MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo2510measureBRTryo0.getWidth());
                this.getScrollerPosition().update(Orientation.Horizontal, cursorRectInScroller, min, mo2510measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, mo2510measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
