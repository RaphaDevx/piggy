...
public final class BarcodeArInfoAnnotationWidthPreset {
    ...
    private static final /* synthetic */ BarcodeArInfoAnnotationWidthPreset[] a;
    ...
    static {
        ...
        a = barcodeArInfoAnnotationWidthPresetArr;
        b = EnumEntriesKt.enumEntries(barcodeArInfoAnnotationWidthPresetArr);
    }

    private BarcodeArInfoAnnotationWidthPreset(String str, int i) {
    }
    ...
    public static BarcodeArInfoAnnotationWidthPreset[] values() {
        return (BarcodeArInfoAnnotationWidthPreset[]) a.clone();
    }
    ...
    public final float toPaddingAndCornerRadius$scandit_barcode_capture() {
        ...
        return PixelExtensionsKt.pxFromDp$default(f, (Context) null, 1, (Object) null);
    }
    ...
    public final int toPixels$scandit_barcode_capture() {
        ...
        return PixelExtensionsKt.pxFromDp$default(i, (Context) null, 1, (Object) null);
    }
}
