...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m2435copy1boDhkU(long id, long uptime, long positionOnScreen, long position, boolean down, int type) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m2419equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m1022equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m1022equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && PointerType.m2468equalsimpl0(this.type, pointerInputEventData.type);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public int hashCode() {
        int m2420hashCodeimpl = ((((((PointerId.m2420hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m1027hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m1027hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((m2420hashCodeimpl + i) * 31) + PointerType.m2469hashCodeimpl(this.type);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m2421toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m1033toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m1033toStringimpl(this.position)) + ", down=" + this.down + ", type=" + ((Object) PointerType.m2470toStringimpl(this.type)) + ')';
    }
    ...
    public final long m2436getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m2438getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m2437getPositionF1C5BW0() {
        return this.position;
    }
