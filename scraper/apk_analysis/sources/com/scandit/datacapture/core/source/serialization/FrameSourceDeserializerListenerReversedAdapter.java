...
public final class FrameSourceDeserializerListenerReversedAdapter extends NativeFrameSourceDeserializerListener {
    ...
    public void onCameraSettingsDeserializationFinished(NativeFrameSourceDeserializer deserializer, NativeCameraSettings settings, NativeJsonValue json) {
        ...
        if (frameSourceDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSourceDeserializer.class), null, deserializer, new b(frameSourceDeserializer));
    ...
    public void onCameraSettingsDeserializationStarted(NativeFrameSourceDeserializer deserializer, NativeCameraSettings settings, NativeJsonValue json) {
        ...
        FrameSourceDeserializer frameSourceDeserializer = (FrameSourceDeserializer) this.c.get();
        if (frameSourceDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSourceDeserializer.class), null, deserializer, new d(frameSourceDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            CameraSettings convert = CoreNativeTypeFactory.INSTANCE.convert(settings);
    ...
    public void onFrameSourceDeserializationFinished(NativeFrameSourceDeserializer deserializer, NativeFrameSource frameSource, NativeJsonValue json) {
        ...
        FrameSourceDeserializer frameSourceDeserializer = (FrameSourceDeserializer) this.c.get();
        if (frameSourceDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSourceDeserializer.class), null, deserializer, new f(frameSourceDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            FrameSource frameSource2 = (FrameSource) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeFrameSource.class), null, frameSource);
    ...
    public void onFrameSourceDeserializationStarted(NativeFrameSourceDeserializer deserializer, NativeFrameSource frameSource, NativeJsonValue json) {
        ...
        FrameSourceDeserializer frameSourceDeserializer = (FrameSourceDeserializer) this.c.get();
        if (frameSourceDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.getOrCreateKotlinClass(NativeFrameSourceDeserializer.class), null, deserializer, new h(frameSourceDeserializer));
            Intrinsics.checkNotNullExpressionValue(orPut, "getOrPut(...)");
            FrameSource frameSource2 = (FrameSource) this.proxyCache.require(Reflection.getOrCreateKotlinClass(NativeFrameSource.class), null, frameSource);
