...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", BuildConfig.PUBLISH_SETTINGS_VERSION, "6", "7", "8", "9", "10"};
        sSmallIntStrs2 = new String[]{PluginCall.CALLBACK_ID_DANGLING, "-2", "-3", "-4", "-5", "-6", "-7", "-8", "-9", "-10"};
    }
