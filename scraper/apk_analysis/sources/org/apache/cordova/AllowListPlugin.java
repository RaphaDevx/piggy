    ...
    private class CustomConfigXmlParser extends ConfigXmlParser {
        ...
        public void handleStartTag(XmlPullParser xml) {
            ...
            if (name.equals("allow-navigation")) {
                String attributeValue2 = xml.getAttributeValue(null, RRWebMetaEvent.JsonKeys.HREF);
            ...
            if (name.equals("allow-intent")) {
                AllowListPlugin.this.allowedIntents.addAllowListEntry(xml.getAttributeValue(null, RRWebMetaEvent.JsonKeys.HREF), false);
                return;
            }
