...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo40measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
        ...
        if (size == 1) {
            ...
            return MeasureScope.DefaultImpls.layout$default(Layout, mo2510measureBRTryo0.getWidth(), mo2510measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                {
                    super(1);
                }
        ...
        if (size2 >= 0) {
            ...
            while (true) {
                int i5 = i4 + 1;
                arrayList.add(measurables.get(i4).mo2510measureBRTryo0(j));
                if (i5 > size2) {
                    break;
                }
                i4 = i5;
