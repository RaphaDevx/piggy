...
public final class AndroidComposeView_androidKt {
    ...
    public static final void m2644preTransformJiSxe2E(float[] fArr, float[] fArr2) {
        float m2642dotp89u6pk = m2642dotp89u6pk(fArr2, 0, fArr, 0);
        float m2642dotp89u6pk2 = m2642dotp89u6pk(fArr2, 0, fArr, 1);
        float m2642dotp89u6pk3 = m2642dotp89u6pk(fArr2, 0, fArr, 2);
        float m2642dotp89u6pk4 = m2642dotp89u6pk(fArr2, 0, fArr, 3);
        float m2642dotp89u6pk5 = m2642dotp89u6pk(fArr2, 1, fArr, 0);
        float m2642dotp89u6pk6 = m2642dotp89u6pk(fArr2, 1, fArr, 1);
        float m2642dotp89u6pk7 = m2642dotp89u6pk(fArr2, 1, fArr, 2);
        float m2642dotp89u6pk8 = m2642dotp89u6pk(fArr2, 1, fArr, 3);
        float m2642dotp89u6pk9 = m2642dotp89u6pk(fArr2, 2, fArr, 0);
        float m2642dotp89u6pk10 = m2642dotp89u6pk(fArr2, 2, fArr, 1);
        float m2642dotp89u6pk11 = m2642dotp89u6pk(fArr2, 2, fArr, 2);
        float m2642dotp89u6pk12 = m2642dotp89u6pk(fArr2, 2, fArr, 3);
        float m2642dotp89u6pk13 = m2642dotp89u6pk(fArr2, 3, fArr, 0);
        float m2642dotp89u6pk14 = m2642dotp89u6pk(fArr2, 3, fArr, 1);
        float m2642dotp89u6pk15 = m2642dotp89u6pk(fArr2, 3, fArr, 2);
        float m2642dotp89u6pk16 = m2642dotp89u6pk(fArr2, 3, fArr, 3);
        fArr[0] = m2642dotp89u6pk;
        fArr[1] = m2642dotp89u6pk2;
        fArr[2] = m2642dotp89u6pk3;
        fArr[3] = m2642dotp89u6pk4;
        fArr[4] = m2642dotp89u6pk5;
        fArr[5] = m2642dotp89u6pk6;
        fArr[6] = m2642dotp89u6pk7;
        fArr[7] = m2642dotp89u6pk8;
        fArr[8] = m2642dotp89u6pk9;
        fArr[9] = m2642dotp89u6pk10;
        fArr[10] = m2642dotp89u6pk11;
        fArr[11] = m2642dotp89u6pk12;
        fArr[12] = m2642dotp89u6pk13;
        fArr[13] = m2642dotp89u6pk14;
        fArr[14] = m2642dotp89u6pk15;
        fArr[15] = m2642dotp89u6pk16;
    }
    ...
    private static final float m2642dotp89u6pk(float[] fArr, int i, float[] fArr2, int i2) {
        int i3 = i * 4;
    ...
    public static final void m2643invertToJiSxe2E(float[] fArr, float[] fArr2) {
        float f = fArr[0];
        float f2 = fArr[1];
        float f3 = fArr[2];
        float f4 = fArr[3];
