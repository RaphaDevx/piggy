...
final class zzge implements Callable {
    ...
    public final /* bridge */ /* synthetic */ Object call() throws Exception {
        ...
        if (!"_iap".equals(zzawVar.zza) && !"_iapx".equals(zzawVar.zza)) {
            zzr.zzt.zzay().zzc().zzc("Generating a payload for this event is not available. package_name, event_name", str3, zzawVar.zza);
            return null;
        }
        ...
        try {
            ...
            if (zzj == null) {
                ...
                zzt.zzad(1);
                zzt.zzZ(ProfileChunk.PLATFORM_ANDROID);
                ...
                try {
                    ...
                    zzr.zzt.zzv().zzM(zzb, zzr.zzt.zzf().zzd(str3));
                    ...
                    if (zzr.zzt.zzv().zzae(zzt.zzap())) {
                        ...
                        zzr.zzt.zzv().zzO(bundle2, NotificationMessage.NOTIF_KEY_REQUEST_ID, 1L);
                    }
                    ...
                    zzpd.zzc();
                    if (zzr.zzt.zzf().zzs(null, zzdu.zzal)) {
                        str2 = str;
                    ...
                    if (zzr.zzt.zzf().zzs(null, zzdu.zzar)) {
                    ...
                    zzr.zzf.zzi().zzC();
                    try {
                        return zzr.zzf.zzu().zzy(((com.google.android.gms.internal.measurement.zzgb) zza.zzaC()).zzbu());
