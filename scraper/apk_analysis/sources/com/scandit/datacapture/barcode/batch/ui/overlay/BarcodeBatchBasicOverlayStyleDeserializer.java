...
public final class BarcodeBatchBasicOverlayStyleDeserializer {
    ...
    public static final BarcodeBatchBasicOverlayStyle fromJson(String json) {
        ...
        NativeBarcodeTrackingBasicOverlayStyle barcodeTrackingBasicOverlayStyleFromJsonString = NativeBarcodeEnumDeserializer.barcodeTrackingBasicOverlayStyleFromJsonString(json);
        Intrinsics.checkNotNullExpressionValue(barcodeTrackingBasicOverlayStyleFromJsonString, "barcodeTrackingBasicOver…yStyleFromJsonString(...)");
        return BarcodeBatchBasicOverlayStyleKt.fromNative(barcodeTrackingBasicOverlayStyleFromJsonString);
    }
}
