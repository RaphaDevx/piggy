    ...
    private static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        */
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            this.pos = 4 + j;
            return (UnsafeUtil.getByte(j) & UByte.MAX_VALUE) | ((UnsafeUtil.getByte(1 + j) & UByte.MAX_VALUE) << 8) | ((UnsafeUtil.getByte(2 + j) & UByte.MAX_VALUE) << 16) | ((UnsafeUtil.getByte(j + 3) & UByte.MAX_VALUE) << 24);
        }
