...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m927setColorDxMtmZc(long color, float alpha) {
        long m926calculateRippleColor5vOe2sY = m926calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m1255equalsimpl0(color2.getValue(), m926calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m1244boximpl(m926calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m1309toArgb8_81llA(m926calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m926calculateRippleColor5vOe2sY(long color, float alpha) {
        return Color.m1253copywmQWz5c$default(color, alpha, 0.0f, 0.0f, 0.0f, 14, null);
    }

    /* compiled from: RippleHostView.android.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, d2 = {"Landroidx/compose/material/ripple/UnprojectedRipple$MRadiusHelper;", "", "()V", "setRadius", "", "ripple", "Landroid/graphics/drawable/RippleDrawable;", "radius", "", "material-ripple_release"}, k = 1, mv = {1, 5, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
