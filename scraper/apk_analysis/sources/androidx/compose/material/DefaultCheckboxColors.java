...
final class DefaultCheckboxColors implements CheckboxColors {
    ...
    public State<Color> checkmarkColor(ToggleableState state, Composer composer, int i) {
        ...
        State<Color> m99animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m99animateColorAsStateKTwxG1Y(j, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
        composer.endReplaceableGroup();
        return m99animateColorAsStateKTwxG1Y;
    }
    ...
    public State<Color> boxColor(boolean z, ToggleableState state, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m99animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
            composer.endReplaceableGroup();
        } else {
