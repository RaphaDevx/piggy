...
public final class BarcodeBatch implements DataCaptureMode, BarcodeBatchProxy {
    ...
    private final BarcodeBatchSession a;
    private final /* synthetic */ BarcodeBatchProxyAdapter b;
    private DataCaptureContext c;
    private com.scandit.datacapture.barcode.internal.module.batch.capture.a d;
    ...
    public static final class Companion {
        ...
        public final BarcodeBatch forDataCaptureContext(DataCaptureContext dataCaptureContext, BarcodeBatchSettings settings) {
            ...
            ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.getOrCreateKotlinClass(BarcodeBatch.class), null, barcodeBatch, new C0262b(barcodeBatch));
    ...
    public BarcodeBatch(NativeBarcodeTracking impl, BarcodeBatchSession session) {
        ...
        this.a = session;
        this.b = new BarcodeBatchProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.listeners = new CopyOnWriteArrayList();
        impl.addListenerAsync(new BarcodeBatchListenerReversedAdapter(new C0263c(this), this, null, 4, null), 1);
    }
    ...
    public static final void access$updateFreezeIndicator(BarcodeBatch barcodeBatch, BarcodeBatchSettings barcodeBatchSettings) {
        com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar = barcodeBatch.d;
        if (aVar != null) {
        ...
        barcodeBatch.d = aVar2;
    }

    public static /* synthetic */ void applySettings$default(BarcodeBatch barcodeBatch, BarcodeBatchSettings barcodeBatchSettings, Runnable runnable, int i, Object obj) {
        if ((i & 2) != 0) {
            runnable = null;
        }
    ...
    public final BarcodeBatchSession getA() {
        return this.a;
    }
    ...
    public final BarcodeBatchLicenseInfo getBarcodeBatchLicenseInfo() {
        NativeBarcodeTrackingLicenseInfo barcodeTrackingLicenseInfo = getA().getBarcodeTrackingLicenseInfo();
    ...
    public final void applySettings(BarcodeBatchSettings settings, Runnable whenDone) {
        ...
        com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar = this.d;
        if (aVar != null) {
            removeListener(aVar);
        }
    ...
    */
    public BarcodeBatch(com.scandit.datacapture.core.capture.DataCaptureContext r1, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSettings r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
        /*
            r0 = this;
            if (r1 == 0) goto L7
        ...
        L7:
            r1 = 0
        L8:
            com.scandit.datacapture.barcode.batch.internal.module.capture.NativeBarcodeTrackingSettings r2 = r2._impl()
            ...
            com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSession r2 = new com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSession
            com.scandit.datacapture.barcode.batch.capture.a r3 = new com.scandit.datacapture.barcode.batch.capture.a
            r3.<init>(r1)
            r2.<init>(r3)
            r0.<init>(r1, r2)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scandit.datacapture.barcode.batch.capture.BarcodeBatch.<init>(com.scandit.datacapture.core.capture.DataCaptureContext, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSettings, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
}
