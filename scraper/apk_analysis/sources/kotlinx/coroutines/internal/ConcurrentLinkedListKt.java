    ...
    public static final <S extends Segment<S>> Object findSegmentInternal(S s, long j, Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s.id >= j && !s.isRemoved()) {
                return SegmentOrClosed.m5510constructorimpl(s);
            }
            Object nextOrClosed = s.getNextOrClosed();
            if (nextOrClosed == CLOSED) {
                return SegmentOrClosed.m5510constructorimpl(CLOSED);
            }
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m5515isClosedimpl(findSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, i, segment, m5513getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m5515isClosedimpl(findSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, obj, segment, m5513getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m5513getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m5515isClosedimpl(findSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, segment, m5513getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m5513getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
